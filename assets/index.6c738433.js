...
);`}],Jt=[{kind:"create",name:"offers",statement:`CREATE OR REPLACE PIPELINE offers AS
...
ON DUPLICATE KEY UPDATE
  ...
  SET center = GEOGRAPHY_POINT(@lng, @lat);`},{kind:"start",statement:"START PIPELINE IF NOT RUNNING worldcities;"}];const ni=e=>{const t=[Ye,He,We,Jt];for(const o of t){const r=o.find(a=>a.name===e);if(r)return r}throw new Error("Could not find schema object: "+e)},ci=e=>{const t=di.find(o=>o.name===e);if(t)return t;throw new Error("Could not find pipeline "+e)},li=async e=>{try{return await ft(e,"SELECT 1"),!0}catch{return!1}},si=async e=>{let t={tables:[],procedures:[],functions:[]};const c=e,{database:o}=c,r=M(c,["database"]);try{t=(await gt(r,`
        ...
        `,o,o)).reduce((l,[u,p])=>(l[u].push(p),l),t)}catch(l){if(!(l instanceof P&&(l.isUnknownDatabase()||l.isDatabaseRecovering())))throw l}const{tables:a,procedures:d,functions:n}=t;return Object.fromEntries([We.map(({name:l})=>[l,l&&a.includes(l)]),He.map(({name:l})=>[l,l&&d.includes(l)]),Ye.map(({name:l})=>[l,l&&n.includes(l)])].flat())},Zt=e=>ft(e,"DROP DATABASE IF EXISTS `"+e.database+"`"),pi=async(e,{progress:t,includeSeedData:o,resetDataOnly:r=!1})=>{r||(t("Dropping existing schema","info"),await Zt(e),t("Creating database","info"),await ft(e,"CREATE DATABASE `"+e.database+"`")),r&&(t("Resetting data","info"),await gi(e),await yi(e));for(const a of Ye)t(`Creating function: ${a.name}`,"info"),await v(e,a.statement);for(const a of We)t(`Creating table: ${a.name}`,"info"),await v(e,a.statement);for(const a of He)t(`Creating procedure: ${a.name}`,"info"),await v(e,a.statement);t("Creating New York","info"),await Kt(e,ot),o&&(t("Creating sample data","info"),await Qt(e)),t("Schema initialized","success")},Qt=async e=>{for(const t of Jt)await v(e,t.statement)},ui=(e,t,o)=>{const r=100*o.partitions,a=Qr(t,r);return $r(e,a)},we=["locations","requests","purchases"],eo=async(e,t)=>{const o=t.prefix,r=await j(e,`
      SELECT
    ...
    `);try{await Promise.all(t.map(({planId:o})=>v(e,`DROP ${o} FROM PLANCACHE`)))}catch(o){if(!(o instanceof P&&o.isPlanMissing()))throw o}return t.length>0},mi=(e,...t)=>{const o=t.map(r=>`"${r}"`).join(",");return Wt(e,`
      ...
      GROUP BY tableName
    `,e.database,e.database)},je=(e,...t)=>mi(e,...t).then(o=>o.reduce((r,{tableName:a,count:d})=>(r[a]=d,r),{})),vi=async(e,t)=>{const{maxRows:o}=t,a=["locations","requests","purchases","notifications"].map(n=>`"${n}"`).join(","),d=await Wt(e,`
      SELECT
...
`):q(e)}))},Mi=()=>s(oe,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(oe,{maxW:"container.md",mb:4,children:i(S,{children:`
          ...
          `})}),i(z,{flex:2,children:i(bo,{height:400,defaultZoom:14,useCells:Vi,colorInterpolater:Qo,getCellConfig:({conversionRate:e,wktPolygon:t})=>({value:e,wktPolygon:t})})})]}),_e=({label:e,placeholder:t,value:o,setValue:r,helpText:a,type:d="text"})=>s(ct,{children:[i(lt,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),i(Mt,{size:"sm",placeholder:t,value:o,onChange:n=>r(n.target.value),type:d}),a?i(er,{fontSize:"xs",children:a}):null]}),$i=()=>{const[e,t]=B(fe);return s(ct,{children:[i(lt,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),i(tr,{size:"sm",required:!0,value:e.name,onChange:o=>{const r=o.target.value;t(Ri(r))},children:X.map(o=>i("option",{value:o.name,children:o.name},o.name))})]})},To=({showDatabase:e,showScaleFactor:t})=>{const[o,r]=B(co),[a,d]=B(lo),[n,c]=B(so),[l,u]=B(de);return s(G,{spacing:4,children:[i(_e,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:o,setValue:r,helpText:i(S,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [Data API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),s(ge,{columns:2,gap:2,children:[i(_e,{label:"Username",placeholder:"admin",value:a,setValue:d}),i(_e,{label:"Password",placeholder:"",value:n,setValue:c,type:"password"}),e&&i(_e,{label:"Database",placeholder:"martech",value:l,setValue:u}),t&&i($i,{})]})]})},No=e=>i(I,N(E({onClick:()=>{const{pathname:t,hash:o}=window.location;window.location.replace(t+o)},colorScheme:"red"},e),{children:"Disconnect"})),ke=e=>{const{connected:t,initialized:o}=O(),r=st(),[a,d]=re(),n=m(de),c=ue.useRef(null),h=e,{skipSeedData:l,resetDataOnly:u,disabled:p}=h,y=M(h,["skipSeedData","resetDataOnly","disabled"]),f=wi({before:g.exports.useCallback(()=>d.on(),[d]),after:mo(()=>{d.off(),r.onClose()},[r,d]),includeSeedData:!l,resetDataOnly:!!u});return s(C,{children:[i(I,E({disabled:!t||p,onClick:r.onOpen,colorScheme:o?"green":"red"},y)),i(or,{isOpen:r.isOpen,onClose:r.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:c,children:i(xe,{children:s(rr,{children:[s(ze,{fontSize:"lg",fontWeight:"bold",children:[o?"Reset":"Setup"," database ",n]}),s(Pe,{children:["This will ",o?"recreate":"create"," the database called ",n,". Are you sure?"]}),s(Ut,{children:[i(I,{ref:c,onClick:r.onClose,disabled:a,children:"Cancel"}),i(I,{disabled:a,colorScheme:o?"red":"green",onClick:f,ml:3,children:a?i(W,{}):o?"Recreate database":"Create database"})]})]})})})]})},qi=({isOpen:e,onClose:t,finalFocusRef:o})=>{const[r,a]=B(ne),{session:d,refresh:n}=ve(),c=r&&d.isController,l=m(b),{connected:u,initialized:p,isVapor:y}=O(),f=st(),[h,A]=re(!1),T=g.exports.useCallback(async()=>{A.on();const Z=!(r&&d.isController);a(Z),await ao(l,d.sessionID,Z),n(),A.off()},[l,r,n,d.isController,d.sessionID,a,A]),[L,w]=re(!1),V=g.exports.useCallback(async()=>{w.on(),await Zt(l),w.off()},[l,w]);return s(ir,{isOpen:e,placement:"right",onClose:t,finalFocusRef:o,children:[i(xe,{}),s(ar,{children:[i(pt,{}),i(ze,{children:"Config"}),i(Pe,{children:s(G,{spacing:4,children:[y?null:i(To,{showScaleFactor:!0,showDatabase:!0}),s(Q,{status:u?"success":"error",borderRadius:"md",children:[i(ee,{}),i(Ne,{children:u?"connected":"disconnected"}),y?i(No,{position:"absolute",right:4,top:3,size:"xs"}):null]}),s(Q,{status:p?"success":"warning",borderRadius:"md",children:[i(ee,{}),i(Ne,{children:"schema"}),i(ke,{position:"absolute",right:4,top:3,size:"xs",children:p?"Reset":"Setup"})]}),s(Q,{status:c?"success":"warning",borderRadius:"md",children:[i(ee,{}),i(Ne,{children:"simulator"}),i(dr,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:c?"green":"red",isChecked:c,disabled:!u||!p||h,onChange:T})]}),s(ie,{onClick:f.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",f.isOpen?i(nr,{ml:2}):i(le,{ml:2})]}),f.isOpen?i(I,{size:"xs",_hover:{colorScheme:"red"},onClick:V,disabled:L,children:"Drop Database"}):void 0]})}),i(Ut,{})]})]})},Te=({to:e,children:t,onClick:o})=>{const r=gr(e),a=fr({path:r.pathname,end:!0});return i($,{as:Pt,to:e,px:2,py:1,onClick:o,rounded:"md",_hover:{textDecoration:"none",bg:Oe("gray.300","gray.600")},fontWeight:a?"bold":"normal",href:"#",color:Oe("gray.700","gray.200"),children:t})},Xi=()=>{const{colorMode:e,toggleColorMode:t}=Me(),o=st(),[r,a]=B(uo),d=ue.useRef(null),{connected:n,initialized:c}=O(),l=m(ne),[u]=ut("(max-width: 640px)"),{session:p}=ve(),y=s(C,{children:[i(Te,{to:"/",onClick:o.onClose,children:"Map"}),i(Te,{to:"/overview",onClick:o.onClose,children:"Overview"}),i(Te,{to:"/admin",onClick:o.onClose,children:"Admin"}),i(Te,{to:"/analytics",onClick:o.onClose,children:"Analytics"})]}),f=n?c&&l&&p.isController?"green":"yellow":"red";let h;return u||(h=n?c?l&&p.isController?"connected":"simulator disabled":"needs schema":"disconnected"),i(C,{children:i(z,{bg:Oe("gray.200","gray.700"),children:s(oe,{maxW:"container.lg",children:[s(Ce,{h:16,alignItems:"center",justifyContent:"space-between",children:[i(Xe,{size:"md",icon:o.isOpen?i(cr,{}):i(lr,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:o.isOpen?o.onClose:o.onOpen}),s(Le,{spacing:8,alignItems:"center",children:[i(yt,{as:"h1",size:u?"sm":"md",children:u?"Martech":"Realtime Digital Marketing"}),i(Le,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:y})]}),s(Ce,{alignItems:"center",gap:2,children:[s(I,{size:"sm",ref:d,onClick:()=>a(!0),colorScheme:f,children:[f==="green"?i(Bt,{}):i(Ft,{}),u||i(ie,{pl:2,children:h})]}),i(Xe,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?i(sr,{size:"1.4em"}):i(pr,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),i(Xe,{"aria-label":"Toggle Color Mode",size:"sm",onClick:t,icon:e==="light"?i(ur,{boxSize:"1.2em"}):i(yr,{boxSize:"1.2em"})})]})]}),o.isOpen?i(z,{pb:4,display:{md:"none"},children:i(G,{as:"nav",spacing:4,children:y})}):null,i(qi,{isOpen:r,onClose:()=>a(!1),finalFocusRef:d})]})})})},Ji=ye("~s"),So=(e,...t)=>{const o=g.exports.useMemo(()=>t.reduce((d,n)=>N(E({},d),{[n]:[]}),{}),[t]),r=g.exports.useRef(o),{data:a}=R(["estimatedRowCount.timeseries",...t],async()=>{const d=await je(e,...t),n=new Date;return r.current=t.reduce((c,l)=>{const u=r.current[l];return u.push([n,d[l]]),c[l]=u.slice(-30),c},{}),r.current},{refreshInterval:1e3});return a!=null?a:o},Ro=r=>{var a=r,{data:e,yAxisLabel:t}=a,o=M(a,["data","yAxisLabel"]);const{colorMode:d}=Me(),n=Object.keys(e),c=g.exports.useCallback(({tooltipData:p,colorScale:y})=>!y||!p?null:n.sort((f,h)=>p.datumByKey[h].datum[1]-p.datumByKey[f].datum[1]).map(f=>{const{datum:h}=p.datumByKey[f];return s(ie,{mb:1,color:y(f),fontSize:"sm",children:[f,": ",ye(".4~s")(h[1])]},f)}),[n]),l=g.exports.useCallback(p=>Ji(p).replace("G","B"),[]);if(n.some(p=>e[p].length<2))return i(H,{height:o.height,children:i(W,{size:"md"})});const u=n.map(p=>i(mr,{dataKey:p,data:e[p],xAccessor:y=>y[0],yAccessor:y=>y[1]},p));return s(vr,N(E({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:d==="light"?hr:br,margin:{left:0,right:50,top:10,bottom:40}},o),{children:[i(Rt,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),i(Rt,{orientation:"right",numTicks:o.height<250?3:5,tickFormat:l,label:t,labelOffset:20}),u,i(Er,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:c})]}))},dt=1e3,Re=60*dt,Ae=60*Re,Ze=24*Ae,F=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),J=e=>e?e<dt?`${F(e)}ms`:e<Re?`${F(e/dt)}s`:e<Ae?`${Math.floor(e/Re)}m${J(e%Re)}`:e<Ze?`${Math.floor(e/Ae)}h${J(e%Ae)}`:`${Math.floor(e/Ze)}d${J(e%Ze)}`:"0s",Zi=100,Qi=1e3,K=class extends te{constructor(t){super();_(this,"latlng");_(this,"age",0);_(this,"marker");_(this,"pulse");this.latlng=t,this.marker=new Ie,this.marker.beginFill(K.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new Ie,this.pulse.beginFill(K.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(t,o){if(this.age+=o/60,this.age>K.lifetime&&this.parent){this.parent.removeChild(this);return}const r=this.age%K.lifetime/K.lifetime,a=Sr(r);this.pulse.scale.set(1+a);const d=.4,n=r<d?_r(r/d):1-Tr((r-d)/(1-d));this.pulse.alpha=n,r<d?this.marker.alpha=n:this.marker.alpha=1-Nr((r-d)/(1-d));const[c,l]=t(this.latlng);this.x=c,this.y=l}};let se=K;_(se,"lifetime",1.5),_(se,"markerColor",306687),_(se,"pulseColor",306687);const Ao=()=>{const e=m(b),{initialized:t}=O();return g.exports.useMemo(()=>["notifications",e,t],[e,t])},Io=({scene:e,latLngToPixel:t,bounds:o})=>{const r=g.exports.useRef(new Date().toISOString()),a=m(b),{initialized:d}=O(),n=go(o,50),c=Ao();return R(c,()=>hi(a,r.current,Zi,n),{refreshInterval:Qi,isPaused:()=>!d,onSuccess:l=>{if(l.length>0){r.current=l[0][0];for(const[,u,p]of l)e.addChild(new se([p,u]))}}}),{update:g.exports.useCallback(l=>{for(let u=e.children.length-1;u>=0;u--)e.children[u].update(t,l)},[t,e])}},ea=()=>{const e=m(b),t=So(e,"locations","requests","purchases","notifications","subscriber_segments"),o=R(["notificationsMapTableCounts",e],()=>je(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),r=m(rt("SimulatorMatcher")),a=m(rt("SimulatorUpdateSegments")),d=ye(".4~s"),n=o.data?s(ge,{spacing:2,minChildWidth:"120px",children:[s(k,{children:[i(D,{children:"Offers"}),i(x,{children:d(o.data.offers)})]}),s(k,{children:[i(D,{children:"Cities"}),i(x,{children:d(o.data.cities)})]}),s(k,{children:[i(D,{children:"Subscribers"}),i(x,{children:d(o.data.subscribers)})]}),s(k,{children:[i(D,{children:"Segments"}),i(x,{children:d(o.data.segments)})]}),s(k,{children:[i(D,{children:"Segmentation"}),i(x,{children:J(a)})]}),s(k,{children:[i(D,{children:"Matching"}),i(x,{children:J(r)})]})]}):null;return s(C,{children:[i(S,{children:`
        ...
        `}),n,s(z,{children:[i(ie,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),i(Ro,{data:t,yAxisLabel:"total rows",height:150})]})]})},ta=()=>{const{connected:e,initialized:t}=O(),o=m(ne);bt(o&&e&&t),Eo(o&&e&&t);const r=De(uo);let a;return e?t?o?a=i(ea,{}):a=i(ho,{}):a=i(ke,{colorScheme:"blue",size:"sm",children:"Setup database"}):a=s(I,{size:"sm",onClick:()=>r(!0),colorScheme:"green",children:[i(Rr,{}),i(ie,{pl:2,children:"Connect to SingleStore"})]}),s(Ce,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[i(G,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:i(Ge,{useRenderer:Io,options:{}})}),s(G,{spacing:4,flex:"1 1 0",minWidth:"0",children:[i(S,{children:`
          ...
          `}),right:i(To,{})}),na=({onClose:e,schemaObjectName:t})=>{const o=ni(t),[r]=ut("(max-width: 640px)");return s(Yt,{isOpen:!0,onClose:e,size:r?"full":"4xl",scrollBehavior:"inside",children:[i(xe,{}),s(Ht,{children:[s(ze,{children:["Create statement for ",o.name]}),i(pt,{}),i(Pe,{children:i(Et,{mb:4,children:o.statement})})]})]})},Oo=({name:e,status:t,onClick:o})=>{const{colorMode:r}=Me();return i(et,{bg:(t?"green":"gray")+(r==="light"?".200":".600"),fontSize:"xs",color:r==="light"?"gray.800":"gray.100",textOverflow:"ellipsis",whiteSpace:"nowrap",overflow:"hidden",borderRadius:"md",px:2,py:1,textAlign:"center",_hover:{fontWeight:"bold"},cursor:"pointer",onClick:o,children:e},e)},ca=({initialized:e})=>{const[t,o]=B(de),r=yo(),[a,d]=g.exports.useState();return s(C,{children:[!!a&&i(na,{onClose:()=>d(null),schemaObjectName:a}),i(Y,{completed:e,title:"Setup the schema",left:s(C,{children:[i(S,{children:`
              ...
              `}),i(ge,{columns:[1,3,3],gap:1,children:we.map(T=>i(Oo,{name:T,status:d(T),onClick:()=>c(T)},T))})]}),right:h||!r?i(H,{h:220,children:A}):i(Ro,{data:f,yAxisLabel:"total rows",height:200})})]})},Ve=(e,t=!0)=>R(["overviewTableCounts",e],()=>je(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!t}),pa=()=>{var n,c;const e=m(b),[t,o]=re(),r=Ve(e),a=g.exports.useCallback(async()=>{o.on(),await Qt(e),r.mutate(),o.off()},[e,r,o]),d=!!((n=r.data)!=null&&n.offers);return i(Y,{completed:d,title:"Offers",left:i(C,{children:s(S,{children:[`
