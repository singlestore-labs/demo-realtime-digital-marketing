...
`),{sql:a,params:n}=Co(t);return{sql:M`
    ...
    `,o.id,o.name,`POINT(${o.lonlat[0]} ${o.lonlat[1]})`,o.diameter),Br=(e,o)=>S(e,"DELETE FROM cities WHERE city_id = ?",o),Fr=["olc_8","purchase","request"],Gr=["minute","hour","day","week","month"],qo=({interval:e,kind:o,value:t})=>Dt(`${e}-${o}-${t}`),Yr=async(e,o)=>{const{sql:t,params:r}=Vo({table:"segments",options:{replace:!0},columns:["segment_id","valid_interval","filter_kind","filter_value"],tuples:o.map(d=>[qo(d),d.interval,d.kind,d.value])});await S(e,t,...r)},Hr=async(e,o)=>{const t={table:"offers",options:{replace:!0},columns:["customer","notification_zone","segment_ids","notification_content","notification_target","maximum_bid_cents"],tuples:[]};let r=0,d=[];const a=async()=>{const{sql:n,params:c}=Vo(t);await Promise.all([S(e,n,...c),Yr(e,d)]),t.tuples=[],d=[],r=0};for(const n of o)t.tuples.push([n.customer,n.notificationZone,JSON.stringify(n.segments.map(qo)),n.notificationContent,n.notificationTarget,n.maximumBidCents]),r++,d=d.concat(n.segments),r>=Ur&&await a();r>0&&await a()},Wr=()=>$o(Fr),jr=()=>$o(Gr),Xo=({vendor:e,tld:o})=>`${e.toLowerCase()}.${o}`,Jo=e=>{const[o,t]=e.lonlat,r=e.diameter/2,[d,a]=[o-r,o+r],[n,c]=[t-r,t+r];return[Qe(d,a),Qe(n,c)]},Vr=(e,o)=>{const t=Wr(),r=jr();switch(t){case"olc_8":{const[d,a]=Jo(e),n=Ze.encode(a,d,8).substring(0,8);return{kind:t,interval:r,value:n}}case"purchase":return{kind:t,interval:r,value:o.vendor};case"request":return{kind:t,interval:r,value:Xo(o)}}},$r=e=>{const o=Ne(1,3),t=Mr(),r=Array.from({length:o},()=>Vr(e,t)),d=Xo(t),n=`${Ne(10,50)}% off at ${t.vendor}`,c=d,[l,u]=Jo(e),p=Ze.encode(u,l,8),y=Ze.decode(p),g={ne:[y.latitudeHi,y.longitudeHi],sw:[y.latitudeLo,y.longitudeLo]};return{customer:t.vendor,segments:r,notificationZone:Fe(g),notificationContent:n,notificationTarget:c,maximumBidCents:Ne(2,15)}},Kr=(e,o)=>Array.from({length:o},()=>$r(e)),qr=e=>(o,t,r,d=1)=>`https://stamen-tiles.a.ssl.fastly.net/${e}/${r}/${o}/${t}${d>=2?"@2x":""}.png`,Xr=s(A,{children:["Map tiles by ",i(K,{href:"http://stamen.com",children:"Stamen Design"}),", under"," ",i(K,{href:"http://creativecommons.org/licenses/by/3.0",children:"CC BY 3.0"}),". Data by ",i(K,{href:"http://openstreetmap.org",children:"OpenStreetMap"}),", under"," ",i(K,{href:"http://www.openstreetmap.org/copyright",children:"ODbL"}),"."]}),Jr=[se.lonlat[1],se.lonlat[0]],Zr=12,Qr=({width:e,height:o,bounds:t,latLngToPixel:r,pixelToLatLng:d,useRenderer:a,options:n})=>{const c=pe.useRef(null),l=ao(()=>new Q),{setup:u,update:p}=a({scene:l,width:e,height:o,bounds:t,latLngToPixel:r,pixelToLatLng:d,options:n});return f.exports.useLayoutEffect(()=>{if(!c.current)throw new Error("No canvas ref");console.log("PixiMapLayer: Setup");const y=new xt({view:c.current,width:e,height:o,backgroundAlpha:0,antialias:!0});return y.stage.addChild(l),u==null||u(),p&&y.ticker.add(g=>{p(g)}),()=>{console.log("PixiMapLayer: Destroy"),y.stage.removeChild(l),y.destroy(!1,{children:!1,texture:!0,baseTexture:!0})}},[o,l,u,p,e]),i("canvas",{ref:c})},ei=({mapState:e,latLngToPixel:o,pixelToLatLng:t,useRenderer:r,options:d})=>{const{width:a,height:n,bounds:c}=e||{width:0,height:0};return a<=0||n<=0||!o||!t||!c?null:i(Qr,{useRenderer:r,width:a,height:n,bounds:c,latLngToPixel:o,pixelToLatLng:t,options:d})},Ge=n=>{var c=n,{height:e="100%",defaultCenter:o=Jr,defaultZoom:t=Zr,useRenderer:r,options:d}=c,a=P(c,["height","defaultCenter","defaultZoom","useRenderer","options"]);const[l,u]=f.exports.useState(o),[p,y]=f.exports.useState(t);return i(D,_(E({borderRadius:"lg",overflow:"hidden",height:e},a),{children:i(kt,{dprs:[1,2],provider:qr("toner-lite"),attribution:Xr,maxZoom:20,center:l,zoom:p,onBoundsChanged:({center:g,zoom:v})=>{u(g),y(v)},children:i(ei,{useRenderer:r,options:d})})}))};var Ye=[{name:"date_sub_dynamic",createStmt:`CREATE OR REPLACE FUNCTION date_sub_dynamic (
  _dt DATETIME(6),
...
END`}],We=[{name:"worldcities",createStmt:`create rowstore table if not exists worldcities (
...
);`}];const Re="singlestore-realtime-digital-marketing",oi=[`CREATE LINK aws_s3 AS S3 CREDENTIALS '{}' CONFIG '{ "region": "us-east-1" }'`,`
    CREATE OR REPLACE PIPELINE worldcities
    AS LOAD DATA LINK aws_s3 '${Re}/cities.ndjson'
  ...
  `,"START PIPELINE worldcities FOREGROUND"],ti=e=>{const o=We.find(d=>d.name===e);if(o)return o;const t=He.find(d=>d.name===e);if(t)return t;const r=Ye.find(d=>d.name===e);if(r)return r;throw new Error("Could not find schema object: "+e)},ri=async e=>{try{return await go(e,"SELECT 1"),!0}catch{return!1}},ii=async e=>{let o={tables:[],procedures:[],functions:[]};const c=e,{database:t}=c,r=P(c,["database"]);try{o=(await yo(r,`
        ...
        `,t,t)).reduce((l,[u,p])=>(l[u].push(p),l),o)}catch(l){if(!(l instanceof k&&(l.isUnknownDatabase()||l.isDatabaseRecovering())))throw l}const{tables:d,procedures:a,functions:n}=o;return Object.fromEntries([We.map(({name:l})=>[l,d.includes(l)]),He.map(({name:l})=>[l,a.includes(l)]),Ye.map(({name:l})=>[l,n.includes(l)])].flat())},Zo=e=>go(e,"DROP DATABASE IF EXISTS `"+e.database+"`"),di=async(e,{progress:o,scaleFactor:t,includeSeedData:r,skipCreate:d=!1})=>{d||(o("Dropping existing schema","info"),await Zo(e),o("Creating database","info"),await go(e,"CREATE DATABASE `"+e.database+"`"));for(const a of Ye)o(`Creating function: ${a.name}`,"info"),await S(e,a.createStmt);for(const a of We)o(`Creating table: ${a.name}`,"info"),await S(e,a.createStmt);for(const a of He)o(`Creating procedure: ${a.name}`,"info"),await S(e,a.createStmt);await ai(e),await Ko(e,se),r&&(o("Creating sample data","info"),await mo(e,se,t)),o("Schema initialized","success")},ai=async e=>{for(const o of oi)await S(e,o)},mo=(e,o,t)=>{const r=100*t.partitions,d=Kr(o,r);return Hr(e,d)},eo=["locations","requests","purchases"],Qo=async(e,o)=>{const t=o.prefix,r=await V(e,`
      SELECT
    ...
    `,e.database,...eo);return eo.map(d=>{var n;const a=r.find(c=>c.pipelineName===d);return{pipelineName:d,needsUpdate:(n=a==null?void 0:a.needsUpdate)!=null?n:!0}})},et=(e,o)=>{switch(e){case"locations":return M`
        CREATE OR REPLACE PIPELINE ${e}
        AS LOAD DATA LINK aws_s3 '${Re}/${o.prefix}/locations.*'
      ...
      `;case"requests":return M`
        CREATE OR REPLACE PIPELINE ${e}
        AS LOAD DATA LINK aws_s3 '${Re}/${o.prefix}/requests.*'
        MAX_PARTITIONS_PER_BATCH ${o.partitions}
        INTO PROCEDURE process_requests FORMAT PARQUET (
          subscriber_id <- subscriberid,
          domain <- domain
        )
      `;case"purchases":return M`
        CREATE OR REPLACE PIPELINE ${e}
        AS LOAD DATA LINK aws_s3 '${Re}/${o.prefix}/purchases.*'
        MAX_PARTITIONS_PER_BATCH ${o.partitions}
        INTO PROCEDURE process_purchases FORMAT PARQUET (
          subscriber_id <- subscriberid,
          vendor <- vendor
        )
      `}},ot=async(e,o)=>{const t=await Qo(e,o);await Promise.all(t.filter(r=>r.needsUpdate).map(async r=>{console.log(`recreating pipeline ${r.pipelineName}`),await S(e,et(r.pipelineName,o)),await S(e,`ALTER PIPELINE ${r.pipelineName} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await S(e,`START PIPELINE IF NOT RUNNING ${r.pipelineName}`),console.log(`finished creating pipeline ${r.pipelineName}`)}))},ni=async e=>{const o=await yo(e,`
      SELECT
    ...
    `,e.database);await Promise.all(o.map(async([t])=>{console.log("restarting pipeline",t),await S(e,`ALTER PIPELINE ${t} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await S(e,`START PIPELINE IF NOT RUNNING ${t}`)}))},tt=async e=>{const o=await V(e,`
      SELECT plan_id AS planId
      FROM information_schema.plancache
      WHERE
        plan_warnings LIKE "%empty tables%"
    `);try{await Promise.all(o.map(({planId:t})=>S(e,`DROP ${t} FROM PLANCACHE`)))}catch(t){if(!(t instanceof k&&t.isPlanMissing()))throw t}return o.length>0},ci=(e,...o)=>{const t=o.map(r=>`"${r}"`).join(",");return jo(e,`
      ...
      GROUP BY tableName
    `,e.database)},je=(e,...o)=>ci(e,...o).then(t=>t.reduce((r,{tableName:d,count:a})=>(r[d]=a,r),{})),li=async(e,o)=>{const{maxRows:t}=o,d=["locations","requests","purchases","notifications"].map(n=>`"${n}"`).join(","),a=await jo(e,`
      SELECT
      ...
      WHERE
        ...
        AND stats.count > ?
    `,e.database,t);await Promise.all(a.map(async({tableName:n,count:c,minTs:l,maxTs:u})=>{const y=(c-t)/c;if(y<.2)return;const g=new Date((l+y*(u-l))*1e3);console.log(`removing rows from ${n} older than ${g.toISOString()}`),await S(e,`DELETE FROM ${n} WHERE ts <= ?`,g.toISOString())}))},vo=(e,o="minute")=>Ue(e,"ECHO run_matching_process(?)",o).then(t=>t.RESULT),ho=async(e,o,t=!0)=>{const r=new Date().toISOString();return await S(e,"CALL update_segments(?, ?)",o,r),t&&await S(e,"CALL prune_segments(?)",r),r},si=(e,o,t,r)=>yo(e,`
      SELECT
        ts,
...
`,gi=(e,o,t,r)=>V(e,fo({with:[["metrics",bo(o)]],base:`
        SELECT
        ...
        ORDER BY ${t} DESC
        LIMIT ${r}
      `}).sql),Lo=(e,o)=>Ue(e,fo({with:[["metrics",bo(o)]],base:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `}).sql),fi=(e,o,t)=>{const r=fo({with:[["metrics",bo(t)]],base:{sql:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `,params:[Fe(o)]}});return V(e,r.sql,...r.params)},mi=(e,o,t)=>Ue(e,"CALL update_sessions(?, ?)",o,t).then(({session_id:r,is_controller:d,expires_at:a})=>({sessionID:r,isController:d,expiresAt:new Date(a)})),rt=(e,o,t)=>S(e,`
      UPDATE sessions
    ...
    `,t,o,o),q=[{name:"s00",maxRows:1e7,prefix:"v2/100k-2p",partitions:2},{name:"s0",maxRows:2e7,prefix:"v2/100k-4p",partitions:4},{name:"s1",maxRows:4e7,prefix:"v2/100k-8p",partitions:8},{name:"s2",maxRows:16e7,prefix:"v2/1m-16p",partitions:16},{name:"s4",maxRows:32e7,prefix:"v2/1m-32p",partitions:16},{name:"s8",maxRows:64e7,prefix:"v2/1m-64p",partitions:64},{name:"s10",maxRows:1e9,prefix:"v2/10m-80p",partitions:80}],vi=e=>q.find(o=>o.name===e)||q[0],oe=({encode:e,decode:o}={encode:JSON.stringify,decode:JSON.parse})=>({setSelf:t,onSet:r,node:d})=>{const a=`recoil.localstorage.${d.key}`,n=localStorage.getItem(a);n!=null&&t(o(n)),r((c,l,u)=>{u?localStorage.removeItem(a):localStorage.setItem(a,e(c))})},Eo=()=>({setSelf:e,node:{key:o}})=>{const{location:t}=window;if(t){const r=new URLSearchParams(t.search);e(r.get(o)||new zt)}},hi=x({key:"skipCreateDatabase",default:null,effects:[Eo()]}),bi=x({key:"sessionID",default:null,effects:[Eo()]}),Ei=x({key:"vaporBaseUrl",default:"https://vapor.labs.singlestore.com",effects:[Eo()]}),it=x({key:"connectionHost",default:"http://127.0.0.1",effects:[oe()]}),dt=x({key:"connectionUser",default:"root",effects:[oe()]}),at=x({key:"connectionPassword",default:"",effects:[oe()]}),te=x({key:"connectionDatabase",default:"martech",effects:[oe()]}),nt=zo({key:"vaporConnectionConfig",get:async({get:e})=>{const o=e(bi),t=e(Ei);if(o&&t)try{const r=await fetch(t+"/api/v1/connect?sessionID="+o);if(r.status===200){const d=await r.json();return{host:"https://"+d.endpoint,user:d.user,password:d.password,database:e(te)}}}catch{console.log(`Failed to connect to vapor at ${t}, falling back to local config`)}}}),b=zo({key:"connectionConfig",get:({get:e})=>{const o=e(nt);if(o)return o;const t=e(it),r=e(dt),d=e(at),a=e(te);return{host:t,user:r,password:d,database:a}},cachePolicy_UNSTABLE:{eviction:"most-recent"}}),re=x({key:"configScaleFactor",default:q[0],effects:[oe({encode:e=>e.name,decode:e=>q.find(o=>o.name===e)||q[0]})]}),ie=x({key:"simulatorEnabled",default:!0,effects:[oe()]}),_i=x({key:"databaseDrawerIsOpen",default:!1}),oo=Pt({key:"tickDurationMs",default:void 0}),Ve=x({key:"resettingSchema",default:!1}),Ti=Object.fromEntries([We.map(({name:e})=>[e,!1]),He.map(({name:e})=>[e,!1]),Ye.map(({name:e})=>[e,!1])].flat()),ct=(e=!1)=>{const o=m(b);return R(["schemaObjects",o,e],()=>ii(o),{isPaused:()=>e,refreshInterval:t=>Object.values(t||[]).some(d=>!d)?1e3:0,fallbackData:Ti})},O=()=>{const a=m(b),{database:e}=a,o=P(a,["database"]),t=m(nt),r=R(["isConnected",o],()=>ri(o)),d=ct(!r.data);return{isVapor:!!t,connected:!!r.data,initialized:!!r.data&&Object.values(d.data||[]).every(Boolean),reset:()=>{r.mutate(),d.mutate()}}},Si=(()=>{let e={};return o=>(o in e||(e[o]=1),`${o}(${e[o]++})`)})(),to=(e,{name:o,enabled:t,intervalMS:r})=>{const d=no(oo(o));f.exports.useEffect(()=>{if(!t)return;const a=new AbortController,n=Si(o);console.log(`Starting ${n}: tick interval: ${r}ms`);const c=async()=>{try{if(console.time(n),a.signal.aborted)return;const l=performance.now();await e(a);const u=performance.now()-l;d(u),setTimeout(c,Math.max(0,r-u))}catch(l){if(a.signal.aborted||l instanceof k&&l.isUnknownDatabase()||l instanceof DOMException&&l.name==="AbortError")return;throw l}finally{console.timeEnd(n)}};return c(),()=>{console.log(`Stopping ${n}`),a.abort()}},[t,e,r,o,d])},Ni=({before:e,after:o,includeSeedData:t})=>{const r=m(b),d=m(re),{reset:a}=O(),[n,c]=B(ie),l=Po(),u=m(hi),p=no(Ve);return f.exports.useCallback(async()=>{const y=n;c(!1),p(!0),e(),await di(r,{progress(g,v){const h="reset-schema";l.isActive(h)?l.update(h,{title:g,status:v,duration:v==="success"?2e3:null,isClosable:!0}):l({id:h,title:g,status:v,duration:null})},scaleFactor:d,includeSeedData:t,skipCreate:!!u}),o(),a(),c(y),p(!1)},[n,c,p,e,r,d,t,u,o,a,l])},lt=(e,o)=>{const[t,r]=f.exports.useState(e);return f.exports.useEffect(()=>{const d=setTimeout(()=>r(e),o);return()=>clearTimeout(d)},[e,o]),t},st=()=>{const[{elapsed:e,isRunning:o},t]=f.exports.useReducer((r,d)=>{switch(d.type){case"start":return{start:Math.floor(performance.now()),isRunning:!0,elapsed:r.elapsed};case"stop":return{elapsed:Math.floor(performance.now())-(r.start||0),isRunning:!1}}},{isRunning:!1});return{elapsed:e,isRunning:o,startTimer:()=>t({type:"start"}),stopTimer:()=>t({type:"stop"})}},pt=(e,o)=>{let t=!1,r=new Mt(0,0),d=0;e.on("pointerdown",a=>{t=!0,r=a.data.global,d=performance.now()}),e.on("pointerup",a=>{if(!t||(t=!1,performance.now()-d>200))return;const c=a.data.global;Math.sqrt(Math.pow(c.x-r.x,2)+Math.pow(c.y-r.y,2))>10||o(a)}),e.on("pointercancel",()=>{t=!1})};class Ri extends Q{constructor(o,t){super();T(this,"gfx");T(this,"hover",!1);this.city=o,this.onRemove=t,this.gfx=new Ce,this.addChild(this.gfx),this.gfx.interactive=!0,this.gfx.on("pointerover",()=>{this.hover=!0}),this.gfx.on("pointerout",()=>{this.hover=!1}),pt(this.gfx,()=>t(this.city))}update(o){this.gfx.clear(),this.gfx.lineStyle(1,this.hover?16711680:306687,1),this.gfx.beginFill(this.hover?16711680:306687,.2);const[t,r]=o([this.city.centerLat,this.city.centerLon]);this.gfx.drawCircle(t,r,25),this.gfx.endFill()}}const Oi=e=>{const o=m(b),{initialized:t}=O();return R(["cities",o,t],()=>ui(o),{isPaused:()=>!t,onSuccess:e})},Ai=({scene:e,latLngToPixel:o,pixelToLatLng:t,width:r,height:d})=>{const a=m(b),n=ao(()=>new Q),{mutate:c}=Oi(p=>{n.removeChildren();for(let y=0;y<p.length;y++)n.addChild(new Ri(p[y],u))}),l=f.exports.useCallback(async(p,y)=>{const g=await yi(a,y,p),v={id:g.id,name:g.name,lonlat:[g.centerLon,g.centerLat],diameter:g.diameter};await Ko(a,v),await mo(a,v,q[0]),c()},[a,c]),u=f.exports.useCallback(async p=>{await Br(a,p.id),c()},[a,c]);return{setup:f.exports.useCallback(()=>{const p=new Q;e.addChild(p),e.addChild(n),p.interactive=!0,p.hitArea=new Ut(0,0,r,d),pt(p,y=>{const[g,v]=t([y.data.global.x,y.data.global.y]);l(g,v)})},[n,d,l,t,e,r]),update:f.exports.useCallback(()=>{for(let p=0;p<n.children.length;p++)n.children[p].update(o)},[n,o])}},Ci=e=>i(Ge,_(E({},e),{useRenderer:Ai,options:{},cursor:"pointer"})),Ii=Bt({a:t=>{var r=t,{children:e}=r,o=P(r,["children"]);const{href:d}=o,a=!!(d!=null&&d.startsWith("http"));return a?s(K,_(E({isExternal:a},o),{children:[e,i(Ft,{bottom:"2px",boxSize:"0.9em",position:"relative",ml:1})]})):i(K,_(E({to:d||""},o),{as:Mo,children:e}))}}),N=t=>{var r=t,{children:e}=r,o=P(r,["children"]);return i(Gt,_(E({},o),{skipHtml:!0,components:Ii,children:Array.isArray(e)?e.filter(d=>d).map(d=>M(d||"")).join(`

`):M(e)}))},wi=()=>s(J,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(J,{maxW:"container.md",mb:10,children:i(N,{children:`
            ## Admin

            You can configure cities and offers on this page. To learn more
            about this application please visit the [Overview page](/).
          `})}),i(Li,{})]}),Li=()=>s(A,{children:[i(J,{maxW:"container.md",mb:4,children:i(N,{children:`
            #### Cities
            ...
            remove it.
          `})}),i(Ci,{defaultZoom:4,defaultCenter:[39.716470511656766,-99.59395661915288],height:300})]}),Do=(()=>{const e=()=>crypto&&crypto.randomUUID?crypto.randomUUID():Yt();let o;return o=e(),console.log(`Session ID: ${o}`),o})(),ko=60,fe=()=>{const e=m(b),o=m(Ve),{connected:t,initialized:r}=O(),{data:d,mutate:a}=R([e,"useSession"],()=>mi(e,Do,ko),{refreshInterval:1e3,isPaused:()=>o||!t||!r});return{session:d||{sessionID:Do,isController:!1,expiresAt:new Date(Date.now()+ko*1e3)},refresh:a}},ut=()=>{const e=no(ie),{session:o,refresh:t}=fe(),r=m(b),{connected:d,initialized:a}=O(),[n,c]=ee(!1),l=f.exports.useCallback(async()=>{c.on(),d&&a&&await rt(r,o.sessionID,!0),e(!0),t(),c.off()},[r,d,c,a,t,o.sessionID,e]);return s(_e,{status:"warning",borderRadius:"md",children:[i(Te,{}),i(Se,{children:"The simulator is disabled"}),i(C,{position:"absolute",right:4,top:3,size:"xs",colorScheme:"blue",disabled:n,onClick:l,children:"Enable simulator"})]})},xo=e=>{const{r:o,g:t,b:r}=e.rgb();return o<<16|t<<8|r};class Di extends Q{constructor(o,t){super();T(this,"points");T(this,"polygon");T(this,"hovering",!1);T(this,"color");T(this,"hoverColor");this.config=o,this.points=Pr(o.wktPolygon),this.polygon=new Ce,this.addChild(this.polygon);const r=t(o.value);this.color=xo(r),this.hoverColor=xo(r.darker(1)),this.polygon.interactive=!0,this.polygon.on("mouseover",()=>{this.hovering=!0}),this.polygon.on("mouseout",()=>{this.hovering=!1})}update(o){const t=this.hovering?this.hoverColor:this.color;this.polygon.clear(),this.polygon.lineStyle(1,t,.5),this.polygon.beginFill(t,.2),this.polygon.drawPolygon(this.points.flatMap(([r,d])=>o([d,r]))),this.polygon.endFill()}}const ki=e=>({scene:o,latLngToPixel:t,bounds:r})=>{const d=lt(r,100),a=ao(()=>Ht(n=>Wt(e.colorInterpolater(n))));return e.useCells(d,n=>{o.removeChildren();let c=1/0,l=-1/0;const u=[];for(const p of n){const y=e.getCellConfig(p);u.push(y),y.value<c&&(c=y.value),y.value>l&&(l=y.value)}a.domain([c,l]);for(const p of u)o.addChild(new Di(p,a))}),{update:f.exports.useCallback(()=>{for(let n=0;n<o.children.length;n++)o.children[n].update(t)},[t,o])}},yt=e=>{const n=e,{useCells:o,getCellConfig:t,colorInterpolater:r}=n,d=P(n,["useCells","getCellConfig","colorInterpolater"]),a=f.exports.useMemo(()=>ki({useCells:o,getCellConfig:t,colorInterpolater:r}),[r,t,o]);return i(Ge,_(E({},d),{useRenderer:a,options:{}}))},xi=10*1e3,_o=e=>{const o=m(b),t=m(re),{initialized:r}=O(),{session:d}=fe(),a=f.exports.useCallback(n=>{const c=_(E({},o),{ctx:n});return Promise.all([ot(c,t),ni(c),li(c,t),tt(c)])},[o,t]);to(a,{name:"SimulatorMonitor",enabled:r&&e&&d.isController,intervalMS:xi})},zi=1*1e3,Pi=1*1e3,gt=e=>{const o=m(b),{initialized:t}=O(),r=f.exports.useRef(new Date(0).toISOString()),{session:d}=fe(),a=f.exports.useCallback(c=>vo(_(E({},o),{ctx:c}),"minute"),[o]);to(a,{name:"SimulatorMatcher",enabled:t&&e&&d.isController,intervalMS:zi});const n=f.exports.useCallback(async c=>{r.current=await ho(_(E({},o),{ctx:c}),r.current)},[o]);to(n,{name:"SimulatorUpdateSegments",enabled:t&&e&&d.isController,intervalMS:Pi})},ro=ue(",.2%"),le=ue(".4~s"),Mi=()=>{const{initialized:e}=O(),o=m(ie);return _o(o),gt(o),i(J,{maxW:"container.lg",mt:10,mb:"30vh",children:e?o?s(W,{gap:10,children:[i(Ui,{}),i(Bi,{}),i(Gi,{})]}):i(ut,{}):i(ft,{})})},ft=()=>i(F,{children:i(G,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})}),Ui=()=>{var d,a;const e=m(b),o=R(["overallConversionRateRequests",e],()=>Lo(e,"requests"),{refreshInterval:1e3}),t=R(["overallConversionRatePurchases",e],()=>Lo(e,"purchases"),{refreshInterval:1e3}),r=R(["analyticsTableCounts",e],()=>je(e,"offers","subscribers","notifications"),{refreshInterval:1e3});return!r.data||!o.data||!t.data?i(ft,{}):s(ye,{spacing:2,minChildWidth:"150px",flex:2,children:[s(I,{children:[i(w,{children:"Offers"}),i(L,{children:le(r.data.offers)})]}),s(I,{children:[i(w,{children:"Subscribers"}),i(L,{children:le(r.data.subscribers)})]}),s(I,{children:[i(w,{children:"Notifications"}),i(L,{children:le(r.data.notifications)})]}),s(I,{children:[i(w,{children:"Conversion Rate"}),i(L,{children:ro(((d=o.data)==null?void 0:d.conversionRate)||0)}),i(Ro,{children:"Requests"})]}),s(I,{children:[i(w,{children:"Conversion Rate"}),i(L,{children:ro(((a=t.data)==null?void 0:a.conversionRate)||0)}),i(Ro,{children:"Purchases"})]})]})},Bi=()=>{var a;const e=m(b),[o,t]=f.exports.useState("conversionRate"),r=R(["customerMetrics",e,o],()=>gi(e,"purchases",o,10),{refreshInterval:1e3}),d=Ie("blue.500","blue.200");return i(D,{overflowX:"auto",children:s(jt,{size:"sm",colorScheme:"gray",variant:"striped",children:[i(Vt,{children:s(Oo,{children:[s(ve,{onClick:()=>t("customer"),_hover:{color:d},color:o==="customer"?d:void 0,cursor:"pointer",children:["Customer",o==="customer"&&i(ne,{})]}),s(ve,{onClick:()=>t("totalNotifications"),_hover:{color:d},color:o==="totalNotifications"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Notifications",o==="totalNotifications"&&i(ne,{})]}),s(ve,{onClick:()=>t("totalConversions"),_hover:{color:d},color:o==="totalConversions"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Conversions",o==="totalConversions"&&i(ne,{})]}),s(ve,{onClick:()=>t("conversionRate"),_hover:{color:d},color:o==="conversionRate"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Conversion Rate",o==="conversionRate"&&i(ne,{})]})]})}),i($t,{children:(a=r.data)==null?void 0:a.map(n=>s(Oo,{children:[i(he,{children:n.customer}),i(he,{isNumeric:!0,children:le(n.totalNotifications)}),i(he,{isNumeric:!0,children:le(n.totalConversions)}),i(he,{isNumeric:!0,children:ro(n.conversionRate)})]},n.customer))})]})})},Fi=(e,o)=>{const t=m(b);R(["zoneMetrics",t,e],()=>fi(t,e,"purchases"),{refreshInterval:1e3,onSuccess:o})},Gi=()=>s(W,{direction:["column","row"],alignItems:"top",children:[i(D,{flex:1,children:i(N,{children:`
            ### Conversion Map
          ...
          `})}),i(D,{flex:2,children:i(yt,{height:400,defaultZoom:14,useCells:Fi,colorInterpolater:Kt,getCellConfig:({conversionRate:e,wktPolygon:o})=>({value:e,wktPolygon:o})})})]}),be=({label:e,placeholder:o,value:t,setValue:r,helpText:d,type:a="text"})=>s(co,{children:[i(lo,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),i(Uo,{size:"sm",placeholder:o,value:t,onChange:n=>r(n.target.value),type:a}),d?i(qt,{fontSize:"xs",children:d}):null]}),Yi=()=>{const[e,o]=B(re);return s(co,{children:[i(lo,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),i(Xt,{size:"sm",required:!0,value:e.name,onChange:t=>{const r=t.target.value;o(vi(r))},children:q.map(t=>i("option",{value:t.name,children:t.name},t.name))})]})},mt=({showDatabase:e,showScaleFactor:o})=>{const[t,r]=B(it),[d,a]=B(dt),[n,c]=B(at),[l,u]=B(te);return s(W,{spacing:4,children:[i(be,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:t,setValue:r,helpText:i(N,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [HTTP API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),s(ye,{columns:2,gap:2,children:[i(be,{label:"Username",placeholder:"admin",value:d,setValue:a}),i(be,{label:"Password",placeholder:"",value:n,setValue:c,type:"password"}),e&&i(be,{label:"Database",placeholder:"martech",value:l,setValue:u}),o&&i(Yi,{})]})]})},vt=e=>i(C,_(E({onClick:()=>{const{pathname:o,hash:t}=window.location;window.location.replace(o+t)},colorScheme:"red"},e),{children:"Disconnect"})),ht=e=>{const{connected:o,initialized:t}=O(),r=so(),[d,a]=ee(),n=m(te),c=pe.useRef(null),g=e,{skipSeedData:l,disabled:u}=g,p=P(g,["skipSeedData","disabled"]),y=Ni({before:f.exports.useCallback(()=>a.on(),[a]),after:f.exports.useCallback(()=>{a.off(),r.onClose()},[r,a]),includeSeedData:!l});return s(A,{children:[i(C,E({disabled:!o||u,onClick:r.onOpen,colorScheme:t?"green":"red"},p)),i(Jt,{isOpen:r.isOpen,onClose:r.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:c,children:i(ke,{children:s(Zt,{children:[s(xe,{fontSize:"lg",fontWeight:"bold",children:[t?"Reset":"Setup"," database ",n]}),s(ze,{children:["This will ",t?"recreate":"create"," the database called ",n,". Are you sure?"]}),s(Bo,{children:[i(C,{ref:c,onClick:r.onClose,disabled:d,children:"Cancel"}),i(C,{disabled:d,colorScheme:t?"red":"green",onClick:y,ml:3,children:d?i(G,{}):t?"Recreate database":"Create database"})]})]})})})]})},Hi=({isOpen:e,onClose:o,finalFocusRef:t})=>{const[r,d]=B(ie),{session:a,refresh:n}=fe(),c=r&&a.isController,l=m(b),{connected:u,initialized:p,isVapor:y}=O(),g=so(),[v,h]=ee(!1),z=f.exports.useCallback(async()=>{h.on();const Z=!(r&&a.isController);d(Z),await rt(l,a.sessionID,Z),n(),h.off()},[l,r,n,a.isController,a.sessionID,d,h]),[Y,U]=ee(!1),de=f.exports.useCallback(async()=>{U.on(),await Zo(l),U.off()},[l,U]);return s(Qt,{isOpen:e,placement:"right",onClose:o,finalFocusRef:t,children:[i(ke,{}),s(er,{children:[i(po,{}),i(xe,{children:"Config"}),i(ze,{children:s(W,{spacing:4,children:[y?null:i(mt,{showScaleFactor:!0,showDatabase:!0}),s(_e,{status:u?"success":"error",borderRadius:"md",children:[i(Te,{}),i(Se,{children:u?"connected":"disconnected"}),y?i(vt,{position:"absolute",right:4,top:3,size:"xs"}):null]}),s(_e,{status:p?"success":"warning",borderRadius:"md",children:[i(Te,{}),i(Se,{children:"schema"}),i(ht,{position:"absolute",right:4,top:3,size:"xs",children:p?"Reset":"Setup"})]}),s(_e,{status:c?"success":"warning",borderRadius:"md",children:[i(Te,{}),i(Se,{children:"simulator"}),i(or,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:c?"green":"red",isChecked:c,disabled:!u||!p||v,onChange:z})]}),s(ge,{onClick:g.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",g.isOpen?i(tr,{ml:2}):i(ne,{ml:2})]}),g.isOpen?i(C,{size:"xs",_hover:{colorScheme:"red"},onClick:de,disabled:Y,children:"Drop Database"}):void 0]})}),i(Bo,{})]})]})},Ee=({to:e,children:o,onClick:t})=>{const r=lr(e),d=sr({path:r.pathname,end:!0});return i(K,{as:Mo,to:e,px:2,py:1,onClick:t,rounded:"md",_hover:{textDecoration:"none",bg:Ie("gray.300","gray.600")},fontWeight:d?"bold":"normal",href:"#",color:Ie("gray.700","gray.200"),children:o})},Wi=()=>{const{colorMode:e,toggleColorMode:o}=Pe(),t=so(),[r,d]=B(_i),a=pe.useRef(null),{connected:n,initialized:c}=O(),l=m(ie),[u]=uo("(max-width: 640px)"),{session:p}=fe(),y=s(A,{children:[i(Ee,{to:"/",onClick:t.onClose,children:"Overview"}),i(Ee,{to:"/map",onClick:t.onClose,children:"Map"}),i(Ee,{to:"/admin",onClick:t.onClose,children:"Admin"}),i(Ee,{to:"/analytics",onClick:t.onClose,children:"Analytics"})]}),g=n?c&&l&&p.isController?"green":"yellow":"red";let v;return u||(v=n?c?l&&p.isController?"connected":"simulator disabled":"needs schema":"disconnected"),i(A,{children:i(D,{bg:Ie("gray.200","gray.700"),children:s(J,{maxW:"container.lg",children:[s(we,{h:16,alignItems:"center",justifyContent:"space-between",children:[i(qe,{size:"md",icon:t.isOpen?i(rr,{}):i(ir,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:t.isOpen?t.onClose:t.onOpen}),s(Le,{spacing:8,alignItems:"center",children:[i(Me,{as:"h1",size:u?"sm":"md",children:u?"Martech":"Realtime Digital Marketing"}),i(Le,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:y})]}),s(we,{alignItems:"center",gap:2,children:[s(C,{size:"sm",ref:a,onClick:()=>d(!0),colorScheme:g,children:[g==="green"?i(Fo,{}):i(Go,{}),u||i(ge,{pl:2,children:v})]}),i(qe,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?i(dr,{size:"1.4em"}):i(ar,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),i(qe,{"aria-label":"Toggle Color Mode",size:"sm",onClick:o,icon:e==="light"?i(nr,{boxSize:"1.2em"}):i(cr,{boxSize:"1.2em"})})]})]}),t.isOpen?i(D,{pb:4,display:{md:"none"},children:i(W,{as:"nav",spacing:4,children:y})}):null,i(Hi,{isOpen:r,onClose:()=>d(!1),finalFocusRef:a})]})})})},ji=ue("~s"),bt=(e,...o)=>{const t=f.exports.useMemo(()=>o.reduce((a,n)=>_(E({},a),{[n]:[]}),{}),[o]),r=f.exports.useRef(t),{data:d}=R(["estimatedRowCount.timeseries",...o],async()=>{const a=await je(e,...o),n=new Date;return r.current=o.reduce((c,l)=>{const u=r.current[l];return u.push([n,a[l]]),c[l]=u.slice(-30),c},{}),r.current},{refreshInterval:1e3});return d!=null?d:t},Et=r=>{var d=r,{data:e,yAxisLabel:o}=d,t=P(d,["data","yAxisLabel"]);const{colorMode:a}=Pe(),n=Object.keys(e),c=f.exports.useCallback(({tooltipData:p,colorScale:y})=>!y||!p?null:n.sort((g,v)=>p.datumByKey[v].datum[1]-p.datumByKey[g].datum[1]).map(g=>{const{datum:v}=p.datumByKey[g];return s(ge,{mb:1,color:y(g),fontSize:"sm",children:[g,": ",ue(".4~s")(v[1])]},g)}),[n]),l=f.exports.useCallback(p=>ji(p).replace("G","B"),[]);if(n.some(p=>e[p].length<2))return i(F,{height:t.height,children:i(G,{size:"md"})});const u=n.map(p=>i(pr,{dataKey:p,data:e[p],xAccessor:y=>y[0],yAccessor:y=>y[1]},p));return s(ur,_(E({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:a==="light"?yr:gr,margin:{left:0,right:50,top:10,bottom:40}},t),{children:[i(Ao,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),i(Ao,{orientation:"right",numTicks:t.height<250?3:5,tickFormat:l,label:o,labelOffset:20}),u,i(fr,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:c})]}))},io=1e3,Oe=60*io,Ae=60*Oe,Je=24*Ae,H=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),X=e=>e?e<io?`${H(e)}ms`:e<Oe?`${H(e/io)}s`:e<Ae?`${Math.floor(e/Oe)}m${X(e%Oe)}`:e<Je?`${Math.floor(e/Ae)}h${X(e%Ae)}`:`${Math.floor(e/Je)}d${X(e%Je)}`:"0s",Vi=100,$i=1e3,$=class extends Q{constructor(o){super();T(this,"latlng");T(this,"age",0);T(this,"marker");T(this,"pulse");this.latlng=o,this.marker=new Ce,this.marker.beginFill($.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new Ce,this.pulse.beginFill($.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(o,t){if(this.age+=t/60,this.age>$.lifetime&&this.parent){this.parent.removeChild(this);return}const r=this.age%$.lifetime/$.lifetime,d=br(r);this.pulse.scale.set(1+d);const a=.4,n=r<a?mr(r/a):1-vr((r-a)/(1-a));this.pulse.alpha=n,r<a?this.marker.alpha=n:this.marker.alpha=1-hr((r-a)/(1-a));const[c,l]=o(this.latlng);this.x=c,this.y=l}};let ce=$;T(ce,"lifetime",1.5),T(ce,"markerColor",306687),T(ce,"pulseColor",306687);const _t=()=>{const e=m(b),{initialized:o}=O();return f.exports.useMemo(()=>["notifications",e,o],[e,o])},Tt=({scene:e,latLngToPixel:o,bounds:t})=>{const r=f.exports.useRef(new Date().toISOString()),d=m(b),{initialized:a}=O(),n=lt(t,50),c=_t();return R(c,()=>si(d,r.current,Vi,n),{refreshInterval:$i,isPaused:()=>!a,onSuccess:l=>{if(l.length>0){r.current=l[0][0];for(const[,u,p]of l)e.addChild(new ce([p,u]))}}}),{update:f.exports.useCallback(l=>{for(let u=e.children.length-1;u>=0;u--)e.children[u].update(o,l)},[o,e])}},Ki=()=>{const e=m(b),o=bt(e,"locations","requests","purchases","notifications","subscriber_segments"),t=R(["notificationsMapTableCounts",e],()=>je(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),r=m(oo("SimulatorMatcher")),d=m(oo("SimulatorUpdateSegments")),a=ue(".4~s"),n=t.data?s(ye,{spacing:2,minChildWidth:"120px",children:[s(I,{children:[i(w,{children:"Offers"}),i(L,{children:a(t.data.offers)})]}),s(I,{children:[i(w,{children:"Cities"}),i(L,{children:a(t.data.cities)})]}),s(I,{children:[i(w,{children:"Subscribers"}),i(L,{children:a(t.data.subscribers)})]}),s(I,{children:[i(w,{children:"Segments"}),i(L,{children:a(t.data.segments)})]}),s(I,{children:[i(w,{children:"Segmentation"}),i(L,{children:X(d)})]}),s(I,{children:[i(w,{children:"Matching"}),i(L,{children:X(r)})]})]}):null;return s(A,{children:[i(N,{children:`
          ...
          about the demo.
        `}),n,s(D,{children:[i(ge,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),i(Et,{data:o,yAxisLabel:"total rows",height:150})]})]})},qi=()=>{const{connected:e,initialized:o}=O(),t=m(ie);return _o(t&&e&&o),gt(t&&e&&o),s(we,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[i(W,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:i(Ge,{useRenderer:Tt,options:{}})}),s(W,{spacing:4,flex:"1 1 0",minWidth:"0",children:[i(N,{children:`
          ...
          `}),t?i(Ki,{}):i(ut,{})]})]})},To=t=>{var r=t,{children:e}=r,o=P(r,["children"]);return i(Er,_(E({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},o),{children:e}))},Xi=1e3,Ji=(e,o)=>{const t=m(b),{initialized:r}=O();R(["offers",t,r,e],()=>pi(t,Xi,e),{isPaused:()=>!r,onSuccess:o})},Zi=e=>i(yt,_(E({},e),{useCells:Ji,colorInterpolater:()=>"#04adff",getCellConfig:o=>({value:1,wktPolygon:o.notificationZone})})),Qi=e=>e.every(([,o])=>o===0),j=e=>{const{completed:o,title:t,left:r,right:d}=e,{colorMode:a}=Pe(),n=a==="light"?".300":".500",c=o?"gray"+n:void 0,l=(o?"green":"gray")+n;return s(A,{children:[s(De,{children:[s(Me,{as:"h2",size:"lg",mb:4,color:c,children:[i(Fo,E({color:l},{boxSize:6,position:"relative",bottom:.5,mr:2})),t]}),r]}),i(De,{children:d})]})},ed=({connected:e,isVapor:o})=>o?i(j,{completed:e,title:"Connected",left:s(A,{children:[i(N,{children:`
                ...
                the button below.
              `}),i(vt,{size:"xs",colorScheme:"gray"})]}),right:null}):i(j,{completed:e,title:"Connect to SingleStore",left:i(N,{children:`
            ...
            **Note**: The HTTP API may need to be enabled on your SingleStore
            ...
            [1]: https://docs.singlestore.com/docs/http-api/
          `}),right:i(mt,{})}),od=({onClose:e,schemaObjectName:o})=>{const t=ti(o),[r]=uo("(max-width: 640px)");return s(Ho,{isOpen:!0,onClose:e,size:r?"full":"4xl",scrollBehavior:"inside",children:[i(ke,{}),s(Wo,{children:[s(xe,{children:["Create statement for ",t.name]}),i(po,{}),i(ze,{children:i(To,{mb:4,children:t.createStmt})})]})]})},St=({name:e,status:o,onClick:t})=>{const{colorMode:r}=Pe();return i(De,{bg:(o?"green":"gray")+(r==="light"?".200":".600"),fontSize:"xs",color:r==="light"?"gray.800":"gray.100",textOverflow:"ellipsis",whiteSpace:"nowrap",overflow:"hidden",borderRadius:"md",px:2,py:1,textAlign:"center",_hover:{fontWeight:"bold"},cursor:"pointer",onClick:t,children:e},e)},td=({initialized:e})=>{const[o,t]=B(te),r=ct(),[d,a]=f.exports.useState();return s(A,{children:[!!d&&i(od,{onClose:()=>a(null),schemaObjectName:d}),i(j,{completed:e,title:"Setup the schema",left:s(A,{children:[i(N,{children:`
              ...
              `}),i(Tr,{mt:4,mb:6}),s(Le,{alignItems:"flex-end",children:[s(co,{flex:1,children:[i(lo,{fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Database name"}),i(Uo,{placeholder:"martech",value:o,size:"sm",onChange:n=>t(n.target.value)})]}),i(D,{flex:1,textAlign:"center",children:i(ht,{colorScheme:"blue",size:"sm",disabled:e,skipSeedData:!0,children:e?"Schema is setup":"Setup schema"})})]})]}),right:i(ye,{columns:[1,3,3],gap:1,children:Object.keys(r.data||{}).sort().map(n=>{var c;return i(St,{name:n,status:(c=r.data)==null?void 0:c[n],onClick:()=>a(n)},n)})})})]})},rd=({onClose:e,name:o,scaleFactor:t})=>{const r=et(o,t),[d]=uo("(max-width: 640px)");return s(Ho,{isOpen:!0,onClose:e,size:d?"full":"4xl",scrollBehavior:"inside",children:[i(ke,{}),s(Wo,{children:[s(xe,{children:["Create statement for pipeline ",o]}),i(po,{}),i(ze,{children:i(To,{mb:4,children:r})})]})]})},Nt=(e,o,t=!0)=>{var a;const r=R(["pipelineStatus",e,o],()=>Qo(e,o),{isPaused:()=>!t}),d=(a=r.data)!=null&&a.length?r.data.every(n=>!n.needsUpdate):!1;return{pipelines:r,completed:d}},id=()=>{const e=m(b),o=m(re),{pipelines:t,completed:r}=Nt(e,o);_o(r);const d=h=>{var Y;const z=(Y=t.data)==null?void 0:Y.find(U=>U.pipelineName===h);return z?!z.needsUpdate:!1},[a,n]=f.exports.useState(),[c,l]=ee(),u=f.exports.useCallback(async()=>{l.on(),await ot(e,o),t.mutate(),l.off()},[l,e,o,t]),p=["locations","requests","purchases"],y=bt(e,...p),g=p.some(h=>y[h].length<2)||p.every(h=>Qi(y[h])),v=s(C,{colorScheme:"blue",size:"sm",onClick:u,disabled:r,children:[(c||r)&&i(G,{mr:2}),c?"Creating Pipelines":r?"...waiting for data":"Create pipelines"]});return s(A,{children:[!!a&&i(rd,{onClose:()=>n(null),name:a,scaleFactor:o}),i(j,{completed:r,title:"Ingest data",left:s(A,{children:[i(N,{children:`
              ...
              `}),i(ye,{columns:[1,3,3],gap:1,children:eo.map(h=>i(St,{name:h,status:d(h),onClick:()=>n(h)},h))})]}),right:g||!r?i(F,{h:220,children:v}):i(Et,{data:y,yAxisLabel:"total rows",height:200})})]})},$e=(e,o=!0)=>R(["overviewTableCounts",e],()=>je(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!o}),dd=()=>{var c,l;const e=m(b),o=m(re),[t,r]=ee(),d=$e(e),a=f.exports.useCallback(async()=>{r.on(),await mo(e,se,o),d.mutate(),r.off()},[e,o,d,r]),n=!!((c=d.data)!=null&&c.offers);return i(j,{completed:n,title:"Offers",left:i(A,{children:s(N,{children:[`
            ...
            `,n&&`
                ...
                database.
            `]})}),right:n?i(Zi,{height:300,defaultZoom:13}):i(F,{h:"100%",children:s(C,{onClick:a,disabled:t,children:[t&&i(G,{mr:2}),t?"loading...":n?"loaded offers!":"load offers"]})})})},ad=({done:e,setDone:o})=>{const t=m(b),r=f.exports.useRef(new Date().toISOString());return f.exports.useEffect(()=>{if(e)return;const d=new AbortController,a=_(E({},t),{ctx:d});return(async()=>{try{for(let n=0;n<10;n++)if(r.current=await ho(a,r.current,!1),await vo(a,"second"),n>1&&!await tt(a))return}catch(n){if(d.signal.aborted||n instanceof DOMException&&n.name==="AbortError")return;throw n}})().then(()=>o(!0)),()=>{d.abort()}},[t,e,o]),e?null:i(De,{colSpan:[1,1,2],children:s(F,{w:"100%",h:"200px",color:"gray.500",children:[i(G,{size:"md",mr:4}),i(Me,{size:"md",children:"Warming up queries..."})]})})},nd=()=>{var p;const e=m(b),o=$e(e),{elapsed:t,isRunning:r,startTimer:d,stopTimer:a}=st(),n=f.exports.useRef(new Date().toISOString()),c=!!((p=o.data)!=null&&p.subscriber_segments),l=f.exports.useCallback(async()=>{d(),n.current=await ho(e,n.current),a(),o.mutate()},[e,o,d,a]);let u;if(t&&o.data){const{segments:y,subscriber_segments:g,locations:v,requests:h,purchases:z}=o.data,Y=X(t),U=H(v+h+z),de=H(y),Z=H(g);u=i(N,{children:`
          The last update evaluated ${U} rows against ${de} segments
          producing ${Z} segment memberships.
          
          **This process took ${Y}**.
        `})}return i(j,{completed:c,title:"Segmentation",left:i(N,{children:`
          ...
          `}),right:i(F,{h:"100%",children:s(Yo,{gap:4,textAlign:"center",children:[s(C,{disabled:r,onClick:l,children:[r&&i(G,{mr:2}),r?"...running":"Match subscribers to segments"]}),u]})})})},cd=()=>{var v;const e=m(b),o=$e(e),t=_t(),{mutate:r}=Sr(),{elapsed:d,isRunning:a,startTimer:n,stopTimer:c}=st(),[l,u]=f.exports.useState(0),p=!!((v=o.data)!=null&&v.notifications),y=f.exports.useCallback(async()=>{let h=0,z=0;for(;h===0&&z++<10;)n(),h=await vo(e,"second");c(),u(h),o.mutate(),r(t)},[e,n,c,o,r,t]);let g;if(d&&o.data){const{offers:h,subscribers:z,subscriber_segments:Y,notifications:U}=o.data,de=H(h*z+U),Z=H(Y),Ot=X(d),At=H(l);g=i(N,{children:`
          The last update evaluated up to ${de} notification opportunities
          against ${Z} segment memberships generating ${At}
          notifications. This process took ${Ot}.
        `})}return i(j,{completed:p,title:"Matching",left:i(N,{children:`
          ...
          `}),right:i(F,{h:"100%",children:s(Yo,{gap:4,w:"100%",children:[s(C,{disabled:a,onClick:y,children:[a&&i(G,{mr:2}),a?"...running":"Generate notifications"]}),i(D,{width:"100%",children:i(Ge,{height:250,defaultZoom:12,useRenderer:Tt,options:{}})}),g]})})})},ld=()=>{const e=m(te);return i(j,{completed:!0,title:"Putting it all together",left:i(N,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: map
          `}),right:null})},sd=()=>{const e=m(b),o=m(re),{connected:t,initialized:r,isVapor:d}=O(),{completed:a}=Nt(e,o,t&&r),{data:n}=$e(e,t&&r),[c,l]=f.exports.useState(!1),u=[{completed:t,component:i(ed,{connected:t,isVapor:d},"connection")},{completed:r,component:i(td,{initialized:r},"schema")},{completed:a,component:i(id,{},"pipelines")},{completed:n?n.offers>0:!1,component:i(dd,{},"offers")},{completed:c,component:i(ad,{done:c,setDone:l},"warmup")},{completed:n?n.subscriber_segments>0:!1,component:i(nd,{},"segmentation")},{completed:n?n.notifications>0:!1,component:i(cd,{},"matching")},{completed:!0,component:i(ld,{},"summary")}];let p=!0;const y=[];for(const{completed:g,component:v}of u)if(p)y.push(v),p=g;else break;return s(J,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(D,{maxW:"container.md",mb:10,px:0,children:i(N,{children:`
          ...
          `})}),i(_r,{columnGap:6,rowGap:10,templateColumns:["minmax(0, 1fr)",null,"repeat(2, minmax(0, 1fr))"],children:y})]})};function pd(){const e=i(F,{height:"100vh",children:i(G,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})});return i(f.exports.Suspense,{fallback:e,children:s(we,{height:"100vh",direction:"column",children:[i(Wi,{}),i(D,{m:4,flex:"1",children:s(Nr,{children:[i(ae,{path:"/",element:i(sd,{})}),i(ae,{path:"/map",element:i(qi,{})}),i(ae,{path:"/admin",element:i(wi,{})}),i(ae,{path:"/analytics",element:i(Mi,{})}),i(ae,{path:"*",element:i(Rr,{to:"/",replace:!0})})]})})]})})}const ud=({children:e})=>{const o=m(Ve);return i(Rt,{isResettingSchema:o,children:e})};class Rt extends pe.Component{constructor(o){super(o);T(this,"state",{});this.handlePromiseRejection=this.handlePromiseRejection.bind(this)}componentDidMount(){window.addEventListener("unhandledrejection",this.handlePromiseRejection)}componentWillUnmount(){window.removeEventListener("unhandledrejection",this.handlePromiseRejection)}handlePromiseRejection(o){this.props.isResettingSchema?console.warn("Ignoring error while resetting schema",o.reason):this.setState({error:o.reason})}componentDidCatch(o){this.props.isResettingSchema?console.warn("Ignoring error while resetting schema",o):this.setState({error:o})}render(){const{error:o}=this.state;if(o){let t;return o instanceof k&&(t=s(A,{children:[i(ge,{textAlign:"center",children:"An error occurred while running the following query:"}),i(To,{children:M(o.sql)})]})),i(J,{maxW:"container.md",my:10,children:s(W,{gap:4,children:[i(F,{children:i(Go,{boxSize:20,color:"red"})}),i(Me,{size:"xl",textAlign:"center",children:o.message}),t,s(Le,{justify:"center",gap:4,children:[i(C,{onClick:()=>this.setState({error:void 0}),size:"sm",children:"Dismiss Error"}),i(C,{onClick:()=>window.location.reload(),size:"sm",colorScheme:"blue",leftIcon:i(Or,{}),children:"Reload"})]})]})})}return this.props.children}}const yd=Ar({fonts:{heading:"InterVariable, sans-serif",body:"InterVariable, sans-serif",mono:'"Source Code ProVariable", monospace'},components:{Link:{baseStyle:e=>({color:e.colorMode==="light"?"blue.600":"blue.300"})}}}),gd=({children:e})=>{const o=m(Ve),t=Po();return i(Dr,{value:{onError:d=>{if(o)console.warn("Ignoring error while resetting schema",d);else{console.error(d);const a="swr-error",n={id:"swr-error",title:"An error occurred",description:d.message,status:"error",duration:5e3,isClosable:!0};t.isActive(a)?t.update(a,n):t(E({id:a},n))}}},children:e})};Cr.render(i(pe.StrictMode,{children:i(Ir,{theme:yd,children:i(Rt,{children:i(wr,{children:i(Lr,{basename:"/",children:i(gd,{children:i(ud,{children:i(pd,{})})})})})})})}),document.getElementById("root"));
