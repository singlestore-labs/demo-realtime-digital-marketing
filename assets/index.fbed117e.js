...
`+$(this.baseQuery.sql()),t}params(){return[...this.fragments.flatMap(([,o])=>o.params()),...this.baseQuery.params()]}}class ar{constructor(t,o,r=!1){b(this,"tuples",[]);this.table=t,this.columns=o,this.replace=r}append(...t){if(t.length!==this.columns.length)throw new Error(`Expected ${this.columns.length} values, got ${t.length}`);this.tuples.push(t)}clear(){this.tuples=[]}sql(){const t=`(${this.columns.map(()=>"?").join(",")})`,o=this.tuples.map(()=>t).join(",");return $`
    ...
    `,t.id,t.name,`POINT(${t.lonlat[0]} ${t.lonlat[1]})`,t.diameter),pr=(e,t)=>v(e,"DELETE FROM cities WHERE city_id = ?",t),yr=["olc_8","purchase","request"],ur=["minute","hour","day","week","month"],It=({interval:e,kind:t,value:o})=>ao(`${e}-${t}-${o}`),gr=async(e,t)=>{const o=new At("segments",["segment_id","valid_interval","filter_kind","filter_value"]);for(const r of t)o.append(It(r),r.interval,r.kind,r.value);await v(e,o.sql(),...o.params())},fr=async(e,t)=>{const o=new At("offers",["customer","notification_zone","segment_ids","notification_content","notification_target","maximum_bid_cents"]);let r=0,d=[];const a=async()=>{await Promise.all([v(e,o.sql(),...o.params()),gr(e,d)]),o.clear(),d=[],r=0};for(const n of t)o.append(n.customer,n.notificationZone,JSON.stringify(n.segments.map(It)),n.notificationContent,n.notificationTarget,n.maximumBidCents),r++,d=d.concat(n.segments),r>=sr&&await a();r>0&&await a()},mr=()=>tt(yr),vr=()=>tt(ur),wt=({vendor:e,tld:t})=>`${e.toLowerCase()}.${t}`,Ct=e=>{const[t,o]=e.lonlat,r=e.diameter/2,[d,a]=[t-r,t+r],[n,l]=[o-r,o+r];return[Fe(d,a),Fe(n,l)]},br=(e,t)=>{const o=mr(),r=vr();switch(o){case"olc_8":{const[d,a]=Ct(e),n=Ue.encode(a,d,8).substring(0,8);return{kind:o,interval:r,value:n}}case"purchase":return{kind:o,interval:r,value:t.vendor};case"request":return{kind:o,interval:r,value:wt(t)}}},hr=e=>{const t=pe(1,3),o=lr(),r=Array.from({length:t},()=>br(e,o)),d=wt(o),n=`${pe(10,50)}% off at ${o.vendor}`,l=d,[c,s]=Ct(e),y=Ue.encode(s,c,tt([8,10])),u=Ue.decode(y),f={ne:[u.latitudeHi,u.longitudeHi],sw:[u.latitudeLo,u.longitudeLo]};return{customer:o.vendor,segments:r,notificationZone:et(f),notificationContent:n,notificationTarget:l,maximumBidCents:pe(2,15)}},Er=(e,t)=>Array.from({length:t},()=>hr(e)),_r=e=>(t,o,r,d=1)=>`https://stamen-tiles.a.ssl.fastly.net/${e}/${r}/${t}/${o}${d>=2?"@2x":""}.png`,Tr=p(R,{children:["Map tiles by ",i(H,{href:"http://stamen.com",children:"Stamen Design"}),", under"," ",i(H,{href:"http://creativecommons.org/licenses/by/3.0",children:"CC BY 3.0"}),". Data by ",i(H,{href:"http://openstreetmap.org",children:"OpenStreetMap"}),", under"," ",i(H,{href:"http://www.openstreetmap.org/copyright",children:"ODbL"}),"."]}),Sr=[oe.lonlat[1],oe.lonlat[0]],Nr=12,Rr=({width:e,height:t,bounds:o,latLngToPixel:r,pixelToLatLng:d,useRenderer:a,options:n})=>{const l=re.useRef(null),c=ut(()=>new K),{setup:s,update:y}=a({scene:c,width:e,height:t,bounds:o,latLngToPixel:r,pixelToLatLng:d,options:n});return g.exports.useLayoutEffect(()=>{if(!l.current)throw new Error("No canvas ref");console.log("PixiMapLayer: Setup");const u=new co({view:l.current,width:e,height:t,backgroundAlpha:0,antialias:!0});return u.stage.addChild(c),s==null||s(),y&&u.ticker.add(f=>{y(f)}),()=>{console.log("PixiMapLayer: Destroy"),u.stage.removeChild(c),u.destroy(!1,{children:!1,texture:!0,baseTexture:!0})}},[t,c,s,y,e]),i("canvas",{ref:l})},Ar=({mapState:e,latLngToPixel:t,pixelToLatLng:o,useRenderer:r,options:d})=>{const{width:a,height:n,bounds:l}=e||{width:0,height:0};return a<=0||n<=0||!t||!o||!l?null:i(Rr,{useRenderer:r,width:a,height:n,bounds:l,latLngToPixel:t,pixelToLatLng:o,options:d})},Ne=n=>{var l=n,{height:e="100%",defaultCenter:t=Sr,defaultZoom:o=Nr,useRenderer:r,options:d}=l,a=L(l,["height","defaultCenter","defaultZoom","useRenderer","options"]);const[c,s]=g.exports.useState(t),[y,u]=g.exports.useState(o);return i(x,S(E({borderRadius:"lg",overflow:"hidden",height:e},a),{children:i(no,{dprs:[1,2],provider:_r("toner-lite"),attribution:Tr,maxZoom:20,center:c,zoom:y,onBoundsChanged:({center:f,zoom:_})=>{s(f),u(_)},children:i(Ar,{useRenderer:r,options:d})})}))};var Re=[{name:"date_sub_dynamic",createStmt:`CREATE OR REPLACE FUNCTION date_sub_dynamic (
  _dt DATETIME(6),
...
END`}],Oe=[{name:"worldcities",createStmt:`create rowstore table if not exists worldcities (
  ...
  UNION
  SELECT * FROM dynamic_subscriber_segments_purchases(_since, _until)
);`}];const ye="singlestore-realtime-digital-marketing",Or=[`CREATE LINK aws_s3 AS S3 CREDENTIALS '{}' CONFIG '{ "region": "us-east-1" }'`,`
    CREATE OR REPLACE PIPELINE worldcities
    AS LOAD DATA LINK aws_s3 '${ye}/cities.ndjson'
  ...
  `,"START PIPELINE worldcities FOREGROUND"],Ir=e=>{const t=Oe.find(d=>d.name===e);if(t)return t;const o=Ae.find(d=>d.name===e);if(o)return o;const r=Re.find(d=>d.name===e);if(r)return r;throw new Error("Could not find schema object: "+e)},wr=async e=>{try{return await Qe(e,"SELECT 1"),!0}catch{return!1}},Cr=async e=>{let t={tables:[],procedures:[],functions:[]};const l=e,{database:o}=l,r=L(l,["database"]);try{t=(await Ze(r,`
        ...
        `,o,o)).reduce((c,[s,y])=>(c[s].push(y),c),t)}catch(c){if(!(c instanceof I&&(c.isUnknownDatabase()||c.isDatabaseRecovering())))throw c}const{tables:d,procedures:a,functions:n}=t;return Object.fromEntries([Oe.map(({name:c})=>[c,d.includes(c)]),Ae.map(({name:c})=>[c,a.includes(c)]),Re.map(({name:c})=>[c,n.includes(c)])].flat())},Lt=e=>Qe(e,"DROP DATABASE IF EXISTS `"+e.database+"`"),Lr=async(e,{progress:t,scaleFactor:o,includeSeedData:r,skipCreate:d=!1})=>{d||(t("Dropping existing schema","info"),await Lt(e),t("Creating database","info"),await Qe(e,"CREATE DATABASE `"+e.database+"`"));for(const a of Re)t(`Creating function: ${a.name}`,"info"),await v(e,a.createStmt);for(const a of Oe)t(`Creating table: ${a.name}`,"info"),await v(e,a.createStmt);for(const a of Ae)t(`Creating procedure: ${a.name}`,"info"),await v(e,a.createStmt);await kr(e),await Ot(e,oe),r&&(t("Creating sample data","info"),await ot(e,oe,o)),t("Schema initialized","success")},kr=async e=>{for(const t of Or)await v(e,t)},ot=(e,t,o)=>{const r=100*o.partitions,d=Er(t,r);return fr(e,d)},kt=async(e,t)=>{const o=t.prefix;return await V(e,`
      SELECT
    ...
    `,e.database)},xt=async(e,t)=>{const o=t.prefix,r=await kt(e,t);await Promise.all(r.filter(d=>d.needsUpdate).map(async d=>{console.log(`recreating pipeline ${d.pipelineName} for city ${d.cityName}`),d.pipelineName.startsWith("locations_")?await v(e,`
            CREATE OR REPLACE PIPELINE ${d.pipelineName}
            AS LOAD DATA LINK aws_s3 '${ye}/${o}/locations.*'
          ...
          `,d.cityId,d.lon,d.diameter,d.lat,d.diameter):d.pipelineName.startsWith("requests_")?await v(e,`
            CREATE OR REPLACE PIPELINE ${d.pipelineName}
            AS LOAD DATA LINK aws_s3 '${ye}/${o}/requests.*'
            MAX_PARTITIONS_PER_BATCH ${t.partitions}
            ...
            SET ts = NOW(),
              city_id = ?;
          `,d.cityId):d.pipelineName.startsWith("purchases_")&&await v(e,`
            CREATE OR REPLACE PIPELINE ${d.pipelineName}
            AS LOAD DATA LINK aws_s3 '${ye}/${o}/purchases.*'
            MAX_PARTITIONS_PER_BATCH ${t.partitions}
            ...
            SET ts = NOW(),
              city_id = ?;
          `,d.cityId),await v(e,`ALTER PIPELINE ${d.pipelineName} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await v(e,`START PIPELINE IF NOT RUNNING ${d.pipelineName}`),console.log(`finished creating pipeline ${d.pipelineName} for city ${d.cityName}`)}))},xr=async e=>{const t=await Ze(e,`
      SELECT
    ...
    `,e.database);await Promise.all(t.map(async([o])=>{console.log("restarting pipeline",o),await v(e,`ALTER PIPELINE ${o} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await v(e,`START PIPELINE IF NOT RUNNING ${o}`)}))},Dr=async e=>{const t=await V(e,`
    ...
    `,e.database);await Promise.all(t.map(o=>(console.log("dropping pipeline",o.pipelineName),v(e,`DROP PIPELINE ${o.pipelineName}`))))},Dt=async e=>{const t=await V(e,`
      SELECT plan_id AS planId
      FROM information_schema.plancache
      WHERE
        plan_warnings LIKE "%empty tables%"
    `);return await Promise.all(t.map(({planId:o})=>v(e,`DROP ${o} FROM PLANCACHE`))),t.length>0},zr=(e,...t)=>{const o=t.map(r=>`"${r}"`).join(",");return Rt(e,`
      ...
      GROUP BY tableName
    `,e.database)},rt=(e,...t)=>zr(e,...t).then(o=>o.reduce((r,{tableName:d,count:a})=>(r[d]=a,r),{})),Pr=async(e,t)=>{const{maxRows:o}=t,d=["locations","requests","purchases","notifications"].map(n=>`"${n}"`).join(","),a=await Rt(e,`
      SELECT
      ...
      WHERE
        ...
        AND stats.count > ?
    `,e.database,o);await Promise.all(a.map(async({tableName:n,count:l,minTs:c,maxTs:s})=>{const u=(l-o)/l;if(u<.2)return;const f=new Date((c+u*(s-c))*1e3);console.log(`removing rows from ${n} older than ${f.toISOString()}`),await v(e,`DELETE FROM ${n} WHERE ts <= ?`,f.toISOString())}))},it=(e,t="minute")=>qe(e,"ECHO run_matching_process(?)",t).then(o=>o.RESULT),dt=async(e,t)=>{const o=new Date().toISOString();return await Promise.all(["update_location_segments","update_request_segments","update_purchase_segments"].map(r=>v(e,`CALL ${r}(?, ?)`,t,o))),await v(e,"CALL prune_segments(?)",o),o},Mr=(e,t,o,r)=>Ze(e,`
      SELECT
        ts,
...
`,Yr=e=>qe(e,new dr(`
    ...
    `).with("metrics",Gr).sql()),W=[{name:"s00",maxRows:1e7,prefix:"v2/100k-2p",partitions:2},{name:"s0",maxRows:2e7,prefix:"v2/100k-4p",partitions:4},{name:"s1",maxRows:4e7,prefix:"v2/100k-8p",partitions:8},{name:"s2",maxRows:16e7,prefix:"v2/1m-16p",partitions:16},{name:"s4",maxRows:32e7,prefix:"v2/1m-32p",partitions:16},{name:"s8",maxRows:64e7,prefix:"v2/1m-64p",partitions:64},{name:"s10",maxRows:1e9,prefix:"v2/10m-80p",partitions:80}],Hr=e=>W.find(t=>t.name===e)||W[0],X=({encode:e,decode:t}={encode:JSON.stringify,decode:JSON.parse})=>({setSelf:o,onSet:r,node:d})=>{const a=`recoil.localstorage.${d.key}`,n=localStorage.getItem(a);n!=null&&o(t(n)),r((l,c,s)=>{s?localStorage.removeItem(a):localStorage.setItem(a,e(l))})},at=()=>({setSelf:e,node:{key:t}})=>{const{location:o}=window;if(o){const r=new URLSearchParams(o.search);e(r.get(t))}},Wr=w({key:"skipCreateDatabase",default:null,effects:[at()]}),jr=w({key:"sessionId",default:null,effects:[at()]}),Vr=w({key:"vaporBaseUrl",default:"https://vapor.labs.singlestore.com",effects:[at()]}),zt=w({key:"connectionHost",default:"http://127.0.0.1",effects:[X()]}),Pt=w({key:"connectionUser",default:"root",effects:[X()]}),Mt=w({key:"connectionPassword",default:"",effects:[X()]}),q=w({key:"connectionDatabase",default:"martech",effects:[X()]}),Ut=gt({key:"vaporConnectionConfig",get:async({get:e})=>{const t=e(jr),o=e(Vr);if(t)try{const r=await fetch(o+"/api/v1/vapor/connect?sessionId="+t);if(r.status===200){const d=await r.json();return{host:d.endpoint,user:d.user,password:d.password,database:e(q)}}}catch{console.log(`Failed to connect to vapor at ${o}, falling back to local config`)}}}),h=gt({key:"connectionConfig",get:({get:e})=>{const t=e(Ut);if(t)return t;const o=e(zt),r=e(Pt),d=e(Mt),a=e(q);return{host:o,user:r,password:d,database:a}},cachePolicy_UNSTABLE:{eviction:"most-recent"}}),Z=w({key:"configScaleFactor",default:W[0],effects:[X({encode:e=>e.name,decode:e=>W.find(t=>t.name===e)||W[0]})]}),Ie=w({key:"simulatorEnabled",default:!0,effects:[X()]}),$r=w({key:"databaseDrawerIsOpen",default:!1}),Ge=lo({key:"tickDurationMs",default:void 0}),Kr=Object.fromEntries([Oe.map(({name:e})=>[e,!1]),Ae.map(({name:e})=>[e,!1]),Re.map(({name:e})=>[e,!1])].flat()),Bt=(e=!1)=>{const t=m(h);return C(["schemaObjects",t,e],()=>Cr(t),{isPaused:()=>e,refreshInterval:o=>Object.values(o||[]).some(d=>!d)?1e3:0,fallbackData:Kr})},A=()=>{const a=m(h),{database:e}=a,t=L(a,["database"]),o=m(Ut),r=C(["isConnected",t],()=>wr(t)),d=Bt(!r.data);return{isVapor:!!o,connected:!!r.data,initialized:!!r.data&&Object.values(d.data||[]).every(Boolean),reset:()=>{r.mutate(),d.mutate()}}},Jr=(()=>{let e={};return t=>(t in e||(e[t]=1),`${t}(${e[t]++})`)})(),Ye=(e,{name:t,enabled:o,intervalMS:r})=>{const d=so(Ge(t));g.exports.useEffect(()=>{if(!o)return;const a=new AbortController,n=Jr(t);console.log(`Starting ${n}: tick interval: ${r}ms`);const l=async()=>{try{if(console.time(n),a.signal.aborted)return;const c=performance.now();await e(a);const s=performance.now()-c;d(s),setTimeout(l,Math.max(0,r-s))}catch(c){if(a.signal.aborted||c instanceof I&&c.isUnknownDatabase()||c instanceof DOMException&&c.name==="AbortError")return;throw c}finally{console.timeEnd(n)}};return l(),()=>{console.log(`Stopping ${n}`),a.abort()}},[o,e,r,t,d])},Xr=({before:e,after:t,includeSeedData:o})=>{const r=m(h),d=m(Z),{reset:a}=A(),[n,l]=O(Ie),c=ft(),s=m(Wr);return g.exports.useCallback(async()=>{const y=n;l(!1),e(),await Lr(r,{progress(u,f){const _="reset-schema";c.isActive(_)?c.update(_,{title:u,status:f,duration:f==="success"?2e3:null,isClosable:!0}):c({id:_,title:u,status:f,duration:null})},scaleFactor:d,includeSeedData:o,skipCreate:!!s}),t(),a(),l(y)},[n,l,e,r,d,o,s,t,a,c])},Ft=(e,t)=>{const[o,r]=g.exports.useState(e);return g.exports.useEffect(()=>{const d=setTimeout(()=>r(e),t);return()=>clearTimeout(d)},[e,t]),o},Gt=()=>{const[{elapsed:e,isRunning:t},o]=g.exports.useReducer((r,d)=>{switch(d.type){case"start":return{start:Math.floor(performance.now()),isRunning:!0,elapsed:r.elapsed};case"stop":return{elapsed:Math.floor(performance.now())-(r.start||0),isRunning:!1}}},{isRunning:!1});return{elapsed:e,isRunning:t,startTimer:()=>o({type:"start"}),stopTimer:()=>o({type:"stop"})}},Yt=(e,t)=>{let o=!1,r=new po(0,0),d=0;e.on("pointerdown",a=>{o=!0,r=a.data.global,d=performance.now()}),e.on("pointerup",a=>{if(!o||(o=!1,performance.now()-d>200))return;const l=a.data.global;Math.sqrt(Math.pow(l.x-r.x,2)+Math.pow(l.y-r.y,2))>10||t(a)}),e.on("pointercancel",()=>{o=!1})};class qr extends K{constructor(t,o){super();b(this,"gfx");b(this,"hover",!1);this.city=t,this.onRemove=o,this.gfx=new fe,this.addChild(this.gfx),this.gfx.interactive=!0,this.gfx.on("pointerover",()=>{this.hover=!0}),this.gfx.on("pointerout",()=>{this.hover=!1}),Yt(this.gfx,()=>o(this.city))}update(t){this.gfx.clear(),this.gfx.lineStyle(1,this.hover?16711680:306687,1),this.gfx.beginFill(this.hover?16711680:306687,.2);const[o,r]=t([this.city.centerLat,this.city.centerLon]);this.gfx.drawCircle(o,r,25),this.gfx.endFill()}}const Zr=e=>{const t=m(h),{initialized:o}=A();return C(["cities",t,o],()=>Br(t),{isPaused:()=>!o,onSuccess:e})},Qr=({scene:e,latLngToPixel:t,pixelToLatLng:o,width:r,height:d})=>{const a=m(h),n=ut(()=>new K),{mutate:l}=Zr(y=>{n.removeChildren();for(let u=0;u<y.length;u++)n.addChild(new qr(y[u],s))}),c=g.exports.useCallback(async(y,u)=>{const f=await Fr(a,u,y),_={id:f.id,name:f.name,lonlat:[f.centerLon,f.centerLat],diameter:f.diameter};await Ot(a,_),await ot(a,_,W[0]),l()},[a,l]),s=g.exports.useCallback(async y=>{await pr(a,y.id),l()},[a,l]);return{setup:g.exports.useCallback(()=>{const y=new K;e.addChild(y),e.addChild(n),y.interactive=!0,y.hitArea=new yo(0,0,r,d),Yt(y,u=>{const[f,_]=o([u.data.global.x,u.data.global.y]);c(f,_)})},[n,d,c,o,e,r]),update:g.exports.useCallback(()=>{for(let y=0;y<n.children.length;y++)n.children[y].update(t)},[n,t])}},ei=e=>i(Ne,S(E({},e),{useRenderer:Qr,options:{},cursor:"pointer"})),ti=uo({a:o=>{var r=o,{children:e}=r,t=L(r,["children"]);const{href:d}=t,a=!!(d!=null&&d.startsWith("http"));return a?p(H,S(E({isExternal:a},t),{children:[e,i(go,{bottom:"2px",boxSize:"0.9em",position:"relative",ml:1})]})):i(H,S(E({to:d||""},t),{as:mt,children:e}))}}),T=o=>{var r=o,{children:e}=r,t=L(r,["children"]);return i(fo,S(E({},t),{skipHtml:!0,components:ti,children:Array.isArray(e)?e.filter(d=>d).map(d=>$(d||"")).join(`

`):$(e)}))},oi=()=>p(D,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(D,{maxW:"container.md",mb:10,children:i(T,{children:`
            ## Admin

            You can configure cities and offers on this page. To learn more
            about this application please visit the [Overview page](/).
          `})}),i(ri,{})]}),ri=()=>p(R,{children:[i(D,{maxW:"container.md",mb:4,children:i(T,{children:`
            #### Cities
            ...
            remove it.
          `})}),i(ei,{defaultZoom:4,defaultCenter:[39.716470511656766,-99.59395661915288],height:300})]}),ii=()=>{var r;const e=m(h),t=C(["overallConversionRate",e],()=>Yr(e),{refreshInterval:1e3}),o=he(",.2%");return p(D,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(D,{maxW:"container.md",mb:10,children:i(T,{children:`
            ## Analytics

            This page showcases some useful business analytics.
          `})}),i(We,{templateColumns:"repeat(auto-fit, minmax(100px, 1fr))",columnGap:2,rowGap:2,children:p(B,{children:[i(F,{children:"Overall Rate"}),i(G,{children:o(((r=t.data)==null?void 0:r.conversionRate)||0)})]})})]})},ae=({label:e,placeholder:t,value:o,setValue:r,helpText:d,type:a="text"})=>p(je,{children:[i(Ve,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),i(vt,{size:"sm",placeholder:t,value:o,onChange:n=>r(n.target.value),type:a}),d?i(mo,{fontSize:"xs",children:d}):null]}),di=()=>{const[e,t]=O(Z);return p(je,{children:[i(Ve,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),i(vo,{size:"sm",required:!0,value:e.name,onChange:o=>{const r=o.target.value;t(Hr(r))},children:W.map(o=>i("option",{value:o.name,children:o.name},o.name))})]})},Ht=({showDatabase:e,showScaleFactor:t})=>{const[o,r]=O(zt),[d,a]=O(Pt),[n,l]=O(Mt),[c,s]=O(q);return p(J,{spacing:4,children:[i(ae,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:o,setValue:r,helpText:i(T,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [HTTP API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),p(bt,{columns:2,gap:2,children:[i(ae,{label:"Username",placeholder:"admin",value:d,setValue:a}),i(ae,{label:"Password",placeholder:"",value:n,setValue:l,type:"password"}),e&&i(ae,{label:"Database",placeholder:"martech",value:c,setValue:s}),t&&i(di,{})]})]})},Wt=e=>i(N,S(E({onClick:()=>{const{pathname:t,hash:o}=window.location;window.location.replace(t+o)},colorScheme:"red"},e),{children:"Disconnect"})),jt=e=>{const{connected:t,initialized:o}=A(),r=$e(),[d,a]=Ee(),n=m(q),l=re.useRef(null),f=e,{skipSeedData:c,disabled:s}=f,y=L(f,["skipSeedData","disabled"]),u=Xr({before:g.exports.useCallback(()=>a.on(),[a]),after:g.exports.useCallback(()=>{a.off(),r.onClose()},[r,a]),includeSeedData:!c});return p(R,{children:[i(N,E({disabled:!t||s,onClick:r.onOpen,colorScheme:o?"green":"red"},y)),i(bo,{isOpen:r.isOpen,onClose:r.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:l,children:i(Ke,{children:p(ho,{children:[p(Je,{fontSize:"lg",fontWeight:"bold",children:[o?"Reset":"Setup"," database ",n]}),p(Xe,{children:["This will ",o?"recreate":"create"," the database called ",n,". Are you sure?"]}),p(ht,{children:[i(N,{ref:l,onClick:r.onClose,disabled:d,children:"Cancel"}),i(N,{disabled:d,colorScheme:o?"red":"green",onClick:u,ml:3,children:d?i(P,{}):o?"Recreate database":"Create database"})]})]})})})]})},ai=({isOpen:e,onClose:t,finalFocusRef:o})=>{const[r,d]=O(Ie),a=m(h),{connected:n,initialized:l,isVapor:c}=A(),s=$e(),[y,u]=Ee(!1),f=g.exports.useCallback(async()=>{u.on(),await Lt(a),u.off()},[a,u]);return p(Eo,{isOpen:e,placement:"right",onClose:t,finalFocusRef:o,children:[i(Ke,{}),p(_o,{children:[i(Et,{}),i(Je,{children:"Config"}),i(Xe,{children:p(J,{spacing:4,children:[c?null:i(Ht,{showScaleFactor:!0,showDatabase:!0}),p(ce,{status:n?"success":"error",borderRadius:"md",children:[i(le,{}),i(se,{children:n?"connected":"disconnected"}),c?i(Wt,{position:"absolute",right:4,top:3,size:"xs"}):null]}),p(ce,{status:l?"success":"warning",borderRadius:"md",children:[i(le,{}),i(se,{children:"schema"}),i(jt,{position:"absolute",right:4,top:3,size:"xs",children:l?"Reset":"Setup"})]}),p(ce,{status:r?"success":"warning",borderRadius:"md",children:[i(le,{}),i(se,{children:"simulator"}),i(To,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:r?"green":"red",isChecked:r,disabled:!n||!l,onChange:()=>d(!r)})]}),p(ie,{onClick:s.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",s.isOpen?i(So,{ml:2}):i(No,{ml:2})]}),s.isOpen?i(N,{size:"xs",_hover:{colorScheme:"red"},onClick:f,disabled:y,children:"Drop Database"}):void 0]})}),i(ht,{})]})]})},ne=({to:e,children:t,onClick:o})=>{const r=Lo(e),d=ko({path:r.pathname,end:!0});return i(H,{as:mt,to:e,px:2,py:1,onClick:o,rounded:"md",_hover:{textDecoration:"none",bg:Be("gray.300","gray.600")},fontWeight:d?"bold":"normal",href:"#",color:Be("gray.700","gray.200"),children:t})},ni=()=>{const{colorMode:e,toggleColorMode:t}=_e(),o=$e(),[r,d]=O($r),a=re.useRef(null),{connected:n,initialized:l}=A(),c=m(Ie),[s]=_t("(max-width: 640px)"),y=p(R,{children:[i(ne,{to:"/",onClick:o.onClose,children:"Overview"}),i(ne,{to:"/map",onClick:o.onClose,children:"Map"}),i(ne,{to:"/admin",onClick:o.onClose,children:"Admin"}),i(ne,{to:"/analytics",onClick:o.onClose,children:"Analytics"})]});let u;return s||(u=n?l?c?"connected":"simulator disabled":"needs schema":"disconnected"),i(R,{children:i(x,{bg:Be("gray.200","gray.700"),children:p(D,{maxW:"container.lg",children:[p(me,{h:16,alignItems:"center",justifyContent:"space-between",children:[i(ze,{size:"md",icon:o.isOpen?i(Ro,{}):i(Ao,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:o.isOpen?o.onClose:o.onOpen}),p(ve,{spacing:8,alignItems:"center",children:[i(Te,{as:"h1",size:s?"sm":"md",children:s?"Martech":"Realtime Digital Marketing"}),i(ve,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:y})]}),p(me,{alignItems:"center",gap:2,children:[p(N,{size:"sm",ref:a,onClick:()=>d(!0),colorScheme:n?l&&c?"green":"yellow":"red",children:[l?i(Tt,{}):i(St,{}),s||i(ie,{pl:2,children:u})]}),i(ze,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?i(Oo,{size:"1.4em"}):i(Io,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),i(ze,{"aria-label":"Toggle Color Mode",size:"sm",onClick:t,icon:e==="light"?i(wo,{boxSize:"1.2em"}):i(Co,{boxSize:"1.2em"})})]})]}),o.isOpen?i(x,{pb:4,display:{md:"none"},children:i(J,{as:"nav",spacing:4,children:y})}):null,i(ai,{isOpen:r,onClose:()=>d(!1),finalFocusRef:a})]})})})},ci=e=>{const t=g.exports.useRef([]),{data:o}=C(["timeseries",e.name,...e.deps||[]],async()=>{const r=await e.fetcher();return t.current.push({data:r,ts:new Date}),t.current=t.current.slice(-e.limit),t.current},{refreshInterval:e.intervalMS});return o||[]},li=he("~s"),Vt=(e,...t)=>ci({name:"estimatedRowCount",deps:t,fetcher:g.exports.useCallback(()=>rt(e,...t),[e,t]),limit:30,intervalMS:1e3}),$t=o=>{var r=o,{data:e}=r,t=L(r,["data"]);const{colorMode:d}=_e(),a=g.exports.useCallback(({tooltipData:c,colorScale:s})=>!s||!c?null:Object.keys(c.datumByKey).sort((y,u)=>c.datumByKey[u].datum.data[u]-c.datumByKey[y].datum.data[y]).map(y=>{const{datum:u}=c.datumByKey[y],f=u.data[y];return p(ie,{mb:1,color:s(y),fontSize:"sm",children:[y,": ",he(".4~s")(f)]},y)}),[]),n=g.exports.useCallback(c=>li(c).replace("G","B"),[]);if(e.length<2)return i(M,{height:t.height,children:i(P,{size:"md"})});const l=e.length>0?Object.keys(e[0].data).filter(c=>c!=="ts").map(c=>i(xo,{dataKey:c,data:e,xAccessor:s=>s==null?void 0:s.ts,yAccessor:s=>s==null?void 0:s.data[c]},c)):null;return p(Do,S(E({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:d==="light"?zo:Po,margin:{left:0,right:50,top:10,bottom:40}},t),{children:[i(lt,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),i(lt,{orientation:"right",numTicks:t.height<250?3:5,tickFormat:n,label:"rows",labelOffset:20}),l,i(Mo,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:a})]}))},si=10*1e3,Kt=e=>{const t=m(h),o=m(Z),{initialized:r}=A(),d=g.exports.useCallback(a=>{const n=S(E({},t),{ctx:a});return Promise.all([xt(n,o),xr(n),Dr(n),Pr(n,o),Dt(n)])},[t,o]);Ye(d,{name:"SimulatorMonitor",enabled:r&&e,intervalMS:si})},pi=1*1e3,yi=10*1e3,ui=e=>{const t=m(h),{initialized:o}=A(),r=g.exports.useRef(new Date(0).toISOString()),d=g.exports.useCallback(n=>it(S(E({},t),{ctx:n}),"minute"),[t]);Ye(d,{name:"SimulatorMatcher",enabled:o&&e,intervalMS:pi});const a=g.exports.useCallback(async n=>{r.current=await dt(S(E({},t),{ctx:n}),r.current)},[t]);Ye(a,{name:"SimulatorUpdateSegments",enabled:o&&e,intervalMS:yi})},He=1e3,ue=60*He,ge=60*ue,Me=24*ge,k=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),j=e=>e?e<He?`${k(e)}ms`:e<ue?`${k(e/He)}s`:e<ge?`${Math.floor(e/ue)}m${j(e%ue)}`:e<Me?`${Math.floor(e/ge)}h${j(e%ge)}`:`${Math.floor(e/Me)}d${j(e%Me)}`:"0s",gi=100,fi=1e3,Y=class extends K{constructor(t){super();b(this,"latlng");b(this,"age",0);b(this,"marker");b(this,"pulse");this.latlng=t,this.marker=new fe,this.marker.beginFill(Y.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new fe,this.pulse.beginFill(Y.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(t,o){if(this.age+=o/60,this.age>Y.lifetime&&this.parent){this.parent.removeChild(this);return}const r=this.age%Y.lifetime/Y.lifetime,d=Go(r);this.pulse.scale.set(1+d);const a=.4,n=r<a?Uo(r/a):1-Bo((r-a)/(1-a));this.pulse.alpha=n,r<a?this.marker.alpha=n:this.marker.alpha=1-Fo((r-a)/(1-a));const[l,c]=t(this.latlng);this.x=l,this.y=c}};let te=Y;b(te,"lifetime",1.5),b(te,"markerColor",306687),b(te,"pulseColor",306687);const Jt=()=>{const e=m(h),{initialized:t}=A();return g.exports.useMemo(()=>["notifications",e,t],[e,t])},Xt=({scene:e,latLngToPixel:t,bounds:o})=>{const r=g.exports.useRef(new Date().toISOString()),d=m(h),{initialized:a}=A(),n=Ft(o,50),l=Jt();return C(l,()=>Mr(d,r.current,gi,n),{refreshInterval:fi,isPaused:()=>!a,onSuccess:c=>{if(c.length>0){r.current=c[0][0];for(const[,s,y]of c)e.addChild(new te([y,s]))}}}),{update:g.exports.useCallback(c=>{for(let s=e.children.length-1;s>=0;s--)e.children[s].update(t,c)},[t,e])}},mi=()=>{const e=m(h),t=Vt(e,"locations","requests","purchases","notifications","subscriber_segments"),o=C(["notificationsMapTableCounts",e],()=>rt(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),r=m(Ge("SimulatorMatcher")),d=m(Ge("SimulatorUpdateSegments")),a=he(".4~s"),n=o.data?p(We,{templateColumns:"repeat(auto-fit, minmax(100px, 1fr))",columnGap:2,rowGap:2,children:[p(B,{children:[i(F,{children:"Offers"}),i(G,{children:a(o.data.offers)})]}),p(B,{children:[i(F,{children:"Cities"}),i(G,{children:a(o.data.cities)})]}),p(B,{children:[i(F,{children:"Subscribers"}),i(G,{children:a(o.data.subscribers)})]}),p(B,{children:[i(F,{children:"Segments"}),i(G,{children:a(o.data.segments)})]}),p(B,{children:[i(F,{children:"Segmentation"}),i(G,{children:j(d)})]}),p(B,{children:[i(F,{children:"Matching"}),i(G,{children:j(r)})]})]}):null;return p(R,{children:[i(T,{children:`
          ...
          about the demo.
        `}),n,p(x,{children:[i(ie,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),i($t,{data:t,height:150})]})]})},vi=()=>{const[e,t]=O(Ie);return Kt(e),ui(e),p(me,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[i(J,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:i(Ne,{useRenderer:Xt,options:{}})}),p(J,{spacing:4,flex:"1 1 0",minWidth:"0",children:[i(T,{children:`
          ...
          `}),e?i(mi,{}):i(R,{children:p(ce,{status:"warning",borderRadius:"md",children:[i(le,{}),i(se,{children:"The simulator is disabled"}),i(N,{position:"absolute",right:4,top:3,size:"xs",colorScheme:"blue",onClick:()=>t(!0),children:"Enable simulator"})]})})]})]})},qt=o=>{var r=o,{children:e}=r,t=L(r,["children"]);return i(Yo,S(E({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},t),{children:e}))},bi=1e3;class hi extends K{constructor(t){super();b(this,"offer");b(this,"points");b(this,"polygon");this.offer=t,this.points=cr(t.notificationZone),this.polygon=new fe,this.addChild(this.polygon),this.polygon.interactive=!0,this.polygon.on("mouseover",()=>{this.polygon.tint=65280}),this.polygon.on("mouseout",()=>{this.polygon.tint=16777215})}update(t){this.polygon.clear(),this.polygon.lineStyle(1,306687,1),this.polygon.beginFill(306687,.2),this.polygon.drawPolygon(this.points.flatMap(([o,r])=>t([r,o]))),this.polygon.endFill()}}const Ei=({scene:e,latLngToPixel:t,bounds:o})=>{const r=m(h),{initialized:d}=A(),a=Ft(o,100);return C(["offers",r,d,a],()=>Ur(r,bi,a),{isPaused:()=>!d,onSuccess:n=>{e.removeChildren();for(let l=0;l<n.length;l++)e.addChild(new hi(n[l]))}}),{update:g.exports.useCallback(()=>{for(let n=0;n<e.children.length;n++)e.children[n].update(t)},[t,e])}},_i=e=>i(Ne,S(E({},e),{useRenderer:Ei,options:{}})),z=e=>{const{completed:t,title:o,left:r,right:d}=e,{colorMode:a}=_e(),n=a==="light"?".300":".500",l=t?"gray"+n:void 0,c=(t?"green":"gray")+n;return p(R,{children:[p(be,{children:[p(Te,{as:"h2",size:"lg",mb:4,color:l,children:[i(Tt,E({color:c},{boxSize:6,position:"relative",bottom:.5,mr:2})),o]}),r]}),i(be,{children:d})]})},Ti=({connected:e,isVapor:t})=>t?i(z,{completed:e,title:"Connected",left:p(R,{children:[i(T,{children:`
                ...
                the button below.
              `}),i(Wt,{size:"xs",colorScheme:"gray"})]}),right:null}):i(z,{completed:e,title:"Connect to SingleStore",left:i(T,{children:`
            ...
            **Note**: The HTTP API may need to be enabled on your SingleStore
            ...
            [1]: https://docs.singlestore.com/docs/http-api/
          `}),right:i(Ht,{})}),Si=({onClose:e,schemaObjectName:t})=>{const o=Ir(t),[r]=_t("(max-width: 640px)");return p(jo,{isOpen:!0,onClose:e,size:r?"full":"4xl",scrollBehavior:"inside",children:[i(Ke,{}),p(Vo,{children:[p(Je,{children:["Create statement for ",o.name]}),i(Et,{}),i(Xe,{children:i(qt,{mb:4,children:o.createStmt})})]})]})},Ni=({initialized:e})=>{const[t,o]=O(q),r=Bt(),{colorMode:d}=_e(),[a,n]=g.exports.useState(),l=g.exports.useCallback(s=>n(s),[]),c=g.exports.useCallback(()=>n(null),[]);return p(R,{children:[!!a&&i(Si,{onClose:c,schemaObjectName:a}),i(z,{completed:e,title:"Setup the schema",left:p(R,{children:[i(T,{children:`
              ...
              `}),i(Ho,{mt:4,mb:6}),p(ve,{alignItems:"flex-end",children:[p(je,{flex:1,children:[i(Ve,{fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Database name"}),i(vt,{placeholder:"martech",value:t,size:"sm",onChange:s=>o(s.target.value)})]}),i(x,{flex:1,textAlign:"center",children:i(jt,{colorScheme:"blue",size:"sm",disabled:e,skipSeedData:!0,children:e?"Schema is setup":"Setup schema"})})]})]}),right:i(bt,{columns:[1,2,2],gap:1,children:Object.keys(r.data||{}).sort().map(s=>{var y;return i(be,{bg:((y=r.data)!=null&&y[s]?"green":"gray")+(d==="light"?".200":".600"),color:d==="light"?"gray.800":"gray.100",textOverflow:"ellipsis",whiteSpace:"nowrap",overflow:"hidden",borderRadius:"md",px:2,py:1,textAlign:"center",_hover:{fontWeight:"bold"},cursor:"pointer",onClick:()=>l(s),children:s},s)})})})]})},Zt=(e,t,o=!0)=>{var a;const r=C(["pipelineStatus",e,t],()=>kt(e,t),{isPaused:()=>!o}),d=(a=r.data)!=null&&a.length?r.data.every(n=>!n.needsUpdate):!1;return{pipelines:r,completed:d}},Ri=()=>{const e=m(h),t=m(Z),{pipelines:o,completed:r}=Zt(e,t);Kt(r);const[d,a]=Ee(),n=g.exports.useCallback(async()=>{a.on(),await xt(e,t),o.mutate(),a.off()},[a,e,t,o]),l=Vt(e,"locations","requests","purchases"),c=l.length<2||l.every(({data:y})=>y.locations+y.purchases+y.requests===0);return i(z,{completed:r,title:"Ingest data",left:i(T,{children:`
          ...
          `}),right:c||!r?i(M,{h:220,children:p(N,{colorScheme:"blue",size:"sm",onClick:n,disabled:r,children:[(d||r)&&i(P,{mr:2}),d?"Creating Pipelines":r?"...waiting for data":"Create pipelines"]})}):i($t,{data:l,height:200})})},we=(e,t=!0)=>C(["overviewTableCounts",e],()=>rt(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!t}),Ai=()=>{var l,c;const e=m(h),t=m(Z),[o,r]=Ee(),d=we(e),a=g.exports.useCallback(async()=>{r.on(),await ot(e,oe,t),d.mutate(),r.off()},[e,t,d,r]),n=!!((l=d.data)!=null&&l.offers);return i(z,{completed:n,title:"Offers",left:i(R,{children:p(T,{children:[`
            ...
            `,n&&`
                ...
                database.
            `]})}),right:n?i(_i,{height:300,defaultZoom:13}):i(M,{h:"100%",children:p(N,{onClick:a,disabled:o,children:[o&&i(P,{mr:2}),o?"loading...":n?"loaded offers!":"load offers"]})})})},Oi=({done:e,setDone:t})=>{const o=m(h),r=g.exports.useRef(new Date().toISOString());return g.exports.useEffect(()=>{if(e)return;const d=new AbortController,a=S(E({},o),{ctx:d});return(async()=>{try{for(let n=0;n<10;n++)if(r.current=await dt(a,r.current),await it(a,"second"),n>1&&!await Dt(a))return}catch(n){if(d.signal.aborted||n instanceof DOMException&&n.name==="AbortError")return;throw n}})().then(()=>t(!0)),()=>{d.abort()}},[o,e,t]),e?null:i(be,{colSpan:[1,1,2],children:p(M,{w:"100%",h:"200px",color:"gray.500",children:[i(P,{size:"md",mr:4}),i(Te,{size:"md",children:"Warming up queries..."})]})})},Ii=()=>{var y;const e=m(h),t=we(e),{elapsed:o,isRunning:r,startTimer:d,stopTimer:a}=Gt(),n=g.exports.useRef(new Date().toISOString()),l=!!((y=t.data)!=null&&y.subscriber_segments),c=g.exports.useCallback(async()=>{d(),n.current=await dt(e,n.current),a(),t.mutate()},[e,t,d,a]);let s;if(o&&t.data){const{segments:u,subscriber_segments:f,locations:_,requests:U,purchases:Q}=t.data,Ce=j(o),Le=k(_+U+Q),ke=k(u),xe=k(f);s=i(T,{children:`
          The last update evaluated ${Le} rows against ${ke} segments
          producing ${xe} segment memberships.
          
          **This process took ${Ce}**.
        `})}return i(z,{completed:l,title:"Segmentation",left:i(T,{children:`
          ...
          `}),right:i(M,{h:"100%",children:p(Nt,{gap:4,textAlign:"center",children:[p(N,{disabled:r,onClick:c,children:[r&&i(P,{mr:2}),r?"...running":"Match subscribers to segments"]}),s]})})})},wi=()=>{var _;const e=m(h),t=we(e),o=Jt(),{mutate:r}=Wo(),{elapsed:d,isRunning:a,startTimer:n,stopTimer:l}=Gt(),[c,s]=g.exports.useState(0),y=!!((_=t.data)!=null&&_.notifications),u=g.exports.useCallback(async()=>{let U=0,Q=0;for(;U===0&&Q++<10;)n(),U=await it(e,"second");l(),s(U),t.mutate(),r(o)},[e,n,l,t,r,o]);let f;if(d&&t.data){const{offers:U,subscribers:Q,subscriber_segments:Ce,notifications:Le}=t.data,ke=k(U*Q+Le),xe=k(Ce),Qt=j(d),eo=k(c);f=i(T,{children:`
          The last update evaluated up to ${ke} notification opportunities
          against ${xe} segment memberships generating ${eo}
        ...
        `})}return i(z,{completed:y,title:"Matching",left:i(T,{children:`
          ...
          `}),right:i(M,{h:"100%",children:p(Nt,{gap:4,w:"100%",children:[p(N,{disabled:a,onClick:u,children:[a&&i(P,{mr:2}),a?"...running":"Generate notifications"]}),i(x,{width:"100%",children:i(Ne,{height:250,defaultZoom:12,useRenderer:Xt,options:{}})}),f]})})})},Ci=()=>{const e=m(q);return i(z,{completed:!0,title:"Putting it all together",left:i(T,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: map
          `}),right:null})},Li=()=>{const e=m(h),t=m(Z),{connected:o,initialized:r,isVapor:d}=A(),{completed:a}=Zt(e,t,o&&r),{data:n}=we(e,o&&r),[l,c]=g.exports.useState(!1),s=[{completed:o,component:i(Ti,{connected:o,isVapor:d},"connection")},{completed:r,component:i(Ni,{initialized:r},"schema")},{completed:a,component:i(Ri,{},"pipelines")},{completed:n?n.offers>0:!1,component:i(Ai,{},"offers")},{completed:l,component:i(Oi,{done:l,setDone:c},"warmup")},{completed:n?n.subscriber_segments>0:!1,component:i(Ii,{},"segmentation")},{completed:n?n.notifications>0:!1,component:i(wi,{},"matching")},{completed:!0,component:i(Ci,{},"summary")}];let y=!0;const u=[];for(const{completed:f,component:_}of s)if(y)u.push(_),y=f;else break;return p(D,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(x,{maxW:"container.md",mb:10,px:0,children:i(T,{children:`
          ...
          `})}),i(We,{columnGap:6,rowGap:10,templateColumns:["minmax(0, 1fr)",null,"repeat(2, minmax(0, 1fr))"],children:u})]})};function ki(){const e=i(M,{height:"100vh",children:i(P,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})});return i(g.exports.Suspense,{fallback:e,children:p(me,{height:"100vh",direction:"column",children:[i(ni,{}),i(x,{m:4,flex:"1",children:p($o,{children:[i(ee,{path:"/",element:i(Li,{})}),i(ee,{path:"/map",element:i(vi,{})}),i(ee,{path:"/admin",element:i(oi,{})}),i(ee,{path:"/analytics",element:i(ii,{})}),i(ee,{path:"*",element:i(Ko,{to:"/",replace:!0})})]})})]})})}class xi extends re.Component{constructor(){super(void 0);b(this,"state",{});this.handlePromiseRejection=this.handlePromiseRejection.bind(this)}componentDidMount(){window.addEventListener("unhandledrejection",this.handlePromiseRejection)}componentWillUnmount(){window.removeEventListener("unhandledrejection",this.handlePromiseRejection)}handlePromiseRejection(t){this.setState({error:t.reason})}static getDerivedStateFromError(t){return{error:t}}render(){const{error:t}=this.state;if(t){let o;return t instanceof I&&(o=p(R,{children:[i(ie,{textAlign:"center",children:"An error occurred while running the following query:"}),i(qt,{children:$(t.sql)})]})),i(D,{maxW:"container.md",my:10,children:p(J,{gap:4,children:[i(M,{children:i(St,{boxSize:20,color:"red"})}),i(Te,{size:"xl",textAlign:"center",children:t.message}),o,p(ve,{justify:"center",gap:4,children:[i(N,{onClick:()=>this.setState({error:void 0}),size:"sm",children:"Dismiss Error"}),i(N,{onClick:()=>window.location.reload(),size:"sm",colorScheme:"blue",leftIcon:i(Jo,{}),children:"Reload"})]})]})})}return this.props.children}}const Di=Xo({fonts:{heading:"InterVariable, sans-serif",body:"InterVariable, sans-serif",mono:'"Source Code ProVariable", monospace'},components:{Link:{baseStyle:e=>({color:e.colorMode==="light"?"blue.600":"blue.300"})}}}),zi=({children:e})=>{const t=ft();return i(tr,{value:{onError:r=>{t({title:"An error occurred",description:r.message,status:"error",duration:5e3,isClosable:!0})}},children:e})};qo.render(i(re.StrictMode,{children:i(Zo,{theme:Di,children:i(xi,{children:i(zi,{children:i(Qo,{children:i(er,{basename:"/",children:i(ki,{})})})})})})}),document.getElementById("root"));
