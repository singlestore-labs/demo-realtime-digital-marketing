var ko=Object.defineProperty,Do=Object.defineProperties;var xo=Object.getOwnPropertyDescriptors;var he=Object.getOwnPropertySymbols;var _t=Object.prototype.hasOwnProperty,Tt=Object.prototype.propertyIsEnumerable;var $e=(e,t,o)=>t in e?ko(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,E=(e,t)=>{for(var o in t||(t={}))_t.call(t,o)&&$e(e,o,t[o]);if(he)for(var o of he(t))Tt.call(t,o)&&$e(e,o,t[o]);return e},N=(e,t)=>Do(e,xo(t));var M=(e,t)=>{var o={};for(var r in e)_t.call(e,r)&&t.indexOf(r)<0&&(o[r]=e[r]);if(e!=null&&he)for(var r of he(e))t.indexOf(r)<0&&Tt.call(e,r)&&(o[r]=e[r]);return o};var _=(e,t,o)=>($e(e,typeof t!="symbol"?t+"":t,o),o);import{d as q,l as zo,s as Po,_ as Ze,r as g,j as i,B as z,M as Mo,a as s,F as C,L as $,R as pe,u as dt,C as te,A as Uo,b as U,c as Bo,e as Dt,f as Fo,g as m,h as R,i as nt,k as B,m as xt,n as zt,P as Go,o as Yo,G as Oe,q as Ho,E as Wo,N as Pt,p as jo,t as oe,v as Vo,w as re,x as Q,y as ee,z as Ne,D as I,H as Ko,I as $o,J as ue,S as G,K as H,O as W,Q as ye,T as k,U as D,V as x,W as Nt,X as Ie,Y as qo,Z as Jo,$ as St,a0 as be,a1 as ce,a2 as Xo,a3 as Ee,a4 as Zo,a5 as ct,a6 as lt,a7 as Mt,a8 as Qo,a9 as er,aa as st,ab as tr,ac as De,ad as or,ae as xe,af as ze,ag as Ut,ah as rr,ai as ir,aj as pt,ak as ar,al as ge,am as dr,an as Pe,ao as ut,ap as Ce,aq as qe,ar as nr,as as cr,at as we,au as yt,av as Bt,aw as Ft,ax as lr,ay as sr,az as pr,aA as ur,aB as yr,aC as gr,aD as fr,aE as mr,aF as vr,aG as hr,aH as Rt,aI as br,aJ as Er,aK as _r,aL as Tr,aM as Nr,aN as Sr,aO as Rr,aP as Ar,aQ as Gt,aR as Qe,aS as Yt,aT as Ht,aU as Or,aV as ne,aW as Ir,aX as Cr,aY as wr,aZ as Lr,a_ as kr,a$ as Dr,b0 as xr,b1 as zr}from"./vendor.5cf8911c.js";const Pr=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const d of a)if(d.type==="childList")for(const n of d.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function o(a){const d={};return a.integrity&&(d.integrity=a.integrity),a.referrerpolicy&&(d.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?d.credentials="include":a.crossorigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function r(a){if(a.ep)return;a.ep=!0;const d=o(a);fetch(a.href,d)}};Pr();const Mr=/^Error (?<code>\d+):/;class P extends Error{constructor(t,o,r){super(t);_(this,"code");_(this,"sql");var a;if(Object.setPrototypeOf(this,P.prototype),this.sql=o,r)this.code=r;else{const d=t.match(Mr);this.code=d?parseInt(((a=d.groups)==null?void 0:a.code)||"-1",10):-1}}isUnknownDatabase(){return this.code===1049}isDatabaseRecovering(){return this.code===2269}isPlanMissing(){return this.code===1885}}const Me=async(e,t,...o)=>{const r=await j(e,t,...o);if(r.length!==1)throw new P("Expected exactly one row",t);return r[0]},j=async(e,t,...o)=>{const r=await Ue("query/rows",e,t,...o);if(r.results.length!==1)throw new P("Expected exactly one result set",t);return r.results[0].rows},Wt=(e,t,...o)=>j(N(E({},e),{database:void 0}),t,...o),gt=async(e,t,...o)=>{const r=await Ue("query/tuples",e,t,...o);if(r.results.length!==1)throw new P("Expected exactly one result set",t);return r.results[0].rows},ft=(e,t,...o)=>Ue("exec",N(E({},e),{database:void 0}),t,...o),v=(e,t,...o)=>Ue("exec",e,t,...o),Ue=async(e,t,o,...r)=>{var n;const a=await fetch(`${t.host}/api/v2/${e}`,{method:"POST",signal:(n=t.ctx)==null?void 0:n.signal,headers:{"Content-Type":"application/json",Authorization:`Basic ${btoa(`${t.user}:${t.password}`)}`},body:JSON.stringify({sql:o,args:r,database:t.database})});if(!a.ok)throw new P(await a.text(),o);const d=await a.json();if(d.error)throw new P(d.error.message,o,d.error.code);return d},jt=e=>{const{table:t,columns:o,tuples:r,options:a}=e,d=`(${o.map(()=>"?").join(",")})`,n=r.map(()=>d).join(",");return{sql:q`
...
`),{sql:d,params:n}=At(o);return{sql:q`
    ...
    `,t.id,t.name,`POINT(${t.lonlat[0]} ${t.lonlat[1]})`,t.diameter),Yr=(e,t)=>v(e,"DELETE FROM cities WHERE city_id = ?",t),Hr=["olc_8","purchase","request"],Wr=["minute","hour","day","week","month"],$t=({interval:e,kind:t,value:o})=>Po(`${e}-${t}-${o}`),jr=async(e,t)=>{const{sql:o,params:r}=jt({table:"segments",options:{replace:!0},columns:["segment_id","valid_interval","filter_kind","filter_value"],tuples:t.map(a=>[$t(a),a.interval,a.kind,a.value])});await v(e,o,...r)},Vr=async(e,t)=>{const o={table:"offers",options:{replace:!0},columns:["customer","notification_zone","segment_ids","notification_content","notification_target","maximum_bid_cents"],tuples:[]};let r=0,a=[];const d=async()=>{const{sql:n,params:c}=jt(o);await Promise.all([v(e,n,...c),jr(e,a)]),o.tuples=[],a=[],r=0};for(const n of t)o.tuples.push([n.customer,n.notificationZone,JSON.stringify(n.segments.map($t)),n.notificationContent,n.notificationTarget,n.maximumBidCents]),r++,a=a.concat(n.segments),r>=Gr&&await d();r>0&&await d()},Kr=()=>Vt(Hr),$r=()=>Vt(Wr),qt=({vendor:e,tld:t})=>`${e.toLowerCase()}.${t}`,Jt=e=>{const[t,o]=e.lonlat,r=e.diameter/2,[a,d]=[t-r,t+r],[n,c]=[o-r,o+r];return[et(a,d),et(n,c)]},qr=(e,t)=>{const o=Kr(),r=$r();switch(o){case"olc_8":{const[a,d]=Jt(e),n=Ze.encode(d,a,8).substring(0,8);return{kind:o,interval:r,value:n}}case"purchase":return{kind:o,interval:r,value:t.vendor};case"request":return{kind:o,interval:r,value:qt(t)}}},Jr=e=>{const t=Se(1,3),o=Fr(),r=Array.from({length:t},()=>qr(e,o)),a=qt(o),n=`${Se(10,50)}% off at ${o.vendor}`,c=a,[l,u]=Jt(e),p=Ze.encode(u,l,8),y=Ze.decode(p),f={ne:[y.latitudeHi,y.longitudeHi],sw:[y.latitudeLo,y.longitudeLo]};return{customer:o.vendor,segments:r,notificationZone:Be(f),notificationContent:n,notificationTarget:c,maximumBidCents:Se(2,15)}},Xr=(e,t)=>Array.from({length:t},()=>Jr(e)),Zr=e=>(t,o,r,a=1)=>`https://stamen-tiles.a.ssl.fastly.net/${e}/${r}/${t}/${o}${a>=2?"@2x":""}.png`,Qr=s(C,{children:["Map tiles by ",i($,{href:"http://stamen.com",children:"Stamen Design"}),", under"," ",i($,{href:"http://creativecommons.org/licenses/by/3.0",children:"CC BY 3.0"}),". Data by ",i($,{href:"http://openstreetmap.org",children:"OpenStreetMap"}),", under"," ",i($,{href:"http://www.openstreetmap.org/copyright",children:"ODbL"}),"."]}),ei=[tt.lonlat[1],tt.lonlat[0]],ti=12,oi=({width:e,height:t,bounds:o,latLngToPixel:r,pixelToLatLng:a,useRenderer:d,options:n})=>{const c=pe.useRef(null),l=dt(()=>new te),{setup:u,update:p}=d({scene:l,width:e,height:t,bounds:o,latLngToPixel:r,pixelToLatLng:a,options:n});return g.exports.useLayoutEffect(()=>{if(!c.current)throw new Error("No canvas ref");console.log("PixiMapLayer: Setup");const y=new Uo({view:c.current,width:e,height:t,backgroundAlpha:0,antialias:!0});return y.stage.addChild(l),u==null||u(),p&&y.ticker.add(f=>{p(f)}),()=>{console.log("PixiMapLayer: Destroy"),y.stage.removeChild(l),y.destroy(!1,{children:!1,texture:!0,baseTexture:!0})}},[t,l,u,p,e]),i("canvas",{ref:c})},ri=({mapState:e,latLngToPixel:t,pixelToLatLng:o,useRenderer:r,options:a})=>{const{width:d,height:n,bounds:c}=e||{width:0,height:0};return d<=0||n<=0||!t||!o||!c?null:i(oi,{useRenderer:r,width:d,height:n,bounds:c,latLngToPixel:t,pixelToLatLng:o,options:a})},Fe=n=>{var c=n,{height:e="100%",defaultCenter:t=ei,defaultZoom:o=ti,useRenderer:r,options:a}=c,d=M(c,["height","defaultCenter","defaultZoom","useRenderer","options"]);const[l,u]=g.exports.useState(t),[p,y]=g.exports.useState(o);return i(z,N(E({borderRadius:"lg",overflow:"hidden",height:e},d),{children:i(Mo,{dprs:[1,2],provider:Zr("toner-lite"),attribution:Qr,maxZoom:20,center:l,zoom:p,onBoundsChanged:({center:f,zoom:h})=>{u(f),y(h)},children:i(ri,{useRenderer:r,options:a})})}))};var Ge=[{kind:"create",name:"date_sub_dynamic",statement:`CREATE OR REPLACE FUNCTION date_sub_dynamic (
  _dt DATETIME(6),
...
BEGIN
  ...
  END IF;
END`}],ii=[{kind:"create",name:"locations",statement:`CREATE OR REPLACE PIPELINE locations
...
INTO PROCEDURE process_purchases FORMAT PARQUET (
  subscriber_id <- subscriberid,
  vendor <- vendor
);`},{kind:"start",statement:"START ALL PIPELINES;"}],Ye=[{kind:"create",name:"process_locations",statement:`CREATE OR REPLACE PROCEDURE process_locations (
  _batch QUERY(
  ...
  EXCEPTION
    WHEN OTHERS THEN
      IF SCALAR(_num_transactions) > 0 THEN
        ROLLBACK;
      END IF;
END`}],He=[{kind:"create",name:"worldcities",statement:`create rowstore table if not exists worldcities (
...
ON DUPLICATE KEY UPDATE
  ...
  SET center = GEOGRAPHY_POINT(@lng, @lat);`},{kind:"start",statement:"START PIPELINE IF NOT RUNNING worldcities;"}];const ai=e=>{const t=[Ge,Ye,He,Xt];for(const o of t){const r=o.find(a=>a.name===e);if(r)return r}throw new Error("Could not find schema object: "+e)},di=e=>{const t=ii.find(o=>o.name===e);if(t)return t;throw new Error("Could not find pipeline "+e)},ni=async e=>{try{return await ft(e,"SELECT 1"),!0}catch{return!1}},ci=async e=>{let t={tables:[],procedures:[],functions:[]};const c=e,{database:o}=c,r=M(c,["database"]);try{t=(await gt(r,`
        ...
        `,o,o)).reduce((l,[u,p])=>(l[u].push(p),l),t)}catch(l){if(!(l instanceof P&&(l.isUnknownDatabase()||l.isDatabaseRecovering())))throw l}const{tables:a,procedures:d,functions:n}=t;return Object.fromEntries([He.map(({name:l})=>[l,l&&a.includes(l)]),Ye.map(({name:l})=>[l,l&&d.includes(l)]),Ge.map(({name:l})=>[l,l&&n.includes(l)])].flat())},Zt=e=>ft(e,"DROP DATABASE IF EXISTS `"+e.database+"`"),li=async(e,{progress:t,includeSeedData:o,resetDataOnly:r=!1})=>{r||(t("Dropping existing schema","info"),await Zt(e),t("Creating database","info"),await ft(e,"CREATE DATABASE `"+e.database+"`")),r&&(t("Resetting data","info"),await ui(e),await pi(e));for(const a of Ge)t(`Creating function: ${a.name}`,"info"),await v(e,a.statement);for(const a of He)t(`Creating table: ${a.name}`,"info"),await v(e,a.statement);for(const a of Ye)t(`Creating procedure: ${a.name}`,"info"),await v(e,a.statement);t("Creating New York","info"),await Kt(e,tt),o&&(t("Creating sample data","info"),await Qt(e)),t("Schema initialized","success")},Qt=async e=>{for(const t of Xt)await v(e,t.statement)},si=(e,t,o)=>{const r=100*o.partitions,a=Xr(t,r);return Vr(e,a)},Le=["locations","requests","purchases"],eo=async(e,t)=>{const o=t.prefix,r=await j(e,`
      SELECT
    ...
    `,e.database,...Le);return Le.map(a=>{var n;const d=r.find(c=>c.pipelineName===a);return{pipelineName:a,needsUpdate:(n=d==null?void 0:d.needsUpdate)!=null?n:!0}})},pi=e=>Promise.all([v(e,"TRUNCATE TABLE cities"),v(e,"TRUNCATE TABLE locations"),v(e,"TRUNCATE TABLE notifications"),v(e,"TRUNCATE TABLE offers"),v(e,"TRUNCATE TABLE purchases"),v(e,"TRUNCATE TABLE requests"),v(e,"TRUNCATE TABLE segments"),v(e,"TRUNCATE TABLE sessions"),v(e,"TRUNCATE TABLE subscriber_segments"),v(e,"TRUNCATE TABLE subscribers"),v(e,"TRUNCATE TABLE subscribers_last_notification")]),to=(e,t)=>{const o=di(e),r=/\$\{([^}]+)\}/g;return o.statement.replaceAll(r,(a,d)=>{switch(d){case"SCALE_FACTOR":return t.prefix;case"PARTITIONS":return t.partitions.toString();default:throw new Error(`Unknown variable: ${d}`)}})},ui=async e=>{await v(e,"STOP ALL PIPELINES"),await Promise.all(Le.map(t=>v(e,`DROP PIPELINE IF EXISTS ${t}`)))},oo=async(e,t)=>{const o=await eo(e,t);await Promise.all(o.filter(r=>r.needsUpdate).map(async r=>{console.log(`recreating pipeline ${r.pipelineName}`),await v(e,to(r.pipelineName,t)),await v(e,`ALTER PIPELINE ${r.pipelineName} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await v(e,`START PIPELINE IF NOT RUNNING ${r.pipelineName}`),console.log(`finished creating pipeline ${r.pipelineName}`)}))},yi=async e=>{const t=await gt(e,`
      SELECT
    ...
    `);try{await Promise.all(t.map(({planId:o})=>v(e,`DROP ${o} FROM PLANCACHE`)))}catch(o){if(!(o instanceof P&&o.isPlanMissing()))throw o}return t.length>0},gi=(e,...t)=>{const o=t.map(r=>`"${r}"`).join(",");return Wt(e,`
      ...
      GROUP BY tableName
    `,e.database)},We=(e,...t)=>gi(e,...t).then(o=>o.reduce((r,{tableName:a,count:d})=>(r[a]=d,r),{})),fi=async(e,t)=>{const{maxRows:o}=t,a=["locations","requests","purchases","notifications"].map(n=>`"${n}"`).join(","),d=await Wt(e,`
      SELECT
      ...
      WHERE
        ...
        AND stats.count > ?
    `,e.database,o);await Promise.all(d.map(async({tableName:n,count:c,minTs:l,maxTs:u})=>{const y=(c-o)/c;if(y<.2)return;const f=new Date((l+y*(u-l))*1e3);console.log(`removing rows from ${n} older than ${f.toISOString()}`),await v(e,`DELETE FROM ${n} WHERE ts <= ?`,f.toISOString())}))},ro=(e,t="minute")=>Me(e,"ECHO run_matching_process(?)",t).then(o=>o.RESULT),io=async(e,t,o=!0)=>{const r=new Date().toISOString();return await v(e,"CALL update_segments(?, ?)",t,r),o&&await v(e,"CALL prune_segments(?)",r),r},mi=(e,t,o,r)=>gt(e,`
      SELECT
        ts,
...
`,Ei=(e,t,o,r)=>j(e,mt({with:[["metrics",ht(t)]],base:`
        SELECT
        ...
        ORDER BY ${o} DESC
        LIMIT ${r}
      `}).sql),Ct=(e,t)=>Me(e,mt({with:[["metrics",ht(t)]],base:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `}).sql),_i=(e,t,o)=>{const r=mt({with:[["metrics",ht(o)]],base:{sql:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `,params:[Be(t)]}});return j(e,r.sql,...r.params)},Ti=(e,t,o)=>Me(e,"CALL update_sessions(?, ?)",t,o).then(({session_id:r,is_controller:a,expires_at:d})=>({sessionID:r,isController:a,expiresAt:new Date(d)})),ao=(e,t,o)=>v(e,`
      UPDATE sessions
    ...
    `,o,t,t),J=[{name:"s00",maxRows:1e7,prefix:"v2/100k-2p",partitions:2},{name:"s0",maxRows:2e7,prefix:"v2/100k-4p",partitions:4},{name:"s1",maxRows:4e7,prefix:"v2/100k-8p",partitions:8},{name:"s2",maxRows:16e7,prefix:"v2/1m-16p",partitions:16},{name:"s4",maxRows:32e7,prefix:"v2/1m-32p",partitions:16},{name:"s8",maxRows:64e7,prefix:"v2/1m-64p",partitions:64},{name:"s10",maxRows:1e9,prefix:"v2/10m-80p",partitions:80}],Ni=e=>J.find(t=>t.name===e)||J[0],ie=({encode:e,decode:t}={encode:JSON.stringify,decode:JSON.parse})=>({setSelf:o,onSet:r,node:a})=>{const d=`recoil.localstorage.${a.key}`,n=localStorage.getItem(d);n!=null&&o(t(n)),r((c,l,u)=>{u?localStorage.removeItem(d):localStorage.setItem(d,e(c))})},no=()=>({setSelf:e,node:{key:t}})=>{const{location:o}=window;if(o){const r=new URLSearchParams(o.search);e(r.get(t)||new Bo)}},Si=U({key:"sessionID",default:null,effects:[no()]}),Ri=U({key:"vaporBaseUrl",default:"https://vapor.labs.singlestore.com",effects:[no()]}),co=U({key:"connectionHost",default:"http://127.0.0.1",effects:[ie()]}),lo=U({key:"connectionUser",default:"root",effects:[ie()]}),so=U({key:"connectionPassword",default:"",effects:[ie()]}),ae=U({key:"connectionDatabase",default:"martech",effects:[ie()]}),po=Dt({key:"vaporConnectionConfig",get:async({get:e})=>{const t=e(Si),o=e(Ri);if(t&&o)try{const r=await fetch(o+"/api/v1/connect?sessionID="+t);if(r.status===200){const a=await r.json();return{host:"https://"+a.endpoint,user:a.user,password:a.password,database:e(ae)}}}catch{console.log(`Failed to connect to vapor at ${o}, falling back to local config`)}}}),b=Dt({key:"connectionConfig",get:({get:e})=>{const t=e(po);if(t)return t;const o=e(co),r=e(lo),a=e(so),d=e(ae);return{host:o,user:r,password:a,database:d}},cachePolicy_UNSTABLE:{eviction:"most-recent"}}),fe=U({key:"configScaleFactor",default:J[0],effects:[ie({encode:e=>e.name,decode:e=>J.find(t=>t.name===e)||J[0]})]}),de=U({key:"simulatorEnabled",default:!0,effects:[ie()]}),Ai=U({key:"databaseDrawerIsOpen",default:!1}),ot=Fo({key:"tickDurationMs",default:void 0}),me=U({key:"resettingSchema",default:!1}),Oi=Object.fromEntries([He.map(({name:e})=>[e,!1]),Ye.map(({name:e})=>[e,!1]),Ge.map(({name:e})=>[e,!1])].flat()),uo=(e=!1)=>{const t=m(b);return R(["schemaObjects",t,e],()=>ci(t),{isPaused:()=>e,refreshInterval:o=>Object.values(o||[]).some(a=>!a)?1e3:0,fallbackData:Oi})},O=()=>{const d=m(b),{database:e}=d,t=M(d,["database"]),o=m(po),r=R(["isConnected",t],()=>ni(t)),a=uo(!r.data);return{isVapor:!!o,connected:!!r.data,initialized:!!r.data&&Object.values(a.data||[]).every(Boolean),reset:()=>{r.mutate(),a.mutate()}}},Ii=(()=>{let e={};return t=>(t in e||(e[t]=1),`${t}(${e[t]++})`)})(),rt=(e,{name:t,enabled:o,intervalMS:r})=>{const a=nt(ot(t));g.exports.useEffect(()=>{if(!o)return;const d=new AbortController,n=Ii(t);console.log(`Starting ${n}: tick interval: ${r}ms`);const c=async()=>{try{if(console.time(n),d.signal.aborted)return;const l=performance.now();await e(d);const u=performance.now()-l;a(u),setTimeout(c,Math.max(0,r-u))}catch(l){if(d.signal.aborted||l instanceof P&&l.isUnknownDatabase()||l instanceof DOMException&&l.name==="AbortError")return;throw l}finally{console.timeEnd(n)}};return c(),()=>{console.log(`Stopping ${n}`),d.abort()}},[o,e,r,t,a])},Ci=()=>{const{cache:e,mutate:t}=zt();if(!(e instanceof Map))throw new Error("useInvalidateSWRCache requires the cache provider to be a Map instance");return g.exports.useCallback(async()=>{for(const[o]of e)await t(o)},[e,t])},wi=({before:e,after:t,includeSeedData:o,resetDataOnly:r=!1})=>{const a=m(b),d=m(fe),[n,c]=B(de),l=xt(),u=nt(me),p=Ci();return g.exports.useCallback(async()=>{const y=n;c(!1),u(!0),e(),await li(a,{progress(f,h){const A="reset-schema";l.isActive(A)?l.update(A,{title:f,status:h,duration:h==="success"?2e3:null,isClosable:!0}):l({id:A,title:f,status:h,duration:null})},includeSeedData:o,resetDataOnly:r}),t(),await p(),c(y),u(!1)},[n,c,u,e,a,d,o,r,t,p,l])},yo=(e,t)=>{const[o,r]=g.exports.useState(e);return g.exports.useEffect(()=>{const a=setTimeout(()=>r(e),t);return()=>clearTimeout(a)},[e,t]),o},go=()=>{const[{elapsed:e,isRunning:t},o]=g.exports.useReducer((r,a)=>{switch(a.type){case"start":return{start:Math.floor(performance.now()),isRunning:!0,elapsed:r.elapsed};case"stop":return{elapsed:Math.floor(performance.now())-(r.start||0),isRunning:!1}}},{isRunning:!1});return{elapsed:e,isRunning:t,startTimer:()=>o({type:"start"}),stopTimer:()=>o({type:"stop"})}},fo=(e,t)=>{const o=g.exports.useRef(!1);return g.exports.useEffect(()=>(o.current=!0,()=>{o.current=!1}),[]),g.exports.useCallback(()=>{o.current&&e()},t)},mo=(e,t)=>{let o=!1,r=new Go(0,0),a=0;e.on("pointerdown",d=>{o=!0,r=d.data.global,a=performance.now()}),e.on("pointerup",d=>{if(!o||(o=!1,performance.now()-a>200))return;const c=d.data.global;Math.sqrt(Math.pow(c.x-r.x,2)+Math.pow(c.y-r.y,2))>10||t(d)}),e.on("pointercancel",()=>{o=!1})};class Li extends te{constructor(t,o){super();_(this,"gfx");_(this,"hover",!1);this.city=t,this.onRemove=o,this.gfx=new Oe,this.addChild(this.gfx),this.gfx.interactive=!0,this.gfx.on("pointerover",()=>{this.hover=!0}),this.gfx.on("pointerout",()=>{this.hover=!1}),mo(this.gfx,()=>o(this.city))}update(t){this.gfx.clear(),this.gfx.lineStyle(1,this.hover?16711680:306687,1),this.gfx.beginFill(this.hover?16711680:306687,.2);const[o,r]=t([this.city.centerLat,this.city.centerLon]);this.gfx.drawCircle(o,r,25),this.gfx.endFill()}}const ki=e=>{const t=m(b),{initialized:o}=O();return R(["cities",t,o],()=>hi(t),{isPaused:()=>!o,onSuccess:e})},Di=({scene:e,latLngToPixel:t,pixelToLatLng:o,width:r,height:a})=>{const d=m(b),n=dt(()=>new te),{mutate:c}=ki(p=>{n.removeChildren();for(let y=0;y<p.length;y++)n.addChild(new Li(p[y],u))}),l=g.exports.useCallback(async(p,y)=>{const f=await bi(d,y,p),h={id:f.id,name:f.name,lonlat:[f.centerLon,f.centerLat],diameter:f.diameter};await Kt(d,h),await si(d,h,J[0]),c()},[d,c]),u=g.exports.useCallback(async p=>{await Yr(d,p.id),c()},[d,c]);return{setup:g.exports.useCallback(()=>{const p=new te;e.addChild(p),e.addChild(n),p.interactive=!0,p.hitArea=new Yo(0,0,r,a),mo(p,y=>{const[f,h]=o([y.data.global.x,y.data.global.y]);l(f,h)})},[n,a,l,o,e,r]),update:g.exports.useCallback(()=>{for(let p=0;p<n.children.length;p++)n.children[p].update(t)},[n,t])}},xi=e=>i(Fe,N(E({},e),{useRenderer:Di,options:{},cursor:"pointer"})),zi=Ho({a:o=>{var r=o,{children:e}=r,t=M(r,["children"]);const{href:a}=t,d=!!(a!=null&&a.startsWith("http"));return d?s($,N(E({isExternal:d},t),{children:[e,i(Wo,{bottom:"2px",boxSize:"0.9em",position:"relative",ml:1})]})):i($,N(E({to:a||""},t),{as:Pt,children:e}))}}),S=o=>{var r=o,{children:e}=r,t=M(r,["children"]);return i(jo,N(E({},t),{skipHtml:!0,components:zi,children:Array.isArray(e)?e.filter(a=>a).map(a=>q(a||"")).join(`

`):q(e)}))},Pi=()=>s(oe,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(oe,{maxW:"container.md",mb:4,children:i(S,{children:`
            ## City Admin
            ...
            remove it.
          `})}),i(xi,{defaultZoom:4,defaultCenter:[39.716470511656766,-99.59395661915288],height:500})]}),wt=(()=>{const e=()=>crypto&&crypto.randomUUID?crypto.randomUUID():Vo();let t;return t=e(),console.log(`Session ID: ${t}`),t})(),Lt=60,ve=()=>{const e=m(b),t=m(me),{connected:o,initialized:r}=O(),{data:a,mutate:d}=R([e,"useSession"],()=>Ti(e,wt,Lt),{refreshInterval:1e3,isPaused:()=>t||!o||!r});return{session:a||{sessionID:wt,isController:!1,expiresAt:new Date(Date.now()+Lt*1e3)},refresh:d}},vo=()=>{const e=nt(de),{session:t,refresh:o}=ve(),r=m(b),{connected:a,initialized:d}=O(),[n,c]=re(!1),l=fo(()=>c.off,[c]),u=g.exports.useCallback(async()=>{c.on(),a&&d&&await ao(r,t.sessionID,!0),e(!0),o(),l()},[r,a,c,d,o,t.sessionID,e,l]);return s(Q,{status:"warning",borderRadius:"md",children:[i(ee,{}),i(Ne,{children:"The simulator is disabled"}),i(I,{position:"absolute",right:4,top:3,size:"xs",colorScheme:"blue",disabled:n,onClick:u,children:"Enable simulator"})]})},kt=e=>{const{r:t,g:o,b:r}=e.rgb();return t<<16|o<<8|r};class Mi extends te{constructor(t,o){super();_(this,"points");_(this,"polygon");_(this,"hovering",!1);_(this,"color");_(this,"hoverColor");this.config=t,this.points=Br(t.wktPolygon),this.polygon=new Oe,this.addChild(this.polygon);const r=o(t.value);this.color=kt(r),this.hoverColor=kt(r.darker(1)),this.polygon.interactive=!0,this.polygon.on("mouseover",()=>{this.hovering=!0}),this.polygon.on("mouseout",()=>{this.hovering=!1})}update(t){const o=this.hovering?this.hoverColor:this.color;this.polygon.clear(),this.polygon.lineStyle(1,o,.5),this.polygon.beginFill(o,.2),this.polygon.drawPolygon(this.points.flatMap(([r,a])=>t([a,r]))),this.polygon.endFill()}}const Ui=e=>({scene:t,latLngToPixel:o,bounds:r})=>{const a=yo(r,100),d=dt(()=>Ko(n=>$o(e.colorInterpolater(n))));return e.useCells(a,n=>{t.removeChildren();let c=1/0,l=-1/0;const u=[];for(const p of n){const y=e.getCellConfig(p);u.push(y),y.value<c&&(c=y.value),y.value>l&&(l=y.value)}d.domain([c,l]);for(const p of u)t.addChild(new Mi(p,d))}),{update:g.exports.useCallback(()=>{for(let n=0;n<t.children.length;n++)t.children[n].update(o)},[o,t])}},ho=e=>{const n=e,{useCells:t,getCellConfig:o,colorInterpolater:r}=n,a=M(n,["useCells","getCellConfig","colorInterpolater"]),d=g.exports.useMemo(()=>Ui({useCells:t,getCellConfig:o,colorInterpolater:r}),[r,o,t]);return i(Fe,N(E({},a),{useRenderer:d,options:{}}))},Bi=10*1e3,bt=e=>{const t=m(b),o=m(fe),{initialized:r}=O(),{session:a}=ve(),d=g.exports.useCallback(n=>{const c=N(E({},t),{ctx:n});return Promise.all([oo(c,o),yi(c),fi(c,o),vt(c)])},[t,o]);rt(d,{name:"SimulatorMonitor",enabled:r&&e&&a.isController,intervalMS:Bi})},Fi=1*1e3,Gi=1*1e3,bo=e=>{const t=m(b),{initialized:o}=O(),r=g.exports.useRef(new Date(0).toISOString()),{session:a}=ve(),d=g.exports.useCallback(c=>ro(N(E({},t),{ctx:c}),"minute"),[t]);rt(d,{name:"SimulatorMatcher",enabled:o&&e&&a.isController,intervalMS:Fi});const n=g.exports.useCallback(async c=>{r.current=await io(N(E({},t),{ctx:c}),r.current)},[t]);rt(n,{name:"SimulatorUpdateSegments",enabled:o&&e&&a.isController,intervalMS:Gi})},it=ue(",.2%"),se=ue(".4~s"),Yi=()=>{const{initialized:e}=O(),t=m(de);return bt(t),bo(t),i(oe,{maxW:"container.lg",mt:10,mb:"30vh",children:e?t?s(G,{gap:10,children:[i(Hi,{}),i(Wi,{}),i(Vi,{})]}):i(vo,{}):i(Eo,{})})},Eo=()=>i(H,{children:i(W,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})}),Hi=()=>{var a,d;const e=m(b),t=R(["overallConversionRateRequests",e],()=>Ct(e,"requests"),{refreshInterval:1e3}),o=R(["overallConversionRatePurchases",e],()=>Ct(e,"purchases"),{refreshInterval:1e3}),r=R(["analyticsTableCounts",e],()=>We(e,"offers","subscribers","notifications"),{refreshInterval:1e3});return!r.data||!t.data||!o.data?i(Eo,{}):s(ye,{spacing:2,minChildWidth:"150px",flex:2,children:[s(k,{children:[i(D,{children:"Offers"}),i(x,{children:se(r.data.offers)})]}),s(k,{children:[i(D,{children:"Subscribers"}),i(x,{children:se(r.data.subscribers)})]}),s(k,{children:[i(D,{children:"Notifications"}),i(x,{children:se(r.data.notifications)})]}),s(k,{children:[i(D,{children:"Conversion Rate"}),i(x,{children:it(((a=t.data)==null?void 0:a.conversionRate)||0)}),i(Nt,{children:"Requests"})]}),s(k,{children:[i(D,{children:"Conversion Rate"}),i(x,{children:it(((d=o.data)==null?void 0:d.conversionRate)||0)}),i(Nt,{children:"Purchases"})]})]})},Wi=()=>{var d;const e=m(b),[t,o]=g.exports.useState("conversionRate"),r=R(["customerMetrics",e,t],()=>Ei(e,"purchases",t,10),{refreshInterval:1e3}),a=Ie("blue.500","blue.200");return i(z,{overflowX:"auto",children:s(qo,{size:"sm",colorScheme:"gray",variant:"striped",children:[i(Jo,{children:s(St,{children:[s(be,{onClick:()=>o("customer"),_hover:{color:a},color:t==="customer"?a:void 0,cursor:"pointer",children:["Customer",t==="customer"&&i(ce,{})]}),s(be,{onClick:()=>o("totalNotifications"),_hover:{color:a},color:t==="totalNotifications"?a:void 0,isNumeric:!0,cursor:"pointer",children:["Total Notifications",t==="totalNotifications"&&i(ce,{})]}),s(be,{onClick:()=>o("totalConversions"),_hover:{color:a},color:t==="totalConversions"?a:void 0,isNumeric:!0,cursor:"pointer",children:["Total Conversions",t==="totalConversions"&&i(ce,{})]}),s(be,{onClick:()=>o("conversionRate"),_hover:{color:a},color:t==="conversionRate"?a:void 0,isNumeric:!0,cursor:"pointer",children:["Conversion Rate",t==="conversionRate"&&i(ce,{})]})]})}),i(Xo,{children:(d=r.data)==null?void 0:d.map(n=>s(St,{children:[i(Ee,{children:n.customer}),i(Ee,{isNumeric:!0,children:se(n.totalNotifications)}),i(Ee,{isNumeric:!0,children:se(n.totalConversions)}),i(Ee,{isNumeric:!0,children:it(n.conversionRate)})]},n.customer))})]})})},ji=(e,t)=>{const o=m(b);R(["zoneMetrics",o,e],()=>_i(o,e,"purchases"),{refreshInterval:1e3,onSuccess:t})},Vi=()=>s(G,{direction:["column","row"],alignItems:"top",children:[i(z,{flex:1,children:i(S,{children:`
            ### Conversion Map
          ...
          `})}),i(z,{flex:2,children:i(ho,{height:400,defaultZoom:14,useCells:ji,colorInterpolater:Zo,getCellConfig:({conversionRate:e,wktPolygon:t})=>({value:e,wktPolygon:t})})})]}),_e=({label:e,placeholder:t,value:o,setValue:r,helpText:a,type:d="text"})=>s(ct,{children:[i(lt,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),i(Mt,{size:"sm",placeholder:t,value:o,onChange:n=>r(n.target.value),type:d}),a?i(Qo,{fontSize:"xs",children:a}):null]}),Ki=()=>{const[e,t]=B(fe);return s(ct,{children:[i(lt,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),i(er,{size:"sm",required:!0,value:e.name,onChange:o=>{const r=o.target.value;t(Ni(r))},children:J.map(o=>i("option",{value:o.name,children:o.name},o.name))})]})},_o=({showDatabase:e,showScaleFactor:t})=>{const[o,r]=B(co),[a,d]=B(lo),[n,c]=B(so),[l,u]=B(ae);return s(G,{spacing:4,children:[i(_e,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:o,setValue:r,helpText:i(S,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [Data API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),s(ye,{columns:2,gap:2,children:[i(_e,{label:"Username",placeholder:"admin",value:a,setValue:d}),i(_e,{label:"Password",placeholder:"",value:n,setValue:c,type:"password"}),e&&i(_e,{label:"Database",placeholder:"martech",value:l,setValue:u}),t&&i(Ki,{})]})]})},To=e=>i(I,N(E({onClick:()=>{const{pathname:t,hash:o}=window.location;window.location.replace(t+o)},colorScheme:"red"},e),{children:"Disconnect"})),ke=e=>{const{connected:t,initialized:o}=O(),r=st(),[a,d]=re(),n=m(ae),c=pe.useRef(null),h=e,{skipSeedData:l,resetDataOnly:u,disabled:p}=h,y=M(h,["skipSeedData","resetDataOnly","disabled"]),f=wi({before:g.exports.useCallback(()=>d.on(),[d]),after:fo(()=>{d.off(),r.onClose()},[r,d]),includeSeedData:!l,resetDataOnly:!!u});return s(C,{children:[i(I,E({disabled:!t||p,onClick:r.onOpen,colorScheme:o?"green":"red"},y)),i(tr,{isOpen:r.isOpen,onClose:r.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:c,children:i(De,{children:s(or,{children:[s(xe,{fontSize:"lg",fontWeight:"bold",children:[o?"Reset":"Setup"," database ",n]}),s(ze,{children:["This will ",o?"recreate":"create"," the database called ",n,". Are you sure?"]}),s(Ut,{children:[i(I,{ref:c,onClick:r.onClose,disabled:a,children:"Cancel"}),i(I,{disabled:a,colorScheme:o?"red":"green",onClick:f,ml:3,children:a?i(W,{}):o?"Recreate database":"Create database"})]})]})})})]})},$i=({isOpen:e,onClose:t,finalFocusRef:o})=>{const[r,a]=B(de),{session:d,refresh:n}=ve(),c=r&&d.isController,l=m(b),{connected:u,initialized:p,isVapor:y}=O(),f=st(),[h,A]=re(!1),T=g.exports.useCallback(async()=>{A.on();const Z=!(r&&d.isController);a(Z),await ao(l,d.sessionID,Z),n(),A.off()},[l,r,n,d.isController,d.sessionID,a,A]),[w,L]=re(!1),V=g.exports.useCallback(async()=>{L.on(),await Zt(l),L.off()},[l,L]);return s(rr,{isOpen:e,placement:"right",onClose:t,finalFocusRef:o,children:[i(De,{}),s(ir,{children:[i(pt,{}),i(xe,{children:"Config"}),i(ze,{children:s(G,{spacing:4,children:[y?null:i(_o,{showScaleFactor:!0,showDatabase:!0}),s(Q,{status:u?"success":"error",borderRadius:"md",children:[i(ee,{}),i(Ne,{children:u?"connected":"disconnected"}),y?i(To,{position:"absolute",right:4,top:3,size:"xs"}):null]}),s(Q,{status:p?"success":"warning",borderRadius:"md",children:[i(ee,{}),i(Ne,{children:"schema"}),i(ke,{position:"absolute",right:4,top:3,size:"xs",children:p?"Reset":"Setup"})]}),s(Q,{status:c?"success":"warning",borderRadius:"md",children:[i(ee,{}),i(Ne,{children:"simulator"}),i(ar,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:c?"green":"red",isChecked:c,disabled:!u||!p||h,onChange:T})]}),s(ge,{onClick:f.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",f.isOpen?i(dr,{ml:2}):i(ce,{ml:2})]}),f.isOpen?i(I,{size:"xs",_hover:{colorScheme:"red"},onClick:V,disabled:w,children:"Drop Database"}):void 0]})}),i(Ut,{})]})]})},Te=({to:e,children:t,onClick:o})=>{const r=yr(e),a=gr({path:r.pathname,end:!0});return i($,{as:Pt,to:e,px:2,py:1,onClick:o,rounded:"md",_hover:{textDecoration:"none",bg:Ie("gray.300","gray.600")},fontWeight:a?"bold":"normal",href:"#",color:Ie("gray.700","gray.200"),children:t})},qi=()=>{const{colorMode:e,toggleColorMode:t}=Pe(),o=st(),[r,a]=B(Ai),d=pe.useRef(null),{connected:n,initialized:c}=O(),l=m(de),[u]=ut("(max-width: 640px)"),{session:p}=ve(),y=s(C,{children:[i(Te,{to:"/",onClick:o.onClose,children:"Map"}),i(Te,{to:"/overview",onClick:o.onClose,children:"Overview"}),i(Te,{to:"/admin",onClick:o.onClose,children:"Admin"}),i(Te,{to:"/analytics",onClick:o.onClose,children:"Analytics"})]}),f=n?c&&l&&p.isController?"green":"yellow":"red";let h;return u||(h=n?c?l&&p.isController?"connected":"simulator disabled":"needs schema":"disconnected"),i(C,{children:i(z,{bg:Ie("gray.200","gray.700"),children:s(oe,{maxW:"container.lg",children:[s(Ce,{h:16,alignItems:"center",justifyContent:"space-between",children:[i(qe,{size:"md",icon:o.isOpen?i(nr,{}):i(cr,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:o.isOpen?o.onClose:o.onOpen}),s(we,{spacing:8,alignItems:"center",children:[i(yt,{as:"h1",size:u?"sm":"md",children:u?"Martech":"Realtime Digital Marketing"}),i(we,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:y})]}),s(Ce,{alignItems:"center",gap:2,children:[s(I,{size:"sm",ref:d,onClick:()=>a(!0),colorScheme:f,children:[f==="green"?i(Bt,{}):i(Ft,{}),u||i(ge,{pl:2,children:h})]}),i(qe,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?i(lr,{size:"1.4em"}):i(sr,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),i(qe,{"aria-label":"Toggle Color Mode",size:"sm",onClick:t,icon:e==="light"?i(pr,{boxSize:"1.2em"}):i(ur,{boxSize:"1.2em"})})]})]}),o.isOpen?i(z,{pb:4,display:{md:"none"},children:i(G,{as:"nav",spacing:4,children:y})}):null,i($i,{isOpen:r,onClose:()=>a(!1),finalFocusRef:d})]})})})},Ji=ue("~s"),No=(e,...t)=>{const o=g.exports.useMemo(()=>t.reduce((d,n)=>N(E({},d),{[n]:[]}),{}),[t]),r=g.exports.useRef(o),{data:a}=R(["estimatedRowCount.timeseries",...t],async()=>{const d=await We(e,...t),n=new Date;return r.current=t.reduce((c,l)=>{const u=r.current[l];return u.push([n,d[l]]),c[l]=u.slice(-30),c},{}),r.current},{refreshInterval:1e3});return a!=null?a:o},So=r=>{var a=r,{data:e,yAxisLabel:t}=a,o=M(a,["data","yAxisLabel"]);const{colorMode:d}=Pe(),n=Object.keys(e),c=g.exports.useCallback(({tooltipData:p,colorScale:y})=>!y||!p?null:n.sort((f,h)=>p.datumByKey[h].datum[1]-p.datumByKey[f].datum[1]).map(f=>{const{datum:h}=p.datumByKey[f];return s(ge,{mb:1,color:y(f),fontSize:"sm",children:[f,": ",ue(".4~s")(h[1])]},f)}),[n]),l=g.exports.useCallback(p=>Ji(p).replace("G","B"),[]);if(n.some(p=>e[p].length<2))return i(H,{height:o.height,children:i(W,{size:"md"})});const u=n.map(p=>i(fr,{dataKey:p,data:e[p],xAccessor:y=>y[0],yAccessor:y=>y[1]},p));return s(mr,N(E({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:d==="light"?vr:hr,margin:{left:0,right:50,top:10,bottom:40}},o),{children:[i(Rt,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),i(Rt,{orientation:"right",numTicks:o.height<250?3:5,tickFormat:l,label:t,labelOffset:20}),u,i(br,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:c})]}))},at=1e3,Re=60*at,Ae=60*Re,Xe=24*Ae,F=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),X=e=>e?e<at?`${F(e)}ms`:e<Re?`${F(e/at)}s`:e<Ae?`${Math.floor(e/Re)}m${X(e%Re)}`:e<Xe?`${Math.floor(e/Ae)}h${X(e%Ae)}`:`${Math.floor(e/Xe)}d${X(e%Xe)}`:"0s",Xi=100,Zi=1e3,K=class extends te{constructor(t){super();_(this,"latlng");_(this,"age",0);_(this,"marker");_(this,"pulse");this.latlng=t,this.marker=new Oe,this.marker.beginFill(K.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new Oe,this.pulse.beginFill(K.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(t,o){if(this.age+=o/60,this.age>K.lifetime&&this.parent){this.parent.removeChild(this);return}const r=this.age%K.lifetime/K.lifetime,a=Nr(r);this.pulse.scale.set(1+a);const d=.4,n=r<d?Er(r/d):1-_r((r-d)/(1-d));this.pulse.alpha=n,r<d?this.marker.alpha=n:this.marker.alpha=1-Tr((r-d)/(1-d));const[c,l]=t(this.latlng);this.x=c,this.y=l}};let le=K;_(le,"lifetime",1.5),_(le,"markerColor",306687),_(le,"pulseColor",306687);const Ro=()=>{const e=m(b),{initialized:t}=O();return g.exports.useMemo(()=>["notifications",e,t],[e,t])},Ao=({scene:e,latLngToPixel:t,bounds:o})=>{const r=g.exports.useRef(new Date().toISOString()),a=m(b),{initialized:d}=O(),n=yo(o,50),c=Ro();return R(c,()=>mi(a,r.current,Xi,n),{refreshInterval:Zi,isPaused:()=>!d,onSuccess:l=>{if(l.length>0){r.current=l[0][0];for(const[,u,p]of l)e.addChild(new le([p,u]))}}}),{update:g.exports.useCallback(l=>{for(let u=e.children.length-1;u>=0;u--)e.children[u].update(t,l)},[t,e])}},Qi=()=>{const e=m(b),t=No(e,"locations","requests","purchases","notifications","subscriber_segments"),o=R(["notificationsMapTableCounts",e],()=>We(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),r=m(ot("SimulatorMatcher")),a=m(ot("SimulatorUpdateSegments")),d=ue(".4~s"),n=o.data?s(ye,{spacing:2,minChildWidth:"120px",children:[s(k,{children:[i(D,{children:"Offers"}),i(x,{children:d(o.data.offers)})]}),s(k,{children:[i(D,{children:"Cities"}),i(x,{children:d(o.data.cities)})]}),s(k,{children:[i(D,{children:"Subscribers"}),i(x,{children:d(o.data.subscribers)})]}),s(k,{children:[i(D,{children:"Segments"}),i(x,{children:d(o.data.segments)})]}),s(k,{children:[i(D,{children:"Segmentation"}),i(x,{children:X(a)})]}),s(k,{children:[i(D,{children:"Matching"}),i(x,{children:X(r)})]})]}):null;return s(C,{children:[i(S,{children:`
          ...
          about the demo.
        `}),n,s(z,{children:[i(ge,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),i(So,{data:t,yAxisLabel:"total rows",height:150})]})]})},ea=()=>{const{connected:e,initialized:t}=O(),o=m(de);return bt(o&&e&&t),bo(o&&e&&t),s(Ce,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[i(G,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:i(Fe,{useRenderer:Ao,options:{}})}),s(G,{spacing:4,flex:"1 1 0",minWidth:"0",children:[i(S,{children:`
          ...
          `}),e&&!t?i(ke,{colorScheme:"blue",size:"sm",children:"Setup database"}):o?i(Qi,{}):i(vo,{})]})]})},Et=o=>{var r=o,{children:e}=r,t=M(r,["children"]);return i(Sr,N(E({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},t),{children:e}))},ta=1e3,oa=(e,t)=>{const o=m(b),{initialized:r}=O();R(["offers",o,r,e],()=>vi(o,ta,e),{isPaused:()=>!r,onSuccess:t})},ra=e=>i(ho,N(E({},e),{useCells:oa,colorInterpolater:()=>"#04adff",getCellConfig:t=>({value:1,wktPolygon:t.notificationZone})})),ia=e=>e.every(([,t])=>t===0),Y=e=>{const{completed:t,title:o,left:r,right:a}=e,{colorMode:d}=Pe(),n=d==="light"?".300":".500",c=t?"gray"+n:void 0,l=(t?"green":"gray")+n;return s(C,{children:[s(Qe,{children:[s(yt,{as:"h2",size:"lg",mb:4,color:c,children:[i(Bt,E({color:l},{boxSize:6,position:"relative",bottom:.5,mr:2})),o]}),r]}),i(Qe,{children:a})]})},aa=({connected:e,isVapor:t})=>t?i(Y,{completed:e,title:"Connected",left:s(C,{children:[i(S,{children:`
                ...
                the button below.
              `}),i(To,{size:"xs",colorScheme:"gray"})]}),right:null}):i(Y,{completed:e,title:"Connect to SingleStore",left:i(S,{children:`
          ...
          `}),right:i(_o,{})}),da=({onClose:e,schemaObjectName:t})=>{const o=ai(t),[r]=ut("(max-width: 640px)");return s(Yt,{isOpen:!0,onClose:e,size:r?"full":"4xl",scrollBehavior:"inside",children:[i(De,{}),s(Ht,{children:[s(xe,{children:["Create statement for ",o.name]}),i(pt,{}),i(ze,{children:i(Et,{mb:4,children:o.statement})})]})]})},Oo=({name:e,status:t,onClick:o})=>{const{colorMode:r}=Pe();return i(Qe,{bg:(t?"green":"gray")+(r==="light"?".200":".600"),fontSize:"xs",color:r==="light"?"gray.800":"gray.100",textOverflow:"ellipsis",whiteSpace:"nowrap",overflow:"hidden",borderRadius:"md",px:2,py:1,textAlign:"center",_hover:{fontWeight:"bold"},cursor:"pointer",onClick:o,children:e},e)},na=({initialized:e})=>{const[t,o]=B(ae),r=uo(),[a,d]=g.exports.useState();return s(C,{children:[!!a&&i(da,{onClose:()=>d(null),schemaObjectName:a}),i(Y,{completed:e,title:"Setup the schema",left:s(C,{children:[i(S,{children:`
              ...
              `}),i(Ar,{mt:4,mb:6}),e?i(ke,{colorScheme:"yellow",size:"sm",skipSeedData:!0,resetDataOnly:!0,children:"Restart tutorial"}):s(we,{alignItems:"flex-end",children:[s(ct,{flex:1,children:[i(lt,{fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Database name"}),i(Mt,{placeholder:"martech",value:t,size:"sm",onChange:n=>o(n.target.value)})]}),i(z,{flex:1,textAlign:"center",children:i(ke,{colorScheme:"blue",size:"sm",skipSeedData:!0,children:"Setup schema"})})]})]}),right:i(ye,{columns:[1,3,3],gap:1,children:Object.keys(r.data||{}).sort().map(n=>{var c;return i(Oo,{name:n,status:(c=r.data)==null?void 0:c[n],onClick:()=>d(n)},n)})})})]})},ca=({onClose:e,name:t,scaleFactor:o})=>{const r=to(t,o),[a]=ut("(max-width: 640px)");return s(Yt,{isOpen:!0,onClose:e,size:a?"full":"4xl",scrollBehavior:"inside",children:[i(De,{}),s(Ht,{children:[s(xe,{children:["Create statement for pipeline ",t]}),i(pt,{}),i(ze,{children:i(Et,{mb:4,children:r})})]})]})},Io=(e,t,o=!0)=>{var d;const r=R(["pipelineStatus",e,t],()=>eo(e,t),{isPaused:()=>!o}),a=(d=r.data)!=null&&d.length?r.data.every(n=>!n.needsUpdate):!1;return{pipelines:r,completed:a}},la=()=>{const e=m(b),t=m(fe),{pipelines:o,completed:r}=Io(e,t),a=m(me);bt(r&&!a);const d=T=>{var L;const w=(L=o.data)==null?void 0:L.find(V=>V.pipelineName===T);return w?!w.needsUpdate:!1},[n,c]=g.exports.useState(),[l,u]=re(),p=g.exports.useCallback(async()=>{u.on(),await oo(e,t),o.mutate(),u.off()},[u,e,t,o]),y=["locations","requests","purchases"],f=No(e,...y),h=y.some(T=>f[T].length<2)||y.every(T=>ia(f[T])),A=s(I,{colorScheme:"blue",size:"sm",onClick:p,disabled:r,children:[(l||r)&&i(W,{mr:2}),l?"Creating Pipelines":r?"...waiting for data":"Create pipelines"]});return s(C,{children:[!!n&&i(ca,{onClose:()=>c(null),name:n,scaleFactor:t}),i(Y,{completed:r,title:"Ingest data",left:s(C,{children:[i(S,{children:`
              ...
              `}),i(ye,{columns:[1,3,3],gap:1,children:Le.map(T=>i(Oo,{name:T,status:d(T),onClick:()=>c(T)},T))})]}),right:h||!r?i(H,{h:220,children:A}):i(So,{data:f,yAxisLabel:"total rows",height:200})})]})},je=(e,t=!0)=>R(["overviewTableCounts",e],()=>We(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!t}),sa=()=>{var n,c;const e=m(b),[t,o]=re(),r=je(e),a=g.exports.useCallback(async()=>{o.on(),await Qt(e),r.mutate(),o.off()},[e,r,o]),d=!!((n=r.data)!=null&&n.offers);return i(Y,{completed:d,title:"Offers",left:i(C,{children:s(S,{children:[`
            ...
            `,d&&`
                ...
                database.
            `]})}),right:d?i(ra,{height:300,defaultZoom:13}):i(H,{h:"100%",children:s(I,{onClick:a,disabled:t,children:[t&&i(W,{mr:2}),t?"loading...":d?"loaded offers!":"load offers"]})})})},pa=()=>{var f;const e=m(b),t=je(e),{elapsed:o,isRunning:r,startTimer:a,stopTimer:d}=go(),[n,c]=g.exports.useState(!1),l=g.exports.useRef(new Date().toISOString()),u=!!((f=t.data)!=null&&f.subscriber_segments),p=g.exports.useCallback(async()=>{a(),l.current=await io(e,l.current),d(),t.mutate(),c((o||0)>1e3&&await vt(e))},[a,e,d,t,o]);let y;if(o&&t.data){const{segments:h,subscriber_segments:A,locations:T,requests:w,purchases:L}=t.data,V=X(o),Z=F(T+w+L),Ve=F(h),Ke=F(A);y=i(S,{children:`
          The last update evaluated ${Z} rows against ${Ve} segments
        ...
        `})}return i(Y,{completed:f,title:"Matching",left:i(S,{children:`
          ...
          `}),right:i(H,{h:"100%",children:s(Gt,{gap:4,w:"100%",children:[s(I,{disabled:d,onClick:h,children:[d&&i(W,{mr:2}),d?"...running":"Generate notifications"]}),i(z,{width:"100%",children:i(Fe,{height:250,defaultZoom:12,useRenderer:Ao,options:{}})}),A,p&&s(Q,{status:"warning",children:[i(ee,{}),"Queries are still warming up. Please wait for a little bit and then try again."]})]})})})},ya=()=>{const e=m(ae);return i(Y,{completed:!0,title:"Putting it all together",left:i(S,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: /
            [2]: analytics
          `}),right:null})},ga=()=>{const e=m(b),t=m(fe),{connected:o,initialized:r,isVapor:a}=O(),{completed:d}=Io(e,t,o&&r),{data:n}=je(e,o&&r),c=[{completed:o,component:i(aa,{connected:o,isVapor:a},"connection")},{completed:r,component:i(na,{initialized:r},"schema")},{completed:d,component:i(la,{},"pipelines")},{completed:n?n.offers>0:!1,component:i(sa,{},"offers")},{completed:n?n.subscriber_segments>0:!1,component:i(pa,{},"segmentation")},{completed:n?n.notifications>0:!1,component:i(ua,{},"matching")},{completed:!0,component:i(ya,{},"summary")}];let l=!0;const u=[];for(const{completed:p,component:y}of c)if(l)u.push(y),l=p;else break;return s(oe,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(z,{maxW:"container.md",mb:10,px:0,children:i(S,{children:`
          ...
          `})}),i(Rr,{columnGap:6,rowGap:10,templateColumns:["minmax(0, 1fr)",null,"repeat(2, minmax(0, 1fr))"],children:u})]})};function fa(){const e=i(H,{height:"100vh",children:i(W,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})});return i(g.exports.Suspense,{fallback:e,children:s(Ce,{height:"100vh",direction:"column",children:[i(qi,{}),i(z,{m:4,flex:"1",children:s(Or,{children:[i(ne,{path:"/",element:i(ea,{})}),i(ne,{path:"/overview",element:i(ga,{})}),i(ne,{path:"/admin",element:i(Pi,{})}),i(ne,{path:"/analytics",element:i(Yi,{})}),i(ne,{path:"*",element:i(Ir,{to:"/",replace:!0})})]})})]})})}const ma=({children:e})=>{const t=m(me);return i(Co,{isResettingSchema:t,children:e})};class Co extends pe.Component{constructor(t){super(t);_(this,"state",{});this.handlePromiseRejection=this.handlePromiseRejection.bind(this)}componentDidMount(){window.addEventListener("unhandledrejection",this.handlePromiseRejection)}componentWillUnmount(){window.removeEventListener("unhandledrejection",this.handlePromiseRejection)}handlePromiseRejection(t){this.props.isResettingSchema?console.warn("Ignoring error while resetting schema",t.reason):this.setState({error:t.reason})}componentDidCatch(t){this.props.isResettingSchema?console.warn("Ignoring error while resetting schema",t):this.setState({error:t})}render(){const{error:t}=this.state;if(t){let o;return t instanceof P&&(o=s(C,{children:[i(ge,{textAlign:"center",children:"An error occurred while running the following query:"}),i(Et,{children:q(t.sql)})]})),i(oe,{maxW:"container.md",my:10,children:s(G,{gap:4,children:[i(H,{children:i(Ft,{boxSize:20,color:"red"})}),i(yt,{size:"xl",textAlign:"center",children:t.message}),o,s(we,{justify:"center",gap:4,children:[i(I,{onClick:()=>this.setState({error:void 0}),size:"sm",children:"Dismiss Error"}),i(I,{onClick:()=>window.location.reload(),size:"sm",colorScheme:"blue",leftIcon:i(Cr,{}),children:"Reload"})]})]})})}return this.props.children}}const va=wr({fonts:{heading:"InterVariable, sans-serif",body:"InterVariable, sans-serif",mono:'"Source Code ProVariable", monospace'},components:{Link:{baseStyle:e=>({color:e.colorMode==="light"?"blue.600":"blue.300"})}}}),ha=({children:e})=>{const t=m(me),o=xt();return i(zr,{value:{onError:a=>{if(t)console.warn("Ignoring error while resetting schema",a);else{console.error(a);const d="swr-error",n={id:"swr-error",title:"An error occurred",description:a.message,status:"error",duration:5e3,isClosable:!0};o.isActive(d)?o.update(d,n):o(E({id:d},n))}}},children:e})};Lr.render(i(pe.StrictMode,{children:i(kr,{theme:va,children:i(Co,{children:i(Dr,{children:i(xr,{basename:"/",children:i(ha,{children:i(ma,{children:i(fa,{})})})})})})})}),document.getElementById("root"));
