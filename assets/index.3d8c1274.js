...
`),{sql:a,params:n}=Tt(o);return{sql:W`
    ...
    `,t.id,t.name,`POINT(${t.lonlat[0]} ${t.lonlat[1]})`,t.diameter),wr=(e,t)=>E(e,"DELETE FROM cities WHERE city_id = ?",t),Ir=["olc_8","purchase","request"],Lr=["minute","hour","day","week","month"],Yt=({interval:e,kind:t,value:o})=>No(`${e}-${t}-${o}`),kr=async(e,t)=>{const{sql:o,params:r}=Bt({table:"segments",options:{replace:!0},columns:["segment_id","valid_interval","filter_kind","filter_value"],tuples:t.map(d=>[Yt(d),d.interval,d.kind,d.value])});await E(e,o,...r)},Dr=async(e,t)=>{const o={table:"offers",options:{replace:!0},columns:["customer","notification_zone","segment_ids","notification_content","notification_target","maximum_bid_cents"],tuples:[]};let r=0,d=[];const a=async()=>{const{sql:n,params:l}=Bt(o);await Promise.all([E(e,n,...l),kr(e,d)]),o.tuples=[],d=[],r=0};for(const n of t)o.tuples.push([n.customer,n.notificationZone,JSON.stringify(n.segments.map(Yt)),n.notificationContent,n.notificationTarget,n.maximumBidCents]),r++,d=d.concat(n.segments),r>=Cr&&await a();r>0&&await a()},xr=()=>Ft(Ir),zr=()=>Ft(Lr),Ht=({vendor:e,tld:t})=>`${e.toLowerCase()}.${t}`,jt=e=>{const[t,o]=e.lonlat,r=e.diameter/2,[d,a]=[t-r,t+r],[n,l]=[o-r,o+r];return[Ke(d,a),Ke(n,l)]},Pr=(e,t)=>{const o=xr(),r=zr();switch(o){case"olc_8":{const[d,a]=jt(e),n=Ve.encode(a,d,8).substring(0,8);return{kind:o,interval:r,value:n}}case"purchase":return{kind:o,interval:r,value:t.vendor};case"request":return{kind:o,interval:r,value:Ht(t)}}},Mr=e=>{const t=ve(1,3),o=Ar(),r=Array.from({length:t},()=>Pr(e,o)),d=Ht(o),n=`${ve(10,50)}% off at ${o.vendor}`,l=d,[c,p]=jt(e),u=Ve.encode(p,c,8),y=Ve.decode(u),f={ne:[y.latitudeHi,y.longitudeHi],sw:[y.latitudeLo,y.longitudeLo]};return{customer:o.vendor,segments:r,notificationZone:Le(f),notificationContent:n,notificationTarget:l,maximumBidCents:ve(2,15)}},Ur=(e,t)=>Array.from({length:t},()=>Mr(e)),Br=e=>(t,o,r,d=1)=>`https://stamen-tiles.a.ssl.fastly.net/${e}/${r}/${t}/${o}${d>=2?"@2x":""}.png`,Fr=s(O,{children:["Map tiles by ",i(j,{href:"http://stamen.com",children:"Stamen Design"}),", under"," ",i(j,{href:"http://creativecommons.org/licenses/by/3.0",children:"CC BY 3.0"}),". Data by ",i(j,{href:"http://openstreetmap.org",children:"OpenStreetMap"}),", under"," ",i(j,{href:"http://www.openstreetmap.org/copyright",children:"ODbL"}),"."]}),Gr=[de.lonlat[1],de.lonlat[0]],Yr=12,Hr=({width:e,height:t,bounds:o,latLngToPixel:r,pixelToLatLng:d,useRenderer:a,options:n})=>{const l=ae.useRef(null),c=At(()=>new q),{setup:p,update:u}=a({scene:c,width:e,height:t,bounds:o,latLngToPixel:r,pixelToLatLng:d,options:n});return g.exports.useLayoutEffect(()=>{if(!l.current)throw new Error("No canvas ref");console.log("PixiMapLayer: Setup");const y=new Oo({view:l.current,width:e,height:t,backgroundAlpha:0,antialias:!0});return y.stage.addChild(c),p==null||p(),u&&y.ticker.add(f=>{u(f)}),()=>{console.log("PixiMapLayer: Destroy"),y.stage.removeChild(c),y.destroy(!1,{children:!1,texture:!0,baseTexture:!0})}},[t,c,p,u,e]),i("canvas",{ref:l})},jr=({mapState:e,latLngToPixel:t,pixelToLatLng:o,useRenderer:r,options:d})=>{const{width:a,height:n,bounds:l}=e||{width:0,height:0};return a<=0||n<=0||!t||!o||!l?null:i(Hr,{useRenderer:r,width:a,height:n,bounds:l,latLngToPixel:t,pixelToLatLng:o,options:d})},ke=n=>{var l=n,{height:e="100%",defaultCenter:t=Gr,defaultZoom:o=Yr,useRenderer:r,options:d}=l,a=z(l,["height","defaultCenter","defaultZoom","useRenderer","options"]);const[c,p]=g.exports.useState(t),[u,y]=g.exports.useState(o);return i(k,_(h({borderRadius:"lg",overflow:"hidden",height:e},a),{children:i(Ro,{dprs:[1,2],provider:Br("toner-lite"),attribution:Fr,maxZoom:20,center:c,zoom:u,onBoundsChanged:({center:f,zoom:v})=>{p(f),y(v)},children:i(jr,{useRenderer:r,options:d})})}))};var De=[{name:"date_sub_dynamic",createStmt:`CREATE OR REPLACE FUNCTION date_sub_dynamic (
  _dt DATETIME(6),
...
END`}],ze=[{name:"worldcities",createStmt:`create rowstore table if not exists worldcities (
...
);`}];const be="singlestore-realtime-digital-marketing",Wr=[`CREATE LINK aws_s3 AS S3 CREDENTIALS '{}' CONFIG '{ "region": "us-east-1" }'`,`
  ...
  `,"START PIPELINE worldcities FOREGROUND"],Vr=e=>{const t=ze.find(d=>d.name===e);if(t)return t;const o=xe.find(d=>d.name===e);if(o)return o;const r=De.find(d=>d.name===e);if(r)return r;throw new Error("Could not find schema object: "+e)},$r=async e=>{try{return await ct(e,"SELECT 1"),!0}catch{return!1}},Kr=async e=>{let t={tables:[],procedures:[],functions:[]};const l=e,{database:o}=l,r=z(l,["database"]);try{t=(await nt(r,`
        ...
        `,o,o)).reduce((c,[p,u])=>(c[p].push(u),c),t)}catch(c){if(!(c instanceof D&&(c.isUnknownDatabase()||c.isDatabaseRecovering())))throw c}const{tables:d,procedures:a,functions:n}=t;return Object.fromEntries([ze.map(({name:c})=>[c,d.includes(c)]),xe.map(({name:c})=>[c,a.includes(c)]),De.map(({name:c})=>[c,n.includes(c)])].flat())},Wt=e=>ct(e,"DROP DATABASE IF EXISTS `"+e.database+"`"),qr=async(e,{progress:t,scaleFactor:o,includeSeedData:r,skipCreate:d=!1})=>{d||(t("Dropping existing schema","info"),await Wt(e),t("Creating database","info"),await ct(e,"CREATE DATABASE `"+e.database+"`"));for(const a of De)t(`Creating function: ${a.name}`,"info"),await E(e,a.createStmt);for(const a of ze)t(`Creating table: ${a.name}`,"info"),await E(e,a.createStmt);for(const a of xe)t(`Creating procedure: ${a.name}`,"info"),await E(e,a.createStmt);await Jr(e),await Gt(e,de),r&&(t("Creating sample data","info"),await st(e,de,o)),t("Schema initialized","success")},Jr=async e=>{for(const t of Wr)await E(e,t)},st=(e,t,o)=>{const r=100*o.partitions,d=Ur(t,r);return Dr(e,d)},Vt=async(e,t)=>{const o=t.prefix,r=["locations","requests","purchases"],d=await Y(e,`
      SELECT
    ...
    `,e.database,...r);return r.map(a=>{var l;const n=d.find(c=>c.pipelineName===a);return{pipelineName:a,needsUpdate:(l=n==null?void 0:n.needsUpdate)!=null?l:!0}})},$t=async(e,t)=>{const o=t.prefix,r=await Vt(e,t);await Promise.all(r.filter(d=>d.needsUpdate).map(async d=>{switch(console.log(`recreating pipeline ${d.pipelineName}`),d.pipelineName){case"locations":await E(e,`
              ...
              `);break}await E(e,`ALTER PIPELINE ${d.pipelineName} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await E(e,`START PIPELINE IF NOT RUNNING ${d.pipelineName}`),console.log(`finished creating pipeline ${d.pipelineName}`)}))},Xr=async e=>{const t=await nt(e,`
      SELECT
    ...
    `,e.database);await Promise.all(t.map(async([o])=>{console.log("restarting pipeline",o),await E(e,`ALTER PIPELINE ${o} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await E(e,`START PIPELINE IF NOT RUNNING ${o}`)}))},Kt=async e=>{const t=await Y(e,`
      SELECT plan_id AS planId
      FROM information_schema.plancache
      WHERE
        plan_warnings LIKE "%empty tables%"
    `);try{await Promise.all(t.map(({planId:o})=>E(e,`DROP ${o} FROM PLANCACHE`)))}catch(o){if(!(o instanceof D&&o.isPlanMissing()))throw o}return t.length>0},Zr=(e,...t)=>{const o=t.map(r=>`"${r}"`).join(",");return Ut(e,`
      ...
      GROUP BY tableName
    `,e.database)},Pe=(e,...t)=>Zr(e,...t).then(o=>o.reduce((r,{tableName:d,count:a})=>(r[d]=a,r),{})),Qr=async(e,t)=>{const{maxRows:o}=t,d=["locations","requests","purchases","notifications"].map(n=>`"${n}"`).join(","),a=await Ut(e,`
      SELECT
      ...
      WHERE
        ...
        AND stats.count > ?
    `,e.database,o);await Promise.all(a.map(async({tableName:n,count:l,minTs:c,maxTs:p})=>{const y=(l-o)/l;if(y<.2)return;const f=new Date((c+y*(p-c))*1e3);console.log(`removing rows from ${n} older than ${f.toISOString()}`),await E(e,`DELETE FROM ${n} WHERE ts <= ?`,f.toISOString())}))},pt=(e,t="minute")=>at(e,"ECHO run_matching_process(?)",t).then(o=>o.RESULT),ut=async(e,t,o=!0)=>{const r=new Date().toISOString();return await E(e,"CALL update_segments(?, ?)",t,r),o&&await E(e,"CALL prune_segments(?)",r),r},ei=(e,t,o,r)=>nt(e,`
      SELECT
        ts,
...
`,ii=(e,t,o,r)=>Y(e,lt({with:[["metrics",yt(t)]],base:`
        SELECT
        ...
        ORDER BY ${o} DESC
        LIMIT ${r}
      `}).sql),Rt=(e,t)=>at(e,lt({with:[["metrics",yt(t)]],base:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `}).sql),di=(e,t,o)=>{const r=lt({with:[["metrics",yt(o)]],base:{sql:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `,params:[Le(t)]}});return Y(e,r.sql,...r.params)},V=[{name:"s00",maxRows:1e7,prefix:"v2/100k-2p",partitions:2},{name:"s0",maxRows:2e7,prefix:"v2/100k-4p",partitions:4},{name:"s1",maxRows:4e7,prefix:"v2/100k-8p",partitions:8},{name:"s2",maxRows:16e7,prefix:"v2/1m-16p",partitions:16},{name:"s4",maxRows:32e7,prefix:"v2/1m-32p",partitions:16},{name:"s8",maxRows:64e7,prefix:"v2/1m-64p",partitions:64},{name:"s10",maxRows:1e9,prefix:"v2/10m-80p",partitions:80}],ai=e=>V.find(t=>t.name===e)||V[0],J=({encode:e,decode:t}={encode:JSON.stringify,decode:JSON.parse})=>({setSelf:o,onSet:r,node:d})=>{const a=`recoil.localstorage.${d.key}`,n=localStorage.getItem(a);n!=null&&o(t(n)),r((l,c,p)=>{p?localStorage.removeItem(a):localStorage.setItem(a,e(l))})},gt=()=>({setSelf:e,node:{key:t}})=>{const{location:o}=window;if(o){const r=new URLSearchParams(o.search);e(r.get(t))}},ni=x({key:"skipCreateDatabase",default:null,effects:[gt()]}),ci=x({key:"sessionId",default:null,effects:[gt()]}),li=x({key:"vaporBaseUrl",default:"https://vapor.labs.singlestore.com",effects:[gt()]}),qt=x({key:"connectionHost",default:"http://127.0.0.1",effects:[J()]}),Jt=x({key:"connectionUser",default:"root",effects:[J()]}),Xt=x({key:"connectionPassword",default:"",effects:[J()]}),X=x({key:"connectionDatabase",default:"martech",effects:[J()]}),Zt=Ct({key:"vaporConnectionConfig",get:async({get:e})=>{const t=e(ci),o=e(li);if(t)try{const r=await fetch(o+"/api/v1/vapor/connect?sessionId="+t);if(r.status===200){const d=await r.json();return{host:d.endpoint,user:d.user,password:d.password,database:e(X)}}}catch{console.log(`Failed to connect to vapor at ${o}, falling back to local config`)}}}),b=Ct({key:"connectionConfig",get:({get:e})=>{const t=e(Zt);if(t)return t;const o=e(qt),r=e(Jt),d=e(Xt),a=e(X);return{host:o,user:r,password:d,database:a}},cachePolicy_UNSTABLE:{eviction:"most-recent"}}),Z=x({key:"configScaleFactor",default:V[0],effects:[J({encode:e=>e.name,decode:e=>V.find(t=>t.name===e)||V[0]})]}),Q=x({key:"simulatorEnabled",default:!0,effects:[J()]}),si=x({key:"databaseDrawerIsOpen",default:!1}),qe=Ao({key:"tickDurationMs",default:void 0}),ft=x({key:"resettingSchema",default:!1}),pi=Object.fromEntries([ze.map(({name:e})=>[e,!1]),xe.map(({name:e})=>[e,!1]),De.map(({name:e})=>[e,!1])].flat()),Qt=(e=!1)=>{const t=m(b);return N(["schemaObjects",t,e],()=>Kr(t),{isPaused:()=>e,refreshInterval:o=>Object.values(o||[]).some(d=>!d)?1e3:0,fallbackData:pi})},A=()=>{const a=m(b),{database:e}=a,t=z(a,["database"]),o=m(Zt),r=N(["isConnected",t],()=>$r(t)),d=Qt(!r.data);return{isVapor:!!o,connected:!!r.data,initialized:!!r.data&&Object.values(d.data||[]).every(Boolean),reset:()=>{r.mutate(),d.mutate()}}},ui=(()=>{let e={};return t=>(t in e||(e[t]=1),`${t}(${e[t]++})`)})(),Je=(e,{name:t,enabled:o,intervalMS:r})=>{const d=Qe(qe(t));g.exports.useEffect(()=>{if(!o)return;const a=new AbortController,n=ui(t);console.log(`Starting ${n}: tick interval: ${r}ms`);const l=async()=>{try{if(console.time(n),a.signal.aborted)return;const c=performance.now();await e(a);const p=performance.now()-c;d(p),setTimeout(l,Math.max(0,r-p))}catch(c){if(a.signal.aborted||c instanceof D&&c.isUnknownDatabase()||c instanceof DOMException&&c.name==="AbortError")return;throw c}finally{console.timeEnd(n)}};return l(),()=>{console.log(`Stopping ${n}`),a.abort()}},[o,e,r,t,d])},yi=({before:e,after:t,includeSeedData:o})=>{const r=m(b),d=m(Z),{reset:a}=A(),[n,l]=P(Q),c=wt(),p=m(ni),u=Qe(ft);return g.exports.useCallback(async()=>{const y=n;l(!1),u(!0),e(),await qr(r,{progress(f,v){const C="reset-schema";c.isActive(C)?c.update(C,{title:f,status:v,duration:v==="success"?2e3:null,isClosable:!0}):c({id:C,title:f,status:v,duration:null})},scaleFactor:d,includeSeedData:o,skipCreate:!!p}),t(),a(),l(y),u(!1)},[n,l,u,e,r,d,o,p,t,a,c])},eo=(e,t)=>{const[o,r]=g.exports.useState(e);return g.exports.useEffect(()=>{const d=setTimeout(()=>r(e),t);return()=>clearTimeout(d)},[e,t]),o},to=()=>{const[{elapsed:e,isRunning:t},o]=g.exports.useReducer((r,d)=>{switch(d.type){case"start":return{start:Math.floor(performance.now()),isRunning:!0,elapsed:r.elapsed};case"stop":return{elapsed:Math.floor(performance.now())-(r.start||0),isRunning:!1}}},{isRunning:!1});return{elapsed:e,isRunning:t,startTimer:()=>o({type:"start"}),stopTimer:()=>o({type:"stop"})}},oo=(e,t)=>{let o=!1,r=new Co(0,0),d=0;e.on("pointerdown",a=>{o=!0,r=a.data.global,d=performance.now()}),e.on("pointerup",a=>{if(!o||(o=!1,performance.now()-d>200))return;const l=a.data.global;Math.sqrt(Math.pow(l.x-r.x,2)+Math.pow(l.y-r.y,2))>10||t(a)}),e.on("pointercancel",()=>{o=!1})};class gi extends q{constructor(t,o){super();S(this,"gfx");S(this,"hover",!1);this.city=t,this.onRemove=o,this.gfx=new _e,this.addChild(this.gfx),this.gfx.interactive=!0,this.gfx.on("pointerover",()=>{this.hover=!0}),this.gfx.on("pointerout",()=>{this.hover=!1}),oo(this.gfx,()=>o(this.city))}update(t){this.gfx.clear(),this.gfx.lineStyle(1,this.hover?16711680:306687,1),this.gfx.beginFill(this.hover?16711680:306687,.2);const[o,r]=t([this.city.centerLat,this.city.centerLon]);this.gfx.drawCircle(o,r,25),this.gfx.endFill()}}const fi=e=>{const t=m(b),{initialized:o}=A();return N(["cities",t,o],()=>oi(t),{isPaused:()=>!o,onSuccess:e})},mi=({scene:e,latLngToPixel:t,pixelToLatLng:o,width:r,height:d})=>{const a=m(b),n=At(()=>new q),{mutate:l}=fi(u=>{n.removeChildren();for(let y=0;y<u.length;y++)n.addChild(new gi(u[y],p))}),c=g.exports.useCallback(async(u,y)=>{const f=await ri(a,y,u),v={id:f.id,name:f.name,lonlat:[f.centerLon,f.centerLat],diameter:f.diameter};await Gt(a,v),await st(a,v,V[0]),l()},[a,l]),p=g.exports.useCallback(async u=>{await wr(a,u.id),l()},[a,l]);return{setup:g.exports.useCallback(()=>{const u=new q;e.addChild(u),e.addChild(n),u.interactive=!0,u.hitArea=new wo(0,0,r,d),oo(u,y=>{const[f,v]=o([y.data.global.x,y.data.global.y]);c(f,v)})},[n,d,c,o,e,r]),update:g.exports.useCallback(()=>{for(let u=0;u<n.children.length;u++)n.children[u].update(t)},[n,t])}},vi=e=>i(ke,_(h({},e),{useRenderer:mi,options:{},cursor:"pointer"})),bi=Io({a:o=>{var r=o,{children:e}=r,t=z(r,["children"]);const{href:d}=t,a=!!(d!=null&&d.startsWith("http"));return a?s(j,_(h({isExternal:a},t),{children:[e,i(Lo,{bottom:"2px",boxSize:"0.9em",position:"relative",ml:1})]})):i(j,_(h({to:d||""},t),{as:It,children:e}))}}),T=o=>{var r=o,{children:e}=r,t=z(r,["children"]);return i(ko,_(h({},t),{skipHtml:!0,components:bi,children:Array.isArray(e)?e.filter(d=>d).map(d=>W(d||"")).join(`

`):W(e)}))},hi=()=>s(K,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(K,{maxW:"container.md",mb:10,children:i(T,{children:`
            ## Admin

            You can configure cities and offers on this page. To learn more
            about this application please visit the [Overview page](/).
          `})}),i(Ei,{})]}),Ei=()=>s(O,{children:[i(K,{maxW:"container.md",mb:4,children:i(T,{children:`
            #### Cities
            ...
            remove it.
          `})}),i(vi,{defaultZoom:4,defaultCenter:[39.716470511656766,-99.59395661915288],height:300})]}),ro=()=>{const e=Qe(Q);return s(ge,{status:"warning",borderRadius:"md",children:[i(fe,{}),i(me,{children:"The simulator is disabled"}),i(R,{position:"absolute",right:4,top:3,size:"xs",colorScheme:"blue",onClick:()=>e(!0),children:"Enable simulator"})]})},Ot=e=>{const{r:t,g:o,b:r}=e.rgb();return t<<16|o<<8|r};class _i extends q{constructor(t){super();S(this,"points");S(this,"polygon");S(this,"hovering",!1);this.config=t,this.points=Or(t.wktPolygon),this.polygon=new _e,this.addChild(this.polygon),this.polygon.interactive=!0,this.polygon.on("mouseover",()=>{this.hovering=!0}),this.polygon.on("mouseout",()=>{this.hovering=!1})}update(t){const o=this.hovering?this.config.hoverColor:this.config.color;this.polygon.clear(),this.polygon.lineStyle(1,Ot(o),.5),this.polygon.beginFill(Ot(o),.2),this.polygon.drawPolygon(this.points.flatMap(([r,d])=>t([d,r]))),this.polygon.endFill()}}const Ti=e=>({scene:t,latLngToPixel:o,bounds:r})=>{const d=eo(r,100);return e.useCells(d,a=>{t.removeChildren();for(const n of a)t.addChild(new _i(e.getCellConfig(n)))}),{update:g.exports.useCallback(()=>{for(let a=0;a<t.children.length;a++)t.children[a].update(o)},[o,t])}},io=e=>{const a=e,{useCells:t,getCellConfig:o}=a,r=z(a,["useCells","getCellConfig"]),d=g.exports.useMemo(()=>Ti({useCells:t,getCellConfig:o}),[o,t]);return i(ke,_(h({},r),{useRenderer:d,options:{}}))},Si=10*1e3,mt=e=>{const t=m(b),o=m(Z),{initialized:r}=A(),d=g.exports.useCallback(a=>{const n=_(h({},t),{ctx:a});return Promise.all([$t(n,o),Xr(n),Qr(n,o),Kt(n)])},[t,o]);Je(d,{name:"SimulatorMonitor",enabled:r&&e,intervalMS:Si})},Ni=1*1e3,Ri=1*1e3,ao=e=>{const t=m(b),{initialized:o}=A(),r=g.exports.useRef(new Date(0).toISOString()),d=g.exports.useCallback(n=>pt(_(h({},t),{ctx:n}),"minute"),[t]);Je(d,{name:"SimulatorMatcher",enabled:o&&e,intervalMS:Ni});const a=g.exports.useCallback(async n=>{r.current=await ut(_(h({},t),{ctx:n}),r.current)},[t]);Je(a,{name:"SimulatorUpdateSegments",enabled:o&&e,intervalMS:Ri})},Xe=ne(",.2%"),ie=ne(".4~s"),Oi=()=>{const{initialized:e}=A(),t=m(Q);return mt(t),ao(t),i(K,{maxW:"container.lg",mt:10,mb:"30vh",children:e?t?s(F,{gap:10,children:[i(Ai,{}),i(Ci,{}),i(Li,{})]}):i(ro,{}):i(no,{})})},no=()=>i(M,{children:i(U,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})}),Ai=()=>{var d,a;const e=m(b),t=N(["overallConversionRateRequests",e],()=>Rt(e,"requests"),{refreshInterval:1e3}),o=N(["overallConversionRatePurchases",e],()=>Rt(e,"purchases"),{refreshInterval:1e3}),r=N(["analyticsTableCounts",e],()=>Pe(e,"offers","subscribers","notifications"),{refreshInterval:1e3});return!r.data||!t.data||!o.data?i(no,{}):s(Oe,{spacing:2,minChildWidth:"150px",flex:2,children:[s(w,{children:[i(I,{children:"Offers"}),i(L,{children:ie(r.data.offers)})]}),s(w,{children:[i(I,{children:"Subscribers"}),i(L,{children:ie(r.data.subscribers)})]}),s(w,{children:[i(I,{children:"Notifications"}),i(L,{children:ie(r.data.notifications)})]}),s(w,{children:[i(I,{children:"Conversion Rate"}),i(L,{children:Xe(((d=t.data)==null?void 0:d.conversionRate)||0)}),i(ht,{children:"Requests"})]}),s(w,{children:[i(I,{children:"Conversion Rate"}),i(L,{children:Xe(((a=o.data)==null?void 0:a.conversionRate)||0)}),i(ht,{children:"Purchases"})]})]})},Ci=()=>{var a;const e=m(b),[t,o]=g.exports.useState("conversionRate"),r=N(["customerMetrics",e,t],()=>ii(e,"purchases",t,10),{refreshInterval:1e3}),d=Te("blue.500","blue.200");return i(k,{overflowX:"auto",children:s(Do,{size:"sm",colorScheme:"gray",variant:"striped",children:[i(xo,{children:s(Et,{children:[s(se,{onClick:()=>o("customer"),_hover:{color:d},color:t==="customer"?d:void 0,cursor:"pointer",children:["Customer",t==="customer"&&i(oe,{})]}),s(se,{onClick:()=>o("totalNotifications"),_hover:{color:d},color:t==="totalNotifications"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Notifications",t==="totalNotifications"&&i(oe,{})]}),s(se,{onClick:()=>o("totalConversions"),_hover:{color:d},color:t==="totalConversions"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Conversions",t==="totalConversions"&&i(oe,{})]}),s(se,{onClick:()=>o("conversionRate"),_hover:{color:d},color:t==="conversionRate"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Conversion Rate",t==="conversionRate"&&i(oe,{})]})]})}),i(zo,{children:(a=r.data)==null?void 0:a.map(n=>s(Et,{children:[i(pe,{children:n.customer}),i(pe,{isNumeric:!0,children:ie(n.totalNotifications)}),i(pe,{isNumeric:!0,children:ie(n.totalConversions)}),i(pe,{isNumeric:!0,children:Xe(n.conversionRate)})]},n.customer))})]})})},wi=(e,t)=>{const o=m(b);N(["zoneMetrics",o,e],()=>di(o,e,"purchases"),{refreshInterval:1e3,onSuccess:t})},Ii=e=>$e(Po(e))||$e(0,0,0),Li=()=>s(F,{direction:["column","row"],alignItems:"top",children:[i(k,{flex:1,children:i(T,{children:`
            ### Conversion Map
          ...
          `})}),i(k,{flex:2,children:i(io,{height:400,defaultZoom:14,useCells:wi,getCellConfig:({conversionRate:e,wktPolygon:t})=>{const o=Ii(e);return{color:o,hoverColor:o.brighter(1),wktPolygon:t}}})})]}),ue=({label:e,placeholder:t,value:o,setValue:r,helpText:d,type:a="text"})=>s(et,{children:[i(tt,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),i(Lt,{size:"sm",placeholder:t,value:o,onChange:n=>r(n.target.value),type:a}),d?i(Mo,{fontSize:"xs",children:d}):null]}),ki=()=>{const[e,t]=P(Z);return s(et,{children:[i(tt,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),i(Uo,{size:"sm",required:!0,value:e.name,onChange:o=>{const r=o.target.value;t(ai(r))},children:V.map(o=>i("option",{value:o.name,children:o.name},o.name))})]})},co=({showDatabase:e,showScaleFactor:t})=>{const[o,r]=P(qt),[d,a]=P(Jt),[n,l]=P(Xt),[c,p]=P(X);return s(F,{spacing:4,children:[i(ue,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:o,setValue:r,helpText:i(T,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [HTTP API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),s(Oe,{columns:2,gap:2,children:[i(ue,{label:"Username",placeholder:"admin",value:d,setValue:a}),i(ue,{label:"Password",placeholder:"",value:n,setValue:l,type:"password"}),e&&i(ue,{label:"Database",placeholder:"martech",value:c,setValue:p}),t&&i(ki,{})]})]})},lo=e=>i(R,_(h({onClick:()=>{const{pathname:t,hash:o}=window.location;window.location.replace(t+o)},colorScheme:"red"},e),{children:"Disconnect"})),so=e=>{const{connected:t,initialized:o}=A(),r=ot(),[d,a]=Ae(),n=m(X),l=ae.useRef(null),f=e,{skipSeedData:c,disabled:p}=f,u=z(f,["skipSeedData","disabled"]),y=yi({before:g.exports.useCallback(()=>a.on(),[a]),after:g.exports.useCallback(()=>{a.off(),r.onClose()},[r,a]),includeSeedData:!c});return s(O,{children:[i(R,h({disabled:!t||p,onClick:r.onOpen,colorScheme:o?"green":"red"},u)),i(Bo,{isOpen:r.isOpen,onClose:r.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:l,children:i(rt,{children:s(Fo,{children:[s(it,{fontSize:"lg",fontWeight:"bold",children:[o?"Reset":"Setup"," database ",n]}),s(dt,{children:["This will ",o?"recreate":"create"," the database called ",n,". Are you sure?"]}),s(kt,{children:[i(R,{ref:l,onClick:r.onClose,disabled:d,children:"Cancel"}),i(R,{disabled:d,colorScheme:o?"red":"green",onClick:y,ml:3,children:d?i(U,{}):o?"Recreate database":"Create database"})]})]})})})]})},Di=({isOpen:e,onClose:t,finalFocusRef:o})=>{const[r,d]=P(Q),a=m(b),{connected:n,initialized:l,isVapor:c}=A(),p=ot(),[u,y]=Ae(!1),f=g.exports.useCallback(async()=>{y.on(),await Wt(a),y.off()},[a,y]);return s(Go,{isOpen:e,placement:"right",onClose:t,finalFocusRef:o,children:[i(rt,{}),s(Yo,{children:[i(Dt,{}),i(it,{children:"Config"}),i(dt,{children:s(F,{spacing:4,children:[c?null:i(co,{showScaleFactor:!0,showDatabase:!0}),s(ge,{status:n?"success":"error",borderRadius:"md",children:[i(fe,{}),i(me,{children:n?"connected":"disconnected"}),c?i(lo,{position:"absolute",right:4,top:3,size:"xs"}):null]}),s(ge,{status:l?"success":"warning",borderRadius:"md",children:[i(fe,{}),i(me,{children:"schema"}),i(so,{position:"absolute",right:4,top:3,size:"xs",children:l?"Reset":"Setup"})]}),s(ge,{status:r?"success":"warning",borderRadius:"md",children:[i(fe,{}),i(me,{children:"simulator"}),i(Ho,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:r?"green":"red",isChecked:r,disabled:!n||!l,onChange:()=>d(!r)})]}),s(ce,{onClick:p.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",p.isOpen?i(jo,{ml:2}):i(oe,{ml:2})]}),p.isOpen?i(R,{size:"xs",_hover:{colorScheme:"red"},onClick:f,disabled:u,children:"Drop Database"}):void 0]})}),i(kt,{})]})]})},ye=({to:e,children:t,onClick:o})=>{const r=Xo(e),d=Zo({path:r.pathname,end:!0});return i(j,{as:It,to:e,px:2,py:1,onClick:o,rounded:"md",_hover:{textDecoration:"none",bg:Te("gray.300","gray.600")},fontWeight:d?"bold":"normal",href:"#",color:Te("gray.700","gray.200"),children:t})},xi=()=>{const{colorMode:e,toggleColorMode:t}=Ce(),o=ot(),[r,d]=P(si),a=ae.useRef(null),{connected:n,initialized:l}=A(),c=m(Q),[p]=xt("(max-width: 640px)"),u=s(O,{children:[i(ye,{to:"/",onClick:o.onClose,children:"Overview"}),i(ye,{to:"/map",onClick:o.onClose,children:"Map"}),i(ye,{to:"/admin",onClick:o.onClose,children:"Admin"}),i(ye,{to:"/analytics",onClick:o.onClose,children:"Analytics"})]});let y;return p||(y=n?l?c?"connected":"simulator disabled":"needs schema":"disconnected"),i(O,{children:i(k,{bg:Te("gray.200","gray.700"),children:s(K,{maxW:"container.lg",children:[s(Se,{h:16,alignItems:"center",justifyContent:"space-between",children:[i(He,{size:"md",icon:o.isOpen?i(Wo,{}):i(Vo,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:o.isOpen?o.onClose:o.onOpen}),s(Ne,{spacing:8,alignItems:"center",children:[i(we,{as:"h1",size:p?"sm":"md",children:p?"Martech":"Realtime Digital Marketing"}),i(Ne,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:u})]}),s(Se,{alignItems:"center",gap:2,children:[s(R,{size:"sm",ref:a,onClick:()=>d(!0),colorScheme:n?l&&c?"green":"yellow":"red",children:[l?i(zt,{}):i(Pt,{}),p||i(ce,{pl:2,children:y})]}),i(He,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?i($o,{size:"1.4em"}):i(Ko,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),i(He,{"aria-label":"Toggle Color Mode",size:"sm",onClick:t,icon:e==="light"?i(qo,{boxSize:"1.2em"}):i(Jo,{boxSize:"1.2em"})})]})]}),o.isOpen?i(k,{pb:4,display:{md:"none"},children:i(F,{as:"nav",spacing:4,children:u})}):null,i(Di,{isOpen:r,onClose:()=>d(!1),finalFocusRef:a})]})})})},zi=ne("~s"),po=(e,...t)=>{const o=g.exports.useMemo(()=>t.reduce((a,n)=>_(h({},a),{[n]:[]}),{}),[t]),r=g.exports.useRef(o),{data:d}=N(["estimatedRowCount.timeseries",...t],async()=>{const a=await Pe(e,...t),n=new Date;return r.current=t.reduce((l,c)=>{const p=r.current[c];return p.push([n,a[c]]),l[c]=p.slice(-30),l},{}),r.current},{refreshInterval:1e3});return d!=null?d:o},uo=r=>{var d=r,{data:e,yAxisLabel:t}=d,o=z(d,["data","yAxisLabel"]);const{colorMode:a}=Ce(),n=Object.keys(e),l=g.exports.useCallback(({tooltipData:u,colorScale:y})=>!y||!u?null:n.sort((f,v)=>u.datumByKey[v].datum[1]-u.datumByKey[f].datum[1]).map(f=>{const{datum:v}=u.datumByKey[f];return s(ce,{mb:1,color:y(f),fontSize:"sm",children:[f,": ",ne(".4~s")(v[1])]},f)}),[n]),c=g.exports.useCallback(u=>zi(u).replace("G","B"),[]);if(n.some(u=>e[u].length<2))return i(M,{height:o.height,children:i(U,{size:"md"})});const p=n.map(u=>i(Qo,{dataKey:u,data:e[u],xAccessor:y=>y[0],yAccessor:y=>y[1]},u));return s(er,_(h({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:a==="light"?tr:or,margin:{left:0,right:50,top:10,bottom:40}},o),{children:[i(_t,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),i(_t,{orientation:"right",numTicks:o.height<250?3:5,tickFormat:c,label:t,labelOffset:20}),p,i(rr,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:l})]}))},Ze=1e3,he=60*Ze,Ee=60*he,We=24*Ee,B=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),$=e=>e?e<Ze?`${B(e)}ms`:e<he?`${B(e/Ze)}s`:e<Ee?`${Math.floor(e/he)}m${$(e%he)}`:e<We?`${Math.floor(e/Ee)}h${$(e%Ee)}`:`${Math.floor(e/We)}d${$(e%We)}`:"0s",Pi=100,Mi=1e3,H=class extends q{constructor(t){super();S(this,"latlng");S(this,"age",0);S(this,"marker");S(this,"pulse");this.latlng=t,this.marker=new _e,this.marker.beginFill(H.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new _e,this.pulse.beginFill(H.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(t,o){if(this.age+=o/60,this.age>H.lifetime&&this.parent){this.parent.removeChild(this);return}const r=this.age%H.lifetime/H.lifetime,d=nr(r);this.pulse.scale.set(1+d);const a=.4,n=r<a?ir(r/a):1-dr((r-a)/(1-a));this.pulse.alpha=n,r<a?this.marker.alpha=n:this.marker.alpha=1-ar((r-a)/(1-a));const[l,c]=t(this.latlng);this.x=l,this.y=c}};let re=H;S(re,"lifetime",1.5),S(re,"markerColor",306687),S(re,"pulseColor",306687);const yo=()=>{const e=m(b),{initialized:t}=A();return g.exports.useMemo(()=>["notifications",e,t],[e,t])},go=({scene:e,latLngToPixel:t,bounds:o})=>{const r=g.exports.useRef(new Date().toISOString()),d=m(b),{initialized:a}=A(),n=eo(o,50),l=yo();return N(l,()=>ei(d,r.current,Pi,n),{refreshInterval:Mi,isPaused:()=>!a,onSuccess:c=>{if(c.length>0){r.current=c[0][0];for(const[,p,u]of c)e.addChild(new re([u,p]))}}}),{update:g.exports.useCallback(c=>{for(let p=e.children.length-1;p>=0;p--)e.children[p].update(t,c)},[t,e])}},Ui=()=>{const e=m(b),t=po(e,"locations","requests","purchases","notifications","subscriber_segments"),o=N(["notificationsMapTableCounts",e],()=>Pe(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),r=m(qe("SimulatorMatcher")),d=m(qe("SimulatorUpdateSegments")),a=ne(".4~s"),n=o.data?s(Oe,{spacing:2,minChildWidth:"120px",children:[s(w,{children:[i(I,{children:"Offers"}),i(L,{children:a(o.data.offers)})]}),s(w,{children:[i(I,{children:"Cities"}),i(L,{children:a(o.data.cities)})]}),s(w,{children:[i(I,{children:"Subscribers"}),i(L,{children:a(o.data.subscribers)})]}),s(w,{children:[i(I,{children:"Segments"}),i(L,{children:a(o.data.segments)})]}),s(w,{children:[i(I,{children:"Segmentation"}),i(L,{children:$(d)})]}),s(w,{children:[i(I,{children:"Matching"}),i(L,{children:$(r)})]})]}):null;return s(O,{children:[i(T,{children:`
          ...
          about the demo.
        `}),n,s(k,{children:[i(ce,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),i(uo,{data:t,yAxisLabel:"total rows",height:150})]})]})},Bi=()=>{const e=m(Q);return mt(e),ao(e),s(Se,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[i(F,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:i(ke,{useRenderer:go,options:{}})}),s(F,{spacing:4,flex:"1 1 0",minWidth:"0",children:[i(T,{children:`
          ...
          `}),e?i(Ui,{}):i(ro,{})]})]})},fo=o=>{var r=o,{children:e}=r,t=z(r,["children"]);return i(cr,_(h({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},t),{children:e}))},Fi=1e3,Gi=(e,t)=>{const o=m(b),{initialized:r}=A();N(["offers",o,r,e],()=>ti(o,Fi,e),{isPaused:()=>!r,onSuccess:t})},Yi=e=>i(io,_(h({},e),{useCells:Gi,getCellConfig:t=>{const o=$e(4,173,255);return{color:o,hoverColor:o.brighter(1),wktPolygon:t.notificationZone}}})),Hi=e=>e.every(([,t])=>t===0),G=e=>{const{completed:t,title:o,left:r,right:d}=e,{colorMode:a}=Ce(),n=a==="light"?".300":".500",l=t?"gray"+n:void 0,c=(t?"green":"gray")+n;return s(O,{children:[s(Re,{children:[s(we,{as:"h2",size:"lg",mb:4,color:l,children:[i(zt,h({color:c},{boxSize:6,position:"relative",bottom:.5,mr:2})),o]}),r]}),i(Re,{children:d})]})},ji=({connected:e,isVapor:t})=>t?i(G,{completed:e,title:"Connected",left:s(O,{children:[i(T,{children:`
                ...
                the button below.
              `}),i(lo,{size:"xs",colorScheme:"gray"})]}),right:null}):i(G,{completed:e,title:"Connect to SingleStore",left:i(T,{children:`
            ...
            **Note**: The HTTP API may need to be enabled on your SingleStore
            ...
            [1]: https://docs.singlestore.com/docs/http-api/
          `}),right:i(co,{})}),Wi=({onClose:e,schemaObjectName:t})=>{const o=Vr(t),[r]=xt("(max-width: 640px)");return s(ur,{isOpen:!0,onClose:e,size:r?"full":"4xl",scrollBehavior:"inside",children:[i(rt,{}),s(yr,{children:[s(it,{children:["Create statement for ",o.name]}),i(Dt,{}),i(dt,{children:i(fo,{mb:4,children:o.createStmt})})]})]})},Vi=({initialized:e})=>{const[t,o]=P(X),r=Qt(),{colorMode:d}=Ce(),[a,n]=g.exports.useState(),l=g.exports.useCallback(p=>n(p),[]),c=g.exports.useCallback(()=>n(null),[]);return s(O,{children:[!!a&&i(Wi,{onClose:c,schemaObjectName:a}),i(G,{completed:e,title:"Setup the schema",left:s(O,{children:[i(T,{children:`
              ...
              `}),i(sr,{mt:4,mb:6}),s(Ne,{alignItems:"flex-end",children:[s(et,{flex:1,children:[i(tt,{fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Database name"}),i(Lt,{placeholder:"martech",value:t,size:"sm",onChange:p=>o(p.target.value)})]}),i(k,{flex:1,textAlign:"center",children:i(so,{colorScheme:"blue",size:"sm",disabled:e,skipSeedData:!0,children:e?"Schema is setup":"Setup schema"})})]})]}),right:i(Oe,{columns:[1,2,2],gap:1,children:Object.keys(r.data||{}).sort().map(p=>{var u;return i(Re,{bg:((u=r.data)!=null&&u[p]?"green":"gray")+(d==="light"?".200":".600"),color:d==="light"?"gray.800":"gray.100",textOverflow:"ellipsis",whiteSpace:"nowrap",overflow:"hidden",borderRadius:"md",px:2,py:1,textAlign:"center",_hover:{fontWeight:"bold"},cursor:"pointer",onClick:()=>l(p),children:p},p)})})})]})},mo=(e,t,o=!0)=>{var a;const r=N(["pipelineStatus",e,t],()=>Vt(e,t),{isPaused:()=>!o}),d=(a=r.data)!=null&&a.length?r.data.every(n=>!n.needsUpdate):!1;return{pipelines:r,completed:d}},$i=()=>{const e=m(b),t=m(Z),{pipelines:o,completed:r}=mo(e,t);mt(r);const[d,a]=Ae(),n=g.exports.useCallback(async()=>{a.on(),await $t(e,t),o.mutate(),a.off()},[a,e,t,o]),l=["locations","requests","purchases"],c=po(e,...l),p=l.some(y=>c[y].length<2)||l.every(y=>Hi(c[y]));return i(G,{completed:r,title:"Ingest data",left:i(T,{children:`
          ...
          `}),right:p||!r?i(M,{h:220,children:s(R,{colorScheme:"blue",size:"sm",onClick:n,disabled:r,children:[(d||r)&&i(U,{mr:2}),d?"Creating Pipelines":r?"...waiting for data":"Create pipelines"]})}):i(uo,{data:c,yAxisLabel:"total rows",height:200})})},Me=(e,t=!0)=>N(["overviewTableCounts",e],()=>Pe(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!t}),Ki=()=>{var l,c;const e=m(b),t=m(Z),[o,r]=Ae(),d=Me(e),a=g.exports.useCallback(async()=>{r.on(),await st(e,de,t),d.mutate(),r.off()},[e,t,d,r]),n=!!((l=d.data)!=null&&l.offers);return i(G,{completed:n,title:"Offers",left:i(O,{children:s(T,{children:[`
            ...
            `,n&&`
                ...
                database.
            `]})}),right:n?i(Yi,{height:300,defaultZoom:13}):i(M,{h:"100%",children:s(R,{onClick:a,disabled:o,children:[o&&i(U,{mr:2}),o?"loading...":n?"loaded offers!":"load offers"]})})})},qi=({done:e,setDone:t})=>{const o=m(b),r=g.exports.useRef(new Date().toISOString());return g.exports.useEffect(()=>{if(e)return;const d=new AbortController,a=_(h({},o),{ctx:d});return(async()=>{try{for(let n=0;n<10;n++)if(r.current=await ut(a,r.current,!1),await pt(a,"second"),n>1&&!await Kt(a))return}catch(n){if(d.signal.aborted||n instanceof DOMException&&n.name==="AbortError")return;throw n}})().then(()=>t(!0)),()=>{d.abort()}},[o,e,t]),e?null:i(Re,{colSpan:[1,1,2],children:s(M,{w:"100%",h:"200px",color:"gray.500",children:[i(U,{size:"md",mr:4}),i(we,{size:"md",children:"Warming up queries..."})]})})},Ji=()=>{var u;const e=m(b),t=Me(e),{elapsed:o,isRunning:r,startTimer:d,stopTimer:a}=to(),n=g.exports.useRef(new Date().toISOString()),l=!!((u=t.data)!=null&&u.subscriber_segments),c=g.exports.useCallback(async()=>{d(),n.current=await ut(e,n.current),a(),t.mutate()},[e,t,d,a]);let p;if(o&&t.data){const{segments:y,subscriber_segments:f,locations:v,requests:C,purchases:ee}=t.data,Ue=$(o),Be=B(v+C+ee),Fe=B(y),Ge=B(f);p=i(T,{children:`
          The last update evaluated ${Be} rows against ${Fe} segments
          producing ${Ge} segment memberships.
          
          **This process took ${Ue}**.
        `})}return i(G,{completed:l,title:"Segmentation",left:i(T,{children:`
          ...
          `}),right:i(M,{h:"100%",children:s(Mt,{gap:4,textAlign:"center",children:[s(R,{disabled:r,onClick:c,children:[r&&i(U,{mr:2}),r?"...running":"Match subscribers to segments"]}),p]})})})},Xi=()=>{var v;const e=m(b),t=Me(e),o=yo(),{mutate:r}=pr(),{elapsed:d,isRunning:a,startTimer:n,stopTimer:l}=to(),[c,p]=g.exports.useState(0),u=!!((v=t.data)!=null&&v.notifications),y=g.exports.useCallback(async()=>{let C=0,ee=0;for(;C===0&&ee++<10;)n(),C=await pt(e,"second");l(),p(C),t.mutate(),r(o)},[e,n,l,t,r,o]);let f;if(d&&t.data){const{offers:C,subscribers:ee,subscriber_segments:Ue,notifications:Be}=t.data,Fe=B(C*ee+Be),Ge=B(Ue),bo=$(d),ho=B(c);f=i(T,{children:`
          The last update evaluated up to ${Fe} notification opportunities
          against ${Ge} segment memberships generating ${ho}
          notifications. This process took ${bo}.
        `})}return i(G,{completed:u,title:"Matching",left:i(T,{children:`
          ...
          `}),right:i(M,{h:"100%",children:s(Mt,{gap:4,w:"100%",children:[s(R,{disabled:a,onClick:y,children:[a&&i(U,{mr:2}),a?"...running":"Generate notifications"]}),i(k,{width:"100%",children:i(ke,{height:250,defaultZoom:12,useRenderer:go,options:{}})}),f]})})})},Zi=()=>{const e=m(X);return i(G,{completed:!0,title:"Putting it all together",left:i(T,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: map
          `}),right:null})},Qi=()=>{const e=m(b),t=m(Z),{connected:o,initialized:r,isVapor:d}=A(),{completed:a}=mo(e,t,o&&r),{data:n}=Me(e,o&&r),[l,c]=g.exports.useState(!1),p=[{completed:o,component:i(ji,{connected:o,isVapor:d},"connection")},{completed:r,component:i(Vi,{initialized:r},"schema")},{completed:a,component:i($i,{},"pipelines")},{completed:n?n.offers>0:!1,component:i(Ki,{},"offers")},{completed:l,component:i(qi,{done:l,setDone:c},"warmup")},{completed:n?n.subscriber_segments>0:!1,component:i(Ji,{},"segmentation")},{completed:n?n.notifications>0:!1,component:i(Xi,{},"matching")},{completed:!0,component:i(Zi,{},"summary")}];let u=!0;const y=[];for(const{completed:f,component:v}of p)if(u)y.push(v),u=f;else break;return s(K,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(k,{maxW:"container.md",mb:10,px:0,children:i(T,{children:`
          ...
          `})}),i(lr,{columnGap:6,rowGap:10,templateColumns:["minmax(0, 1fr)",null,"repeat(2, minmax(0, 1fr))"],children:y})]})};function ed(){const e=i(M,{height:"100vh",children:i(U,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})});return i(g.exports.Suspense,{fallback:e,children:s(Se,{height:"100vh",direction:"column",children:[i(xi,{}),i(k,{m:4,flex:"1",children:s(gr,{children:[i(te,{path:"/",element:i(Qi,{})}),i(te,{path:"/map",element:i(Bi,{})}),i(te,{path:"/admin",element:i(hi,{})}),i(te,{path:"/analytics",element:i(Oi,{})}),i(te,{path:"*",element:i(fr,{to:"/",replace:!0})})]})})]})})}const td=({children:e})=>{const t=m(ft);return i(vo,{isResettingSchema:t,children:e})};class vo extends ae.Component{constructor(t){super(t);S(this,"state",{});this.handlePromiseRejection=this.handlePromiseRejection.bind(this)}componentDidMount(){window.addEventListener("unhandledrejection",this.handlePromiseRejection)}componentWillUnmount(){window.removeEventListener("unhandledrejection",this.handlePromiseRejection)}handlePromiseRejection(t){this.props.isResettingSchema?console.warn("Ignoring error while resetting schema",t.reason):this.setState({error:t.reason})}componentDidCatch(t){this.props.isResettingSchema?console.warn("Ignoring error while resetting schema",t):this.setState({error:t})}render(){const{error:t}=this.state;if(t){let o;return t instanceof D&&(o=s(O,{children:[i(ce,{textAlign:"center",children:"An error occurred while running the following query:"}),i(fo,{children:W(t.sql)})]})),i(K,{maxW:"container.md",my:10,children:s(F,{gap:4,children:[i(M,{children:i(Pt,{boxSize:20,color:"red"})}),i(we,{size:"xl",textAlign:"center",children:t.message}),o,s(Ne,{justify:"center",gap:4,children:[i(R,{onClick:()=>this.setState({error:void 0}),size:"sm",children:"Dismiss Error"}),i(R,{onClick:()=>window.location.reload(),size:"sm",colorScheme:"blue",leftIcon:i(mr,{}),children:"Reload"})]})]})})}return this.props.children}}const od=vr({fonts:{heading:"InterVariable, sans-serif",body:"InterVariable, sans-serif",mono:'"Source Code ProVariable", monospace'},components:{Link:{baseStyle:e=>({color:e.colorMode==="light"?"blue.600":"blue.300"})}}}),rd=({children:e})=>{const t=m(ft),o=wt();return i(Tr,{value:{onError:d=>{t?console.warn("Ignoring error while resetting schema",d):o({title:"An error occurred",description:d.message,status:"error",duration:5e3,isClosable:!0})}},children:e})};br.render(i(ae.StrictMode,{children:i(hr,{theme:od,children:i(vo,{children:i(Er,{children:i(_r,{basename:"/",children:i(rd,{children:i(td,{children:i(ed,{})})})})})})})}),document.getElementById("root"));
