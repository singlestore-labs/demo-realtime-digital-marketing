...
`+K(this.baseQuery.sql()),t}params(){return[...this.fragments.flatMap(([,o])=>o.params()),...this.baseQuery.params()]}}class Sr{constructor(t,o,i=!1){E(this,"tuples",[]);this.table=t,this.columns=o,this.replace=i}append(...t){if(t.length!==this.columns.length)throw new Error(`Expected ${this.columns.length} values, got ${t.length}`);this.tuples.push(t)}clear(){this.tuples=[]}sql(){const t=`(${this.columns.map(()=>"?").join(",")})`,o=this.tuples.map(()=>t).join(",");return K`
    ...
    `,t.id,t.name,`POINT(${t.lonlat[0]} ${t.lonlat[1]})`,t.diameter),Cr=(e,t)=>h(e,"DELETE FROM cities WHERE city_id = ?",t),Ir=["olc_8","purchase","request"],wr=["minute","hour","day","week","month"],Yt=({interval:e,kind:t,value:o})=>So(`${e}-${t}-${o}`),Lr=async(e,t)=>{const o=new Ft("segments",["segment_id","valid_interval","filter_kind","filter_value"]);for(const i of t)o.append(Yt(i),i.interval,i.kind,i.value);await h(e,o.sql(),...o.params())},kr=async(e,t)=>{const o=new Ft("offers",["customer","notification_zone","segment_ids","notification_content","notification_target","maximum_bid_cents"]);let i=0,d=[];const a=async()=>{await Promise.all([h(e,o.sql(),...o.params()),Lr(e,d)]),o.clear(),d=[],i=0};for(const n of t)o.append(n.customer,n.notificationZone,JSON.stringify(n.segments.map(Yt)),n.notificationContent,n.notificationTarget,n.maximumBidCents),i++,d=d.concat(n.segments),i>=Or&&await a();i>0&&await a()},xr=()=>ct(Ir),Dr=()=>ct(wr),Ht=({vendor:e,tld:t})=>`${e.toLowerCase()}.${t}`,Wt=e=>{const[t,o]=e.lonlat,i=e.diameter/2,[d,a]=[t-i,t+i],[n,s]=[o-i,o+i];return[Ve(d,a),Ve(n,s)]},zr=(e,t)=>{const o=xr(),i=Dr();switch(o){case"olc_8":{const[d,a]=Wt(e),n=je.encode(a,d,8).substring(0,8);return{kind:o,interval:i,value:n}}case"purchase":return{kind:o,interval:i,value:t.vendor};case"request":return{kind:o,interval:i,value:Ht(t)}}},Pr=e=>{const t=ve(1,3),o=Ar(),i=Array.from({length:t},()=>zr(e,o)),d=Ht(o),n=`${ve(10,50)}% off at ${o.vendor}`,s=d,[c,p]=Wt(e),u=je.encode(p,c,ct([8,10])),y=je.decode(u),m={ne:[y.latitudeHi,y.longitudeHi],sw:[y.latitudeLo,y.longitudeLo]};return{customer:o.vendor,segments:i,notificationZone:we(m),notificationContent:n,notificationTarget:s,maximumBidCents:ve(2,15)}},Mr=(e,t)=>Array.from({length:t},()=>Pr(e)),Ur=e=>(t,o,i,d=1)=>`https://stamen-tiles.a.ssl.fastly.net/${e}/${i}/${t}/${o}${d>=2?"@2x":""}.png`,Br=l(A,{children:["Map tiles by ",r(W,{href:"http://stamen.com",children:"Stamen Design"}),", under"," ",r(W,{href:"http://creativecommons.org/licenses/by/3.0",children:"CC BY 3.0"}),". Data by ",r(W,{href:"http://openstreetmap.org",children:"OpenStreetMap"}),", under"," ",r(W,{href:"http://www.openstreetmap.org/copyright",children:"ODbL"}),"."]}),Fr=[de.lonlat[1],de.lonlat[0]],Gr=12,Yr=({width:e,height:t,bounds:o,latLngToPixel:i,pixelToLatLng:d,useRenderer:a,options:n})=>{const s=ae.useRef(null),c=Rt(()=>new J),{setup:p,update:u}=a({scene:c,width:e,height:t,bounds:o,latLngToPixel:i,pixelToLatLng:d,options:n});return g.exports.useLayoutEffect(()=>{if(!s.current)throw new Error("No canvas ref");console.log("PixiMapLayer: Setup");const y=new Ro({view:s.current,width:e,height:t,backgroundAlpha:0,antialias:!0});return y.stage.addChild(c),p==null||p(),u&&y.ticker.add(m=>{u(m)}),()=>{console.log("PixiMapLayer: Destroy"),y.stage.removeChild(c),y.destroy(!1,{children:!1,texture:!0,baseTexture:!0})}},[t,c,p,u,e]),r("canvas",{ref:s})},Hr=({mapState:e,latLngToPixel:t,pixelToLatLng:o,useRenderer:i,options:d})=>{const{width:a,height:n,bounds:s}=e||{width:0,height:0};return a<=0||n<=0||!t||!o||!s?null:r(Yr,{useRenderer:i,width:a,height:n,bounds:s,latLngToPixel:t,pixelToLatLng:o,options:d})},Le=n=>{var s=n,{height:e="100%",defaultCenter:t=Fr,defaultZoom:o=Gr,useRenderer:i,options:d}=s,a=k(s,["height","defaultCenter","defaultZoom","useRenderer","options"]);const[c,p]=g.exports.useState(t),[u,y]=g.exports.useState(o);return r(L,T(b({borderRadius:"lg",overflow:"hidden",height:e},a),{children:r(No,{dprs:[1,2],provider:Ur("toner-lite"),attribution:Br,maxZoom:20,center:c,zoom:u,onBoundsChanged:({center:m,zoom:_})=>{p(m),y(_)},children:r(Hr,{useRenderer:i,options:d})})}))};var ke=[{name:"date_sub_dynamic",createStmt:`CREATE OR REPLACE FUNCTION date_sub_dynamic (
  _dt DATETIME(6),
...
END`}],De=[{name:"worldcities",createStmt:`create rowstore table if not exists worldcities (
  ...
  UNION
  SELECT * FROM dynamic_subscriber_segments_purchases(_since, _until)
);`}];const he="singlestore-realtime-digital-marketing",Wr=[`CREATE LINK aws_s3 AS S3 CREDENTIALS '{}' CONFIG '{ "region": "us-east-1" }'`,`
    CREATE OR REPLACE PIPELINE worldcities
    AS LOAD DATA LINK aws_s3 '${he}/cities.ndjson'
  ...
  `,"START PIPELINE worldcities FOREGROUND"],jr=e=>{const t=De.find(d=>d.name===e);if(t)return t;const o=xe.find(d=>d.name===e);if(o)return o;const i=ke.find(d=>d.name===e);if(i)return i;throw new Error("Could not find schema object: "+e)},Vr=async e=>{try{return await at(e,"SELECT 1"),!0}catch{return!1}},$r=async e=>{let t={tables:[],procedures:[],functions:[]};const s=e,{database:o}=s,i=k(s,["database"]);try{t=(await dt(i,`
        ...
        `,o,o)).reduce((c,[p,u])=>(c[p].push(u),c),t)}catch(c){if(!(c instanceof x&&(c.isUnknownDatabase()||c.isDatabaseRecovering())))throw c}const{tables:d,procedures:a,functions:n}=t;return Object.fromEntries([De.map(({name:c})=>[c,d.includes(c)]),xe.map(({name:c})=>[c,a.includes(c)]),ke.map(({name:c})=>[c,n.includes(c)])].flat())},jt=e=>at(e,"DROP DATABASE IF EXISTS `"+e.database+"`"),Kr=async(e,{progress:t,scaleFactor:o,includeSeedData:i,skipCreate:d=!1})=>{d||(t("Dropping existing schema","info"),await jt(e),t("Creating database","info"),await at(e,"CREATE DATABASE `"+e.database+"`"));for(const a of ke)t(`Creating function: ${a.name}`,"info"),await h(e,a.createStmt);for(const a of De)t(`Creating table: ${a.name}`,"info"),await h(e,a.createStmt);for(const a of xe)t(`Creating procedure: ${a.name}`,"info"),await h(e,a.createStmt);await Jr(e),await Gt(e,de),i&&(t("Creating sample data","info"),await lt(e,de,o)),t("Schema initialized","success")},Jr=async e=>{for(const t of Wr)await h(e,t)},lt=(e,t,o)=>{const i=100*o.partitions,d=Mr(t,i);return kr(e,d)},Vt=async(e,t)=>{const o=t.prefix;return await U(e,`
      SELECT
    ...
    `,e.database)},$t=async(e,t)=>{const o=t.prefix,i=await Vt(e,t);await Promise.all(i.filter(d=>d.needsUpdate).map(async d=>{console.log(`recreating pipeline ${d.pipelineName} for city ${d.cityName}`),d.pipelineName.startsWith("locations_")?await h(e,`
            CREATE OR REPLACE PIPELINE ${d.pipelineName}
            AS LOAD DATA LINK aws_s3 '${he}/${o}/locations.*'
          ...
          `,d.cityId,d.lon,d.diameter,d.lat,d.diameter):d.pipelineName.startsWith("requests_")?await h(e,`
            CREATE OR REPLACE PIPELINE ${d.pipelineName}
            AS LOAD DATA LINK aws_s3 '${he}/${o}/requests.*'
            MAX_PARTITIONS_PER_BATCH ${t.partitions}
            ...
            SET ts = NOW(),
              city_id = ?;
          `,d.cityId):d.pipelineName.startsWith("purchases_")&&await h(e,`
            CREATE OR REPLACE PIPELINE ${d.pipelineName}
            AS LOAD DATA LINK aws_s3 '${he}/${o}/purchases.*'
            MAX_PARTITIONS_PER_BATCH ${t.partitions}
            ...
            SET ts = NOW(),
              city_id = ?;
          `,d.cityId),await h(e,`ALTER PIPELINE ${d.pipelineName} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await h(e,`START PIPELINE IF NOT RUNNING ${d.pipelineName}`),console.log(`finished creating pipeline ${d.pipelineName} for city ${d.cityName}`)}))},qr=async e=>{const t=await dt(e,`
      SELECT
    ...
    `,e.database);await Promise.all(t.map(async([o])=>{console.log("restarting pipeline",o),await h(e,`ALTER PIPELINE ${o} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await h(e,`START PIPELINE IF NOT RUNNING ${o}`)}))},Xr=async e=>{const t=await U(e,`
    ...
    `,e.database);await Promise.all(t.map(o=>(console.log("dropping pipeline",o.pipelineName),h(e,`DROP PIPELINE ${o.pipelineName}`))))},Kt=async e=>{const t=await U(e,`
      SELECT plan_id AS planId
      FROM information_schema.plancache
      WHERE
        plan_warnings LIKE "%empty tables%"
    `);return await Promise.all(t.map(({planId:o})=>h(e,`DROP ${o} FROM PLANCACHE`))),t.length>0},Zr=(e,...t)=>{const o=t.map(i=>`"${i}"`).join(",");return Ut(e,`
      ...
      GROUP BY tableName
    `,e.database)},ze=(e,...t)=>Zr(e,...t).then(o=>o.reduce((i,{tableName:d,count:a})=>(i[d]=a,i),{})),Qr=async(e,t)=>{const{maxRows:o}=t,d=["locations","requests","purchases","notifications"].map(n=>`"${n}"`).join(","),a=await Ut(e,`
      SELECT
      ...
      WHERE
        ...
        AND stats.count > ?
    `,e.database,o);await Promise.all(a.map(async({tableName:n,count:s,minTs:c,maxTs:p})=>{const y=(s-o)/s;if(y<.2)return;const m=new Date((c+y*(p-c))*1e3);console.log(`removing rows from ${n} older than ${m.toISOString()}`),await h(e,`DELETE FROM ${n} WHERE ts <= ?`,m.toISOString())}))},st=(e,t="minute")=>it(e,"ECHO run_matching_process(?)",t).then(o=>o.RESULT),pt=async(e,t)=>{const o=new Date().toISOString();return await Promise.all(["update_location_segments","update_request_segments","update_purchase_segments"].map(i=>h(e,`CALL ${i}(?, ?)`,t,o))),await h(e,"CALL prune_segments(?)",o),o},ei=(e,t,o,i)=>dt(e,`
      SELECT
        ts,
...
`,ii=(e,t,o,i)=>U(e,new nt(`
      ...
      ORDER BY ${o} DESC
      LIMIT ${i}
    `).with("metrics",ut(t)).sql()),Nt=(e,t)=>it(e,new nt(`
      SELECT
        *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
      FROM (
        SELECT
    ...
    `).with("metrics",ut(t)).sql()),di=(e,t,o)=>{const i=new nt(new Bt(`
          SELECT
            *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
          FROM (
            SELECT
        ...
        `,[we(t)])).with("metrics",ut(o));return U(e,i.sql(),...i.params())},j=[{name:"s00",maxRows:1e7,prefix:"v2/100k-2p",partitions:2},{name:"s0",maxRows:2e7,prefix:"v2/100k-4p",partitions:4},{name:"s1",maxRows:4e7,prefix:"v2/100k-8p",partitions:8},{name:"s2",maxRows:16e7,prefix:"v2/1m-16p",partitions:16},{name:"s4",maxRows:32e7,prefix:"v2/1m-32p",partitions:16},{name:"s8",maxRows:64e7,prefix:"v2/1m-64p",partitions:64},{name:"s10",maxRows:1e9,prefix:"v2/10m-80p",partitions:80}],ai=e=>j.find(t=>t.name===e)||j[0],q=({encode:e,decode:t}={encode:JSON.stringify,decode:JSON.parse})=>({setSelf:o,onSet:i,node:d})=>{const a=`recoil.localstorage.${d.key}`,n=localStorage.getItem(a);n!=null&&o(t(n)),i((s,c,p)=>{p?localStorage.removeItem(a):localStorage.setItem(a,e(s))})},yt=()=>({setSelf:e,node:{key:t}})=>{const{location:o}=window;if(o){const i=new URLSearchParams(o.search);e(i.get(t))}},ni=D({key:"skipCreateDatabase",default:null,effects:[yt()]}),ci=D({key:"sessionId",default:null,effects:[yt()]}),li=D({key:"vaporBaseUrl",default:"https://vapor.labs.singlestore.com",effects:[yt()]}),Jt=D({key:"connectionHost",default:"http://127.0.0.1",effects:[q()]}),qt=D({key:"connectionUser",default:"root",effects:[q()]}),Xt=D({key:"connectionPassword",default:"",effects:[q()]}),X=D({key:"connectionDatabase",default:"martech",effects:[q()]}),Zt=At({key:"vaporConnectionConfig",get:async({get:e})=>{const t=e(ci),o=e(li);if(t)try{const i=await fetch(o+"/api/v1/vapor/connect?sessionId="+t);if(i.status===200){const d=await i.json();return{host:d.endpoint,user:d.user,password:d.password,database:e(X)}}}catch{console.log(`Failed to connect to vapor at ${o}, falling back to local config`)}}}),v=At({key:"connectionConfig",get:({get:e})=>{const t=e(Zt);if(t)return t;const o=e(Jt),i=e(qt),d=e(Xt),a=e(X);return{host:o,user:i,password:d,database:a}},cachePolicy_UNSTABLE:{eviction:"most-recent"}}),Z=D({key:"configScaleFactor",default:j[0],effects:[q({encode:e=>e.name,decode:e=>j.find(t=>t.name===e)||j[0]})]}),Q=D({key:"simulatorEnabled",default:!0,effects:[q()]}),si=D({key:"databaseDrawerIsOpen",default:!1}),$e=Ao({key:"tickDurationMs",default:void 0}),pi=Object.fromEntries([De.map(({name:e})=>[e,!1]),xe.map(({name:e})=>[e,!1]),ke.map(({name:e})=>[e,!1])].flat()),Qt=(e=!1)=>{const t=f(v);return N(["schemaObjects",t,e],()=>$r(t),{isPaused:()=>e,refreshInterval:o=>Object.values(o||[]).some(d=>!d)?1e3:0,fallbackData:pi})},O=()=>{const a=f(v),{database:e}=a,t=k(a,["database"]),o=f(Zt),i=N(["isConnected",t],()=>Vr(t)),d=Qt(!i.data);return{isVapor:!!o,connected:!!i.data,initialized:!!i.data&&Object.values(d.data||[]).every(Boolean),reset:()=>{i.mutate(),d.mutate()}}},ui=(()=>{let e={};return t=>(t in e||(e[t]=1),`${t}(${e[t]++})`)})(),Ke=(e,{name:t,enabled:o,intervalMS:i})=>{const d=Ot($e(t));g.exports.useEffect(()=>{if(!o)return;const a=new AbortController,n=ui(t);console.log(`Starting ${n}: tick interval: ${i}ms`);const s=async()=>{try{if(console.time(n),a.signal.aborted)return;const c=performance.now();await e(a);const p=performance.now()-c;d(p),setTimeout(s,Math.max(0,i-p))}catch(c){if(a.signal.aborted||c instanceof x&&c.isUnknownDatabase()||c instanceof DOMException&&c.name==="AbortError")return;throw c}finally{console.timeEnd(n)}};return s(),()=>{console.log(`Stopping ${n}`),a.abort()}},[o,e,i,t,d])},yi=({before:e,after:t,includeSeedData:o})=>{const i=f(v),d=f(Z),{reset:a}=O(),[n,s]=z(Q),c=Ct(),p=f(ni);return g.exports.useCallback(async()=>{const u=n;s(!1),e(),await Kr(i,{progress(y,m){const _="reset-schema";c.isActive(_)?c.update(_,{title:y,status:m,duration:m==="success"?2e3:null,isClosable:!0}):c({id:_,title:y,status:m,duration:null})},scaleFactor:d,includeSeedData:o,skipCreate:!!p}),t(),a(),s(u)},[n,s,e,i,d,o,p,t,a,c])},eo=(e,t)=>{const[o,i]=g.exports.useState(e);return g.exports.useEffect(()=>{const d=setTimeout(()=>i(e),t);return()=>clearTimeout(d)},[e,t]),o},to=()=>{const[{elapsed:e,isRunning:t},o]=g.exports.useReducer((i,d)=>{switch(d.type){case"start":return{start:Math.floor(performance.now()),isRunning:!0,elapsed:i.elapsed};case"stop":return{elapsed:Math.floor(performance.now())-(i.start||0),isRunning:!1}}},{isRunning:!1});return{elapsed:e,isRunning:t,startTimer:()=>o({type:"start"}),stopTimer:()=>o({type:"stop"})}},oo=(e,t)=>{let o=!1,i=new Oo(0,0),d=0;e.on("pointerdown",a=>{o=!0,i=a.data.global,d=performance.now()}),e.on("pointerup",a=>{if(!o||(o=!1,performance.now()-d>200))return;const s=a.data.global;Math.sqrt(Math.pow(s.x-i.x,2)+Math.pow(s.y-i.y,2))>10||t(a)}),e.on("pointercancel",()=>{o=!1})};class gi extends J{constructor(t,o){super();E(this,"gfx");E(this,"hover",!1);this.city=t,this.onRemove=o,this.gfx=new _e,this.addChild(this.gfx),this.gfx.interactive=!0,this.gfx.on("pointerover",()=>{this.hover=!0}),this.gfx.on("pointerout",()=>{this.hover=!1}),oo(this.gfx,()=>o(this.city))}update(t){this.gfx.clear(),this.gfx.lineStyle(1,this.hover?16711680:306687,1),this.gfx.beginFill(this.hover?16711680:306687,.2);const[o,i]=t([this.city.centerLat,this.city.centerLon]);this.gfx.drawCircle(o,i,25),this.gfx.endFill()}}const fi=e=>{const t=f(v),{initialized:o}=O();return N(["cities",t,o],()=>oi(t),{isPaused:()=>!o,onSuccess:e})},mi=({scene:e,latLngToPixel:t,pixelToLatLng:o,width:i,height:d})=>{const a=f(v),n=Rt(()=>new J),{mutate:s}=fi(u=>{n.removeChildren();for(let y=0;y<u.length;y++)n.addChild(new gi(u[y],p))}),c=g.exports.useCallback(async(u,y)=>{const m=await ri(a,y,u),_={id:m.id,name:m.name,lonlat:[m.centerLon,m.centerLat],diameter:m.diameter};await Gt(a,_),await lt(a,_,j[0]),s()},[a,s]),p=g.exports.useCallback(async u=>{await Cr(a,u.id),s()},[a,s]);return{setup:g.exports.useCallback(()=>{const u=new J;e.addChild(u),e.addChild(n),u.interactive=!0,u.hitArea=new Co(0,0,i,d),oo(u,y=>{const[m,_]=o([y.data.global.x,y.data.global.y]);c(m,_)})},[n,d,c,o,e,i]),update:g.exports.useCallback(()=>{for(let u=0;u<n.children.length;u++)n.children[u].update(t)},[n,t])}},vi=e=>r(Le,T(b({},e),{useRenderer:mi,options:{},cursor:"pointer"})),hi=Io({a:o=>{var i=o,{children:e}=i,t=k(i,["children"]);const{href:d}=t,a=!!(d!=null&&d.startsWith("http"));return a?l(W,T(b({isExternal:a},t),{children:[e,r(wo,{bottom:"2px",boxSize:"0.9em",position:"relative",ml:1})]})):r(W,T(b({to:d||""},t),{as:It,children:e}))}}),S=o=>{var i=o,{children:e}=i,t=k(i,["children"]);return r(Lo,T(b({},t),{skipHtml:!0,components:hi,children:Array.isArray(e)?e.filter(d=>d).map(d=>K(d||"")).join(`

`):K(e)}))},bi=()=>l($,{maxW:"container.lg",mt:10,mb:"30vh",children:[r($,{maxW:"container.md",mb:10,children:r(S,{children:`
            ## Admin

            You can configure cities and offers on this page. To learn more
            about this application please visit the [Overview page](/).
          `})}),r(Ei,{})]}),Ei=()=>l(A,{children:[r($,{maxW:"container.md",mb:4,children:r(S,{children:`
            #### Cities
            ...
            remove it.
          `})}),r(vi,{defaultZoom:4,defaultCenter:[39.716470511656766,-99.59395661915288],height:300})]}),ro=()=>{const e=Ot(Q);return l(ge,{status:"warning",borderRadius:"md",children:[r(fe,{}),r(me,{children:"The simulator is disabled"}),r(R,{position:"absolute",right:4,top:3,size:"xs",colorScheme:"blue",onClick:()=>e(!0),children:"Enable simulator"})]})};class _i extends J{constructor(t,o){super();E(this,"points");E(this,"polygon");this.color=o,this.points=Rr(t),this.polygon=new _e,this.addChild(this.polygon),this.polygon.interactive=!0,this.polygon.on("mouseover",()=>{this.polygon.tint=65280}),this.polygon.on("mouseout",()=>{this.polygon.tint=16777215})}update(t){this.polygon.clear(),this.polygon.lineStyle(1,this.color,1),this.polygon.beginFill(this.color,.2),this.polygon.drawPolygon(this.points.flatMap(([o,i])=>t([i,o]))),this.polygon.endFill()}}const Ti=e=>({scene:t,latLngToPixel:o,bounds:i})=>{const d=eo(i,100);return e.useCells(d,a=>{t.removeChildren();for(const n of a)t.addChild(new _i(e.getCellWKTPolygon(n),e.getCellColor(n)))}),{update:g.exports.useCallback(()=>{for(let a=0;a<t.children.length;a++)t.children[a].update(o)},[o,t])}},io=e=>{const n=e,{useCells:t,getCellColor:o,getCellWKTPolygon:i}=n,d=k(n,["useCells","getCellColor","getCellWKTPolygon"]),a=g.exports.useMemo(()=>Ti({useCells:t,getCellColor:o,getCellWKTPolygon:i}),[o,i,t]);return r(Le,T(b({},d),{useRenderer:a,options:{}}))},Si=10*1e3,gt=e=>{const t=f(v),o=f(Z),{initialized:i}=O(),d=g.exports.useCallback(a=>{const n=T(b({},t),{ctx:a});return Promise.all([$t(n,o),qr(n),Xr(n),Qr(n,o),Kt(n)])},[t,o]);Ke(d,{name:"SimulatorMonitor",enabled:i&&e,intervalMS:Si})},Ni=1*1e3,Ri=10*1e3,ao=e=>{const t=f(v),{initialized:o}=O(),i=g.exports.useRef(new Date(0).toISOString()),d=g.exports.useCallback(n=>st(T(b({},t),{ctx:n}),"minute"),[t]);Ke(d,{name:"SimulatorMatcher",enabled:o&&e,intervalMS:Ni});const a=g.exports.useCallback(async n=>{i.current=await pt(T(b({},t),{ctx:n}),i.current)},[t]);Ke(a,{name:"SimulatorUpdateSegments",enabled:o&&e,intervalMS:Ri})},Je=ne(",.2%"),ie=ne(".4~s"),Ai=()=>{const{initialized:e}=O(),t=f(Q);return gt(t),ao(t),r($,{maxW:"container.lg",mt:10,mb:"30vh",children:e?t?l(F,{gap:10,children:[r(Oi,{}),r(Ci,{}),r(ki,{})]}):r(ro,{}):r(no,{})})},no=()=>r(P,{children:r(M,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})}),Oi=()=>{var d,a;const e=f(v),t=N(["overallConversionRateRequests",e],()=>Nt(e,"requests"),{refreshInterval:1e3}),o=N(["overallConversionRatePurchases",e],()=>Nt(e,"purchases"),{refreshInterval:1e3}),i=N(["analyticsTableCounts",e],()=>ze(e,"offers","subscribers","notifications"),{refreshInterval:1e3});return!i.data||!t.data||!o.data?r(no,{}):l(Xe,{spacing:2,minChildWidth:"150px",flex:2,children:[l(C,{children:[r(I,{children:"Offers"}),r(w,{children:ie(i.data.offers)})]}),l(C,{children:[r(I,{children:"Subscribers"}),r(w,{children:ie(i.data.subscribers)})]}),l(C,{children:[r(I,{children:"Notifications"}),r(w,{children:ie(i.data.notifications)})]}),l(C,{children:[r(I,{children:"Conversion Rate"}),r(w,{children:Je(((d=t.data)==null?void 0:d.conversionRate)||0)}),r(vt,{children:"Requests"})]}),l(C,{children:[r(I,{children:"Conversion Rate"}),r(w,{children:Je(((a=o.data)==null?void 0:a.conversionRate)||0)}),r(vt,{children:"Purchases"})]})]})},Ci=()=>{var a;const e=f(v),[t,o]=g.exports.useState("conversionRate"),i=N(["customerMetrics",e,t],()=>ii(e,"purchases",t,10),{refreshInterval:1e3}),d=Te("blue.500","blue.200");return r(L,{overflowX:"auto",children:l(ko,{size:"sm",colorScheme:"gray",variant:"striped",children:[r(xo,{children:l(ht,{children:[l(se,{onClick:()=>o("customer"),_hover:{color:d},color:t==="customer"?d:void 0,cursor:"pointer",children:["Customer",t==="customer"&&r(oe,{})]}),l(se,{onClick:()=>o("totalNotifications"),_hover:{color:d},color:t==="totalNotifications"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Notifications",t==="totalNotifications"&&r(oe,{})]}),l(se,{onClick:()=>o("totalConversions"),_hover:{color:d},color:t==="totalConversions"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Conversions",t==="totalConversions"&&r(oe,{})]}),l(se,{onClick:()=>o("conversionRate"),_hover:{color:d},color:t==="conversionRate"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Conversion Rate",t==="conversionRate"&&r(oe,{})]})]})}),r(Do,{children:(a=i.data)==null?void 0:a.map(n=>l(ht,{children:[r(pe,{children:n.customer}),r(pe,{isNumeric:!0,children:ie(n.totalNotifications)}),r(pe,{isNumeric:!0,children:ie(n.totalConversions)}),r(pe,{isNumeric:!0,children:Je(n.conversionRate)})]},n.customer))})]})})},Ii=(e,t)=>{const o=f(v);N(["zoneMetrics",o,e],()=>di(o,e,"purchases"),{refreshInterval:1e3,onSuccess:t})},wi=({r:e,g:t,b:o})=>e<<16|t<<8|o,Li=e=>wi(bt(zo(.3+e))||bt(0,0,0)),ki=()=>l(F,{direction:["column","row"],alignItems:"top",children:[r(L,{flex:1,children:r(S,{children:`
            ### Conversion Map
          ...
          `})}),r(L,{flex:2,children:r(io,{height:400,defaultZoom:14,useCells:Ii,getCellColor:e=>Li(e.conversionRate),getCellWKTPolygon:e=>e.wktPolygon})})]}),ue=({label:e,placeholder:t,value:o,setValue:i,helpText:d,type:a="text"})=>l(Ze,{children:[r(Qe,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),r(wt,{size:"sm",placeholder:t,value:o,onChange:n=>i(n.target.value),type:a}),d?r(Po,{fontSize:"xs",children:d}):null]}),xi=()=>{const[e,t]=z(Z);return l(Ze,{children:[r(Qe,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),r(Mo,{size:"sm",required:!0,value:e.name,onChange:o=>{const i=o.target.value;t(ai(i))},children:j.map(o=>r("option",{value:o.name,children:o.name},o.name))})]})},co=({showDatabase:e,showScaleFactor:t})=>{const[o,i]=z(Jt),[d,a]=z(qt),[n,s]=z(Xt),[c,p]=z(X);return l(F,{spacing:4,children:[r(ue,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:o,setValue:i,helpText:r(S,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [HTTP API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),l(Xe,{columns:2,gap:2,children:[r(ue,{label:"Username",placeholder:"admin",value:d,setValue:a}),r(ue,{label:"Password",placeholder:"",value:n,setValue:s,type:"password"}),e&&r(ue,{label:"Database",placeholder:"martech",value:c,setValue:p}),t&&r(xi,{})]})]})},lo=e=>r(R,T(b({onClick:()=>{const{pathname:t,hash:o}=window.location;window.location.replace(t+o)},colorScheme:"red"},e),{children:"Disconnect"})),so=e=>{const{connected:t,initialized:o}=O(),i=et(),[d,a]=Ae(),n=f(X),s=ae.useRef(null),m=e,{skipSeedData:c,disabled:p}=m,u=k(m,["skipSeedData","disabled"]),y=yi({before:g.exports.useCallback(()=>a.on(),[a]),after:g.exports.useCallback(()=>{a.off(),i.onClose()},[i,a]),includeSeedData:!c});return l(A,{children:[r(R,b({disabled:!t||p,onClick:i.onOpen,colorScheme:o?"green":"red"},u)),r(Uo,{isOpen:i.isOpen,onClose:i.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:s,children:r(tt,{children:l(Bo,{children:[l(ot,{fontSize:"lg",fontWeight:"bold",children:[o?"Reset":"Setup"," database ",n]}),l(rt,{children:["This will ",o?"recreate":"create"," the database called ",n,". Are you sure?"]}),l(Lt,{children:[r(R,{ref:s,onClick:i.onClose,disabled:d,children:"Cancel"}),r(R,{disabled:d,colorScheme:o?"red":"green",onClick:y,ml:3,children:d?r(M,{}):o?"Recreate database":"Create database"})]})]})})})]})},Di=({isOpen:e,onClose:t,finalFocusRef:o})=>{const[i,d]=z(Q),a=f(v),{connected:n,initialized:s,isVapor:c}=O(),p=et(),[u,y]=Ae(!1),m=g.exports.useCallback(async()=>{y.on(),await jt(a),y.off()},[a,y]);return l(Fo,{isOpen:e,placement:"right",onClose:t,finalFocusRef:o,children:[r(tt,{}),l(Go,{children:[r(kt,{}),r(ot,{children:"Config"}),r(rt,{children:l(F,{spacing:4,children:[c?null:r(co,{showScaleFactor:!0,showDatabase:!0}),l(ge,{status:n?"success":"error",borderRadius:"md",children:[r(fe,{}),r(me,{children:n?"connected":"disconnected"}),c?r(lo,{position:"absolute",right:4,top:3,size:"xs"}):null]}),l(ge,{status:s?"success":"warning",borderRadius:"md",children:[r(fe,{}),r(me,{children:"schema"}),r(so,{position:"absolute",right:4,top:3,size:"xs",children:s?"Reset":"Setup"})]}),l(ge,{status:i?"success":"warning",borderRadius:"md",children:[r(fe,{}),r(me,{children:"simulator"}),r(Yo,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:i?"green":"red",isChecked:i,disabled:!n||!s,onChange:()=>d(!i)})]}),l(ce,{onClick:p.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",p.isOpen?r(Ho,{ml:2}):r(oe,{ml:2})]}),p.isOpen?r(R,{size:"xs",_hover:{colorScheme:"red"},onClick:m,disabled:u,children:"Drop Database"}):void 0]})}),r(Lt,{})]})]})},ye=({to:e,children:t,onClick:o})=>{const i=qo(e),d=Xo({path:i.pathname,end:!0});return r(W,{as:It,to:e,px:2,py:1,onClick:o,rounded:"md",_hover:{textDecoration:"none",bg:Te("gray.300","gray.600")},fontWeight:d?"bold":"normal",href:"#",color:Te("gray.700","gray.200"),children:t})},zi=()=>{const{colorMode:e,toggleColorMode:t}=Oe(),o=et(),[i,d]=z(si),a=ae.useRef(null),{connected:n,initialized:s}=O(),c=f(Q),[p]=xt("(max-width: 640px)"),u=l(A,{children:[r(ye,{to:"/",onClick:o.onClose,children:"Overview"}),r(ye,{to:"/map",onClick:o.onClose,children:"Map"}),r(ye,{to:"/admin",onClick:o.onClose,children:"Admin"}),r(ye,{to:"/analytics",onClick:o.onClose,children:"Analytics"})]});let y;return p||(y=n?s?c?"connected":"simulator disabled":"needs schema":"disconnected"),r(A,{children:r(L,{bg:Te("gray.200","gray.700"),children:l($,{maxW:"container.lg",children:[l(Se,{h:16,alignItems:"center",justifyContent:"space-between",children:[r(Ye,{size:"md",icon:o.isOpen?r(Wo,{}):r(jo,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:o.isOpen?o.onClose:o.onOpen}),l(Ne,{spacing:8,alignItems:"center",children:[r(Ce,{as:"h1",size:p?"sm":"md",children:p?"Martech":"Realtime Digital Marketing"}),r(Ne,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:u})]}),l(Se,{alignItems:"center",gap:2,children:[l(R,{size:"sm",ref:a,onClick:()=>d(!0),colorScheme:n?s&&c?"green":"yellow":"red",children:[s?r(Dt,{}):r(zt,{}),p||r(ce,{pl:2,children:y})]}),r(Ye,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?r(Vo,{size:"1.4em"}):r($o,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),r(Ye,{"aria-label":"Toggle Color Mode",size:"sm",onClick:t,icon:e==="light"?r(Ko,{boxSize:"1.2em"}):r(Jo,{boxSize:"1.2em"})})]})]}),o.isOpen?r(L,{pb:4,display:{md:"none"},children:r(F,{as:"nav",spacing:4,children:u})}):null,r(Di,{isOpen:i,onClose:()=>d(!1),finalFocusRef:a})]})})})},Pi=e=>{const t=g.exports.useRef([]),{data:o}=N(["timeseries",e.name,...e.deps||[]],async()=>{const i=await e.fetcher();return t.current.push({data:i,ts:new Date}),t.current=t.current.slice(-e.limit),t.current},{refreshInterval:e.intervalMS});return o||[]},Mi=ne("~s"),po=(e,...t)=>Pi({name:"estimatedRowCount",deps:t,fetcher:g.exports.useCallback(()=>ze(e,...t),[e,t]),limit:30,intervalMS:1e3}),uo=o=>{var i=o,{data:e}=i,t=k(i,["data"]);const{colorMode:d}=Oe(),a=g.exports.useCallback(({tooltipData:c,colorScale:p})=>!p||!c?null:Object.keys(c.datumByKey).sort((u,y)=>c.datumByKey[y].datum.data[y]-c.datumByKey[u].datum.data[u]).map(u=>{const{datum:y}=c.datumByKey[u],m=y.data[u];return l(ce,{mb:1,color:p(u),fontSize:"sm",children:[u,": ",ne(".4~s")(m)]},u)}),[]),n=g.exports.useCallback(c=>Mi(c).replace("G","B"),[]);if(e.length<2)return r(P,{height:t.height,children:r(M,{size:"md"})});const s=e.length>0?Object.keys(e[0].data).filter(c=>c!=="ts").map(c=>r(Zo,{dataKey:c,data:e,xAccessor:p=>p==null?void 0:p.ts,yAccessor:p=>p==null?void 0:p.data[c]},c)):null;return l(Qo,T(b({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:d==="light"?er:tr,margin:{left:0,right:50,top:10,bottom:40}},t),{children:[r(Et,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),r(Et,{orientation:"right",numTicks:t.height<250?3:5,tickFormat:n,label:"rows",labelOffset:20}),s,r(or,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:a})]}))},qe=1e3,be=60*qe,Ee=60*be,We=24*Ee,B=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),V=e=>e?e<qe?`${B(e)}ms`:e<be?`${B(e/qe)}s`:e<Ee?`${Math.floor(e/be)}m${V(e%be)}`:e<We?`${Math.floor(e/Ee)}h${V(e%Ee)}`:`${Math.floor(e/We)}d${V(e%We)}`:"0s",Ui=100,Bi=1e3,H=class extends J{constructor(t){super();E(this,"latlng");E(this,"age",0);E(this,"marker");E(this,"pulse");this.latlng=t,this.marker=new _e,this.marker.beginFill(H.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new _e,this.pulse.beginFill(H.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(t,o){if(this.age+=o/60,this.age>H.lifetime&&this.parent){this.parent.removeChild(this);return}const i=this.age%H.lifetime/H.lifetime,d=ar(i);this.pulse.scale.set(1+d);const a=.4,n=i<a?rr(i/a):1-ir((i-a)/(1-a));this.pulse.alpha=n,i<a?this.marker.alpha=n:this.marker.alpha=1-dr((i-a)/(1-a));const[s,c]=t(this.latlng);this.x=s,this.y=c}};let re=H;E(re,"lifetime",1.5),E(re,"markerColor",306687),E(re,"pulseColor",306687);const yo=()=>{const e=f(v),{initialized:t}=O();return g.exports.useMemo(()=>["notifications",e,t],[e,t])},go=({scene:e,latLngToPixel:t,bounds:o})=>{const i=g.exports.useRef(new Date().toISOString()),d=f(v),{initialized:a}=O(),n=eo(o,50),s=yo();return N(s,()=>ei(d,i.current,Ui,n),{refreshInterval:Bi,isPaused:()=>!a,onSuccess:c=>{if(c.length>0){i.current=c[0][0];for(const[,p,u]of c)e.addChild(new re([u,p]))}}}),{update:g.exports.useCallback(c=>{for(let p=e.children.length-1;p>=0;p--)e.children[p].update(t,c)},[t,e])}},Fi=()=>{const e=f(v),t=po(e,"locations","requests","purchases","notifications","subscriber_segments"),o=N(["notificationsMapTableCounts",e],()=>ze(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),i=f($e("SimulatorMatcher")),d=f($e("SimulatorUpdateSegments")),a=ne(".4~s"),n=o.data?l(Pt,{templateColumns:"repeat(auto-fit, minmax(100px, 1fr))",columnGap:2,rowGap:2,children:[l(C,{children:[r(I,{children:"Offers"}),r(w,{children:a(o.data.offers)})]}),l(C,{children:[r(I,{children:"Cities"}),r(w,{children:a(o.data.cities)})]}),l(C,{children:[r(I,{children:"Subscribers"}),r(w,{children:a(o.data.subscribers)})]}),l(C,{children:[r(I,{children:"Segments"}),r(w,{children:a(o.data.segments)})]}),l(C,{children:[r(I,{children:"Segmentation"}),r(w,{children:V(d)})]}),l(C,{children:[r(I,{children:"Matching"}),r(w,{children:V(i)})]})]}):null;return l(A,{children:[r(S,{children:`
          ...
          about the demo.
        `}),n,l(L,{children:[r(ce,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),r(uo,{data:t,height:150})]})]})},Gi=()=>{const e=f(Q);return gt(e),ao(e),l(Se,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[r(F,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:r(Le,{useRenderer:go,options:{}})}),l(F,{spacing:4,flex:"1 1 0",minWidth:"0",children:[r(S,{children:`
          ...
          `}),e?r(Fi,{}):r(ro,{})]})]})},fo=o=>{var i=o,{children:e}=i,t=k(i,["children"]);return r(nr,T(b({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},t),{children:e}))},Yi=1e3,Hi=(e,t)=>{const o=f(v),{initialized:i}=O();N(["offers",o,i,e],()=>ti(o,Yi,e),{isPaused:()=>!i,onSuccess:t})},Wi=e=>r(io,T(b({},e),{useCells:Hi,getCellColor:()=>306687,getCellWKTPolygon:t=>t.notificationZone})),G=e=>{const{completed:t,title:o,left:i,right:d}=e,{colorMode:a}=Oe(),n=a==="light"?".300":".500",s=t?"gray"+n:void 0,c=(t?"green":"gray")+n;return l(A,{children:[l(Re,{children:[l(Ce,{as:"h2",size:"lg",mb:4,color:s,children:[r(Dt,b({color:c},{boxSize:6,position:"relative",bottom:.5,mr:2})),o]}),i]}),r(Re,{children:d})]})},ji=({connected:e,isVapor:t})=>t?r(G,{completed:e,title:"Connected",left:l(A,{children:[r(S,{children:`
                ...
                the button below.
              `}),r(lo,{size:"xs",colorScheme:"gray"})]}),right:null}):r(G,{completed:e,title:"Connect to SingleStore",left:r(S,{children:`
            ...
            **Note**: The HTTP API may need to be enabled on your SingleStore
            ...
            [1]: https://docs.singlestore.com/docs/http-api/
          `}),right:r(co,{})}),Vi=({onClose:e,schemaObjectName:t})=>{const o=jr(t),[i]=xt("(max-width: 640px)");return l(sr,{isOpen:!0,onClose:e,size:i?"full":"4xl",scrollBehavior:"inside",children:[r(tt,{}),l(pr,{children:[l(ot,{children:["Create statement for ",o.name]}),r(kt,{}),r(rt,{children:r(fo,{mb:4,children:o.createStmt})})]})]})},$i=({initialized:e})=>{const[t,o]=z(X),i=Qt(),{colorMode:d}=Oe(),[a,n]=g.exports.useState(),s=g.exports.useCallback(p=>n(p),[]),c=g.exports.useCallback(()=>n(null),[]);return l(A,{children:[!!a&&r(Vi,{onClose:c,schemaObjectName:a}),r(G,{completed:e,title:"Setup the schema",left:l(A,{children:[r(S,{children:`
              ...
              `}),r(cr,{mt:4,mb:6}),l(Ne,{alignItems:"flex-end",children:[l(Ze,{flex:1,children:[r(Qe,{fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Database name"}),r(wt,{placeholder:"martech",value:t,size:"sm",onChange:p=>o(p.target.value)})]}),r(L,{flex:1,textAlign:"center",children:r(so,{colorScheme:"blue",size:"sm",disabled:e,skipSeedData:!0,children:e?"Schema is setup":"Setup schema"})})]})]}),right:r(Xe,{columns:[1,2,2],gap:1,children:Object.keys(i.data||{}).sort().map(p=>{var u;return r(Re,{bg:((u=i.data)!=null&&u[p]?"green":"gray")+(d==="light"?".200":".600"),color:d==="light"?"gray.800":"gray.100",textOverflow:"ellipsis",whiteSpace:"nowrap",overflow:"hidden",borderRadius:"md",px:2,py:1,textAlign:"center",_hover:{fontWeight:"bold"},cursor:"pointer",onClick:()=>s(p),children:p},p)})})})]})},mo=(e,t,o=!0)=>{var a;const i=N(["pipelineStatus",e,t],()=>Vt(e,t),{isPaused:()=>!o}),d=(a=i.data)!=null&&a.length?i.data.every(n=>!n.needsUpdate):!1;return{pipelines:i,completed:d}},Ki=()=>{const e=f(v),t=f(Z),{pipelines:o,completed:i}=mo(e,t);gt(i);const[d,a]=Ae(),n=g.exports.useCallback(async()=>{a.on(),await $t(e,t),o.mutate(),a.off()},[a,e,t,o]),s=po(e,"locations","requests","purchases"),c=s.length<2||s.every(({data:u})=>u.locations+u.purchases+u.requests===0);return r(G,{completed:i,title:"Ingest data",left:r(S,{children:`
          ...
          `}),right:c||!i?r(P,{h:220,children:l(R,{colorScheme:"blue",size:"sm",onClick:n,disabled:i,children:[(d||i)&&r(M,{mr:2}),d?"Creating Pipelines":i?"...waiting for data":"Create pipelines"]})}):r(uo,{data:s,height:200})})},Pe=(e,t=!0)=>N(["overviewTableCounts",e],()=>ze(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!t}),Ji=()=>{var s,c;const e=f(v),t=f(Z),[o,i]=Ae(),d=Pe(e),a=g.exports.useCallback(async()=>{i.on(),await lt(e,de,t),d.mutate(),i.off()},[e,t,d,i]),n=!!((s=d.data)!=null&&s.offers);return r(G,{completed:n,title:"Offers",left:r(A,{children:l(S,{children:[`
            ...
            `,n&&`
                ...
                database.
            `]})}),right:n?r(Wi,{height:300,defaultZoom:13}):r(P,{h:"100%",children:l(R,{onClick:a,disabled:o,children:[o&&r(M,{mr:2}),o?"loading...":n?"loaded offers!":"load offers"]})})})},qi=({done:e,setDone:t})=>{const o=f(v),i=g.exports.useRef(new Date().toISOString());return g.exports.useEffect(()=>{if(e)return;const d=new AbortController,a=T(b({},o),{ctx:d});return(async()=>{try{for(let n=0;n<10;n++)if(i.current=await pt(a,i.current),await st(a,"second"),n>1&&!await Kt(a))return}catch(n){if(d.signal.aborted||n instanceof DOMException&&n.name==="AbortError")return;throw n}})().then(()=>t(!0)),()=>{d.abort()}},[o,e,t]),e?null:r(Re,{colSpan:[1,1,2],children:l(P,{w:"100%",h:"200px",color:"gray.500",children:[r(M,{size:"md",mr:4}),r(Ce,{size:"md",children:"Warming up queries..."})]})})},Xi=()=>{var u;const e=f(v),t=Pe(e),{elapsed:o,isRunning:i,startTimer:d,stopTimer:a}=to(),n=g.exports.useRef(new Date().toISOString()),s=!!((u=t.data)!=null&&u.subscriber_segments),c=g.exports.useCallback(async()=>{d(),n.current=await pt(e,n.current),a(),t.mutate()},[e,t,d,a]);let p;if(o&&t.data){const{segments:y,subscriber_segments:m,locations:_,requests:Y,purchases:ee}=t.data,Me=V(o),Ue=B(_+Y+ee),Be=B(y),Fe=B(m);p=r(S,{children:`
          The last update evaluated ${Ue} rows against ${Be} segments
          producing ${Fe} segment memberships.
          
          **This process took ${Me}**.
        `})}return r(G,{completed:s,title:"Segmentation",left:r(S,{children:`
          ...
          `}),right:r(P,{h:"100%",children:l(Mt,{gap:4,textAlign:"center",children:[l(R,{disabled:i,onClick:c,children:[i&&r(M,{mr:2}),i?"...running":"Match subscribers to segments"]}),p]})})})},Zi=()=>{var _;const e=f(v),t=Pe(e),o=yo(),{mutate:i}=lr(),{elapsed:d,isRunning:a,startTimer:n,stopTimer:s}=to(),[c,p]=g.exports.useState(0),u=!!((_=t.data)!=null&&_.notifications),y=g.exports.useCallback(async()=>{let Y=0,ee=0;for(;Y===0&&ee++<10;)n(),Y=await st(e,"second");s(),p(Y),t.mutate(),i(o)},[e,n,s,t,i,o]);let m;if(d&&t.data){const{offers:Y,subscribers:ee,subscriber_segments:Me,notifications:Ue}=t.data,Be=B(Y*ee+Ue),Fe=B(Me),vo=V(d),ho=B(c);m=r(S,{children:`
          The last update evaluated up to ${Be} notification opportunities
          against ${Fe} segment memberships generating ${ho}
          notifications. This process took ${vo}.
        `})}return r(G,{completed:u,title:"Matching",left:r(S,{children:`
          ...
          `}),right:r(P,{h:"100%",children:l(Mt,{gap:4,w:"100%",children:[l(R,{disabled:a,onClick:y,children:[a&&r(M,{mr:2}),a?"...running":"Generate notifications"]}),r(L,{width:"100%",children:r(Le,{height:250,defaultZoom:12,useRenderer:go,options:{}})}),m]})})})},Qi=()=>{const e=f(X);return r(G,{completed:!0,title:"Putting it all together",left:r(S,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: map
          `}),right:null})},ed=()=>{const e=f(v),t=f(Z),{connected:o,initialized:i,isVapor:d}=O(),{completed:a}=mo(e,t,o&&i),{data:n}=Pe(e,o&&i),[s,c]=g.exports.useState(!1),p=[{completed:o,component:r(ji,{connected:o,isVapor:d},"connection")},{completed:i,component:r($i,{initialized:i},"schema")},{completed:a,component:r(Ki,{},"pipelines")},{completed:n?n.offers>0:!1,component:r(Ji,{},"offers")},{completed:s,component:r(qi,{done:s,setDone:c},"warmup")},{completed:n?n.subscriber_segments>0:!1,component:r(Xi,{},"segmentation")},{completed:n?n.notifications>0:!1,component:r(Zi,{},"matching")},{completed:!0,component:r(Qi,{},"summary")}];let u=!0;const y=[];for(const{completed:m,component:_}of p)if(u)y.push(_),u=m;else break;return l($,{maxW:"container.lg",mt:10,mb:"30vh",children:[r(L,{maxW:"container.md",mb:10,px:0,children:r(S,{children:`
          ...
          `})}),r(Pt,{columnGap:6,rowGap:10,templateColumns:["minmax(0, 1fr)",null,"repeat(2, minmax(0, 1fr))"],children:y})]})};function td(){const e=r(P,{height:"100vh",children:r(M,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})});return r(g.exports.Suspense,{fallback:e,children:l(Se,{height:"100vh",direction:"column",children:[r(zi,{}),r(L,{m:4,flex:"1",children:l(ur,{children:[r(te,{path:"/",element:r(ed,{})}),r(te,{path:"/map",element:r(Gi,{})}),r(te,{path:"/admin",element:r(bi,{})}),r(te,{path:"/analytics",element:r(Ai,{})}),r(te,{path:"*",element:r(yr,{to:"/",replace:!0})})]})})]})})}class od extends ae.Component{constructor(){super(void 0);E(this,"state",{});this.handlePromiseRejection=this.handlePromiseRejection.bind(this)}componentDidMount(){window.addEventListener("unhandledrejection",this.handlePromiseRejection)}componentWillUnmount(){window.removeEventListener("unhandledrejection",this.handlePromiseRejection)}handlePromiseRejection(t){this.setState({error:t.reason})}static getDerivedStateFromError(t){return{error:t}}render(){const{error:t}=this.state;if(t){let o;return t instanceof x&&(o=l(A,{children:[r(ce,{textAlign:"center",children:"An error occurred while running the following query:"}),r(fo,{children:K(t.sql)})]})),r($,{maxW:"container.md",my:10,children:l(F,{gap:4,children:[r(P,{children:r(zt,{boxSize:20,color:"red"})}),r(Ce,{size:"xl",textAlign:"center",children:t.message}),o,l(Ne,{justify:"center",gap:4,children:[r(R,{onClick:()=>this.setState({error:void 0}),size:"sm",children:"Dismiss Error"}),r(R,{onClick:()=>window.location.reload(),size:"sm",colorScheme:"blue",leftIcon:r(gr,{}),children:"Reload"})]})]})})}return this.props.children}}const rd=fr({fonts:{heading:"InterVariable, sans-serif",body:"InterVariable, sans-serif",mono:'"Source Code ProVariable", monospace'},components:{Link:{baseStyle:e=>({color:e.colorMode==="light"?"blue.600":"blue.300"})}}}),id=({children:e})=>{const t=Ct();return r(Er,{value:{onError:i=>{t({title:"An error occurred",description:i.message,status:"error",duration:5e3,isClosable:!0})}},children:e})};mr.render(r(ae.StrictMode,{children:r(vr,{theme:rd,children:r(od,{children:r(id,{children:r(hr,{children:r(br,{basename:"/",children:r(td,{})})})})})})}),document.getElementById("root"));
