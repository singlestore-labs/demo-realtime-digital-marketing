var et=Object.defineProperty,ot=Object.defineProperties;var tt=Object.getOwnPropertyDescriptors;var re=Object.getOwnPropertySymbols;var io=Object.prototype.hasOwnProperty,ao=Object.prototype.propertyIsEnumerable;var Ce=(e,o,t)=>o in e?et(e,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[o]=t,h=(e,o)=>{for(var t in o||(o={}))io.call(o,t)&&Ce(e,t,o[t]);if(re)for(var t of re(o))ao.call(o,t)&&Ce(e,t,o[t]);return e},T=(e,o)=>ot(e,tt(o));var x=(e,o)=>{var t={};for(var r in e)io.call(e,r)&&o.indexOf(r)<0&&(t[r]=e[r]);if(e!=null&&re)for(var r of re(e))o.indexOf(r)<0&&ao.call(e,r)&&(t[r]=e[r]);return t};var E=(e,o,t)=>(Ce(e,typeof o!="symbol"?o+"":o,t),t);import{d as ye,s as rt,_ as Pe,r as g,j as i,B as P,M as it,a as p,F as N,L as G,R as te,u as co,C as K,A as at,b as C,c as po,e as nt,f as v,g as z,h as dt,i as w,k as yo,P as lt,l as st,G as ue,q as ct,E as pt,N as uo,m as yt,n as $,o as je,p as We,I as go,t as ut,S as gt,v as J,w as mo,x as O,y as vo,z as Ve,D as mt,H as Ke,J as vt,K as $e,O as Je,Q as bo,T as U,U as bt,V as ht,W as ho,X as ne,Y as de,Z as le,$ as ft,a0 as be,a1 as fo,a2 as Me,a3 as ge,a4 as ke,a5 as Et,a6 as _t,a7 as me,a8 as he,a9 as Eo,aa as _o,ab as fe,ac as Tt,ad as St,ae as Nt,af as Ot,ag as Rt,ah as wt,ai as Ze,aj as B,ak as It,al as At,am as Lt,an as Ct,ao as no,ap as kt,aq as xt,ar as zt,as as Dt,at as Pt,au as To,av as j,aw as W,ax as V,ay as Mt,az as Ut,aA as ve,aB as So,aC as Bt,aD as Ft,aE as Gt,aF as Yt,aG as xe,aH as Ht,aI as jt,aJ as Wt,aK as Vt,aL as Kt,aM as $t,aN as Jt}from"./vendor.a7545f4c.js";const Zt=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const d of n.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function t(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerpolicy&&(n.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?n.credentials="include":a.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(a){if(a.ep)return;a.ep=!0;const n=t(a);fetch(a.href,n)}};Zt();const Xt=/^Error (?<code>\d+):/;class L extends Error{constructor(o,t,r){super(o);E(this,"code");E(this,"sql");var a;if(Object.setPrototypeOf(this,L.prototype),this.sql=t,r)this.code=r;else{const n=o.match(Xt);this.code=n?parseInt(((a=n.groups)==null?void 0:a.code)||"-1",10):-1}}isUnknownDatabase(){return this.code===1049}isDatabaseRecovering(){return this.code===2269}}const Ee=async(e,o,...t)=>{const r=await H(e,o,...t);if(r.length!==1)throw new L("Expected exactly one row",o);return r[0]},H=async(e,o,...t)=>{const r=await _e("query/rows",e,o,...t);if(r.results.length!==1)throw new L("Expected exactly one result set",o);return r.results[0].rows},No=(e,o,...t)=>H(T(h({},e),{database:void 0}),o,...t),Xe=async(e,o,...t)=>{const r=await _e("query/tuples",e,o,...t);if(r.results.length!==1)throw new L("Expected exactly one result set",o);return r.results[0].rows},Ue=(e,o,...t)=>_e("exec",T(h({},e),{database:void 0}),o,...t),f=(e,o,...t)=>_e("exec",e,o,...t),_e=async(e,o,t,...r)=>{var d;const a=await fetch(`${o.host}/api/v1/${e}`,{method:"POST",signal:(d=o.ctx)==null?void 0:d.signal,headers:{"Content-Type":"application/json",Authorization:`Basic ${btoa(`${o.user}:${o.password}`)}`},body:JSON.stringify({sql:t,args:r,database:o.database})});if(!a.ok)throw new L(await a.text(),t);const n=await a.json();if(n.error)throw new L(n.error.message,t,n.error.code);return n};class qt{constructor(o,t,r=!1){E(this,"tuples",[]);this.table=o,this.columns=t,this.replace=r}append(...o){if(o.length!==this.columns.length)throw new Error(`Expected ${this.columns.length} values, got ${o.length}`);this.tuples.push(o)}clear(){this.tuples=[]}sql(){const o=`(${this.columns.map(()=>"?").join(",")})`,t=this.tuples.map(()=>o).join(",");return ye`
    ...
    `,o.id,o.name,`POINT(${o.lonlat[0]} ${o.lonlat[1]})`,o.diameter),ir=(e,o)=>f(e,"DELETE FROM cities WHERE city_id = ?",o),ar=["olc_8","olc_6","purchase","request"],nr=["minute","hour","day","week","month"],wo=({interval:e,kind:o,value:t})=>rt(`${e}-${o}-${t}`),dr=async(e,o)=>{const t=new Oo("segments",["segment_id","valid_interval","filter_kind","filter_value"]);for(const r of o)t.append(wo(r),r.interval,r.kind,r.value);await f(e,t.sql(),...t.params())},lr=async(e,o,t=tr)=>{const r=new Oo("offers",["customer_id","notification_zone","segment_ids","notification_content","notification_target","maximum_bid_cents"]);let a=0,n=[];const d=async()=>{await Promise.all([f(e,r.sql(),...r.params()),dr(e,n)]),r.clear(),n=[],a=0};for(const l of o)r.append(t,l.notificationZone,JSON.stringify(l.segments.map(wo)),l.notificationContent,l.notificationTarget,l.maximumBidCents),a++,n=n.concat(l.segments),a>=rr&&await d();a>0&&await d()},sr=()=>Te(ar),cr=()=>Te(nr),Io=({vendor:e,tld:o})=>`${e.toLowerCase()}.${o}`,Ao=e=>{const[o,t]=e.lonlat,r=e.diameter/2,[a,n]=[o-r,o+r],[d,l]=[t-r,t+r];return[Be(a,n),Be(d,l)]},pr=e=>{const o=sr(),t=cr();switch(o){case"olc_8":case"olc_6":{const[r,a]=Ao(e),n=o==="olc_8"?8:6,d=Pe.encode(a,r,n).substring(0,n);return{kind:o,interval:t,value:d}}case"purchase":return{kind:o,interval:t,value:Fe().vendor};case"request":return{kind:o,interval:t,value:Io(Fe())}}},yr=e=>{const o=ie(1,3),t=Array.from({length:o},()=>pr(e)),r=Fe(),a=Io(r),n=ie(10,50),d=ie(1,1e3),l=`${n}% off at ${r.vendor}`,s=`https://${a}/offers/${d}`,[c,y]=Ao(e),u=Pe.encode(y,c,Te([8,10])),m=Pe.decode(u),b={ne:[m.latitudeHi,m.longitudeHi],sw:[m.latitudeLo,m.longitudeLo]};return{segments:t,notificationZone:qe(b),notificationContent:l,notificationTarget:s,maximumBidCents:ie(2,15)}},ur=(e,o)=>Array.from({length:o},()=>yr(e)),gr=e=>(o,t,r,a=1)=>`https://stamen-tiles.a.ssl.fastly.net/${e}/${r}/${o}/${t}${a>=2?"@2x":""}.png`,mr=p(N,{children:["Map tiles by ",i(G,{href:"http://stamen.com",children:"Stamen Design"}),", under"," ",i(G,{href:"http://creativecommons.org/licenses/by/3.0",children:"CC BY 3.0"}),". Data by ",i(G,{href:"http://openstreetmap.org",children:"OpenStreetMap"}),", under"," ",i(G,{href:"http://www.openstreetmap.org/copyright",children:"ODbL"}),"."]}),vr=[oe.lonlat[1],oe.lonlat[0]],br=12,hr=({width:e,height:o,bounds:t,latLngToPixel:r,pixelToLatLng:a,useRenderer:n,options:d})=>{const l=te.useRef(null),s=co(()=>new K),{setup:c,update:y}=n({scene:s,width:e,height:o,bounds:t,latLngToPixel:r,pixelToLatLng:a,options:d});return g.exports.useLayoutEffect(()=>{if(!l.current)throw new Error("No canvas ref");console.log("PixiMapLayer: Setup");const u=new at({view:l.current,width:e,height:o,backgroundAlpha:0,antialias:!0});return u.stage.addChild(s),c==null||c(),y&&u.ticker.add(m=>{y(m)}),()=>{console.log("PixiMapLayer: Destroy"),u.stage.removeChild(s),u.destroy(!1,{children:!1,texture:!0,baseTexture:!0})}},[o,s,c,y,e]),i("canvas",{ref:l})},fr=({mapState:e,latLngToPixel:o,pixelToLatLng:t,useRenderer:r,options:a})=>{const{width:n,height:d,bounds:l}=e||{width:0,height:0};return n<=0||d<=0||!o||!t||!l?null:i(hr,{useRenderer:r,width:n,height:d,bounds:l,latLngToPixel:o,pixelToLatLng:t,options:a})},Se=d=>{var l=d,{height:e="100%",defaultCenter:o=vr,defaultZoom:t=br,useRenderer:r,options:a}=l,n=x(l,["height","defaultCenter","defaultZoom","useRenderer","options"]);const[s,c]=g.exports.useState(o),[y,u]=g.exports.useState(t);return i(P,T(h({borderRadius:"lg",overflow:"hidden",height:e},n),{children:i(it,{dprs:[1,2],provider:gr("toner-lite"),attribution:mr,maxZoom:20,center:s,zoom:y,onBoundsChanged:({center:m,zoom:b})=>{c(m),u(b)},children:i(fr,{useRenderer:r,options:a})})}))};var Ne=[{name:"date_sub_dynamic",createStmt:`CREATE OR REPLACE FUNCTION date_sub_dynamic (
  _dt DATETIME(6),
...
BEGIN
    ...
    RETURN _count;
END`}],Re=[{name:"worldcities",createStmt:`create rowstore table if not exists worldcities (
  ...
  WHERE
    ...
    AND ts >= date_sub_dynamic(NOW(6), segments.valid_interval)
);`}];const se="singlestore-realtime-digital-marketing",Er=[`CREATE LINK aws_s3 AS S3 CREDENTIALS '{}' CONFIG '{ "region": "us-east-1" }'`,"REPLACE INTO customers VALUES (0, 'default customer')",`
    CREATE OR REPLACE PIPELINE worldcities
    AS LOAD DATA LINK aws_s3 '${se}/cities.ndjson'
  ...
  `,"START PIPELINE worldcities FOREGROUND"],_r=e=>{const o=Re.find(a=>a.name===e);if(o)return o;const t=Oe.find(a=>a.name===e);if(t)return t;const r=Ne.find(a=>a.name===e);if(r)return r;throw new Error("Could not find schema object: "+e)},Tr=async e=>{try{return await Ue(e,"SELECT 1"),!0}catch{return!1}},Sr=async e=>{let o={tables:[],procedures:[],functions:[]};const l=e,{database:t}=l,r=x(l,["database"]);try{o=(await Xe(r,`
        ...
        `,t,t)).reduce((s,[c,y])=>(s[c].push(y),s),o)}catch(s){if(!(s instanceof L&&(s.isUnknownDatabase()||s.isDatabaseRecovering())))throw s}const{tables:a,procedures:n,functions:d}=o;return Object.fromEntries([Re.map(({name:s})=>[s,a.includes(s)]),Oe.map(({name:s})=>[s,n.includes(s)]),Ne.map(({name:s})=>[s,d.includes(s)])].flat())},Nr=async e=>Ee(e,`
      SELECT COUNT(*) AS count
      FROM information_schema.distributed_partitions
      WHERE
        database_name = ?
        AND role = "Master"
    `,e.database).then(o=>o.count),Or=async(e,{progress:o,scaleFactor:t,includeSeedData:r,skipCreate:a=!1})=>{a||(o("Dropping existing schema","info"),await Ue(e,"DROP DATABASE IF EXISTS `"+e.database+"`"),o("Creating database","info"),await Ue(e,"CREATE DATABASE `"+e.database+"`"));for(const n of Ne)o(`Creating function: ${n.name}`,"info"),await f(e,n.createStmt);for(const n of Re)o(`Creating table: ${n.name}`,"info"),await f(e,n.createStmt);for(const n of Oe)o(`Creating procedure: ${n.name}`,"info"),await f(e,n.createStmt);await Rr(e),await Ro(e,oe),r&&(o("Creating sample data","info"),await Qe(e,oe,t)),o("Schema initialized","success")},Rr=async e=>{for(const o of Er)await f(e,o)},Qe=(e,o,t)=>{const r=100*t.partitions,a=ur(o,r);return lr(e,a)},Lo=async(e,o)=>{const t=o.prefix;return await H(e,`
      SELECT
    ...
    `,e.database)},Co=async(e,o)=>{const t=o.prefix,r=await Lo(e,o);await Promise.all(r.filter(a=>a.needsUpdate).map(async a=>{console.log(`recreating pipeline ${a.pipelineName} for city ${a.cityName}`),a.pipelineName.startsWith("locations_")?await f(e,`
            ...
            AS LOAD DATA LINK aws_s3 '${se}/${t}/locations.*'
          ...
          `,a.cityId,a.lon,a.diameter,a.lat,a.diameter):a.pipelineName.startsWith("requests_")?await f(e,`
            CREATE OR REPLACE PIPELINE ${a.pipelineName}
            AS LOAD DATA LINK aws_s3 '${se}/${t}/requests.*'
          ...
          `,a.cityId):a.pipelineName.startsWith("purchases_")&&await f(e,`
            CREATE OR REPLACE PIPELINE ${a.pipelineName}
            AS LOAD DATA LINK aws_s3 '${se}/${t}/purchases.*'
    ...
    `,e.database);await Promise.all(o.map(t=>(console.log("dropping pipeline",t.pipelineName),f(e,`DROP PIPELINE ${t.pipelineName}`))))},ko=async e=>{const o=await H(e,`
    ...
    `,e.database)},eo=(e,...o)=>Ar(e,...o).then(t=>t.reduce((r,{tableName:a,count:n})=>(r[a]=n,r),{})),Lr=async(e,o)=>{const{maxRows:t}=o,a=["locations","requests","purchases","notifications"].map(d=>`"${d}"`).join(","),n=await No(e,`
      ...
      WHERE
        ...
        AND stats.count > ?
    `,e.database,t);await Promise.all(n.map(async({tableName:d,count:l,minTs:s,maxTs:c})=>{const u=(l-t)/l;if(u<.2)return;const m=new Date((s+u*(c-s))*1e3);console.log(`removing rows from ${d} older than ${m.toISOString()}`),await f(e,`DELETE FROM ${d} WHERE ts <= ?`,m.toISOString())}))},oo=(e,o="minute")=>Ee(e,"ECHO run_matching_process(?)",o).then(t=>t.RESULT),to=e=>Ee(e,"ECHO update_segments()").then(o=>o.RESULT),Cr=(e,o,t,r)=>Xe(e,`
      SELECT
        ts,
    ...
    `),zr=(e,o,t)=>Ee(e,`
      ...
      LIMIT 1
    `,o,t),A=[{name:"s00",maxRows:1e7,prefix:"v2/100k-2p",partitions:2},{name:"s0",maxRows:2e7,prefix:"v2/100k-4p",partitions:4},{name:"s1",maxRows:4e7,prefix:"v2/100k-8p",partitions:8},{name:"s2",maxRows:16e7,prefix:"v2/1m-16p",partitions:16},{name:"s4",maxRows:32e7,prefix:"v2/1m-32p",partitions:16},{name:"s8",maxRows:64e7,prefix:"v2/1m-64p",partitions:64},{name:"s10",maxRows:1e9,prefix:"v2/10m-80p",partitions:80}],Dr=e=>A.find(o=>o.name===e)||A[0],Pr=e=>[...A].sort((o,t)=>t.partitions-o.partitions).find(o=>o.partitions<=e)||A[A.length-1],Z=({encode:e,decode:o}={encode:JSON.stringify,decode:JSON.parse})=>({setSelf:t,onSet:r,node:a})=>{const n=`recoil.localstorage.${a.key}`,d=localStorage.getItem(n);d!=null&&t(o(d)),r((l,s,c)=>{c?localStorage.removeItem(n):localStorage.setItem(n,e(l))})},ro=()=>({setSelf:e,node:{key:o}})=>{const{location:t}=window;if(t){const r=new URLSearchParams(t.search);e(r.get(o))}},Mr=C({key:"skipCreateDatabase",default:null,effects:[ro()]}),Ur=C({key:"sessionId",default:null,effects:[ro()]}),Br=C({key:"vaporBaseUrl",default:"https://vapor.labs.singlestore.com",effects:[ro()]}),xo=C({key:"connectionHost",default:"http://127.0.0.1",effects:[Z()]}),zo=C({key:"connectionUser",default:"root",effects:[Z()]}),Do=C({key:"connectionPassword",default:"",effects:[Z()]}),X=C({key:"connectionDatabase",default:"martech",effects:[Z()]}),Po=po({key:"vaporConnectionConfig",get:async({get:e})=>{const o=e(Ur),t=e(Br);if(o)try{const r=await fetch(t+"/api/v1/vapor/connect?sessionId="+o);if(r.status===200){const a=await r.json();return{host:a.endpoint,user:a.user,password:a.password,database:e(X)}}}catch{console.log(`Failed to connect to vapor at ${t}, falling back to local config`)}}}),_=po({key:"connectionConfig",get:({get:e})=>{const o=e(Po);if(o)return o;const t=e(xo),r=e(zo),a=e(Do),n=e(X);return{host:t,user:r,password:a,database:n}},cachePolicy_UNSTABLE:{eviction:"most-recent"}}),q=C({key:"configScaleFactor",default:A[0],effects:[Z({encode:e=>e.name,decode:e=>A.find(o=>o.name===e)||A[0]})]}),Q=C({key:"simulatorEnabled",default:!0,effects:[Z()]}),Fr=C({key:"databaseDrawerIsOpen",default:!1}),Ge=nt({key:"tickDurationMs",default:void 0}),Gr=Object.fromEntries([Re.map(({name:e})=>[e,!1]),Oe.map(({name:e})=>[e,!1]),Ne.map(({name:e})=>[e,!1])].flat()),Mo=(e=!1)=>{const o=v(_);return z(["schemaObjects",o,e],()=>Sr(o),{isPaused:()=>e,refreshInterval:t=>Object.values(t||[]).some(a=>!a)?1e3:0,fallbackData:Gr})},I=()=>{const n=v(_),{database:e}=n,o=x(n,["database"]),t=v(Po),r=z(["isConnected",o],()=>Tr(o)),a=Mo(!r.data);return{isVapor:!!t,connected:!!r.data,initialized:!!r.data&&Object.values(a.data||[]).every(Boolean),reset:()=>{r.mutate(),a.mutate()}}},Yr=(()=>{let e={};return o=>(o in e||(e[o]=1),`${o}(${e[o]++})`)})(),Ye=(e,{name:o,enabled:t,intervalMS:r})=>{const a=dt(Ge(o));g.exports.useEffect(()=>{if(!t)return;const n=new AbortController,d=Yr(o);console.log(`Starting ${d}: tick interval: ${r}ms`);const l=async()=>{try{if(console.time(d),n.signal.aborted)return;const s=performance.now();await e(n);const c=performance.now()-s;a(c),setTimeout(l,Math.max(0,r-c))}catch(s){if(n.signal.aborted||s instanceof L&&s.isUnknownDatabase()||s instanceof DOMException&&s.name==="AbortError")return;throw s}finally{console.timeEnd(d)}};return l(),()=>{console.log(`Stopping ${d}`),n.abort()}},[t,e,r,o,a])},Hr=({before:e,after:o,includeSeedData:t})=>{const r=v(_),[a,n]=w(q),{reset:d}=I(),[l,s]=w(Q),c=yo(),y=v(Mr);return g.exports.useCallback(async()=>{const u=l;s(!1),e(),await Or(r,{progress(b,R){const k="reset-schema";c.isActive(k)?c.update(k,{title:b,status:R,duration:R==="success"?2e3:null,isClosable:!0}):c({id:k,title:b,status:R,duration:null})},scaleFactor:a,includeSeedData:t,skipCreate:!!y});const m=await Nr(r);n(Pr(m)),o(),d(),s(u)},[l,s,e,r,a,t,y,n,o,d,c])},Uo=(e,o)=>{const[t,r]=g.exports.useState(e);return g.exports.useEffect(()=>{const a=setTimeout(()=>r(e),o);return()=>clearTimeout(a)},[e,o]),t},Bo=()=>{const[{elapsed:e,isRunning:o},t]=g.exports.useReducer((r,a)=>{switch(a.type){case"start":return{start:Math.floor(performance.now()),isRunning:!0,elapsed:r.elapsed};case"stop":return{elapsed:Math.floor(performance.now())-(r.start||0),isRunning:!1}}},{isRunning:!1});return{elapsed:e,isRunning:o,startTimer:()=>t({type:"start"}),stopTimer:()=>t({type:"stop"})}},Fo=(e,o)=>{let t=!1,r=new lt(0,0),a=0;e.on("pointerdown",n=>{t=!0,r=n.data.global,a=performance.now()}),e.on("pointerup",n=>{if(!t||(t=!1,performance.now()-a>200))return;const l=n.data.global;Math.sqrt(Math.pow(l.x-r.x,2)+Math.pow(l.y-r.y,2))>10||o(n)}),e.on("pointercancel",()=>{t=!1})};class jr extends K{constructor(o,t){super();E(this,"gfx");E(this,"hover",!1);this.city=o,this.onRemove=t,this.gfx=new ue,this.addChild(this.gfx),this.gfx.interactive=!0,this.gfx.on("pointerover",()=>{this.hover=!0}),this.gfx.on("pointerout",()=>{this.hover=!1}),Fo(this.gfx,()=>t(this.city))}update(o){this.gfx.clear(),this.gfx.lineStyle(1,this.hover?16711680:306687,1),this.gfx.beginFill(this.hover?16711680:306687,.2);const[t,r]=o([this.city.centerLat,this.city.centerLon]);this.gfx.drawCircle(t,r,25),this.gfx.endFill()}}const Wr=e=>{const o=v(_),{initialized:t}=I();return z(["cities",o,t],()=>xr(o),{isPaused:()=>!t,onSuccess:e})},Vr=({scene:e,latLngToPixel:o,pixelToLatLng:t,width:r,height:a})=>{const n=v(_),d=co(()=>new K),{mutate:l}=Wr(y=>{d.removeChildren();for(let u=0;u<y.length;u++)d.addChild(new jr(y[u],c))}),s=g.exports.useCallback(async(y,u)=>{const m=await zr(n,u,y),b={id:m.id,name:m.name,lonlat:[m.centerLon,m.centerLat],diameter:m.diameter};await Ro(n,b),await Qe(n,b,A[0]),l()},[n,l]),c=g.exports.useCallback(async y=>{await ir(n,y.id),l()},[n,l]);return{setup:g.exports.useCallback(()=>{const y=new K;e.addChild(y),e.addChild(d),y.interactive=!0,y.hitArea=new st(0,0,r,a),Fo(y,u=>{const[m,b]=t([u.data.global.x,u.data.global.y]);s(m,b)})},[d,a,s,t,e,r]),update:g.exports.useCallback(()=>{for(let y=0;y<d.children.length;y++)d.children[y].update(o)},[d,o])}},Kr=e=>i(Se,T(h({},e),{useRenderer:Vr,options:{},cursor:"pointer"})),$r=ct({a:t=>{var r=t,{children:e}=r,o=x(r,["children"]);const{href:a}=o,n=!!(a!=null&&a.startsWith("http"));return n?p(G,T(h({isExternal:n},o),{children:[e,i(pt,{bottom:"2px",boxSize:"0.9em",position:"relative",ml:1})]})):i(G,T(h({to:a||""},o),{as:uo,children:e}))}}),S=t=>{var r=t,{children:e}=r,o=x(r,["children"]);return i(yt,T(h({},o),{skipHtml:!0,components:$r,children:Array.isArray(e)?e.filter(a=>a).map(a=>ye(a||"")).join(`

`):ye(e)}))},Jr=()=>p($,{maxW:"container.lg",mt:10,mb:"30vh",children:[i($,{maxW:"container.md",mb:10,children:i(S,{children:`
            ## Admin

            You can configure cities and offers on this page. To learn more
            about this application please visit the [Overview page](/).
          `})}),i(Zr,{})]}),Zr=()=>p(N,{children:[i($,{maxW:"container.md",mb:4,children:i(S,{children:`
            #### Cities
            ...
            remove it.
          `})}),i(Kr,{defaultZoom:4,defaultCenter:[39.716470511656766,-99.59395661915288],height:300})]}),ae=({label:e,placeholder:o,value:t,setValue:r,helpText:a,type:n="text"})=>p(je,{children:[i(We,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),i(go,{size:"sm",placeholder:o,value:t,onChange:d=>r(d.target.value),type:n}),a?i(ut,{fontSize:"xs",children:a}):null]}),Xr=()=>{const[e,o]=w(q);return p(je,{children:[i(We,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),i(gt,{size:"sm",required:!0,value:e.name,onChange:t=>{const r=t.target.value;o(Dr(r))},children:A.map(t=>i("option",{value:t.name,children:t.name},t.name))})]})},Go=({showDatabase:e,showScaleFactor:o})=>{const[t,r]=w(xo),[a,n]=w(zo),[d,l]=w(Do),[s,c]=w(X);return p(J,{spacing:4,children:[i(ae,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:t,setValue:r,helpText:i(S,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [HTTP API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),p(mo,{columns:2,gap:2,children:[i(ae,{label:"Username",placeholder:"admin",value:a,setValue:n}),i(ae,{label:"Password",placeholder:"",value:d,setValue:l,type:"password"}),e&&i(ae,{label:"Database",placeholder:"martech",value:s,setValue:c}),o&&i(Xr,{})]})]})},Yo=e=>i(O,T(h({onClick:()=>{const{pathname:o,hash:t}=window.location;window.location.replace(o+t)},colorScheme:"red"},e),{children:"Disconnect"})),Ho=e=>{const{connected:o,initialized:t}=I(),r=vo(),[a,n]=Ve(),d=v(X),l=te.useRef(null),m=e,{skipSeedData:s,disabled:c}=m,y=x(m,["skipSeedData","disabled"]),u=Hr({before:g.exports.useCallback(()=>n.on(),[n]),after:g.exports.useCallback(()=>{n.off(),r.onClose()},[r,n]),includeSeedData:!s});return p(N,{children:[i(O,h({disabled:!o||c,onClick:r.onOpen,colorScheme:t?"green":"red"},y)),i(mt,{isOpen:r.isOpen,onClose:r.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:l,children:i(Ke,{children:p(vt,{children:[p($e,{fontSize:"lg",fontWeight:"bold",children:[t?"Reset":"Setup"," database ",d]}),p(Je,{children:["This will ",t?"recreate":"create"," the database called ",d,". Are you sure?"]}),p(bo,{children:[i(O,{ref:l,onClick:r.onClose,disabled:a,children:"Cancel"}),i(O,{disabled:a,colorScheme:t?"red":"green",onClick:u,ml:3,children:a?i(U,{}):t?"Recreate database":"Create database"})]})]})})})]})},qr=({isOpen:e,onClose:o,finalFocusRef:t})=>{const[r,a]=w(Q),{connected:n,initialized:d,isVapor:l}=I();return p(bt,{isOpen:e,placement:"right",onClose:o,finalFocusRef:t,children:[i(Ke,{}),p(ht,{children:[i(ho,{}),i($e,{children:"Config"}),i(Je,{children:p(J,{spacing:4,children:[l?null:i(Go,{showScaleFactor:!0,showDatabase:!0}),p(ne,{status:n?"success":"error",borderRadius:"md",children:[i(de,{}),i(le,{children:n?"connected":"disconnected"}),l?i(Yo,{position:"absolute",right:4,top:3,size:"xs"}):null]}),p(ne,{status:d?"success":"warning",borderRadius:"md",children:[i(de,{}),i(le,{children:"schema"}),i(Ho,{position:"absolute",right:4,top:3,size:"xs",children:d?"Reset":"Setup"})]}),p(ne,{status:r?"success":"warning",borderRadius:"md",children:[i(de,{}),i(le,{children:"simulator"}),i(ft,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:r?"green":"red",isChecked:r,disabled:!n||!d,onChange:()=>a(!r)})]})]})}),i(bo,{})]})]})},ze=({to:e,children:o,onClick:t})=>{const r=Rt(e),a=wt({path:r.pathname,end:!0});return i(G,{as:uo,to:e,px:2,py:1,onClick:t,rounded:"md",_hover:{textDecoration:"none",bg:Me("gray.300","gray.600")},fontWeight:a?"bold":"normal",href:"#",color:Me("gray.700","gray.200"),children:o})},Qr=()=>{const{colorMode:e,toggleColorMode:o}=be(),t=vo(),[r,a]=w(Fr),n=te.useRef(null),{connected:d,initialized:l}=I(),s=v(Q),[c]=fo("(max-width: 640px)"),y=p(N,{children:[i(ze,{to:"/",onClick:t.onClose,children:"Overview"}),i(ze,{to:"/map",onClick:t.onClose,children:"Map"}),i(ze,{to:"/admin",onClick:t.onClose,children:"Admin"})]});let u;return c||(u=d?l?s?"connected":"simulator disabled":"needs schema":"disconnected"),i(N,{children:i(P,{bg:Me("gray.200","gray.700"),children:p($,{maxW:"container.lg",children:[p(ge,{h:16,alignItems:"center",justifyContent:"space-between",children:[i(ke,{size:"md",icon:t.isOpen?i(Et,{}):i(_t,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:t.isOpen?t.onClose:t.onOpen}),p(me,{spacing:8,alignItems:"center",children:[i(he,{as:"h1",size:c?"sm":"md",children:c?"Martech":"Realtime Digital Marketing"}),i(me,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:y})]}),p(ge,{alignItems:"center",gap:2,children:[p(O,{size:"sm",ref:n,onClick:()=>a(!0),colorScheme:d?l&&s?"green":"yellow":"red",children:[l?i(Eo,{}):i(_o,{}),c||i(fe,{pl:2,children:u})]}),i(ke,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?i(Tt,{size:"1.4em"}):i(St,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),i(ke,{"aria-label":"Toggle Color Mode",size:"sm",onClick:o,icon:e==="light"?i(Nt,{boxSize:"1.2em"}):i(Ot,{boxSize:"1.2em"})})]})]}),t.isOpen?i(P,{pb:4,display:{md:"none"},children:i(J,{as:"nav",spacing:4,children:y})}):null,i(qr,{isOpen:r,onClose:()=>a(!1),finalFocusRef:n})]})})})},ei=e=>{const o=g.exports.useRef([]),{data:t}=z(["timeseries",e.name,...e.deps||[]],async()=>{const r=await e.fetcher();return o.current.push({data:r,ts:new Date}),o.current=o.current.slice(-e.limit),o.current},{refreshInterval:e.intervalMS});return t||[]},oi=Ze("~s"),jo=(e,...o)=>ei({name:"estimatedRowCount",deps:o,fetcher:g.exports.useCallback(()=>eo(e,...o),[e,o]),limit:30,intervalMS:1e3}),Wo=t=>{var r=t,{data:e}=r,o=x(r,["data"]);const{colorMode:a}=be(),n=g.exports.useCallback(({tooltipData:s,colorScale:c})=>!c||!s?null:Object.keys(s.datumByKey).sort((y,u)=>s.datumByKey[u].datum.data[u]-s.datumByKey[y].datum.data[y]).map(y=>{const{datum:u}=s.datumByKey[y],m=u.data[y];return p(fe,{mb:1,color:c(y),fontSize:"sm",children:[y,": ",Ze(".4~s")(m)]},y)}),[]),d=g.exports.useCallback(s=>oi(s).replace("G","B"),[]);if(e.length<2)return i(B,{height:o.height,children:i(U,{size:"md"})});const l=e.length>0?Object.keys(e[0].data).filter(s=>s!=="ts").map(s=>i(It,{dataKey:s,data:e,xAccessor:c=>c==null?void 0:c.ts,yAccessor:c=>c==null?void 0:c.data[s]},s)):null;return p(At,T(h({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:a==="light"?Lt:Ct,margin:{left:0,right:50,top:10,bottom:40}},o),{children:[i(no,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),i(no,{orientation:"right",numTicks:o.height<250?3:5,tickFormat:d,label:"rows",labelOffset:20}),l,i(kt,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:n})]}))},ti=10*1e3,Vo=(e=!1)=>{const o=v(_),t=v(q),r=v(Q),{initialized:a}=I(),n=g.exports.useCallback(d=>{const l=T(h({},o),{ctx:d});return Promise.all([Co(l,t),wr(l),Ir(l),Lr(l,t),ko(l)])},[o,t]);Ye(n,{name:"SimulatorMonitor",enabled:a&&r&&!e,intervalMS:ti})},ri=1*1e3,ii=10*1e3,ai=()=>{const e=v(_),o=v(Q),{initialized:t}=I(),r=g.exports.useCallback(n=>oo(T(h({},e),{ctx:n}),"minute"),[e]);Ye(r,{name:"SimulatorMatcher",enabled:t&&o,intervalMS:ri});const a=g.exports.useCallback(n=>to(T(h({},e),{ctx:n})),[e]);Ye(a,{name:"SimulatorUpdateSegments",enabled:t&&o,intervalMS:ii})},He=1e3,ce=60*He,pe=60*ce,De=24*pe,D=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),Y=e=>e?e<He?`${D(e)}ms`:e<ce?`${D(e/He)}s`:e<pe?`${Math.floor(e/ce)}m${Y(e%ce)}`:e<De?`${Math.floor(e/pe)}h${Y(e%pe)}`:`${Math.floor(e/De)}d${Y(e%De)}`:"0s",ni=100,di=1e3,F=class extends K{constructor(o){super();E(this,"latlng");E(this,"age",0);E(this,"marker");E(this,"pulse");this.latlng=o,this.marker=new ue,this.marker.beginFill(F.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new ue,this.pulse.beginFill(F.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(o,t){if(this.age+=t/60,this.age>F.lifetime&&this.parent){this.parent.removeChild(this);return}const r=this.age%F.lifetime/F.lifetime,a=Pt(r);this.pulse.scale.set(1+a);const n=.4,d=r<n?xt(r/n):1-zt((r-n)/(1-n));this.pulse.alpha=d,r<n?this.marker.alpha=d:this.marker.alpha=1-Dt((r-n)/(1-n));const[l,s]=o(this.latlng);this.x=l,this.y=s}};let ee=F;E(ee,"lifetime",1.5),E(ee,"markerColor",306687),E(ee,"pulseColor",306687);const Ko=()=>{const e=v(_),{initialized:o}=I();return g.exports.useMemo(()=>["notifications",e,o],[e,o])},$o=({scene:e,latLngToPixel:o,bounds:t})=>{const r=g.exports.useRef(new Date().toISOString()),a=v(_),{initialized:n}=I(),d=Uo(t,50),l=Ko();return z(l,()=>Cr(a,r.current,ni,d),{refreshInterval:di,isPaused:()=>!n,onSuccess:s=>{if(s.length>0){r.current=s[0][0];for(const[,c,y]of s)e.addChild(new ee([y,c]))}}}),{update:g.exports.useCallback(s=>{for(let c=e.children.length-1;c>=0;c--)e.children[c].update(o,s)},[o,e])}},li=()=>{const e=v(_),o=jo(e,"locations","requests","purchases","notifications"),t=z(["notificationsMapTableCounts",e],()=>eo(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),r=v(Ge("SimulatorMatcher")),a=v(Ge("SimulatorUpdateSegments")),n=Ze(".4~s"),d=t.data?p(To,{templateColumns:"repeat(auto-fit, minmax(100px, 1fr))",columnGap:2,rowGap:2,children:[p(j,{children:[i(W,{children:"Offers"}),i(V,{children:n(t.data.offers)})]}),p(j,{children:[i(W,{children:"Cities"}),i(V,{children:n(t.data.cities)})]}),p(j,{children:[i(W,{children:"Subscribers"}),i(V,{children:n(t.data.subscribers)})]}),p(j,{children:[i(W,{children:"Segments"}),i(V,{children:n(t.data.segments)})]}),p(j,{children:[i(W,{children:"Segmentation"}),i(V,{children:Y(a)})]}),p(j,{children:[i(W,{children:"Matching"}),i(V,{children:Y(r)})]})]}):null;return p(N,{children:[i(S,{children:`
          ...
          about the demo.
        `}),d,p(P,{children:[i(fe,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),i(Wo,{data:o,height:150})]})]})},si=()=>{const[e,o]=w(Q);return Vo(),ai(),p(ge,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[i(J,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:i(Se,{useRenderer:$o,options:{}})}),p(J,{spacing:4,flex:"1 1 0",minWidth:"0",children:[i(S,{children:`
          ...
          `}),e?i(li,{}):i(N,{children:p(ne,{status:"warning",borderRadius:"md",children:[i(de,{}),i(le,{children:"The simulator is disabled"}),i(O,{position:"absolute",right:4,top:3,size:"xs",colorScheme:"blue",onClick:()=>o(!0),children:"Enable simulator"})]})})]})]})},Jo=t=>{var r=t,{children:e}=r,o=x(r,["children"]);return i(Mt,T(h({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},o),{children:e}))},ci=1e3;class pi extends K{constructor(o){super();E(this,"offer");E(this,"points");E(this,"polygon");this.offer=o,this.points=er(o.notificationZone),this.polygon=new ue,this.addChild(this.polygon),this.polygon.interactive=!0,this.polygon.on("mouseover",()=>{this.polygon.tint=65280}),this.polygon.on("mouseout",()=>{this.polygon.tint=16777215})}update(o){this.polygon.clear(),this.polygon.lineStyle(1,306687,1),this.polygon.beginFill(306687,.2),this.polygon.drawPolygon(this.points.flatMap(([t,r])=>o([r,t]))),this.polygon.endFill()}}const yi=({scene:e,latLngToPixel:o,bounds:t})=>{const r=v(_),{initialized:a}=I(),n=Uo(t,100);return z(["offers",r,a,n],()=>kr(r,ci,n),{isPaused:()=>!a,onSuccess:d=>{e.removeChildren();for(let l=0;l<d.length;l++)e.addChild(new pi(d[l]))}}),{update:g.exports.useCallback(()=>{for(let d=0;d<e.children.length;d++)e.children[d].update(o)},[o,e])}},ui=e=>i(Se,T(h({},e),{useRenderer:yi,options:{}})),M=e=>{const{completed:o,title:t,left:r,right:a}=e,{colorMode:n}=be(),d=n==="light"?".300":".500",l=o?"gray"+d:void 0,s=(o?"green":"gray")+d;return p(N,{children:[p(ve,{children:[p(he,{as:"h2",size:"lg",mb:4,color:l,children:[i(Eo,h({color:s},{boxSize:6,position:"relative",bottom:.5,mr:2})),t]}),r]}),i(ve,{children:a})]})},gi=({connected:e,isVapor:o})=>o?i(M,{completed:e,title:"Connected",left:p(N,{children:[i(S,{children:`
                ...
                the button below.
              `}),i(Yo,{size:"xs",colorScheme:"gray"})]}),right:null}):i(M,{completed:e,title:"Connect to SingleStore",left:i(S,{children:`
            ...
            **Note**: The HTTP API may need to be enabled on your SingleStore
            ...
            [1]: https://docs.singlestore.com/docs/http-api/
          `}),right:i(Go,{})}),mi=({onClose:e,schemaObjectName:o})=>{const t=_r(o),[r]=fo("(max-width: 640px)");return p(Ft,{isOpen:!0,onClose:e,size:r?"full":"4xl",scrollBehavior:"inside",children:[i(Ke,{}),p(Gt,{children:[p($e,{children:["Create statement for ",t.name]}),i(ho,{}),i(Je,{children:i(Jo,{mb:4,children:t.createStmt})})]})]})},vi=({initialized:e})=>{const[o,t]=w(X),r=Mo(),{colorMode:a}=be(),[n,d]=g.exports.useState(),l=g.exports.useCallback(c=>d(c),[]),s=g.exports.useCallback(()=>d(null),[]);return p(N,{children:[!!n&&i(mi,{onClose:s,schemaObjectName:n}),i(M,{completed:e,title:"Setup the schema",left:p(N,{children:[i(S,{children:`
              ...
              `}),i(Ut,{mt:4,mb:6}),p(me,{alignItems:"flex-end",children:[p(je,{flex:1,children:[i(We,{fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Database name"}),i(go,{placeholder:"martech",value:o,size:"sm",onChange:c=>t(c.target.value)})]}),i(P,{flex:1,textAlign:"center",children:i(Ho,{colorScheme:"blue",size:"sm",disabled:e,skipSeedData:!0,children:e?"Schema is setup":"Setup schema"})})]})]}),right:i(mo,{columns:[1,2,2],gap:1,children:Object.keys(r.data||{}).sort().map(c=>{var y;return i(ve,{bg:((y=r.data)!=null&&y[c]?"green":"gray")+(a==="light"?".200":".600"),color:a==="light"?"gray.800":"gray.100",textOverflow:"ellipsis",whiteSpace:"nowrap",overflow:"hidden",borderRadius:"md",px:2,py:1,textAlign:"center",_hover:{fontWeight:"bold"},cursor:"pointer",onClick:()=>l(c),children:c},c)})})})]})},Zo=(e,o,t=!0)=>{var n;const r=z(["pipelineStatus",e,o],()=>Lo(e,o),{isPaused:()=>!t}),a=!!((n=r.data)!=null&&n.every(d=>!d.needsUpdate));return{pipelines:r,completed:a}},bi=()=>{const e=v(_),o=v(q),{pipelines:t,completed:r}=Zo(e,o);Vo(!r);const[a,n]=Ve(),d=g.exports.useCallback(async()=>{n.on(),await Co(e,o),t.mutate(),n.off()},[n,e,o,t]),l=jo(e,"locations","requests","purchases"),s=l.length<2||l.every(({data:y})=>y.locations+y.purchases+y.requests===0);return i(M,{completed:r,title:"Ingest data",left:i(S,{children:`
          ...
          `}),right:s||!r?i(B,{h:220,children:p(O,{colorScheme:"blue",size:"sm",onClick:d,disabled:r,children:[(a||r)&&i(U,{mr:2}),a?"Creating Pipelines":r?"...waiting for data":"Create pipelines"]})}):i(Wo,{data:l,height:200})})},we=(e,o=!0)=>z(["overviewTableCounts",e],()=>eo(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!o}),hi=()=>{var l,s;const e=v(_),o=v(q),[t,r]=Ve(),a=we(e),n=g.exports.useCallback(async()=>{r.on(),await Qe(e,oe,o),a.mutate(),r.off()},[e,o,a,r]),d=!!((l=a.data)!=null&&l.offers);return i(M,{completed:d,title:"Offers",left:i(N,{children:p(S,{children:[`
            ...
            `,d&&`
                ...
                database.
            `]})}),right:d?i(ui,{height:300}):i(B,{h:"100%",children:p(O,{onClick:n,disabled:t,children:[t&&i(U,{mr:2}),t?"loading...":d?"loaded offers!":"load offers"]})})})},fi=({done:e,setDone:o})=>{const t=v(_);return g.exports.useEffect(()=>{if(e)return;const r=new AbortController,a=T(h({},t),{ctx:r});return(async()=>{try{for(let n=0;n<10;n++){const d=performance.now();if(await to(a),await oo(a,"second"),performance.now()-d<2e3||n>1&&!await ko(a))return}}catch(n){if(r.signal.aborted||n instanceof DOMException&&n.name==="AbortError")return;throw n}})().then(()=>o(!0)),()=>{r.abort()}},[t,e,o]),e?null:i(ve,{colSpan:[1,1,2],children:p(B,{w:"100%",h:"200px",color:"gray.500",children:[i(U,{size:"md",mr:4}),i(he,{size:"md",children:"Warming up queries..."})]})})},Ei=()=>{var c;const e=v(_),o=we(e),{elapsed:t,isRunning:r,startTimer:a,stopTimer:n}=Bo(),d=!!((c=o.data)!=null&&c.subscriber_segments),l=g.exports.useCallback(async()=>{a(),await to(e),n(),o.mutate()},[e,o,a,n]);let s;if(t&&o.data){const{segments:y,subscriber_segments:u,locations:m,requests:b,purchases:R}=o.data,k=Y(t),Ie=D(m+b+R),Ae=D(y),Le=D(u);s=i(S,{children:`
          The last update evaluated ${Ie} rows against ${Ae} segments
          producing ${Le} segment memberships.
          
          **This process took ${k}**.
        `})}return i(M,{completed:d,title:"Segmentation",left:i(S,{children:`
            ...
            Click the button to run the update interactively, or run the following query in your favorite SQL client:
                ...
                select * from dynamic_subscriber_segments;
          `}),right:i(B,{h:"100%",children:p(So,{gap:4,textAlign:"center",children:[p(O,{disabled:r,onClick:l,children:[r&&i(U,{mr:2}),r?"...running":"Match subscribers to segments"]}),s]})})})},_i=()=>{var b;const e=v(_),o=we(e),t=Ko(),{mutate:r}=Bt(),{elapsed:a,isRunning:n,startTimer:d,stopTimer:l}=Bo(),[s,c]=g.exports.useState(0),y=!!((b=o.data)!=null&&b.notifications),u=g.exports.useCallback(async()=>{let R=0,k=0;for(;R===0&&k++<10;)d(),R=await oo(e,"second");l(),c(R),o.mutate(),r(t)},[e,d,l,o,r,t]);let m;if(a&&o.data){const{offers:R,subscribers:k,subscriber_segments:Ie,notifications:Ae}=o.data,Le=D(R*k+Ae),Xo=D(Ie),qo=Y(a),Qo=D(s);m=i(S,{children:`
        ...
        `})}return i(M,{completed:y,title:"Matching",left:i(S,{children:`
          ...
          `}),right:i(B,{h:"100%",children:p(So,{gap:4,w:"100%",children:[p(O,{disabled:n,onClick:u,children:[n&&i(U,{mr:2}),n?"...running":"Generate notifications"]}),i(P,{width:"100%",children:i(Se,{height:250,defaultZoom:12,useRenderer:$o,options:{}})}),m]})})})},Ti=()=>{const e=v(X);return i(M,{completed:!0,title:"Putting it all together",left:i(S,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: map
          `}),right:null})},Si=()=>{const e=v(_),o=v(q),{connected:t,initialized:r,isVapor:a}=I(),{completed:n}=Zo(e,o,t&&r),{data:d}=we(e,t&&r),[l,s]=g.exports.useState(!1),c=[{completed:t,component:i(gi,{connected:t,isVapor:a},"connection")},{completed:r,component:i(vi,{initialized:r},"schema")},{completed:n,component:i(bi,{},"pipelines")},{completed:d?d.offers>0:!1,component:i(hi,{},"offers")},{completed:l,component:i(fi,{done:l,setDone:s},"warmup")},{completed:d?d.subscriber_segments>0:!1,component:i(Ei,{},"segmentation")},{completed:d?d.notifications>0:!1,component:i(_i,{},"matching")},{completed:!0,component:i(Ti,{},"summary")}];let y=!0;const u=[];for(const{completed:m,component:b}of c)if(y)u.push(b),y=m;else break;return p($,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(P,{maxW:"container.md",mb:10,px:0,children:i(S,{children:`
          ...
          `})}),i(To,{columnGap:6,rowGap:10,templateColumns:["minmax(0, 1fr)",null,"repeat(2, minmax(0, 1fr))"],children:u})]})};function Ni(){const e=i(B,{height:"100vh",children:i(U,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})});return i(g.exports.Suspense,{fallback:e,children:p(ge,{height:"100vh",direction:"column",children:[i(Qr,{}),i(P,{m:4,flex:"1",children:p(Yt,{children:[i(xe,{path:"/",element:i(Si,{})}),i(xe,{path:"/map",element:i(si,{})}),i(xe,{path:"/admin",element:i(Jr,{})})]})})]})})}class Oi extends te.Component{constructor(){super(void 0);E(this,"state",{});this.handlePromiseRejection=this.handlePromiseRejection.bind(this)}componentDidMount(){window.addEventListener("unhandledrejection",this.handlePromiseRejection)}componentWillUnmount(){window.removeEventListener("unhandledrejection",this.handlePromiseRejection)}handlePromiseRejection(o){this.setState({error:o.reason})}static getDerivedStateFromError(o){return{error:o}}render(){const{error:o}=this.state;if(o){let t;return o instanceof L&&(t=p(N,{children:[i(fe,{textAlign:"center",children:"An error occurred while running the following query:"}),i(Jo,{children:ye(o.sql)})]})),i($,{maxW:"container.md",my:10,children:p(J,{gap:4,children:[i(B,{children:i(_o,{boxSize:20,color:"red"})}),i(he,{size:"xl",textAlign:"center",children:o.message}),t,p(me,{justify:"center",gap:4,children:[i(O,{onClick:()=>this.setState({error:void 0}),size:"sm",children:"Dismiss Error"}),i(O,{onClick:()=>window.location.reload(),size:"sm",colorScheme:"blue",leftIcon:i(Ht,{}),children:"Reload"})]})]})})}return this.props.children}}const Ri=jt({fonts:{heading:"InterVariable, sans-serif",body:"InterVariable, sans-serif",mono:'"Source Code ProVariable", monospace'},components:{Link:{baseStyle:e=>({color:e.colorMode==="light"?"blue.600":"blue.300"})}}}),wi=({children:e})=>{const o=yo();return i(Jt,{value:{onError:r=>{o({title:"An error occurred",description:r.message,status:"error",duration:5e3,isClosable:!0})}},children:e})};Wt.render(i(te.StrictMode,{children:i(Vt,{theme:Ri,children:i(Oi,{children:i(wi,{children:i(Kt,{children:i($t,{basename:"/",children:i(Ni,{})})})})})})}),document.getElementById("root"));
