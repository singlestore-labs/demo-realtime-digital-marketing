...
END`}],Ge=[{name:"worldcities",createStmt:`create rowstore table if not exists worldcities (
  ...
  `,"START PIPELINE worldcities FOREGROUND"],Zr=e=>{const o=Ge.find(d=>d.name===e);if(o)return o;const t=Fe.find(d=>d.name===e);if(t)return t;const r=Be.find(d=>d.name===e);if(r)return r;throw new Error("Could not find schema object: "+e)},Qr=async e=>{try{return await po(e,"SELECT 1"),!0}catch{return!1}},ei=async e=>{let o={tables:[],procedures:[],functions:[]};const c=e,{database:t}=c,r=z(c,["database"]);try{o=(await so(r,`
    ...
    `);try{await Promise.all(o.map(({planId:t})=>E(e,`DROP ${t} FROM PLANCACHE`)))}catch(t){if(!(t instanceof D&&t.isPlanMissing()))throw t}return o.length>0},ii=(e,...o)=>{const t=o.map(r=>`"${r}"`).join(",");return Yo(e,`
      ...
      GROUP BY tableName
    `,e.database)},Ye=(e,...o)=>ii(e,...o).then(t=>t.reduce((r,{tableName:d,count:a})=>(r[d]=a,r),{})),di=async(e,o)=>{const{maxRows:t}=o,d=["locations","requests","purchases","notifications"].map(n=>`"${n}"`).join(","),a=await Yo(e,`
      SELECT
...
`,si=(e,o,t,r)=>Y(e,uo({with:[["metrics",mo(o)]],base:`
      ...
      `,params:[Me(o)]}});return Y(e,r.sql,...r.params)},ui=(e,o,t)=>ze(e,"CALL update_sessions(?, ?)",o,t).then(({session_id:r,is_controller:d,expires_at:a})=>({sessionId:r,isController:d,expiresAt:new Date(a)})),Qo=(e,o,t)=>E(e,`
      UPDATE sessions
    ...
    `,t,o,o),K=[{name:"s00",maxRows:1e7,prefix:"v2/100k-2p",partitions:2},{name:"s0",maxRows:2e7,prefix:"v2/100k-4p",partitions:4},{name:"s1",maxRows:4e7,prefix:"v2/100k-8p",partitions:8},{name:"s2",maxRows:16e7,prefix:"v2/1m-16p",partitions:16},{name:"s4",maxRows:32e7,prefix:"v2/1m-32p",partitions:16},{name:"s8",maxRows:64e7,prefix:"v2/1m-64p",partitions:64},{name:"s10",maxRows:1e9,prefix:"v2/10m-80p",partitions:80}],yi=e=>K.find(o=>o.name===e)||K[0],ee=({encode:e,decode:o}={encode:JSON.stringify,decode:JSON.parse})=>({setSelf:t,onSet:r,node:d})=>{const a=`recoil.localstorage.${d.key}`,n=localStorage.getItem(a);n!=null&&t(o(n)),r((c,l,u)=>{u?localStorage.removeItem(a):localStorage.setItem(a,e(c))})},vo=()=>({setSelf:e,node:{key:o}})=>{const{location:t}=window;if(t){const r=new URLSearchParams(t.search);e(r.get(o)||new Lt)}},gi=x({key:"skipCreateDatabase",default:null,effects:[vo()]}),fi=x({key:"sessionId",default:null,effects:[vo()]}),mi=x({key:"vaporBaseUrl",default:"https://vapor.labs.singlestore.com",effects:[vo()]}),et=x({key:"connectionHost",default:"http://127.0.0.1",effects:[ee()]}),ot=x({key:"connectionUser",default:"root",effects:[ee()]}),tt=x({key:"connectionPassword",default:"",effects:[ee()]}),oe=x({key:"connectionDatabase",default:"martech",effects:[ee()]}),rt=ko({key:"vaporConnectionConfig",get:async({get:e})=>{const o=e(fi),t=e(mi);if(o&&t)try{const r=await fetch(t+"/api/v1/vapor/connect?sessionId="+o);if(r.status===200){const d=await r.json();return{host:d.endpoint,user:d.user,password:d.password,database:e(oe)}}}catch{console.log(`Failed to connect to vapor at ${t}, falling back to local config`)}}}),b=ko({key:"connectionConfig",get:({get:e})=>{const o=e(rt);if(o)return o;const t=e(et),r=e(ot),d=e(tt),a=e(oe);return{host:t,user:r,password:d,database:a}},cachePolicy_UNSTABLE:{eviction:"most-recent"}}),te=x({key:"configScaleFactor",default:K[0],effects:[ee({encode:e=>e.name,decode:e=>K.find(o=>o.name===e)||K[0]})]}),re=x({key:"simulatorEnabled",default:!0,effects:[ee()]}),vi=x({key:"databaseDrawerIsOpen",default:!1}),Ze=kt({key:"tickDurationMs",default:void 0}),He=x({key:"resettingSchema",default:!1}),bi=Object.fromEntries([Ge.map(({name:e})=>[e,!1]),Fe.map(({name:e})=>[e,!1]),Be.map(({name:e})=>[e,!1])].flat()),it=(e=!1)=>{const o=m(b);return R(["schemaObjects",o,e],()=>ei(o),{isPaused:()=>e,refreshInterval:t=>Object.values(t||[]).some(d=>!d)?1e3:0,fallbackData:bi})},O=()=>{const a=m(b),{database:e}=a,o=z(a,["database"]),t=m(rt),r=R(["isConnected",o],()=>Qr(o)),d=it(!r.data);return{isVapor:!!t,connected:!!r.data,initialized:!!r.data&&Object.values(d.data||[]).every(Boolean),reset:()=>{r.mutate(),d.mutate()}}},hi=(()=>{let e={};return o=>(o in e||(e[o]=1),`${o}(${e[o]++})`)})(),Qe=(e,{name:o,enabled:t,intervalMS:r})=>{const d=to(Ze(o));g.exports.useEffect(()=>{if(!t)return;const a=new AbortController,n=hi(o);console.log(`Starting ${n}: tick interval: ${r}ms`);const c=async()=>{try{if(console.time(n),a.signal.aborted)return;const l=performance.now();await e(a);const u=performance.now()-l;d(u),setTimeout(c,Math.max(0,r-u))}catch(l){if(a.signal.aborted||l instanceof D&&l.isUnknownDatabase()||l instanceof DOMException&&l.name==="AbortError")return;throw l}finally{console.timeEnd(n)}};return c(),()=>{console.log(`Stopping ${n}`),a.abort()}},[t,e,r,o,d])},Ei=({before:e,after:o,includeSeedData:t})=>{const r=m(b),d=m(te),{reset:a}=O(),[n,c]=P(re),l=Do(),u=m(gi),p=to(He);return g.exports.useCallback(async()=>{const y=n;c(!1),p(!0),e(),await oi(r,{progress(f,v){const N="reset-schema";l.isActive(N)?l.update(N,{title:f,status:v,duration:v==="success"?2e3:null,isClosable:!0}):l({id:N,title:f,status:v,duration:null})},scaleFactor:d,includeSeedData:t,skipCreate:!!u}),o(),a(),c(y),p(!1)},[n,c,p,e,r,d,t,u,o,a,l])},dt=(e,o)=>{const[t,r]=g.exports.useState(e);return g.exports.useEffect(()=>{const d=setTimeout(()=>r(e),o);return()=>clearTimeout(d)},[e,o]),t},at=()=>{const[{elapsed:e,isRunning:o},t]=g.exports.useReducer((r,d)=>{switch(d.type){case"start":return{start:Math.floor(performance.now()),isRunning:!0,elapsed:r.elapsed};case"stop":return{elapsed:Math.floor(performance.now())-(r.start||0),isRunning:!1}}},{isRunning:!1});return{elapsed:e,isRunning:o,startTimer:()=>t({type:"start"}),stopTimer:()=>t({type:"stop"})}},nt=(e,o)=>{let t=!1,r=new Dt(0,0),d=0;e.on("pointerdown",a=>{t=!0,r=a.data.global,d=performance.now()}),e.on("pointerup",a=>{if(!t||(t=!1,performance.now()-d>200))return;const c=a.data.global;Math.sqrt(Math.pow(c.x-r.x,2)+Math.pow(c.y-r.y,2))>10||o(a)}),e.on("pointercancel",()=>{t=!1})};class _i extends Z{constructor(o,t){super();S(this,"gfx");S(this,"hover",!1);this.city=o,this.onRemove=t,this.gfx=new Ae,this.addChild(this.gfx),this.gfx.interactive=!0,this.gfx.on("pointerover",()=>{this.hover=!0}),this.gfx.on("pointerout",()=>{this.hover=!1}),nt(this.gfx,()=>t(this.city))}update(o){this.gfx.clear(),this.gfx.lineStyle(1,this.hover?16711680:306687,1),this.gfx.beginFill(this.hover?16711680:306687,.2);const[t,r]=o([this.city.centerLat,this.city.centerLon]);this.gfx.drawCircle(t,r,25),this.gfx.endFill()}}const Ti=e=>{const o=m(b),{initialized:t}=O();return R(["cities",o,t],()=>ci(o),{isPaused:()=>!t,onSuccess:e})},Si=({scene:e,latLngToPixel:o,pixelToLatLng:t,width:r,height:d})=>{const a=m(b),n=Lo(()=>new Z),{mutate:c}=Ti(p=>{n.removeChildren();for(let y=0;y<p.length;y++)n.addChild(new _i(p[y],u))}),l=g.exports.useCallback(async(p,y)=>{const f=await li(a,y,p),v={id:f.id,name:f.name,lonlat:[f.centerLon,f.centerLat],diameter:f.diameter};await jo(a,v),await yo(a,v,K[0]),c()},[a,c]),u=g.exports.useCallback(async p=>{await zr(a,p.id),c()},[a,c]);return{setup:g.exports.useCallback(()=>{const p=new Z;e.addChild(p),e.addChild(n),p.interactive=!0,p.hitArea=new xt(0,0,r,d),nt(p,y=>{const[f,v]=t([y.data.global.x,y.data.global.y]);l(f,v)})},[n,d,l,t,e,r]),update:g.exports.useCallback(()=>{for(let p=0;p<n.children.length;p++)n.children[p].update(o)},[n,o])}},Ni=e=>i(Ue,_(h({},e),{useRenderer:Si,options:{},cursor:"pointer"})),Ri=zt({a:t=>{var r=t,{children:e}=r,o=z(r,["children"]);const{href:d}=o,a=!!(d!=null&&d.startsWith("http"));return a?s(V,_(h({isExternal:a},o),{children:[e,i(Pt,{bottom:"2px",boxSize:"0.9em",position:"relative",ml:1})]})):i(V,_(h({to:d||""},o),{as:xo,children:e}))}}),T=t=>{var r=t,{children:e}=r,o=z(r,["children"]);return i(Mt,_(h({},o),{skipHtml:!0,components:Ri,children:Array.isArray(e)?e.filter(d=>d).map(d=>$(d||"")).join(`

`):$(e)}))},Oi=()=>s(q,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(q,{maxW:"container.md",mb:10,children:i(T,{children:`
            ## Admin

            You can configure cities and offers on this page. To learn more
            about this application please visit the [Overview page](/).
          `})}),i(Ai,{})]}),Ai=()=>s(C,{children:[i(q,{maxW:"container.md",mb:4,children:i(T,{children:`
            #### Cities
            ...
            remove it.
          `})}),i(Ni,{defaultZoom:4,defaultCenter:[39.716470511656766,-99.59395661915288],height:300})]}),Co=(()=>{const e=()=>crypto&&crypto.randomUUID?crypto.randomUUID():Ut();let o;return o=e(),console.log(`Session ID: ${o}`),o})(),Io=60,ge=()=>{const e=m(b),o=m(He),{connected:t,initialized:r}=O(),{data:d,mutate:a}=R([e,"useSession"],()=>ui(e,Co,Io),{refreshInterval:1e3,isPaused:()=>o||!t||!r});return{session:d||{sessionId:Co,isController:!1,expiresAt:new Date(Date.now()+Io*1e3)},refresh:a}},ct=()=>{const e=to(re),{session:o,refresh:t}=ge(),r=m(b),{connected:d,initialized:a}=O(),[n,c]=Q(!1),l=g.exports.useCallback(async()=>{c.on(),d&&a&&await Qo(r,o.sessionId,!0),e(!0),t(),c.off()},[r,d,c,a,t,o.sessionId,e]);return s(Ee,{status:"warning",borderRadius:"md",children:[i(_e,{}),i(Te,{children:"The simulator is disabled"}),i(A,{position:"absolute",right:4,top:3,size:"xs",colorScheme:"blue",disabled:n,onClick:l,children:"Enable simulator"})]})},wo=e=>{const{r:o,g:t,b:r}=e.rgb();return o<<16|t<<8|r};class Ci extends Z{constructor(o){super();S(this,"points");S(this,"polygon");S(this,"hovering",!1);this.config=o,this.points=kr(o.wktPolygon),this.polygon=new Ae,this.addChild(this.polygon),this.polygon.interactive=!0,this.polygon.on("mouseover",()=>{this.hovering=!0}),this.polygon.on("mouseout",()=>{this.hovering=!1})}update(o){const t=this.hovering?this.config.hoverColor:this.config.color;this.polygon.clear(),this.polygon.lineStyle(1,wo(t),.5),this.polygon.beginFill(wo(t),.2),this.polygon.drawPolygon(this.points.flatMap(([r,d])=>o([d,r]))),this.polygon.endFill()}}const Ii=e=>({scene:o,latLngToPixel:t,bounds:r})=>{const d=dt(r,100);return e.useCells(d,a=>{o.removeChildren();for(const n of a)o.addChild(new Ci(e.getCellConfig(n)))}),{update:g.exports.useCallback(()=>{for(let a=0;a<o.children.length;a++)o.children[a].update(t)},[t,o])}},lt=e=>{const a=e,{useCells:o,getCellConfig:t}=a,r=z(a,["useCells","getCellConfig"]),d=g.exports.useMemo(()=>Ii({useCells:o,getCellConfig:t}),[t,o]);return i(Ue,_(h({},r),{useRenderer:d,options:{}}))},wi=10*1e3,bo=e=>{const o=m(b),t=m(te),{initialized:r}=O(),{session:d}=ge(),a=g.exports.useCallback(n=>{const c=_(h({},o),{ctx:n});return Promise.all([Jo(c,t),ri(c),di(c,t),Zo(c)])},[o,t]);Qe(a,{name:"SimulatorMonitor",enabled:r&&e&&d.isController,intervalMS:wi})},Li=1*1e3,ki=1*1e3,st=e=>{const o=m(b),{initialized:t}=O(),r=g.exports.useRef(new Date(0).toISOString()),{session:d}=ge(),a=g.exports.useCallback(c=>go(_(h({},o),{ctx:c}),"minute"),[o]);Qe(a,{name:"SimulatorMatcher",enabled:t&&e&&d.isController,intervalMS:Li});const n=g.exports.useCallback(async c=>{r.current=await fo(_(h({},o),{ctx:c}),r.current)},[o]);Qe(n,{name:"SimulatorUpdateSegments",enabled:t&&e&&d.isController,intervalMS:ki})},eo=ue(",.2%"),le=ue(".4~s"),Di=()=>{const{initialized:e}=O(),o=m(re);return bo(o),st(o),i(q,{maxW:"container.lg",mt:10,mb:"30vh",children:e?o?s(F,{gap:10,children:[i(xi,{}),i(zi,{}),i(Ui,{})]}):i(ct,{}):i(pt,{})})},pt=()=>i(M,{children:i(U,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})}),xi=()=>{var d,a;const e=m(b),o=R(["overallConversionRateRequests",e],()=>Ao(e,"requests"),{refreshInterval:1e3}),t=R(["overallConversionRatePurchases",e],()=>Ao(e,"purchases"),{refreshInterval:1e3}),r=R(["analyticsTableCounts",e],()=>Ye(e,"offers","subscribers","notifications"),{refreshInterval:1e3});return!r.data||!o.data||!t.data?i(pt,{}):s(ke,{spacing:2,minChildWidth:"150px",flex:2,children:[s(I,{children:[i(w,{children:"Offers"}),i(L,{children:le(r.data.offers)})]}),s(I,{children:[i(w,{children:"Subscribers"}),i(L,{children:le(r.data.subscribers)})]}),s(I,{children:[i(w,{children:"Notifications"}),i(L,{children:le(r.data.notifications)})]}),s(I,{children:[i(w,{children:"Conversion Rate"}),i(L,{children:eo(((d=o.data)==null?void 0:d.conversionRate)||0)}),i(_o,{children:"Requests"})]}),s(I,{children:[i(w,{children:"Conversion Rate"}),i(L,{children:eo(((a=t.data)==null?void 0:a.conversionRate)||0)}),i(_o,{children:"Purchases"})]})]})},zi=()=>{var a;const e=m(b),[o,t]=g.exports.useState("conversionRate"),r=R(["customerMetrics",e,o],()=>si(e,"purchases",o,10),{refreshInterval:1e3}),d=Ce("blue.500","blue.200");return i(k,{overflowX:"auto",children:s(Bt,{size:"sm",colorScheme:"gray",variant:"striped",children:[i(Ft,{children:s(To,{children:[s(me,{onClick:()=>t("customer"),_hover:{color:d},color:o==="customer"?d:void 0,cursor:"pointer",children:["Customer",o==="customer"&&i(ne,{})]}),s(me,{onClick:()=>t("totalNotifications"),_hover:{color:d},color:o==="totalNotifications"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Notifications",o==="totalNotifications"&&i(ne,{})]}),s(me,{onClick:()=>t("totalConversions"),_hover:{color:d},color:o==="totalConversions"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Conversions",o==="totalConversions"&&i(ne,{})]}),s(me,{onClick:()=>t("conversionRate"),_hover:{color:d},color:o==="conversionRate"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Conversion Rate",o==="conversionRate"&&i(ne,{})]})]})}),i(Gt,{children:(a=r.data)==null?void 0:a.map(n=>s(To,{children:[i(ve,{children:n.customer}),i(ve,{isNumeric:!0,children:le(n.totalNotifications)}),i(ve,{isNumeric:!0,children:le(n.totalConversions)}),i(ve,{isNumeric:!0,children:eo(n.conversionRate)})]},n.customer))})]})})},Pi=(e,o)=>{const t=m(b);R(["zoneMetrics",t,e],()=>pi(t,e,"purchases"),{refreshInterval:1e3,onSuccess:o})},Mi=e=>qe(Yt(e))||qe(0,0,0),Ui=()=>s(F,{direction:["column","row"],alignItems:"top",children:[i(k,{flex:1,children:i(T,{children:`
            ### Conversion Map
          ...
          `})}),i(k,{flex:2,children:i(lt,{height:400,defaultZoom:14,useCells:Pi,getCellConfig:({conversionRate:e,wktPolygon:o})=>{const t=Mi(e);return{color:t,hoverColor:t.brighter(1),wktPolygon:o}}})})]}),be=({label:e,placeholder:o,value:t,setValue:r,helpText:d,type:a="text"})=>s(ro,{children:[i(io,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),i(zo,{size:"sm",placeholder:o,value:t,onChange:n=>r(n.target.value),type:a}),d?i(Ht,{fontSize:"xs",children:d}):null]}),Bi=()=>{const[e,o]=P(te);return s(ro,{children:[i(io,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),i(Wt,{size:"sm",required:!0,value:e.name,onChange:t=>{const r=t.target.value;o(yi(r))},children:K.map(t=>i("option",{value:t.name,children:t.name},t.name))})]})},ut=({showDatabase:e,showScaleFactor:o})=>{const[t,r]=P(et),[d,a]=P(ot),[n,c]=P(tt),[l,u]=P(oe);return s(F,{spacing:4,children:[i(be,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:t,setValue:r,helpText:i(T,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [HTTP API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),s(ke,{columns:2,gap:2,children:[i(be,{label:"Username",placeholder:"admin",value:d,setValue:a}),i(be,{label:"Password",placeholder:"",value:n,setValue:c,type:"password"}),e&&i(be,{label:"Database",placeholder:"martech",value:l,setValue:u}),o&&i(Bi,{})]})]})},yt=e=>i(A,_(h({onClick:()=>{const{pathname:o,hash:t}=window.location;window.location.replace(o+t)},colorScheme:"red"},e),{children:"Disconnect"})),gt=e=>{const{connected:o,initialized:t}=O(),r=ao(),[d,a]=Q(),n=m(oe),c=pe.useRef(null),f=e,{skipSeedData:l,disabled:u}=f,p=z(f,["skipSeedData","disabled"]),y=Ei({before:g.exports.useCallback(()=>a.on(),[a]),after:g.exports.useCallback(()=>{a.off(),r.onClose()},[r,a]),includeSeedData:!l});return s(C,{children:[i(A,h({disabled:!o||u,onClick:r.onOpen,colorScheme:t?"green":"red"},p)),i(jt,{isOpen:r.isOpen,onClose:r.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:c,children:i(no,{children:s(Vt,{children:[s(co,{fontSize:"lg",fontWeight:"bold",children:[t?"Reset":"Setup"," database ",n]}),s(lo,{children:["This will ",t?"recreate":"create"," the database called ",n,". Are you sure?"]}),s(Po,{children:[i(A,{ref:c,onClick:r.onClose,disabled:d,children:"Cancel"}),i(A,{disabled:d,colorScheme:t?"red":"green",onClick:y,ml:3,children:d?i(U,{}):t?"Recreate database":"Create database"})]})]})})})]})},Fi=({isOpen:e,onClose:o,finalFocusRef:t})=>{const[r,d]=P(re),{session:a,refresh:n}=ge(),c=r&&a.isController,l=m(b),{connected:u,initialized:p,isVapor:y}=O(),f=ao(),[v,N]=Q(!1),H=g.exports.useCallback(async()=>{N.on();const J=!(r&&a.isController);d(J),await Qo(l,a.sessionId,J),n(),N.off()},[l,r,n,a.isController,a.sessionId,d,N]),[ie,W]=Q(!1),de=g.exports.useCallback(async()=>{W.on(),await Xo(l),W.off()},[l,W]);return s($t,{isOpen:e,placement:"right",onClose:o,finalFocusRef:t,children:[i(no,{}),s(Kt,{children:[i(Mo,{}),i(co,{children:"Config"}),i(lo,{children:s(F,{spacing:4,children:[y?null:i(ut,{showScaleFactor:!0,showDatabase:!0}),s(Ee,{status:u?"success":"error",borderRadius:"md",children:[i(_e,{}),i(Te,{children:u?"connected":"disconnected"}),y?i(yt,{position:"absolute",right:4,top:3,size:"xs"}):null]}),s(Ee,{status:p?"success":"warning",borderRadius:"md",children:[i(_e,{}),i(Te,{children:"schema"}),i(gt,{position:"absolute",right:4,top:3,size:"xs",children:p?"Reset":"Setup"})]}),s(Ee,{status:c?"success":"warning",borderRadius:"md",children:[i(_e,{}),i(Te,{children:"simulator"}),i(Xt,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:c?"green":"red",isChecked:c,disabled:!u||!p||v,onChange:H})]}),s(ye,{onClick:f.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",f.isOpen?i(qt,{ml:2}):i(ne,{ml:2})]}),f.isOpen?i(A,{size:"xs",_hover:{colorScheme:"red"},onClick:de,disabled:ie,children:"Drop Database"}):void 0]})}),i(Po,{})]})]})},he=({to:e,children:o,onClick:t})=>{const r=rr(e),d=ir({path:r.pathname,end:!0});return i(V,{as:xo,to:e,px:2,py:1,onClick:t,rounded:"md",_hover:{textDecoration:"none",bg:Ce("gray.300","gray.600")},fontWeight:d?"bold":"normal",href:"#",color:Ce("gray.700","gray.200"),children:o})},Gi=()=>{const{colorMode:e,toggleColorMode:o}=De(),t=ao(),[r,d]=P(vi),a=pe.useRef(null),{connected:n,initialized:c}=O(),l=m(re),[u]=Uo("(max-width: 640px)"),{session:p}=ge(),y=s(C,{children:[i(he,{to:"/",onClick:t.onClose,children:"Overview"}),i(he,{to:"/map",onClick:t.onClose,children:"Map"}),i(he,{to:"/admin",onClick:t.onClose,children:"Admin"}),i(he,{to:"/analytics",onClick:t.onClose,children:"Analytics"})]}),f=n?c&&l&&p.isController?"green":"yellow":"red";let v;return u||(v=n?c?l&&p.isController?"connected":"simulator disabled":"needs schema":"disconnected"),i(C,{children:i(k,{bg:Ce("gray.200","gray.700"),children:s(q,{maxW:"container.lg",children:[s(Ie,{h:16,alignItems:"center",justifyContent:"space-between",children:[i(Ve,{size:"md",icon:t.isOpen?i(Jt,{}):i(Zt,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:t.isOpen?t.onClose:t.onOpen}),s(we,{spacing:8,alignItems:"center",children:[i(xe,{as:"h1",size:u?"sm":"md",children:u?"Martech":"Realtime Digital Marketing"}),i(we,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:y})]}),s(Ie,{alignItems:"center",gap:2,children:[s(A,{size:"sm",ref:a,onClick:()=>d(!0),colorScheme:f,children:[f==="green"?i(Bo,{}):i(Fo,{}),u||i(ye,{pl:2,children:v})]}),i(Ve,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?i(Qt,{size:"1.4em"}):i(er,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),i(Ve,{"aria-label":"Toggle Color Mode",size:"sm",onClick:o,icon:e==="light"?i(or,{boxSize:"1.2em"}):i(tr,{boxSize:"1.2em"})})]})]}),t.isOpen?i(k,{pb:4,display:{md:"none"},children:i(F,{as:"nav",spacing:4,children:y})}):null,i(Fi,{isOpen:r,onClose:()=>d(!1),finalFocusRef:a})]})})})},Yi=ue("~s"),ft=(e,...o)=>{const t=g.exports.useMemo(()=>o.reduce((a,n)=>_(h({},a),{[n]:[]}),{}),[o]),r=g.exports.useRef(t),{data:d}=R(["estimatedRowCount.timeseries",...o],async()=>{const a=await Ye(e,...o),n=new Date;return r.current=o.reduce((c,l)=>{const u=r.current[l];return u.push([n,a[l]]),c[l]=u.slice(-30),c},{}),r.current},{refreshInterval:1e3});return d!=null?d:t},mt=r=>{var d=r,{data:e,yAxisLabel:o}=d,t=z(d,["data","yAxisLabel"]);const{colorMode:a}=De(),n=Object.keys(e),c=g.exports.useCallback(({tooltipData:p,colorScale:y})=>!y||!p?null:n.sort((f,v)=>p.datumByKey[v].datum[1]-p.datumByKey[f].datum[1]).map(f=>{const{datum:v}=p.datumByKey[f];return s(ye,{mb:1,color:y(f),fontSize:"sm",children:[f,": ",ue(".4~s")(v[1])]},f)}),[n]),l=g.exports.useCallback(p=>Yi(p).replace("G","B"),[]);if(n.some(p=>e[p].length<2))return i(M,{height:t.height,children:i(U,{size:"md"})});const u=n.map(p=>i(dr,{dataKey:p,data:e[p],xAccessor:y=>y[0],yAccessor:y=>y[1]},p));return s(ar,_(h({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:a==="light"?nr:cr,margin:{left:0,right:50,top:10,bottom:40}},t),{children:[i(So,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),i(So,{orientation:"right",numTicks:t.height<250?3:5,tickFormat:l,label:o,labelOffset:20}),u,i(lr,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:c})]}))},oo=1e3,Re=60*oo,Oe=60*Re,Ke=24*Oe,B=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),X=e=>e?e<oo?`${B(e)}ms`:e<Re?`${B(e/oo)}s`:e<Oe?`${Math.floor(e/Re)}m${X(e%Re)}`:e<Ke?`${Math.floor(e/Oe)}h${X(e%Oe)}`:`${Math.floor(e/Ke)}d${X(e%Ke)}`:"0s",Hi=100,Wi=1e3,j=class extends Z{constructor(o){super();S(this,"latlng");S(this,"age",0);S(this,"marker");S(this,"pulse");this.latlng=o,this.marker=new Ae,this.marker.beginFill(j.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new Ae,this.pulse.beginFill(j.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(o,t){if(this.age+=t/60,this.age>j.lifetime&&this.parent){this.parent.removeChild(this);return}const r=this.age%j.lifetime/j.lifetime,d=yr(r);this.pulse.scale.set(1+d);const a=.4,n=r<a?sr(r/a):1-pr((r-a)/(1-a));this.pulse.alpha=n,r<a?this.marker.alpha=n:this.marker.alpha=1-ur((r-a)/(1-a));const[c,l]=o(this.latlng);this.x=c,this.y=l}};let ce=j;S(ce,"lifetime",1.5),S(ce,"markerColor",306687),S(ce,"pulseColor",306687);const vt=()=>{const e=m(b),{initialized:o}=O();return g.exports.useMemo(()=>["notifications",e,o],[e,o])},bt=({scene:e,latLngToPixel:o,bounds:t})=>{const r=g.exports.useRef(new Date().toISOString()),d=m(b),{initialized:a}=O(),n=dt(t,50),c=vt();return R(c,()=>ai(d,r.current,Hi,n),{refreshInterval:Wi,isPaused:()=>!a,onSuccess:l=>{if(l.length>0){r.current=l[0][0];for(const[,u,p]of l)e.addChild(new ce([p,u]))}}}),{update:g.exports.useCallback(l=>{for(let u=e.children.length-1;u>=0;u--)e.children[u].update(o,l)},[o,e])}},ji=()=>{const e=m(b),o=ft(e,"locations","requests","purchases","notifications","subscriber_segments"),t=R(["notificationsMapTableCounts",e],()=>Ye(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),r=m(Ze("SimulatorMatcher")),d=m(Ze("SimulatorUpdateSegments")),a=ue(".4~s"),n=t.data?s(ke,{spacing:2,minChildWidth:"120px",children:[s(I,{children:[i(w,{children:"Offers"}),i(L,{children:a(t.data.offers)})]}),s(I,{children:[i(w,{children:"Cities"}),i(L,{children:a(t.data.cities)})]}),s(I,{children:[i(w,{children:"Subscribers"}),i(L,{children:a(t.data.subscribers)})]}),s(I,{children:[i(w,{children:"Segments"}),i(L,{children:a(t.data.segments)})]}),s(I,{children:[i(w,{children:"Segmentation"}),i(L,{children:X(d)})]}),s(I,{children:[i(w,{children:"Matching"}),i(L,{children:X(r)})]})]}):null;return s(C,{children:[i(T,{children:`
          ...
          about the demo.
        `}),n,s(k,{children:[i(ye,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),i(mt,{data:o,yAxisLabel:"total rows",height:150})]})]})},Vi=()=>{const{connected:e,initialized:o}=O(),t=m(re);return bo(t&&e&&o),st(t&&e&&o),s(Ie,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[i(F,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:i(Ue,{useRenderer:bt,options:{}})}),s(F,{spacing:4,flex:"1 1 0",minWidth:"0",children:[i(T,{children:`
          ...
          `}),t?i(ji,{}):i(ct,{})]})]})},ht=t=>{var r=t,{children:e}=r,o=z(r,["children"]);return i(gr,_(h({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},o),{children:e}))},$i=1e3,Ki=(e,o)=>{const t=m(b),{initialized:r}=O();R(["offers",t,r,e],()=>ni(t,$i,e),{isPaused:()=>!r,onSuccess:o})},Xi=e=>i(lt,_(h({},e),{useCells:Ki,getCellConfig:o=>{const t=qe(4,173,255);return{color:t,hoverColor:t.brighter(1),wktPolygon:o.notificationZone}}})),qi=e=>e.every(([,o])=>o===0),G=e=>{const{completed:o,title:t,left:r,right:d}=e,{colorMode:a}=De(),n=a==="light"?".300":".500",c=o?"gray"+n:void 0,l=(o?"green":"gray")+n;return s(C,{children:[s(Le,{children:[s(xe,{as:"h2",size:"lg",mb:4,color:c,children:[i(Bo,h({color:l},{boxSize:6,position:"relative",bottom:.5,mr:2})),t]}),r]}),i(Le,{children:d})]})},Ji=({connected:e,isVapor:o})=>o?i(G,{completed:e,title:"Connected",left:s(C,{children:[i(T,{children:`
            ...
            **Note**: The HTTP API may need to be enabled on your SingleStore
            ...
            [1]: https://docs.singlestore.com/docs/http-api/
          `}),right:i(ut,{})}),Zi=({onClose:e,schemaObjectName:o})=>{const t=Zr(o),[r]=Uo("(max-width: 640px)");return s(br,{isOpen:!0,onClose:e,size:r?"full":"4xl",scrollBehavior:"inside",children:[i(no,{}),s(hr,{children:[s(co,{children:["Create statement for ",t.name]}),i(Mo,{}),i(lo,{children:i(ht,{mb:4,children:t.createStmt})})]})]})},Qi=({initialized:e})=>{const[o,t]=P(oe),r=it(),{colorMode:d}=De(),[a,n]=g.exports.useState(),c=g.exports.useCallback(u=>n(u),[]),l=g.exports.useCallback(()=>n(null),[]);return s(C,{children:[!!a&&i(Zi,{onClose:l,schemaObjectName:a}),i(G,{completed:e,title:"Setup the schema",left:s(C,{children:[i(T,{children:`
          ...
          `}),right:u||!r?i(M,{h:220,children:s(A,{colorScheme:"blue",size:"sm",onClick:n,disabled:r,children:[(d||r)&&i(U,{mr:2}),d?"Creating Pipelines":r?"...waiting for data":"Create pipelines"]})}):i(mt,{data:l,yAxisLabel:"total rows",height:200})})},We=(e,o=!0)=>R(["overviewTableCounts",e],()=>Ye(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!o}),od=()=>{var c,l;const e=m(b),o=m(te),[t,r]=Q(),d=We(e),a=g.exports.useCallback(async()=>{r.on(),await yo(e,se,o),d.mutate(),r.off()},[e,o,d,r]),n=!!((c=d.data)!=null&&c.offers);return i(G,{completed:n,title:"Offers",left:i(C,{children:s(T,{children:[`
            ...
            `,n&&`
                ...
                database.
            `]})}),right:n?i(Xi,{height:300,defaultZoom:13}):i(M,{h:"100%",children:s(A,{onClick:a,disabled:t,children:[t&&i(U,{mr:2}),t?"loading...":n?"loaded offers!":"load offers"]})})})},td=({done:e,setDone:o})=>{const t=m(b),r=g.exports.useRef(new Date().toISOString());return g.exports.useEffect(()=>{if(e)return;const d=new AbortController,a=_(h({},t),{ctx:d});return(async()=>{try{for(let n=0;n<10;n++)if(r.current=await fo(a,r.current,!1),await go(a,"second"),n>1&&!await Zo(a))return}catch(n){if(d.signal.aborted||n instanceof DOMException&&n.name==="AbortError")return;throw n}})().then(()=>o(!0)),()=>{d.abort()}},[t,e,o]),e?null:i(Le,{colSpan:[1,1,2],children:s(M,{w:"100%",h:"200px",color:"gray.500",children:[i(U,{size:"md",mr:4}),i(xe,{size:"md",children:"Warming up queries..."})]})})},rd=()=>{var p;const e=m(b),o=We(e),{elapsed:t,isRunning:r,startTimer:d,stopTimer:a}=at(),n=g.exports.useRef(new Date().toISOString()),c=!!((p=o.data)!=null&&p.subscriber_segments),l=g.exports.useCallback(async()=>{d(),n.current=await fo(e,n.current),a(),o.mutate()},[e,o,d,a]);let u;if(t&&o.data){const{segments:y,subscriber_segments:f,locations:v,requests:N,purchases:H}=o.data,ie=X(t),W=B(v+N+H),de=B(y),J=B(f);u=i(T,{children:`
        ...
        `})}return i(G,{completed:c,title:"Segmentation",left:i(T,{children:`
          ...
          `}),right:i(M,{h:"100%",children:s(Go,{gap:4,textAlign:"center",children:[s(A,{disabled:r,onClick:l,children:[r&&i(U,{mr:2}),r?"...running":"Match subscribers to segments"]}),u]})})})},id=()=>{var v;const e=m(b),o=We(e),t=vt(),{mutate:r}=vr(),{elapsed:d,isRunning:a,startTimer:n,stopTimer:c}=at(),[l,u]=g.exports.useState(0),p=!!((v=o.data)!=null&&v.notifications),y=g.exports.useCallback(async()=>{let N=0,H=0;for(;N===0&&H++<10;)n(),N=await go(e,"second");c(),u(N),o.mutate(),r(t)},[e,n,c,o,r,t]);let f;if(d&&o.data){const{offers:N,subscribers:H,subscriber_segments:ie,notifications:W}=o.data,de=B(N*H+W),J=B(ie),Tt=X(d),St=B(l);f=i(T,{children:`
        ...
        `})}return i(G,{completed:p,title:"Matching",left:i(T,{children:`
          ...
          `}),right:i(M,{h:"100%",children:s(Go,{gap:4,w:"100%",children:[s(A,{disabled:a,onClick:y,children:[a&&i(U,{mr:2}),a?"...running":"Generate notifications"]}),i(k,{width:"100%",children:i(Ue,{height:250,defaultZoom:12,useRenderer:bt,options:{}})}),f]})})})},dd=()=>{const e=m(oe);return i(G,{completed:!0,title:"Putting it all together",left:i(T,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: map
          `}),right:null})},ad=()=>{const e=m(b),o=m(te),{connected:t,initialized:r,isVapor:d}=O(),{completed:a}=Et(e,o,t&&r),{data:n}=We(e,t&&r),[c,l]=g.exports.useState(!1),u=[{completed:t,component:i(Ji,{connected:t,isVapor:d},"connection")},{completed:r,component:i(Qi,{initialized:r},"schema")},{completed:a,component:i(ed,{},"pipelines")},{completed:n?n.offers>0:!1,component:i(od,{},"offers")},{completed:c,component:i(td,{done:c,setDone:l},"warmup")},{completed:n?n.subscriber_segments>0:!1,component:i(rd,{},"segmentation")},{completed:n?n.notifications>0:!1,component:i(id,{},"matching")},{completed:!0,component:i(dd,{},"summary")}];let p=!0;const y=[];for(const{completed:f,component:v}of u)if(p)y.push(v),p=f;else break;return s(q,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(k,{maxW:"container.md",mb:10,px:0,children:i(T,{children:`
