...
`),{sql:a,params:n}=Ct(o);return{sql:U`
    ...
    `,t.id,t.name,`POINT(${t.lonlat[0]} ${t.lonlat[1]})`,t.diameter),Gr=(e,t)=>v(e,"DELETE FROM cities WHERE city_id = ?",t),Yr=["olc_8","purchase","request"],Hr=["minute","hour","day","week","month"],qt=({interval:e,kind:t,value:o})=>zo(`${e}-${t}-${o}`),Wr=async(e,t)=>{const{sql:o,params:r}=$t({table:"segments",options:{replace:!0},columns:["segment_id","valid_interval","filter_kind","filter_value"],tuples:t.map(d=>[qt(d),d.interval,d.kind,d.value])});await v(e,o,...r)},jr=async(e,t)=>{const o={table:"offers",options:{replace:!0},columns:["customer","notification_zone","segment_ids","notification_content","notification_target","maximum_bid_cents"],tuples:[]};let r=0,d=[];const a=async()=>{const{sql:n,params:c}=$t(o);await Promise.all([v(e,n,...c),Wr(e,d)]),o.tuples=[],d=[],r=0};for(const n of t)o.tuples.push([n.customer,n.notificationZone,JSON.stringify(n.segments.map(qt)),n.notificationContent,n.notificationTarget,n.maximumBidCents]),r++,d=d.concat(n.segments),r>=Fr&&await a();r>0&&await a()},Vr=()=>Kt(Yr),$r=()=>Kt(Hr),Jt=({vendor:e,tld:t})=>`${e.toLowerCase()}.${t}`,Zt=e=>{const[t,o]=e.lonlat,r=e.diameter/2,[d,a]=[t-r,t+r],[n,c]=[o-r,o+r];return[tt(d,a),tt(n,c)]},Kr=(e,t)=>{const o=Vr(),r=$r();switch(o){case"olc_8":{const[d,a]=Zt(e),n=Qe.encode(a,d,8).substring(0,8);return{kind:o,interval:r,value:n}}case"purchase":return{kind:o,interval:r,value:t.vendor};case"request":return{kind:o,interval:r,value:Jt(t)}}},Xr=e=>{const t=Re(1,3),o=Br(),r=Array.from({length:t},()=>Kr(e,o)),d=Jt(o),n=`${Re(10,50)}% off at ${o.vendor}`,c=d,[l,u]=Zt(e),p=Qe.encode(u,l,8),y=Qe.decode(p),f={ne:[y.latitudeHi,y.longitudeHi],sw:[y.latitudeLo,y.longitudeLo]};return{customer:o.vendor,segments:r,notificationZone:Be(f),notificationContent:n,notificationTarget:c,maximumBidCents:Re(2,15)}},qr=(e,t)=>Array.from({length:t},()=>Xr(e)),Jr=e=>(t,o,r,d=1)=>`https://stamen-tiles.a.ssl.fastly.net/${e}/${r}/${t}/${o}${d>=2?"@2x":""}.png`,Zr=s(I,{children:["Map tiles by ",i(K,{href:"http://stamen.com",children:"Stamen Design"}),", under"," ",i(K,{href:"http://creativecommons.org/licenses/by/3.0",children:"CC BY 3.0"}),". Data by ",i(K,{href:"http://openstreetmap.org",children:"OpenStreetMap"}),", under"," ",i(K,{href:"http://www.openstreetmap.org/copyright",children:"ODbL"}),"."]}),Qr=[ue.lonlat[1],ue.lonlat[0]],ei=12,ti=({width:e,height:t,bounds:o,latLngToPixel:r,pixelToLatLng:d,useRenderer:a,options:n})=>{const c=ye.useRef(null),l=nt(()=>new ee),{setup:u,update:p}=a({scene:l,width:e,height:t,bounds:o,latLngToPixel:r,pixelToLatLng:d,options:n});return g.exports.useLayoutEffect(()=>{if(!c.current)throw new Error("No canvas ref");console.log("PixiMapLayer: Setup");const y=new Mo({view:c.current,width:e,height:t,backgroundAlpha:0,antialias:!0});return y.stage.addChild(l),u==null||u(),p&&y.ticker.add(f=>{p(f)}),()=>{console.log("PixiMapLayer: Destroy"),y.stage.removeChild(l),y.destroy(!1,{children:!1,texture:!0,baseTexture:!0})}},[t,l,u,p,e]),i("canvas",{ref:c})},oi=({mapState:e,latLngToPixel:t,pixelToLatLng:o,useRenderer:r,options:d})=>{const{width:a,height:n,bounds:c}=e||{width:0,height:0};return a<=0||n<=0||!t||!o||!c?null:i(ti,{useRenderer:r,width:a,height:n,bounds:c,latLngToPixel:t,pixelToLatLng:o,options:d})},Fe=n=>{var c=n,{height:e="100%",defaultCenter:t=Qr,defaultZoom:o=ei,useRenderer:r,options:d}=c,a=M(c,["height","defaultCenter","defaultZoom","useRenderer","options"]);const[l,u]=g.exports.useState(t),[p,y]=g.exports.useState(o);return i(z,S(_({borderRadius:"lg",overflow:"hidden",height:e},a),{children:i(Po,{dprs:[1,2],provider:Jr("toner-lite"),attribution:Zr,maxZoom:20,center:l,zoom:p,onBoundsChanged:({center:f,zoom:h})=>{u(f),y(h)},children:i(oi,{useRenderer:r,options:d})})}))};var Ge=[{name:"date_sub_dynamic",createStmt:`CREATE OR REPLACE FUNCTION date_sub_dynamic (
  _dt DATETIME(6),
...
BEGIN
  ...
  END IF;
END`}],Ye=[{name:"process_locations",createStmt:`CREATE OR REPLACE PROCEDURE process_locations (
  _batch QUERY(
  ...
  EXCEPTION
    WHEN OTHERS THEN
      IF SCALAR(_num_transactions) > 0 THEN
        ROLLBACK;
      END IF;
END`}],He=[{name:"worldcities",createStmt:`create rowstore table if not exists worldcities (
  ...
  SHARD KEY (city_id, subscriber_id),
  SORT KEY (ts)
);`},{name:"segments",createStmt:`create rowstore reference table if not exists segments (
...
);`},{name:"subscriber_segments",createStmt:`create rowstore table if not exists subscriber_segments (
  city_id BIGINT NOT NULL,
  subscriber_id BIGINT NOT NULL,
  segment_id BIGINT NOT NULL,
  ...
  SELECT * FROM dynamic_subscriber_segments_purchases(_since, _until)
);`}];const Ae="singlestore-realtime-digital-marketing",ri=e=>{const t=He.find(d=>d.name===e);if(t)return t;const o=Ye.find(d=>d.name===e);if(o)return o;const r=Ge.find(d=>d.name===e);if(r)return r;throw new Error("Could not find schema object: "+e)},ii=async e=>{try{return await mt(e,"SELECT 1"),!0}catch{return!1}},di=async e=>{let t={tables:[],procedures:[],functions:[]};const c=e,{database:o}=c,r=M(c,["database"]);try{t=(await ft(r,`
        ...
        `,o,o)).reduce((l,[u,p])=>(l[u].push(p),l),t)}catch(l){if(!(l instanceof P&&(l.isUnknownDatabase()||l.isDatabaseRecovering())))throw l}const{tables:d,procedures:a,functions:n}=t;return Object.fromEntries([He.map(({name:l})=>[l,d.includes(l)]),Ye.map(({name:l})=>[l,a.includes(l)]),Ge.map(({name:l})=>[l,n.includes(l)])].flat())},Qt=e=>mt(e,"DROP DATABASE IF EXISTS `"+e.database+"`"),ai=async(e,{progress:t,scaleFactor:o,includeSeedData:r,resetDataOnly:d=!1})=>{d||(t("Dropping existing schema","info"),await Qt(e),t("Creating database","info"),await mt(e,"CREATE DATABASE `"+e.database+"`")),d&&(t("Resetting data","info"),await li(e),await ci(e));for(const a of Ge)t(`Creating function: ${a.name}`,"info"),await v(e,a.createStmt);for(const a of He)t(`Creating table: ${a.name}`,"info"),await v(e,a.createStmt);for(const a of Ye)t(`Creating procedure: ${a.name}`,"info"),await v(e,a.createStmt);t("Initializing reference data","info"),await ni(e),await Xt(e,ue),r&&(t("Creating sample data","info"),await ht(e,ue,o)),t("Schema initialized","success")},ni=async e=>{(await ve(e,`
      select count(*) as c from information_schema.links
      where database_name = ? and link = "aws_s3"
    `,e.database)).c===0&&await v(e,`CREATE LINK aws_s3 AS S3 CREDENTIALS '{}' CONFIG '{ "region": "us-east-1" }'`),await v(e,`
      CREATE OR REPLACE PIPELINE worldcities
      AS LOAD DATA LINK aws_s3 '${Ae}/cities.ndjson'
    ...
    `),await v(e,"START PIPELINE worldcities")},ht=(e,t,o)=>{const r=100*o.partitions,d=qr(t,r);return jr(e,d)},ke=["locations","requests","purchases"],eo=async(e,t)=>{const o=t.prefix,r=await V(e,`
      SELECT
    ...
    `,e.database,...ke);return ke.map(d=>{var n;const a=r.find(c=>c.pipelineName===d);return{pipelineName:d,needsUpdate:(n=a==null?void 0:a.needsUpdate)!=null?n:!0}})},ci=e=>Promise.all([v(e,"TRUNCATE TABLE cities"),v(e,"TRUNCATE TABLE locations"),v(e,"TRUNCATE TABLE notifications"),v(e,"TRUNCATE TABLE offers"),v(e,"TRUNCATE TABLE purchases"),v(e,"TRUNCATE TABLE requests"),v(e,"TRUNCATE TABLE segments"),v(e,"TRUNCATE TABLE sessions"),v(e,"TRUNCATE TABLE subscriber_segments"),v(e,"TRUNCATE TABLE subscribers"),v(e,"TRUNCATE TABLE subscribers_last_notification")]),to=(e,t)=>{switch(e){case"locations":return U`
        CREATE OR REPLACE PIPELINE ${e}
        AS LOAD DATA LINK aws_s3 '${Ae}/${t.prefix}/locations.*'
    ...
    `,e.database);await Promise.all(t.map(async([o])=>{console.log("restarting pipeline",o),await v(e,`ALTER PIPELINE ${o} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await v(e,`START PIPELINE IF NOT RUNNING ${o}`)}))},bt=async e=>{const t=await V(e,`
      SELECT plan_id AS planId
      FROM information_schema.plancache
      WHERE
        plan_warnings LIKE "%empty tables%"
    `);try{await Promise.all(t.map(({planId:o})=>v(e,`DROP ${o} FROM PLANCACHE`)))}catch(o){if(!(o instanceof P&&o.isPlanMissing()))throw o}return t.length>0},pi=(e,...t)=>{const o=t.map(r=>`"${r}"`).join(",");return Vt(e,`
      ...
      GROUP BY tableName
    `,e.database)},We=(e,...t)=>pi(e,...t).then(o=>o.reduce((r,{tableName:d,count:a})=>(r[d]=a,r),{})),ui=async(e,t)=>{const{maxRows:o}=t,d=["locations","requests","purchases","notifications"].map(n=>`"${n}"`).join(","),a=await Vt(e,`
      SELECT
      ...
      WHERE
        ...
        AND stats.count > ?
    `,e.database,o);await Promise.all(a.map(async({tableName:n,count:c,minTs:l,maxTs:u})=>{const y=(c-o)/c;if(y<.2)return;const f=new Date((l+y*(u-l))*1e3);console.log(`removing rows from ${n} older than ${f.toISOString()}`),await v(e,`DELETE FROM ${n} WHERE ts <= ?`,f.toISOString())}))},ro=(e,t="minute")=>ve(e,"ECHO run_matching_process(?)",t).then(o=>o.RESULT),io=async(e,t,o=!0)=>{const r=new Date().toISOString();return await v(e,"CALL update_segments(?, ?)",t,r),o&&await v(e,"CALL prune_segments(?)",r),r},yi=(e,t,o,r)=>ft(e,`
      SELECT
        ts,
...
`,vi=(e,t,o,r)=>V(e,vt({with:[["metrics",Et(t)]],base:`
        SELECT
        ...
        ORDER BY ${o} DESC
        LIMIT ${r}
      `}).sql),Lt=(e,t)=>ve(e,vt({with:[["metrics",Et(t)]],base:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `}).sql),hi=(e,t,o)=>{const r=vt({with:[["metrics",Et(o)]],base:{sql:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `,params:[Be(t)]}});return V(e,r.sql,...r.params)},bi=(e,t,o)=>ve(e,"CALL update_sessions(?, ?)",t,o).then(({session_id:r,is_controller:d,expires_at:a})=>({sessionID:r,isController:d,expiresAt:new Date(a)})),ao=(e,t,o)=>v(e,`
      UPDATE sessions
    ...
    `,o,t,t),X=[{name:"s00",maxRows:1e7,prefix:"v2/100k-2p",partitions:2},{name:"s0",maxRows:2e7,prefix:"v2/100k-4p",partitions:4},{name:"s1",maxRows:4e7,prefix:"v2/100k-8p",partitions:8},{name:"s2",maxRows:16e7,prefix:"v2/1m-16p",partitions:16},{name:"s4",maxRows:32e7,prefix:"v2/1m-32p",partitions:16},{name:"s8",maxRows:64e7,prefix:"v2/1m-64p",partitions:64},{name:"s10",maxRows:1e9,prefix:"v2/10m-80p",partitions:80}],Ei=e=>X.find(t=>t.name===e)||X[0],re=({encode:e,decode:t}={encode:JSON.stringify,decode:JSON.parse})=>({setSelf:o,onSet:r,node:d})=>{const a=`recoil.localstorage.${d.key}`,n=localStorage.getItem(a);n!=null&&o(t(n)),r((c,l,u)=>{u?localStorage.removeItem(a):localStorage.setItem(a,e(c))})},no=()=>({setSelf:e,node:{key:t}})=>{const{location:o}=window;if(o){const r=new URLSearchParams(o.search);e(r.get(t)||new Uo)}},_i=B({key:"sessionID",default:null,effects:[no()]}),Ti=B({key:"vaporBaseUrl",default:"https://vapor.labs.singlestore.com",effects:[no()]}),co=B({key:"connectionHost",default:"http://127.0.0.1",effects:[re()]}),lo=B({key:"connectionUser",default:"root",effects:[re()]}),so=B({key:"connectionPassword",default:"",effects:[re()]}),ie=B({key:"connectionDatabase",default:"martech",effects:[re()]}),po=zt({key:"vaporConnectionConfig",get:async({get:e})=>{const t=e(_i),o=e(Ti);if(t&&o)try{const r=await fetch(o+"/api/v1/connect?sessionID="+t);if(r.status===200){const d=await r.json();return{host:"https://"+d.endpoint,user:d.user,password:d.password,database:e(ie)}}}catch{console.log(`Failed to connect to vapor at ${o}, falling back to local config`)}}}),E=zt({key:"connectionConfig",get:({get:e})=>{const t=e(po);if(t)return t;const o=e(co),r=e(lo),d=e(so),a=e(ie);return{host:o,user:r,password:d,database:a}},cachePolicy_UNSTABLE:{eviction:"most-recent"}}),de=B({key:"configScaleFactor",default:X[0],effects:[re({encode:e=>e.name,decode:e=>X.find(t=>t.name===e)||X[0]})]}),ae=B({key:"simulatorEnabled",default:!0,effects:[re()]}),Si=B({key:"databaseDrawerIsOpen",default:!1}),ot=Bo({key:"tickDurationMs",default:void 0}),je=B({key:"resettingSchema",default:!1}),Ni=Object.fromEntries([He.map(({name:e})=>[e,!1]),Ye.map(({name:e})=>[e,!1]),Ge.map(({name:e})=>[e,!1])].flat()),uo=(e=!1)=>{const t=m(E);return R(["schemaObjects",t,e],()=>di(t),{isPaused:()=>e,refreshInterval:o=>Object.values(o||[]).some(d=>!d)?1e3:0,fallbackData:Ni})},A=()=>{const a=m(E),{database:e}=a,t=M(a,["database"]),o=m(po),r=R(["isConnected",t],()=>ii(t)),d=uo(!r.data);return{isVapor:!!o,connected:!!r.data,initialized:!!r.data&&Object.values(d.data||[]).every(Boolean),reset:()=>{r.mutate(),d.mutate()}}},Ri=(()=>{let e={};return t=>(t in e||(e[t]=1),`${t}(${e[t]++})`)})(),rt=(e,{name:t,enabled:o,intervalMS:r})=>{const d=ct(ot(t));g.exports.useEffect(()=>{if(!o)return;const a=new AbortController,n=Ri(t);console.log(`Starting ${n}: tick interval: ${r}ms`);const c=async()=>{try{if(console.time(n),a.signal.aborted)return;const l=performance.now();await e(a);const u=performance.now()-l;d(u),setTimeout(c,Math.max(0,r-u))}catch(l){if(a.signal.aborted||l instanceof P&&l.isUnknownDatabase()||l instanceof DOMException&&l.name==="AbortError")return;throw l}finally{console.timeEnd(n)}};return c(),()=>{console.log(`Stopping ${n}`),a.abort()}},[o,e,r,t,d])},Ai=()=>{const{cache:e}=Mt();if(!(e instanceof Map))throw new Error("useInvalidateSWRCache requires the cache provider to be a Map instance");return g.exports.useCallback(()=>e.clear(),[e])},Oi=({before:e,after:t,includeSeedData:o,resetDataOnly:r=!1})=>{const d=m(E),a=m(de),{reset:n}=A(),[c,l]=F(ae),u=Pt(),p=ct(je),y=Ai();return g.exports.useCallback(async()=>{const f=c;l(!1),p(!0),e(),await ai(d,{progress(h,b){const O="reset-schema";u.isActive(O)?u.update(O,{title:h,status:b,duration:b==="success"?2e3:null,isClosable:!0}):u({id:O,title:h,status:b,duration:null})},scaleFactor:a,includeSeedData:o,resetDataOnly:r}),t(),n(),y(),l(f),p(!1)},[c,l,p,e,d,a,o,r,t,n,y,u])},yo=(e,t)=>{const[o,r]=g.exports.useState(e);return g.exports.useEffect(()=>{const d=setTimeout(()=>r(e),t);return()=>clearTimeout(d)},[e,t]),o},go=()=>{const[{elapsed:e,isRunning:t},o]=g.exports.useReducer((r,d)=>{switch(d.type){case"start":return{start:Math.floor(performance.now()),isRunning:!0,elapsed:r.elapsed};case"stop":return{elapsed:Math.floor(performance.now())-(r.start||0),isRunning:!1}}},{isRunning:!1});return{elapsed:e,isRunning:t,startTimer:()=>o({type:"start"}),stopTimer:()=>o({type:"stop"})}},fo=(e,t)=>{let o=!1,r=new Fo(0,0),d=0;e.on("pointerdown",a=>{o=!0,r=a.data.global,d=performance.now()}),e.on("pointerup",a=>{if(!o||(o=!1,performance.now()-d>200))return;const c=a.data.global;Math.sqrt(Math.pow(c.x-r.x,2)+Math.pow(c.y-r.y,2))>10||t(a)}),e.on("pointercancel",()=>{o=!1})};class Ci extends ee{constructor(t,o){super();T(this,"gfx");T(this,"hover",!1);this.city=t,this.onRemove=o,this.gfx=new Ie,this.addChild(this.gfx),this.gfx.interactive=!0,this.gfx.on("pointerover",()=>{this.hover=!0}),this.gfx.on("pointerout",()=>{this.hover=!1}),fo(this.gfx,()=>o(this.city))}update(t){this.gfx.clear(),this.gfx.lineStyle(1,this.hover?16711680:306687,1),this.gfx.beginFill(this.hover?16711680:306687,.2);const[o,r]=t([this.city.centerLat,this.city.centerLon]);this.gfx.drawCircle(o,r,25),this.gfx.endFill()}}const Ii=e=>{const t=m(E),{initialized:o}=A();return R(["cities",t,o],()=>fi(t),{isPaused:()=>!o,onSuccess:e})},wi=({scene:e,latLngToPixel:t,pixelToLatLng:o,width:r,height:d})=>{const a=m(E),n=nt(()=>new ee),{mutate:c}=Ii(p=>{n.removeChildren();for(let y=0;y<p.length;y++)n.addChild(new Ci(p[y],u))}),l=g.exports.useCallback(async(p,y)=>{const f=await mi(a,y,p),h={id:f.id,name:f.name,lonlat:[f.centerLon,f.centerLat],diameter:f.diameter};await Xt(a,h),await ht(a,h,X[0]),c()},[a,c]),u=g.exports.useCallback(async p=>{await Gr(a,p.id),c()},[a,c]);return{setup:g.exports.useCallback(()=>{const p=new ee;e.addChild(p),e.addChild(n),p.interactive=!0,p.hitArea=new Go(0,0,r,d),fo(p,y=>{const[f,h]=o([y.data.global.x,y.data.global.y]);l(f,h)})},[n,d,l,o,e,r]),update:g.exports.useCallback(()=>{for(let p=0;p<n.children.length;p++)n.children[p].update(t)},[n,t])}},Li=e=>i(Fe,S(_({},e),{useRenderer:wi,options:{},cursor:"pointer"})),Di=Yo({a:o=>{var r=o,{children:e}=r,t=M(r,["children"]);const{href:d}=t,a=!!(d!=null&&d.startsWith("http"));return a?s(K,S(_({isExternal:a},t),{children:[e,i(Ho,{bottom:"2px",boxSize:"0.9em",position:"relative",ml:1})]})):i(K,S(_({to:d||""},t),{as:Ut,children:e}))}}),N=o=>{var r=o,{children:e}=r,t=M(r,["children"]);return i(Wo,S(_({},t),{skipHtml:!0,components:Di,children:Array.isArray(e)?e.filter(d=>d).map(d=>U(d||"")).join(`

`):U(e)}))},ki=()=>s(te,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(te,{maxW:"container.md",mb:4,children:i(N,{children:`
            ## City Admin
            ...
            remove it.
          `})}),i(Li,{defaultZoom:4,defaultCenter:[39.716470511656766,-99.59395661915288],height:500})]}),Dt=(()=>{const e=()=>crypto&&crypto.randomUUID?crypto.randomUUID():jo();let t;return t=e(),console.log(`Session ID: ${t}`),t})(),kt=60,he=()=>{const e=m(E),t=m(je),{connected:o,initialized:r}=A(),{data:d,mutate:a}=R([e,"useSession"],()=>bi(e,Dt,kt),{refreshInterval:1e3,isPaused:()=>t||!o||!r});return{session:d||{sessionID:Dt,isController:!1,expiresAt:new Date(Date.now()+kt*1e3)},refresh:a}},mo=()=>{const e=ct(ae),{session:t,refresh:o}=he(),r=m(E),{connected:d,initialized:a}=A(),[n,c]=oe(!1),l=g.exports.useCallback(async()=>{c.on(),d&&a&&await ao(r,t.sessionID,!0),e(!0),o(),c.off()},[r,d,c,a,o,t.sessionID,e]);return s(Z,{status:"warning",borderRadius:"md",children:[i(Q,{}),i(Ne,{children:"The simulator is disabled"}),i(C,{position:"absolute",right:4,top:3,size:"xs",colorScheme:"blue",disabled:n,onClick:l,children:"Enable simulator"})]})},xt=e=>{const{r:t,g:o,b:r}=e.rgb();return t<<16|o<<8|r};class xi extends ee{constructor(t,o){super();T(this,"points");T(this,"polygon");T(this,"hovering",!1);T(this,"color");T(this,"hoverColor");this.config=t,this.points=Ur(t.wktPolygon),this.polygon=new Ie,this.addChild(this.polygon);const r=o(t.value);this.color=xt(r),this.hoverColor=xt(r.darker(1)),this.polygon.interactive=!0,this.polygon.on("mouseover",()=>{this.hovering=!0}),this.polygon.on("mouseout",()=>{this.hovering=!1})}update(t){const o=this.hovering?this.hoverColor:this.color;this.polygon.clear(),this.polygon.lineStyle(1,o,.5),this.polygon.beginFill(o,.2),this.polygon.drawPolygon(this.points.flatMap(([r,d])=>t([d,r]))),this.polygon.endFill()}}const zi=e=>({scene:t,latLngToPixel:o,bounds:r})=>{const d=yo(r,100),a=nt(()=>Vo(n=>$o(e.colorInterpolater(n))));return e.useCells(d,n=>{t.removeChildren();let c=1/0,l=-1/0;const u=[];for(const p of n){const y=e.getCellConfig(p);u.push(y),y.value<c&&(c=y.value),y.value>l&&(l=y.value)}a.domain([c,l]);for(const p of u)t.addChild(new xi(p,a))}),{update:g.exports.useCallback(()=>{for(let n=0;n<t.children.length;n++)t.children[n].update(o)},[o,t])}},vo=e=>{const n=e,{useCells:t,getCellConfig:o,colorInterpolater:r}=n,d=M(n,["useCells","getCellConfig","colorInterpolater"]),a=g.exports.useMemo(()=>zi({useCells:t,getCellConfig:o,colorInterpolater:r}),[r,o,t]);return i(Fe,S(_({},d),{useRenderer:a,options:{}}))},Pi=10*1e3,_t=e=>{const t=m(E),o=m(de),{initialized:r}=A(),{session:d}=he(),a=g.exports.useCallback(n=>{const c=S(_({},t),{ctx:n});return Promise.all([oo(c,o),si(c),ui(c,o),bt(c)])},[t,o]);rt(a,{name:"SimulatorMonitor",enabled:r&&e&&d.isController,intervalMS:Pi})},Mi=1*1e3,Ui=1*1e3,ho=e=>{const t=m(E),{initialized:o}=A(),r=g.exports.useRef(new Date(0).toISOString()),{session:d}=he(),a=g.exports.useCallback(c=>ro(S(_({},t),{ctx:c}),"minute"),[t]);rt(a,{name:"SimulatorMatcher",enabled:o&&e&&d.isController,intervalMS:Mi});const n=g.exports.useCallback(async c=>{r.current=await io(S(_({},t),{ctx:c}),r.current)},[t]);rt(n,{name:"SimulatorUpdateSegments",enabled:o&&e&&d.isController,intervalMS:Ui})},it=ge(",.2%"),pe=ge(".4~s"),Bi=()=>{const{initialized:e}=A(),t=m(ae);return _t(t),ho(t),i(te,{maxW:"container.lg",mt:10,mb:"30vh",children:e?t?s(Y,{gap:10,children:[i(Fi,{}),i(Gi,{}),i(Hi,{})]}):i(mo,{}):i(bo,{})})},bo=()=>i(W,{children:i(j,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})}),Fi=()=>{var d,a;const e=m(E),t=R(["overallConversionRateRequests",e],()=>Lt(e,"requests"),{refreshInterval:1e3}),o=R(["overallConversionRatePurchases",e],()=>Lt(e,"purchases"),{refreshInterval:1e3}),r=R(["analyticsTableCounts",e],()=>We(e,"offers","subscribers","notifications"),{refreshInterval:1e3});return!r.data||!t.data||!o.data?i(bo,{}):s(fe,{spacing:2,minChildWidth:"150px",flex:2,children:[s(D,{children:[i(k,{children:"Offers"}),i(x,{children:pe(r.data.offers)})]}),s(D,{children:[i(k,{children:"Subscribers"}),i(x,{children:pe(r.data.subscribers)})]}),s(D,{children:[i(k,{children:"Notifications"}),i(x,{children:pe(r.data.notifications)})]}),s(D,{children:[i(k,{children:"Conversion Rate"}),i(x,{children:it(((d=t.data)==null?void 0:d.conversionRate)||0)}),i(Rt,{children:"Requests"})]}),s(D,{children:[i(k,{children:"Conversion Rate"}),i(x,{children:it(((a=o.data)==null?void 0:a.conversionRate)||0)}),i(Rt,{children:"Purchases"})]})]})},Gi=()=>{var a;const e=m(E),[t,o]=g.exports.useState("conversionRate"),r=R(["customerMetrics",e,t],()=>vi(e,"purchases",t,10),{refreshInterval:1e3}),d=we("blue.500","blue.200");return i(z,{overflowX:"auto",children:s(Ko,{size:"sm",colorScheme:"gray",variant:"striped",children:[i(Xo,{children:s(At,{children:[s(Ee,{onClick:()=>o("customer"),_hover:{color:d},color:t==="customer"?d:void 0,cursor:"pointer",children:["Customer",t==="customer"&&i(le,{})]}),s(Ee,{onClick:()=>o("totalNotifications"),_hover:{color:d},color:t==="totalNotifications"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Notifications",t==="totalNotifications"&&i(le,{})]}),s(Ee,{onClick:()=>o("totalConversions"),_hover:{color:d},color:t==="totalConversions"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Conversions",t==="totalConversions"&&i(le,{})]}),s(Ee,{onClick:()=>o("conversionRate"),_hover:{color:d},color:t==="conversionRate"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Conversion Rate",t==="conversionRate"&&i(le,{})]})]})}),i(qo,{children:(a=r.data)==null?void 0:a.map(n=>s(At,{children:[i(_e,{children:n.customer}),i(_e,{isNumeric:!0,children:pe(n.totalNotifications)}),i(_e,{isNumeric:!0,children:pe(n.totalConversions)}),i(_e,{isNumeric:!0,children:it(n.conversionRate)})]},n.customer))})]})})},Yi=(e,t)=>{const o=m(E);R(["zoneMetrics",o,e],()=>hi(o,e,"purchases"),{refreshInterval:1e3,onSuccess:t})},Hi=()=>s(Y,{direction:["column","row"],alignItems:"top",children:[i(z,{flex:1,children:i(N,{children:`
            ### Conversion Map
          ...
          `})}),i(z,{flex:2,children:i(vo,{height:400,defaultZoom:14,useCells:Yi,colorInterpolater:Jo,getCellConfig:({conversionRate:e,wktPolygon:t})=>({value:e,wktPolygon:t})})})]}),Te=({label:e,placeholder:t,value:o,setValue:r,helpText:d,type:a="text"})=>s(lt,{children:[i(st,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),i(Bt,{size:"sm",placeholder:t,value:o,onChange:n=>r(n.target.value),type:a}),d?i(Zo,{fontSize:"xs",children:d}):null]}),Wi=()=>{const[e,t]=F(de);return s(lt,{children:[i(st,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),i(Qo,{size:"sm",required:!0,value:e.name,onChange:o=>{const r=o.target.value;t(Ei(r))},children:X.map(o=>i("option",{value:o.name,children:o.name},o.name))})]})},Eo=({showDatabase:e,showScaleFactor:t})=>{const[o,r]=F(co),[d,a]=F(lo),[n,c]=F(so),[l,u]=F(ie);return s(Y,{spacing:4,children:[i(Te,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:o,setValue:r,helpText:i(N,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [Data API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),s(fe,{columns:2,gap:2,children:[i(Te,{label:"Username",placeholder:"admin",value:d,setValue:a}),i(Te,{label:"Password",placeholder:"",value:n,setValue:c,type:"password"}),e&&i(Te,{label:"Database",placeholder:"martech",value:l,setValue:u}),t&&i(Wi,{})]})]})},_o=e=>i(C,S(_({onClick:()=>{const{pathname:t,hash:o}=window.location;window.location.replace(t+o)},colorScheme:"red"},e),{children:"Disconnect"})),dt=e=>{const{connected:t,initialized:o}=A(),r=pt(),[d,a]=oe(),n=m(ie),c=ye.useRef(null),h=e,{skipSeedData:l,resetDataOnly:u,disabled:p}=h,y=M(h,["skipSeedData","resetDataOnly","disabled"]),f=Oi({before:g.exports.useCallback(()=>a.on(),[a]),after:g.exports.useCallback(()=>{a.off(),r.onClose()},[r,a]),includeSeedData:!l,resetDataOnly:!!u});return s(I,{children:[i(C,_({disabled:!t||p,onClick:r.onOpen,colorScheme:o?"green":"red"},y)),i(er,{isOpen:r.isOpen,onClose:r.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:c,children:i(xe,{children:s(tr,{children:[s(ze,{fontSize:"lg",fontWeight:"bold",children:[o?"Reset":"Setup"," database ",n]}),s(Pe,{children:["This will ",o?"recreate":"create"," the database called ",n,". Are you sure?"]}),s(Ft,{children:[i(C,{ref:c,onClick:r.onClose,disabled:d,children:"Cancel"}),i(C,{disabled:d,colorScheme:o?"red":"green",onClick:f,ml:3,children:d?i(j,{}):o?"Recreate database":"Create database"})]})]})})})]})},ji=({isOpen:e,onClose:t,finalFocusRef:o})=>{const[r,d]=F(ae),{session:a,refresh:n}=he(),c=r&&a.isController,l=m(E),{connected:u,initialized:p,isVapor:y}=A(),f=pt(),[h,b]=oe(!1),O=g.exports.useCallback(async()=>{b.on();const J=!(r&&a.isController);d(J),await ao(l,a.sessionID,J),n(),b.off()},[l,r,n,a.isController,a.sessionID,d,b]),[w,L]=oe(!1),ne=g.exports.useCallback(async()=>{L.on(),await Qt(l),L.off()},[l,L]);return s(or,{isOpen:e,placement:"right",onClose:t,finalFocusRef:o,children:[i(xe,{}),s(rr,{children:[i(ut,{}),i(ze,{children:"Config"}),i(Pe,{children:s(Y,{spacing:4,children:[y?null:i(Eo,{showScaleFactor:!0,showDatabase:!0}),s(Z,{status:u?"success":"error",borderRadius:"md",children:[i(Q,{}),i(Ne,{children:u?"connected":"disconnected"}),y?i(_o,{position:"absolute",right:4,top:3,size:"xs"}):null]}),s(Z,{status:p?"success":"warning",borderRadius:"md",children:[i(Q,{}),i(Ne,{children:"schema"}),i(dt,{position:"absolute",right:4,top:3,size:"xs",children:p?"Reset":"Setup"})]}),s(Z,{status:c?"success":"warning",borderRadius:"md",children:[i(Q,{}),i(Ne,{children:"simulator"}),i(ir,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:c?"green":"red",isChecked:c,disabled:!u||!p||h,onChange:O})]}),s(me,{onClick:f.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",f.isOpen?i(dr,{ml:2}):i(le,{ml:2})]}),f.isOpen?i(C,{size:"xs",_hover:{colorScheme:"red"},onClick:ne,disabled:w,children:"Drop Database"}):void 0]})}),i(Ft,{})]})]})},Se=({to:e,children:t,onClick:o})=>{const r=ur(e),d=yr({path:r.pathname,end:!0});return i(K,{as:Ut,to:e,px:2,py:1,onClick:o,rounded:"md",_hover:{textDecoration:"none",bg:we("gray.300","gray.600")},fontWeight:d?"bold":"normal",href:"#",color:we("gray.700","gray.200"),children:t})},Vi=()=>{const{colorMode:e,toggleColorMode:t}=Me(),o=pt(),[r,d]=F(Si),a=ye.useRef(null),{connected:n,initialized:c}=A(),l=m(ae),[u]=yt("(max-width: 640px)"),{session:p}=he(),y=s(I,{children:[i(Se,{to:"/",onClick:o.onClose,children:"Overview"}),i(Se,{to:"/map",onClick:o.onClose,children:"Map"}),i(Se,{to:"/admin",onClick:o.onClose,children:"Admin"}),i(Se,{to:"/analytics",onClick:o.onClose,children:"Analytics"})]}),f=n?c&&l&&p.isController?"green":"yellow":"red";let h;return u||(h=n?c?l&&p.isController?"connected":"simulator disabled":"needs schema":"disconnected"),i(I,{children:i(z,{bg:we("gray.200","gray.700"),children:s(te,{maxW:"container.lg",children:[s(Le,{h:16,alignItems:"center",justifyContent:"space-between",children:[i(qe,{size:"md",icon:o.isOpen?i(ar,{}):i(nr,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:o.isOpen?o.onClose:o.onOpen}),s(De,{spacing:8,alignItems:"center",children:[i(gt,{as:"h1",size:u?"sm":"md",children:u?"Martech":"Realtime Digital Marketing"}),i(De,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:y})]}),s(Le,{alignItems:"center",gap:2,children:[s(C,{size:"sm",ref:a,onClick:()=>d(!0),colorScheme:f,children:[f==="green"?i(Gt,{}):i(Yt,{}),u||i(me,{pl:2,children:h})]}),i(qe,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?i(cr,{size:"1.4em"}):i(lr,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),i(qe,{"aria-label":"Toggle Color Mode",size:"sm",onClick:t,icon:e==="light"?i(sr,{boxSize:"1.2em"}):i(pr,{boxSize:"1.2em"})})]})]}),o.isOpen?i(z,{pb:4,display:{md:"none"},children:i(Y,{as:"nav",spacing:4,children:y})}):null,i(ji,{isOpen:r,onClose:()=>d(!1),finalFocusRef:a})]})})})},$i=ge("~s"),To=(e,...t)=>{const o=g.exports.useMemo(()=>t.reduce((a,n)=>S(_({},a),{[n]:[]}),{}),[t]),r=g.exports.useRef(o),{data:d}=R(["estimatedRowCount.timeseries",...t],async()=>{const a=await We(e,...t),n=new Date;return r.current=t.reduce((c,l)=>{const u=r.current[l];return u.push([n,a[l]]),c[l]=u.slice(-30),c},{}),r.current},{refreshInterval:1e3});return d!=null?d:o},So=r=>{var d=r,{data:e,yAxisLabel:t}=d,o=M(d,["data","yAxisLabel"]);const{colorMode:a}=Me(),n=Object.keys(e),c=g.exports.useCallback(({tooltipData:p,colorScale:y})=>!y||!p?null:n.sort((f,h)=>p.datumByKey[h].datum[1]-p.datumByKey[f].datum[1]).map(f=>{const{datum:h}=p.datumByKey[f];return s(me,{mb:1,color:y(f),fontSize:"sm",children:[f,": ",ge(".4~s")(h[1])]},f)}),[n]),l=g.exports.useCallback(p=>$i(p).replace("G","B"),[]);if(n.some(p=>e[p].length<2))return i(W,{height:o.height,children:i(j,{size:"md"})});const u=n.map(p=>i(gr,{dataKey:p,data:e[p],xAccessor:y=>y[0],yAccessor:y=>y[1]},p));return s(fr,S(_({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:a==="light"?mr:vr,margin:{left:0,right:50,top:10,bottom:40}},o),{children:[i(Ot,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),i(Ot,{orientation:"right",numTicks:o.height<250?3:5,tickFormat:l,label:t,labelOffset:20}),u,i(hr,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:c})]}))},at=1e3,Oe=60*at,Ce=60*Oe,Ze=24*Ce,G=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),q=e=>e?e<at?`${G(e)}ms`:e<Oe?`${G(e/at)}s`:e<Ce?`${Math.floor(e/Oe)}m${q(e%Oe)}`:e<Ze?`${Math.floor(e/Ce)}h${q(e%Ce)}`:`${Math.floor(e/Ze)}d${q(e%Ze)}`:"0s",Ki=100,Xi=1e3,$=class extends ee{constructor(t){super();T(this,"latlng");T(this,"age",0);T(this,"marker");T(this,"pulse");this.latlng=t,this.marker=new Ie,this.marker.beginFill($.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new Ie,this.pulse.beginFill($.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(t,o){if(this.age+=o/60,this.age>$.lifetime&&this.parent){this.parent.removeChild(this);return}const r=this.age%$.lifetime/$.lifetime,d=Tr(r);this.pulse.scale.set(1+d);const a=.4,n=r<a?br(r/a):1-Er((r-a)/(1-a));this.pulse.alpha=n,r<a?this.marker.alpha=n:this.marker.alpha=1-_r((r-a)/(1-a));const[c,l]=t(this.latlng);this.x=c,this.y=l}};let se=$;T(se,"lifetime",1.5),T(se,"markerColor",306687),T(se,"pulseColor",306687);const No=()=>{const e=m(E),{initialized:t}=A();return g.exports.useMemo(()=>["notifications",e,t],[e,t])},Ro=({scene:e,latLngToPixel:t,bounds:o})=>{const r=g.exports.useRef(new Date().toISOString()),d=m(E),{initialized:a}=A(),n=yo(o,50),c=No();return R(c,()=>yi(d,r.current,Ki,n),{refreshInterval:Xi,isPaused:()=>!a,onSuccess:l=>{if(l.length>0){r.current=l[0][0];for(const[,u,p]of l)e.addChild(new se([p,u]))}}}),{update:g.exports.useCallback(l=>{for(let u=e.children.length-1;u>=0;u--)e.children[u].update(t,l)},[t,e])}},qi=()=>{const e=m(E),t=To(e,"locations","requests","purchases","notifications","subscriber_segments"),o=R(["notificationsMapTableCounts",e],()=>We(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),r=m(ot("SimulatorMatcher")),d=m(ot("SimulatorUpdateSegments")),a=ge(".4~s"),n=o.data?s(fe,{spacing:2,minChildWidth:"120px",children:[s(D,{children:[i(k,{children:"Offers"}),i(x,{children:a(o.data.offers)})]}),s(D,{children:[i(k,{children:"Cities"}),i(x,{children:a(o.data.cities)})]}),s(D,{children:[i(k,{children:"Subscribers"}),i(x,{children:a(o.data.subscribers)})]}),s(D,{children:[i(k,{children:"Segments"}),i(x,{children:a(o.data.segments)})]}),s(D,{children:[i(k,{children:"Segmentation"}),i(x,{children:q(d)})]}),s(D,{children:[i(k,{children:"Matching"}),i(x,{children:q(r)})]})]}):null;return s(I,{children:[i(N,{children:`
          ...
          about the demo.
        `}),n,s(z,{children:[i(me,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),i(So,{data:t,yAxisLabel:"total rows",height:150})]})]})},Ji=()=>{const{connected:e,initialized:t}=A(),o=m(ae);return _t(o&&e&&t),ho(o&&e&&t),s(Le,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[i(Y,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:i(Fe,{useRenderer:Ro,options:{}})}),s(Y,{spacing:4,flex:"1 1 0",minWidth:"0",children:[i(N,{children:`
          ...
          `}),o?i(qi,{}):i(mo,{})]})]})},Tt=o=>{var r=o,{children:e}=r,t=M(r,["children"]);return i(Sr,S(_({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},t),{children:e}))},Zi=1e3,Qi=(e,t)=>{const o=m(E),{initialized:r}=A();R(["offers",o,r,e],()=>gi(o,Zi,e),{isPaused:()=>!r,onSuccess:t})},ed=e=>i(vo,S(_({},e),{useCells:Qi,colorInterpolater:()=>"#04adff",getCellConfig:t=>({value:1,wktPolygon:t.notificationZone})})),td=e=>e.every(([,t])=>t===0),H=e=>{const{completed:t,title:o,left:r,right:d}=e,{colorMode:a}=Me(),n=a==="light"?".300":".500",c=t?"gray"+n:void 0,l=(t?"green":"gray")+n;return s(I,{children:[s(et,{children:[s(gt,{as:"h2",size:"lg",mb:4,color:c,children:[i(Gt,_({color:l},{boxSize:6,position:"relative",bottom:.5,mr:2})),o]}),r]}),i(et,{children:d})]})},od=({connected:e,isVapor:t})=>t?i(H,{completed:e,title:"Connected",left:s(I,{children:[i(N,{children:`
                ...
                the button below.
              `}),i(_o,{size:"xs",colorScheme:"gray"})]}),right:null}):i(H,{completed:e,title:"Connect to SingleStore",left:i(N,{children:`
          ...
          `}),right:i(Eo,{})}),rd=({onClose:e,schemaObjectName:t})=>{const o=ri(t),[r]=yt("(max-width: 640px)");return s(Wt,{isOpen:!0,onClose:e,size:r?"full":"4xl",scrollBehavior:"inside",children:[i(xe,{}),s(jt,{children:[s(ze,{children:["Create statement for ",o.name]}),i(ut,{}),i(Pe,{children:i(Tt,{mb:4,children:o.createStmt})})]})]})},Ao=({name:e,status:t,onClick:o})=>{const{colorMode:r}=Me();return i(et,{bg:(t?"green":"gray")+(r==="light"?".200":".600"),fontSize:"xs",color:r==="light"?"gray.800":"gray.100",textOverflow:"ellipsis",whiteSpace:"nowrap",overflow:"hidden",borderRadius:"md",px:2,py:1,textAlign:"center",_hover:{fontWeight:"bold"},cursor:"pointer",onClick:o,children:e},e)},id=({initialized:e})=>{const[t,o]=F(ie),r=uo(),[d,a]=g.exports.useState();return s(I,{children:[!!d&&i(rd,{onClose:()=>a(null),schemaObjectName:d}),i(H,{completed:e,title:"Setup the schema",left:s(I,{children:[i(N,{children:`
              ...
              `}),i(Rr,{mt:4,mb:6}),e?i(dt,{colorScheme:"yellow",size:"sm",skipSeedData:!0,resetDataOnly:!0,children:"Restart tutorial"}):s(De,{alignItems:"flex-end",children:[s(lt,{flex:1,children:[i(st,{fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Database name"}),i(Bt,{placeholder:"martech",value:t,size:"sm",onChange:n=>o(n.target.value)})]}),i(z,{flex:1,textAlign:"center",children:i(dt,{colorScheme:"blue",size:"sm",skipSeedData:!0,children:"Setup schema"})})]})]}),right:i(fe,{columns:[1,3,3],gap:1,children:Object.keys(r.data||{}).sort().map(n=>{var c;return i(Ao,{name:n,status:(c=r.data)==null?void 0:c[n],onClick:()=>a(n)},n)})})})]})},dd=({onClose:e,name:t,scaleFactor:o})=>{const r=to(t,o),[d]=yt("(max-width: 640px)");return s(Wt,{isOpen:!0,onClose:e,size:d?"full":"4xl",scrollBehavior:"inside",children:[i(xe,{}),s(jt,{children:[s(ze,{children:["Create statement for pipeline ",t]}),i(ut,{}),i(Pe,{children:i(Tt,{mb:4,children:r})})]})]})},Oo=(e,t,o=!0)=>{var a;const r=R(["pipelineStatus",e,t],()=>eo(e,t),{isPaused:()=>!o}),d=(a=r.data)!=null&&a.length?r.data.every(n=>!n.needsUpdate):!1;return{pipelines:r,completed:d}},ad=()=>{const e=m(E),t=m(de),{pipelines:o,completed:r}=Oo(e,t);_t(r);const d=b=>{var w;const O=(w=o.data)==null?void 0:w.find(L=>L.pipelineName===b);return O?!O.needsUpdate:!1},[a,n]=g.exports.useState(),[c,l]=oe(),u=g.exports.useCallback(async()=>{l.on(),await oo(e,t),o.mutate(),l.off()},[l,e,t,o]),p=["locations","requests","purchases"],y=To(e,...p),f=p.some(b=>y[b].length<2)||p.every(b=>td(y[b])),h=s(C,{colorScheme:"blue",size:"sm",onClick:u,disabled:r,children:[(c||r)&&i(j,{mr:2}),c?"Creating Pipelines":r?"...waiting for data":"Create pipelines"]});return s(I,{children:[!!a&&i(dd,{onClose:()=>n(null),name:a,scaleFactor:t}),i(H,{completed:r,title:"Ingest data",left:s(I,{children:[i(N,{children:`
              ...
              `}),i(fe,{columns:[1,3,3],gap:1,children:ke.map(b=>i(Ao,{name:b,status:d(b),onClick:()=>n(b)},b))})]}),right:f||!r?i(W,{h:220,children:h}):i(So,{data:y,yAxisLabel:"total rows",height:200})})]})},Ve=(e,t=!0)=>R(["overviewTableCounts",e],()=>We(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!t}),nd=()=>{var c,l;const e=m(E),t=m(de),[o,r]=oe(),d=Ve(e),a=g.exports.useCallback(async()=>{r.on(),await ht(e,ue,t),d.mutate(),r.off()},[e,t,d,r]),n=!!((c=d.data)!=null&&c.offers);return i(H,{completed:n,title:"Offers",left:i(I,{children:s(N,{children:[`
            ...
            `,n&&`
                ...
                database.
            `]})}),right:n?i(ed,{height:300,defaultZoom:13}):i(W,{h:"100%",children:s(C,{onClick:a,disabled:o,children:[o&&i(j,{mr:2}),o?"loading...":n?"loaded offers!":"load offers"]})})})},cd=()=>{var f;const e=m(E),t=Ve(e),{elapsed:o,isRunning:r,startTimer:d,stopTimer:a}=go(),[n,c]=g.exports.useState(!1),l=g.exports.useRef(new Date().toISOString()),u=!!((f=t.data)!=null&&f.subscriber_segments),p=g.exports.useCallback(async()=>{d(),l.current=await io(e,l.current),a(),t.mutate(),c((o||0)>1e3&&await bt(e))},[d,e,a,t,o]);let y;if(o&&t.data){const{segments:h,subscriber_segments:b,locations:O,requests:w,purchases:L}=t.data,ne=q(o),J=G(O+w+L),$e=G(h),Ke=G(b);y=i(N,{children:`
          The last update evaluated ${J} rows against ${$e} segments
          producing ${Ke} segment memberships.
          
          **This process took ${ne}**.
        `})}return i(H,{completed:u,title:"Segmentation",left:i(N,{children:`
          ...
          `}),right:i(W,{h:"100%",children:s(Ht,{gap:4,textAlign:"center",children:[s(C,{disabled:r,onClick:p,children:[r&&i(j,{mr:2}),r?"...running":"Match subscribers to segments"]}),y,n&&s(Z,{status:"warning",children:[i(Q,{}),"Queries are still warming up. Please wait for a little bit and then try again."]})]})})})},ld=()=>{var O;const e=m(E),t=Ve(e),o=No(),{mutate:r}=Mt(),{elapsed:d,isRunning:a,startTimer:n,stopTimer:c}=go(),[l,u]=g.exports.useState(0),[p,y]=g.exports.useState(!1),f=!!((O=t.data)!=null&&O.notifications),h=g.exports.useCallback(async()=>{let w=0,L=0;for(;w===0&&L++<10;)n(),w=await ro(e,"second");c(),u(w),t.mutate(),r(o),y((d||0)>1e3&&await bt(e))},[c,t,r,o,d,n,e]);let b;if(d&&t.data){const{offers:w,subscribers:L,subscriber_segments:ne,notifications:J}=t.data,$e=G(w*L+J),Ke=G(ne),Io=q(d),wo=G(l);b=i(N,{children:`
          The last update evaluated up to ${$e} notification opportunities
          against ${Ke} segment memberships generating ${wo}
          notifications. This process took ${Io}.
        `})}return i(H,{completed:f,title:"Matching",left:i(N,{children:`
          ...
          `}),right:i(W,{h:"100%",children:s(Ht,{gap:4,w:"100%",children:[s(C,{disabled:a,onClick:h,children:[a&&i(j,{mr:2}),a?"...running":"Generate notifications"]}),i(z,{width:"100%",children:i(Fe,{height:250,defaultZoom:12,useRenderer:Ro,options:{}})}),b,p&&s(Z,{status:"warning",children:[i(Q,{}),"Queries are still warming up. Please wait for a little bit and then try again."]})]})})})},sd=()=>{const e=m(ie);return i(H,{completed:!0,title:"Putting it all together",left:i(N,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: map
            [2]: analytics
          `}),right:null})},pd=()=>{const e=m(E),t=m(de),{connected:o,initialized:r,isVapor:d}=A(),{completed:a}=Oo(e,t,o&&r),{data:n}=Ve(e,o&&r),c=[{completed:o,component:i(od,{connected:o,isVapor:d},"connection")},{completed:r,component:i(id,{initialized:r},"schema")},{completed:a,component:i(ad,{},"pipelines")},{completed:n?n.offers>0:!1,component:i(nd,{},"offers")},{completed:n?n.subscriber_segments>0:!1,component:i(cd,{},"segmentation")},{completed:n?n.notifications>0:!1,component:i(ld,{},"matching")},{completed:!0,component:i(sd,{},"summary")}];let l=!0;const u=[];for(const{completed:p,component:y}of c)if(l)u.push(y),l=p;else break;return s(te,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(z,{maxW:"container.md",mb:10,px:0,children:i(N,{children:`
          ...
          `})}),i(Nr,{columnGap:6,rowGap:10,templateColumns:["minmax(0, 1fr)",null,"repeat(2, minmax(0, 1fr))"],children:u})]})};function ud(){const e=i(W,{height:"100vh",children:i(j,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})});return i(g.exports.Suspense,{fallback:e,children:s(Le,{height:"100vh",direction:"column",children:[i(Vi,{}),i(z,{m:4,flex:"1",children:s(Ar,{children:[i(ce,{path:"/",element:i(pd,{})}),i(ce,{path:"/map",element:i(Ji,{})}),i(ce,{path:"/admin",element:i(ki,{})}),i(ce,{path:"/analytics",element:i(Bi,{})}),i(ce,{path:"*",element:i(Or,{to:"/",replace:!0})})]})})]})})}const yd=({children:e})=>{const t=m(je);return i(Co,{isResettingSchema:t,children:e})};class Co extends ye.Component{constructor(t){super(t);T(this,"state",{});this.handlePromiseRejection=this.handlePromiseRejection.bind(this)}componentDidMount(){window.addEventListener("unhandledrejection",this.handlePromiseRejection)}componentWillUnmount(){window.removeEventListener("unhandledrejection",this.handlePromiseRejection)}handlePromiseRejection(t){this.props.isResettingSchema?console.warn("Ignoring error while resetting schema",t.reason):this.setState({error:t.reason})}componentDidCatch(t){this.props.isResettingSchema?console.warn("Ignoring error while resetting schema",t):this.setState({error:t})}render(){const{error:t}=this.state;if(t){let o;return t instanceof P&&(o=s(I,{children:[i(me,{textAlign:"center",children:"An error occurred while running the following query:"}),i(Tt,{children:U(t.sql)})]})),i(te,{maxW:"container.md",my:10,children:s(Y,{gap:4,children:[i(W,{children:i(Yt,{boxSize:20,color:"red"})}),i(gt,{size:"xl",textAlign:"center",children:t.message}),o,s(De,{justify:"center",gap:4,children:[i(C,{onClick:()=>this.setState({error:void 0}),size:"sm",children:"Dismiss Error"}),i(C,{onClick:()=>window.location.reload(),size:"sm",colorScheme:"blue",leftIcon:i(Cr,{}),children:"Reload"})]})]})})}return this.props.children}}const gd=Ir({fonts:{heading:"InterVariable, sans-serif",body:"InterVariable, sans-serif",mono:'"Source Code ProVariable", monospace'},components:{Link:{baseStyle:e=>({color:e.colorMode==="light"?"blue.600":"blue.300"})}}}),fd=({children:e})=>{const t=m(je),o=Pt();return i(xr,{value:{onError:d=>{if(t)console.warn("Ignoring error while resetting schema",d);else{console.error(d);const a="swr-error",n={id:"swr-error",title:"An error occurred",description:d.message,status:"error",duration:5e3,isClosable:!0};o.isActive(a)?o.update(a,n):o(_({id:a},n))}}},children:e})};wr.render(i(ye.StrictMode,{children:i(Lr,{theme:gd,children:i(Co,{children:i(Dr,{children:i(kr,{basename:"/",children:i(fd,{children:i(yd,{children:i(ud,{})})})})})})})}),document.getElementById("root"));
