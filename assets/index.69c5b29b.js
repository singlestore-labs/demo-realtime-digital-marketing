...
`),{sql:a,params:n}=_t(o);return{sql:j`
    ...
    `,t.id,t.name,`POINT(${t.lonlat[0]} ${t.lonlat[1]})`,t.diameter),Ar=(e,t)=>b(e,"DELETE FROM cities WHERE city_id = ?",t),Or=["olc_8","purchase","request"],Cr=["minute","hour","day","week","month"],Gt=({interval:e,kind:t,value:o})=>To(`${e}-${t}-${o}`),Ir=async(e,t)=>{const{sql:o,params:i}=Bt({table:"segments",options:{replace:!0},columns:["segment_id","valid_interval","filter_kind","filter_value"],tuples:t.map(d=>[Gt(d),d.interval,d.kind,d.value])});await b(e,o,...i)},wr=async(e,t)=>{const o={table:"offers",options:{replace:!0},columns:["customer","notification_zone","segment_ids","notification_content","notification_target","maximum_bid_cents"],tuples:[]};let i=0,d=[];const a=async()=>{const{sql:n,params:s}=Bt(o);await Promise.all([b(e,n,...s),Ir(e,d)]),o.tuples=[],d=[],i=0};for(const n of t)o.tuples.push([n.customer,n.notificationZone,JSON.stringify(n.segments.map(Gt)),n.notificationContent,n.notificationTarget,n.maximumBidCents]),i++,d=d.concat(n.segments),i>=Rr&&await a();i>0&&await a()},Lr=()=>ct(Or),kr=()=>ct(Cr),Yt=({vendor:e,tld:t})=>`${e.toLowerCase()}.${t}`,Ht=e=>{const[t,o]=e.lonlat,i=e.diameter/2,[d,a]=[t-i,t+i],[n,s]=[o-i,o+i];return[Ve(d,a),Ve(n,s)]},Dr=(e,t)=>{const o=Lr(),i=kr();switch(o){case"olc_8":{const[d,a]=Ht(e),n=je.encode(a,d,8).substring(0,8);return{kind:o,interval:i,value:n}}case"purchase":return{kind:o,interval:i,value:t.vendor};case"request":return{kind:o,interval:i,value:Yt(t)}}},xr=e=>{const t=ve(1,3),o=Nr(),i=Array.from({length:t},()=>Dr(e,o)),d=Yt(o),n=`${ve(10,50)}% off at ${o.vendor}`,s=d,[c,p]=Ht(e),y=je.encode(p,c,ct([8,10])),u=je.decode(y),m={ne:[u.latitudeHi,u.longitudeHi],sw:[u.latitudeLo,u.longitudeLo]};return{customer:o.vendor,segments:i,notificationZone:we(m),notificationContent:n,notificationTarget:s,maximumBidCents:ve(2,15)}},zr=(e,t)=>Array.from({length:t},()=>xr(e)),Pr=e=>(t,o,i,d=1)=>`https://stamen-tiles.a.ssl.fastly.net/${e}/${i}/${t}/${o}${d>=2?"@2x":""}.png`,Mr=l(A,{children:["Map tiles by ",r(W,{href:"http://stamen.com",children:"Stamen Design"}),", under"," ",r(W,{href:"http://creativecommons.org/licenses/by/3.0",children:"CC BY 3.0"}),". Data by ",r(W,{href:"http://openstreetmap.org",children:"OpenStreetMap"}),", under"," ",r(W,{href:"http://www.openstreetmap.org/copyright",children:"ODbL"}),"."]}),Ur=[de.lonlat[1],de.lonlat[0]],Br=12,Fr=({width:e,height:t,bounds:o,latLngToPixel:i,pixelToLatLng:d,useRenderer:a,options:n})=>{const s=ae.useRef(null),c=Rt(()=>new q),{setup:p,update:y}=a({scene:c,width:e,height:t,bounds:o,latLngToPixel:i,pixelToLatLng:d,options:n});return g.exports.useLayoutEffect(()=>{if(!s.current)throw new Error("No canvas ref");console.log("PixiMapLayer: Setup");const u=new No({view:s.current,width:e,height:t,backgroundAlpha:0,antialias:!0});return u.stage.addChild(c),p==null||p(),y&&u.ticker.add(m=>{y(m)}),()=>{console.log("PixiMapLayer: Destroy"),u.stage.removeChild(c),u.destroy(!1,{children:!1,texture:!0,baseTexture:!0})}},[t,c,p,y,e]),r("canvas",{ref:s})},Gr=({mapState:e,latLngToPixel:t,pixelToLatLng:o,useRenderer:i,options:d})=>{const{width:a,height:n,bounds:s}=e||{width:0,height:0};return a<=0||n<=0||!t||!o||!s?null:r(Fr,{useRenderer:i,width:a,height:n,bounds:s,latLngToPixel:t,pixelToLatLng:o,options:d})},Le=n=>{var s=n,{height:e="100%",defaultCenter:t=Ur,defaultZoom:o=Br,useRenderer:i,options:d}=s,a=k(s,["height","defaultCenter","defaultZoom","useRenderer","options"]);const[c,p]=g.exports.useState(t),[y,u]=g.exports.useState(o);return r(L,_(h({borderRadius:"lg",overflow:"hidden",height:e},a),{children:r(So,{dprs:[1,2],provider:Pr("toner-lite"),attribution:Mr,maxZoom:20,center:c,zoom:y,onBoundsChanged:({center:m,zoom:E})=>{p(m),u(E)},children:r(Gr,{useRenderer:i,options:d})})}))};var ke=[{name:"date_sub_dynamic",createStmt:`CREATE OR REPLACE FUNCTION date_sub_dynamic (
  _dt DATETIME(6),
...
BEGIN
  ...
  END IF;
END`}],De=[{name:"process_locations",createStmt:`CREATE OR REPLACE PROCEDURE process_locations (
    _batch QUERY(
...
END`}],xe=[{name:"worldcities",createStmt:`create rowstore table if not exists worldcities (
  ...
  UNION
  SELECT * FROM dynamic_subscriber_segments_purchases(_since, _until)
);`}];const be="singlestore-realtime-digital-marketing",Yr=[`CREATE LINK aws_s3 AS S3 CREDENTIALS '{}' CONFIG '{ "region": "us-east-1" }'`,`
  ...
  `,"START PIPELINE worldcities FOREGROUND"],Hr=e=>{const t=xe.find(d=>d.name===e);if(t)return t;const o=De.find(d=>d.name===e);if(o)return o;const i=ke.find(d=>d.name===e);if(i)return i;throw new Error("Could not find schema object: "+e)},Wr=async e=>{try{return await at(e,"SELECT 1"),!0}catch{return!1}},jr=async e=>{let t={tables:[],procedures:[],functions:[]};const s=e,{database:o}=s,i=k(s,["database"]);try{t=(await dt(i,`
        ...
        `,o,o)).reduce((c,[p,y])=>(c[p].push(y),c),t)}catch(c){if(!(c instanceof D&&(c.isUnknownDatabase()||c.isDatabaseRecovering())))throw c}const{tables:d,procedures:a,functions:n}=t;return Object.fromEntries([xe.map(({name:c})=>[c,d.includes(c)]),De.map(({name:c})=>[c,a.includes(c)]),ke.map(({name:c})=>[c,n.includes(c)])].flat())},Wt=e=>at(e,"DROP DATABASE IF EXISTS `"+e.database+"`"),Vr=async(e,{progress:t,scaleFactor:o,includeSeedData:i,skipCreate:d=!1})=>{d||(t("Dropping existing schema","info"),await Wt(e),t("Creating database","info"),await at(e,"CREATE DATABASE `"+e.database+"`"));for(const a of ke)t(`Creating function: ${a.name}`,"info"),await b(e,a.createStmt);for(const a of xe)t(`Creating table: ${a.name}`,"info"),await b(e,a.createStmt);for(const a of De)t(`Creating procedure: ${a.name}`,"info"),await b(e,a.createStmt);await $r(e),await Ft(e,de),i&&(t("Creating sample data","info"),await lt(e,de,o)),t("Schema initialized","success")},$r=async e=>{for(const t of Yr)await b(e,t)},lt=(e,t,o)=>{const i=100*o.partitions,d=zr(t,i);return wr(e,d)},jt=async(e,t)=>{const o=t.prefix;return await U(e,`
      SELECT
    ...
    `,e.database)},Vt=async(e,t)=>{const o=t.prefix,i=await jt(e,t);await Promise.all(i.filter(d=>d.needsUpdate).map(async d=>{console.log(`recreating pipeline ${d.pipelineName} for city ${d.cityName}`),d.pipelineName.startsWith("locations_")?await b(e,`
          ...
          `,d.cityId):d.pipelineName.startsWith("purchases_")&&await b(e,`
            ...
            SET ts = NOW(),
              city_id = ?;
          `,d.cityId),await b(e,`ALTER PIPELINE ${d.pipelineName} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await b(e,`START PIPELINE IF NOT RUNNING ${d.pipelineName}`),console.log(`finished creating pipeline ${d.pipelineName} for city ${d.cityName}`)}))},Kr=async e=>{const t=await dt(e,`
      SELECT
    ...
    `,e.database);await Promise.all(t.map(async([o])=>{console.log("restarting pipeline",o),await b(e,`ALTER PIPELINE ${o} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await b(e,`START PIPELINE IF NOT RUNNING ${o}`)}))},qr=async e=>{const t=await U(e,`
    ...
    `);return await Promise.all(t.map(({planId:o})=>b(e,`DROP ${o} FROM PLANCACHE`))),t.length>0},Jr=(e,...t)=>{const o=t.map(i=>`"${i}"`).join(",");return Ut(e,`
      ...
      GROUP BY tableName
    `,e.database)},ze=(e,...t)=>Jr(e,...t).then(o=>o.reduce((i,{tableName:d,count:a})=>(i[d]=a,i),{})),Xr=async(e,t)=>{const{maxRows:o}=t,d=["locations","requests","purchases","notifications"].map(n=>`"${n}"`).join(","),a=await Ut(e,`
      SELECT
      ...
      WHERE
        ...
        AND stats.count > ?
    `,e.database,o);await Promise.all(a.map(async({tableName:n,count:s,minTs:c,maxTs:p})=>{const u=(s-o)/s;if(u<.2)return;const m=new Date((c+u*(p-c))*1e3);console.log(`removing rows from ${n} older than ${m.toISOString()}`),await b(e,`DELETE FROM ${n} WHERE ts <= ?`,m.toISOString())}))},st=(e,t="minute")=>it(e,"ECHO run_matching_process(?)",t).then(o=>o.RESULT),pt=async(e,t)=>{const o=new Date().toISOString();return await Promise.all(["update_location_segments","update_request_segments","update_purchase_segments"].map(i=>b(e,`CALL ${i}(?, ?)`,t,o))),await b(e,"CALL prune_segments(?)",o),o},Zr=(e,t,o,i)=>dt(e,`
      SELECT
        ts,
...
`,oi=(e,t,o,i)=>U(e,nt({with:[["metrics",yt(t)]],base:`
        SELECT
        ...
        ORDER BY ${o} DESC
        LIMIT ${i}
      `}).sql),Nt=(e,t)=>it(e,nt({with:[["metrics",yt(t)]],base:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `}).sql),ri=(e,t,o)=>{const i=nt({with:[["metrics",yt(o)]],base:{sql:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `,params:[we(t)]}});return U(e,i.sql,...i.params)},V=[{name:"s00",maxRows:1e7,prefix:"v2/100k-2p",partitions:2},{name:"s0",maxRows:2e7,prefix:"v2/100k-4p",partitions:4},{name:"s1",maxRows:4e7,prefix:"v2/100k-8p",partitions:8},{name:"s2",maxRows:16e7,prefix:"v2/1m-16p",partitions:16},{name:"s4",maxRows:32e7,prefix:"v2/1m-32p",partitions:16},{name:"s8",maxRows:64e7,prefix:"v2/1m-64p",partitions:64},{name:"s10",maxRows:1e9,prefix:"v2/10m-80p",partitions:80}],ii=e=>V.find(t=>t.name===e)||V[0],J=({encode:e,decode:t}={encode:JSON.stringify,decode:JSON.parse})=>({setSelf:o,onSet:i,node:d})=>{const a=`recoil.localstorage.${d.key}`,n=localStorage.getItem(a);n!=null&&o(t(n)),i((s,c,p)=>{p?localStorage.removeItem(a):localStorage.setItem(a,e(s))})},ut=()=>({setSelf:e,node:{key:t}})=>{const{location:o}=window;if(o){const i=new URLSearchParams(o.search);e(i.get(t))}},di=x({key:"skipCreateDatabase",default:null,effects:[ut()]}),ai=x({key:"sessionId",default:null,effects:[ut()]}),ni=x({key:"vaporBaseUrl",default:"https://vapor.labs.singlestore.com",effects:[ut()]}),Kt=x({key:"connectionHost",default:"http://127.0.0.1",effects:[J()]}),qt=x({key:"connectionUser",default:"root",effects:[J()]}),Jt=x({key:"connectionPassword",default:"",effects:[J()]}),X=x({key:"connectionDatabase",default:"martech",effects:[J()]}),Xt=At({key:"vaporConnectionConfig",get:async({get:e})=>{const t=e(ai),o=e(ni);if(t)try{const i=await fetch(o+"/api/v1/vapor/connect?sessionId="+t);if(i.status===200){const d=await i.json();return{host:d.endpoint,user:d.user,password:d.password,database:e(X)}}}catch{console.log(`Failed to connect to vapor at ${o}, falling back to local config`)}}}),v=At({key:"connectionConfig",get:({get:e})=>{const t=e(Xt);if(t)return t;const o=e(Kt),i=e(qt),d=e(Jt),a=e(X);return{host:o,user:i,password:d,database:a}},cachePolicy_UNSTABLE:{eviction:"most-recent"}}),Z=x({key:"configScaleFactor",default:V[0],effects:[J({encode:e=>e.name,decode:e=>V.find(t=>t.name===e)||V[0]})]}),Q=x({key:"simulatorEnabled",default:!0,effects:[J()]}),ci=x({key:"databaseDrawerIsOpen",default:!1}),$e=Ro({key:"tickDurationMs",default:void 0}),li=Object.fromEntries([xe.map(({name:e})=>[e,!1]),De.map(({name:e})=>[e,!1]),ke.map(({name:e})=>[e,!1])].flat()),Zt=(e=!1)=>{const t=f(v);return N(["schemaObjects",t,e],()=>jr(t),{isPaused:()=>e,refreshInterval:o=>Object.values(o||[]).some(d=>!d)?1e3:0,fallbackData:li})},O=()=>{const a=f(v),{database:e}=a,t=k(a,["database"]),o=f(Xt),i=N(["isConnected",t],()=>Wr(t)),d=Zt(!i.data);return{isVapor:!!o,connected:!!i.data,initialized:!!i.data&&Object.values(d.data||[]).every(Boolean),reset:()=>{i.mutate(),d.mutate()}}},si=(()=>{let e={};return t=>(t in e||(e[t]=1),`${t}(${e[t]++})`)})(),Ke=(e,{name:t,enabled:o,intervalMS:i})=>{const d=Ot($e(t));g.exports.useEffect(()=>{if(!o)return;const a=new AbortController,n=si(t);console.log(`Starting ${n}: tick interval: ${i}ms`);const s=async()=>{try{if(console.time(n),a.signal.aborted)return;const c=performance.now();await e(a);const p=performance.now()-c;d(p),setTimeout(s,Math.max(0,i-p))}catch(c){if(a.signal.aborted||c instanceof D&&c.isUnknownDatabase()||c instanceof DOMException&&c.name==="AbortError")return;throw c}finally{console.timeEnd(n)}};return s(),()=>{console.log(`Stopping ${n}`),a.abort()}},[o,e,i,t,d])},pi=({before:e,after:t,includeSeedData:o})=>{const i=f(v),d=f(Z),{reset:a}=O(),[n,s]=z(Q),c=Ct(),p=f(di);return g.exports.useCallback(async()=>{const y=n;s(!1),e(),await Vr(i,{progress(u,m){const E="reset-schema";c.isActive(E)?c.update(E,{title:u,status:m,duration:m==="success"?2e3:null,isClosable:!0}):c({id:E,title:u,status:m,duration:null})},scaleFactor:d,includeSeedData:o,skipCreate:!!p}),t(),a(),s(y)},[n,s,e,i,d,o,p,t,a,c])},Qt=(e,t)=>{const[o,i]=g.exports.useState(e);return g.exports.useEffect(()=>{const d=setTimeout(()=>i(e),t);return()=>clearTimeout(d)},[e,t]),o},eo=()=>{const[{elapsed:e,isRunning:t},o]=g.exports.useReducer((i,d)=>{switch(d.type){case"start":return{start:Math.floor(performance.now()),isRunning:!0,elapsed:i.elapsed};case"stop":return{elapsed:Math.floor(performance.now())-(i.start||0),isRunning:!1}}},{isRunning:!1});return{elapsed:e,isRunning:t,startTimer:()=>o({type:"start"}),stopTimer:()=>o({type:"stop"})}},to=(e,t)=>{let o=!1,i=new Ao(0,0),d=0;e.on("pointerdown",a=>{o=!0,i=a.data.global,d=performance.now()}),e.on("pointerup",a=>{if(!o||(o=!1,performance.now()-d>200))return;const s=a.data.global;Math.sqrt(Math.pow(s.x-i.x,2)+Math.pow(s.y-i.y,2))>10||t(a)}),e.on("pointercancel",()=>{o=!1})};class yi extends q{constructor(t,o){super();S(this,"gfx");S(this,"hover",!1);this.city=t,this.onRemove=o,this.gfx=new _e,this.addChild(this.gfx),this.gfx.interactive=!0,this.gfx.on("pointerover",()=>{this.hover=!0}),this.gfx.on("pointerout",()=>{this.hover=!1}),to(this.gfx,()=>o(this.city))}update(t){this.gfx.clear(),this.gfx.lineStyle(1,this.hover?16711680:306687,1),this.gfx.beginFill(this.hover?16711680:306687,.2);const[o,i]=t([this.city.centerLat,this.city.centerLon]);this.gfx.drawCircle(o,i,25),this.gfx.endFill()}}const ui=e=>{const t=f(v),{initialized:o}=O();return N(["cities",t,o],()=>ei(t),{isPaused:()=>!o,onSuccess:e})},gi=({scene:e,latLngToPixel:t,pixelToLatLng:o,width:i,height:d})=>{const a=f(v),n=Rt(()=>new q),{mutate:s}=ui(y=>{n.removeChildren();for(let u=0;u<y.length;u++)n.addChild(new yi(y[u],p))}),c=g.exports.useCallback(async(y,u)=>{const m=await ti(a,u,y),E={id:m.id,name:m.name,lonlat:[m.centerLon,m.centerLat],diameter:m.diameter};await Ft(a,E),await lt(a,E,V[0]),s()},[a,s]),p=g.exports.useCallback(async y=>{await Ar(a,y.id),s()},[a,s]);return{setup:g.exports.useCallback(()=>{const y=new q;e.addChild(y),e.addChild(n),y.interactive=!0,y.hitArea=new Oo(0,0,i,d),to(y,u=>{const[m,E]=o([u.data.global.x,u.data.global.y]);c(m,E)})},[n,d,c,o,e,i]),update:g.exports.useCallback(()=>{for(let y=0;y<n.children.length;y++)n.children[y].update(t)},[n,t])}},fi=e=>r(Le,_(h({},e),{useRenderer:gi,options:{},cursor:"pointer"})),mi=Co({a:o=>{var i=o,{children:e}=i,t=k(i,["children"]);const{href:d}=t,a=!!(d!=null&&d.startsWith("http"));return a?l(W,_(h({isExternal:a},t),{children:[e,r(Io,{bottom:"2px",boxSize:"0.9em",position:"relative",ml:1})]})):r(W,_(h({to:d||""},t),{as:It,children:e}))}}),T=o=>{var i=o,{children:e}=i,t=k(i,["children"]);return r(wo,_(h({},t),{skipHtml:!0,components:mi,children:Array.isArray(e)?e.filter(d=>d).map(d=>j(d||"")).join(`

`):j(e)}))},vi=()=>l(K,{maxW:"container.lg",mt:10,mb:"30vh",children:[r(K,{maxW:"container.md",mb:10,children:r(T,{children:`
            ## Admin

            You can configure cities and offers on this page. To learn more
            about this application please visit the [Overview page](/).
          `})}),r(bi,{})]}),bi=()=>l(A,{children:[r(K,{maxW:"container.md",mb:4,children:r(T,{children:`
            #### Cities
            ...
            remove it.
          `})}),r(fi,{defaultZoom:4,defaultCenter:[39.716470511656766,-99.59395661915288],height:300})]}),oo=()=>{const e=Ot(Q);return l(ge,{status:"warning",borderRadius:"md",children:[r(fe,{}),r(me,{children:"The simulator is disabled"}),r(R,{position:"absolute",right:4,top:3,size:"xs",colorScheme:"blue",onClick:()=>e(!0),children:"Enable simulator"})]})};class hi extends q{constructor(t,o){super();S(this,"points");S(this,"polygon");this.color=o,this.points=Sr(t),this.polygon=new _e,this.addChild(this.polygon),this.polygon.interactive=!0,this.polygon.on("mouseover",()=>{this.polygon.tint=65280}),this.polygon.on("mouseout",()=>{this.polygon.tint=16777215})}update(t){this.polygon.clear(),this.polygon.lineStyle(1,this.color,1),this.polygon.beginFill(this.color,.2),this.polygon.drawPolygon(this.points.flatMap(([o,i])=>t([i,o]))),this.polygon.endFill()}}const Ei=e=>({scene:t,latLngToPixel:o,bounds:i})=>{const d=Qt(i,100);return e.useCells(d,a=>{t.removeChildren();for(const n of a)t.addChild(new hi(e.getCellWKTPolygon(n),e.getCellColor(n)))}),{update:g.exports.useCallback(()=>{for(let a=0;a<t.children.length;a++)t.children[a].update(o)},[o,t])}},ro=e=>{const n=e,{useCells:t,getCellColor:o,getCellWKTPolygon:i}=n,d=k(n,["useCells","getCellColor","getCellWKTPolygon"]),a=g.exports.useMemo(()=>Ei({useCells:t,getCellColor:o,getCellWKTPolygon:i}),[o,i,t]);return r(Le,_(h({},d),{useRenderer:a,options:{}}))},_i=10*1e3,gt=e=>{const t=f(v),o=f(Z),{initialized:i}=O(),d=g.exports.useCallback(a=>{const n=_(h({},t),{ctx:a});return Promise.all([Vt(n,o),Kr(n),qr(n),Xr(n,o),$t(n)])},[t,o]);Ke(d,{name:"SimulatorMonitor",enabled:i&&e,intervalMS:_i})},Ti=1*1e3,Si=10*1e3,io=e=>{const t=f(v),{initialized:o}=O(),i=g.exports.useRef(new Date(0).toISOString()),d=g.exports.useCallback(n=>st(_(h({},t),{ctx:n}),"minute"),[t]);Ke(d,{name:"SimulatorMatcher",enabled:o&&e,intervalMS:Ti});const a=g.exports.useCallback(async n=>{i.current=await pt(_(h({},t),{ctx:n}),i.current)},[t]);Ke(a,{name:"SimulatorUpdateSegments",enabled:o&&e,intervalMS:Si})},qe=ne(",.2%"),ie=ne(".4~s"),Ni=()=>{const{initialized:e}=O(),t=f(Q);return gt(t),io(t),r(K,{maxW:"container.lg",mt:10,mb:"30vh",children:e?t?l(F,{gap:10,children:[r(Ri,{}),r(Ai,{}),r(wi,{})]}):r(oo,{}):r(ao,{})})},ao=()=>r(P,{children:r(M,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})}),Ri=()=>{var d,a;const e=f(v),t=N(["overallConversionRateRequests",e],()=>Nt(e,"requests"),{refreshInterval:1e3}),o=N(["overallConversionRatePurchases",e],()=>Nt(e,"purchases"),{refreshInterval:1e3}),i=N(["analyticsTableCounts",e],()=>ze(e,"offers","subscribers","notifications"),{refreshInterval:1e3});return!i.data||!t.data||!o.data?r(ao,{}):l(Xe,{spacing:2,minChildWidth:"150px",flex:2,children:[l(C,{children:[r(I,{children:"Offers"}),r(w,{children:ie(i.data.offers)})]}),l(C,{children:[r(I,{children:"Subscribers"}),r(w,{children:ie(i.data.subscribers)})]}),l(C,{children:[r(I,{children:"Notifications"}),r(w,{children:ie(i.data.notifications)})]}),l(C,{children:[r(I,{children:"Conversion Rate"}),r(w,{children:qe(((d=t.data)==null?void 0:d.conversionRate)||0)}),r(vt,{children:"Requests"})]}),l(C,{children:[r(I,{children:"Conversion Rate"}),r(w,{children:qe(((a=o.data)==null?void 0:a.conversionRate)||0)}),r(vt,{children:"Purchases"})]})]})},Ai=()=>{var a;const e=f(v),[t,o]=g.exports.useState("conversionRate"),i=N(["customerMetrics",e,t],()=>oi(e,"purchases",t,10),{refreshInterval:1e3}),d=Te("blue.500","blue.200");return r(L,{overflowX:"auto",children:l(Lo,{size:"sm",colorScheme:"gray",variant:"striped",children:[r(ko,{children:l(bt,{children:[l(se,{onClick:()=>o("customer"),_hover:{color:d},color:t==="customer"?d:void 0,cursor:"pointer",children:["Customer",t==="customer"&&r(oe,{})]}),l(se,{onClick:()=>o("totalNotifications"),_hover:{color:d},color:t==="totalNotifications"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Notifications",t==="totalNotifications"&&r(oe,{})]}),l(se,{onClick:()=>o("totalConversions"),_hover:{color:d},color:t==="totalConversions"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Conversions",t==="totalConversions"&&r(oe,{})]}),l(se,{onClick:()=>o("conversionRate"),_hover:{color:d},color:t==="conversionRate"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Conversion Rate",t==="conversionRate"&&r(oe,{})]})]})}),r(Do,{children:(a=i.data)==null?void 0:a.map(n=>l(bt,{children:[r(pe,{children:n.customer}),r(pe,{isNumeric:!0,children:ie(n.totalNotifications)}),r(pe,{isNumeric:!0,children:ie(n.totalConversions)}),r(pe,{isNumeric:!0,children:qe(n.conversionRate)})]},n.customer))})]})})},Oi=(e,t)=>{const o=f(v);N(["zoneMetrics",o,e],()=>ri(o,e,"purchases"),{refreshInterval:1e3,onSuccess:t})},Ci=({r:e,g:t,b:o})=>e<<16|t<<8|o,Ii=e=>Ci(ht(xo(.3+e))||ht(0,0,0)),wi=()=>l(F,{direction:["column","row"],alignItems:"top",children:[r(L,{flex:1,children:r(T,{children:`
            ### Conversion Map
          ...
          `})}),r(L,{flex:2,children:r(ro,{height:400,defaultZoom:14,useCells:Oi,getCellColor:e=>Ii(e.conversionRate),getCellWKTPolygon:e=>e.wktPolygon})})]}),ye=({label:e,placeholder:t,value:o,setValue:i,helpText:d,type:a="text"})=>l(Ze,{children:[r(Qe,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),r(wt,{size:"sm",placeholder:t,value:o,onChange:n=>i(n.target.value),type:a}),d?r(zo,{fontSize:"xs",children:d}):null]}),Li=()=>{const[e,t]=z(Z);return l(Ze,{children:[r(Qe,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),r(Po,{size:"sm",required:!0,value:e.name,onChange:o=>{const i=o.target.value;t(ii(i))},children:V.map(o=>r("option",{value:o.name,children:o.name},o.name))})]})},no=({showDatabase:e,showScaleFactor:t})=>{const[o,i]=z(Kt),[d,a]=z(qt),[n,s]=z(Jt),[c,p]=z(X);return l(F,{spacing:4,children:[r(ye,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:o,setValue:i,helpText:r(T,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [HTTP API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),l(Xe,{columns:2,gap:2,children:[r(ye,{label:"Username",placeholder:"admin",value:d,setValue:a}),r(ye,{label:"Password",placeholder:"",value:n,setValue:s,type:"password"}),e&&r(ye,{label:"Database",placeholder:"martech",value:c,setValue:p}),t&&r(Li,{})]})]})},co=e=>r(R,_(h({onClick:()=>{const{pathname:t,hash:o}=window.location;window.location.replace(t+o)},colorScheme:"red"},e),{children:"Disconnect"})),lo=e=>{const{connected:t,initialized:o}=O(),i=et(),[d,a]=Ae(),n=f(X),s=ae.useRef(null),m=e,{skipSeedData:c,disabled:p}=m,y=k(m,["skipSeedData","disabled"]),u=pi({before:g.exports.useCallback(()=>a.on(),[a]),after:g.exports.useCallback(()=>{a.off(),i.onClose()},[i,a]),includeSeedData:!c});return l(A,{children:[r(R,h({disabled:!t||p,onClick:i.onOpen,colorScheme:o?"green":"red"},y)),r(Mo,{isOpen:i.isOpen,onClose:i.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:s,children:r(tt,{children:l(Uo,{children:[l(ot,{fontSize:"lg",fontWeight:"bold",children:[o?"Reset":"Setup"," database ",n]}),l(rt,{children:["This will ",o?"recreate":"create"," the database called ",n,". Are you sure?"]}),l(Lt,{children:[r(R,{ref:s,onClick:i.onClose,disabled:d,children:"Cancel"}),r(R,{disabled:d,colorScheme:o?"red":"green",onClick:u,ml:3,children:d?r(M,{}):o?"Recreate database":"Create database"})]})]})})})]})},ki=({isOpen:e,onClose:t,finalFocusRef:o})=>{const[i,d]=z(Q),a=f(v),{connected:n,initialized:s,isVapor:c}=O(),p=et(),[y,u]=Ae(!1),m=g.exports.useCallback(async()=>{u.on(),await Wt(a),u.off()},[a,u]);return l(Bo,{isOpen:e,placement:"right",onClose:t,finalFocusRef:o,children:[r(tt,{}),l(Fo,{children:[r(kt,{}),r(ot,{children:"Config"}),r(rt,{children:l(F,{spacing:4,children:[c?null:r(no,{showScaleFactor:!0,showDatabase:!0}),l(ge,{status:n?"success":"error",borderRadius:"md",children:[r(fe,{}),r(me,{children:n?"connected":"disconnected"}),c?r(co,{position:"absolute",right:4,top:3,size:"xs"}):null]}),l(ge,{status:s?"success":"warning",borderRadius:"md",children:[r(fe,{}),r(me,{children:"schema"}),r(lo,{position:"absolute",right:4,top:3,size:"xs",children:s?"Reset":"Setup"})]}),l(ge,{status:i?"success":"warning",borderRadius:"md",children:[r(fe,{}),r(me,{children:"simulator"}),r(Go,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:i?"green":"red",isChecked:i,disabled:!n||!s,onChange:()=>d(!i)})]}),l(ce,{onClick:p.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",p.isOpen?r(Yo,{ml:2}):r(oe,{ml:2})]}),p.isOpen?r(R,{size:"xs",_hover:{colorScheme:"red"},onClick:m,disabled:y,children:"Drop Database"}):void 0]})}),r(Lt,{})]})]})},ue=({to:e,children:t,onClick:o})=>{const i=qo(e),d=Jo({path:i.pathname,end:!0});return r(W,{as:It,to:e,px:2,py:1,onClick:o,rounded:"md",_hover:{textDecoration:"none",bg:Te("gray.300","gray.600")},fontWeight:d?"bold":"normal",href:"#",color:Te("gray.700","gray.200"),children:t})},Di=()=>{const{colorMode:e,toggleColorMode:t}=Oe(),o=et(),[i,d]=z(ci),a=ae.useRef(null),{connected:n,initialized:s}=O(),c=f(Q),[p]=Dt("(max-width: 640px)"),y=l(A,{children:[r(ue,{to:"/",onClick:o.onClose,children:"Overview"}),r(ue,{to:"/map",onClick:o.onClose,children:"Map"}),r(ue,{to:"/admin",onClick:o.onClose,children:"Admin"}),r(ue,{to:"/analytics",onClick:o.onClose,children:"Analytics"})]});let u;return p||(u=n?s?c?"connected":"simulator disabled":"needs schema":"disconnected"),r(A,{children:r(L,{bg:Te("gray.200","gray.700"),children:l(K,{maxW:"container.lg",children:[l(Se,{h:16,alignItems:"center",justifyContent:"space-between",children:[r(Ye,{size:"md",icon:o.isOpen?r(Ho,{}):r(Wo,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:o.isOpen?o.onClose:o.onOpen}),l(Ne,{spacing:8,alignItems:"center",children:[r(Ce,{as:"h1",size:p?"sm":"md",children:p?"Martech":"Realtime Digital Marketing"}),r(Ne,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:y})]}),l(Se,{alignItems:"center",gap:2,children:[l(R,{size:"sm",ref:a,onClick:()=>d(!0),colorScheme:n?s&&c?"green":"yellow":"red",children:[s?r(xt,{}):r(zt,{}),p||r(ce,{pl:2,children:u})]}),r(Ye,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?r(jo,{size:"1.4em"}):r(Vo,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),r(Ye,{"aria-label":"Toggle Color Mode",size:"sm",onClick:t,icon:e==="light"?r($o,{boxSize:"1.2em"}):r(Ko,{boxSize:"1.2em"})})]})]}),o.isOpen?r(L,{pb:4,display:{md:"none"},children:r(F,{as:"nav",spacing:4,children:y})}):null,r(ki,{isOpen:i,onClose:()=>d(!1),finalFocusRef:a})]})})})},xi=e=>{const t=g.exports.useRef([]),{data:o}=N(["timeseries",e.name,...e.deps||[]],async()=>{const i=await e.fetcher();return t.current.push({data:i,ts:new Date}),t.current=t.current.slice(-e.limit),t.current},{refreshInterval:e.intervalMS});return o||[]},zi=ne("~s"),so=(e,...t)=>xi({name:"estimatedRowCount",deps:t,fetcher:g.exports.useCallback(()=>ze(e,...t),[e,t]),limit:30,intervalMS:1e3}),po=o=>{var i=o,{data:e}=i,t=k(i,["data"]);const{colorMode:d}=Oe(),a=g.exports.useCallback(({tooltipData:c,colorScale:p})=>!p||!c?null:Object.keys(c.datumByKey).sort((y,u)=>c.datumByKey[u].datum.data[u]-c.datumByKey[y].datum.data[y]).map(y=>{const{datum:u}=c.datumByKey[y],m=u.data[y];return l(ce,{mb:1,color:p(y),fontSize:"sm",children:[y,": ",ne(".4~s")(m)]},y)}),[]),n=g.exports.useCallback(c=>zi(c).replace("G","B"),[]);if(e.length<2)return r(P,{height:t.height,children:r(M,{size:"md"})});const s=e.length>0?Object.keys(e[0].data).filter(c=>c!=="ts").map(c=>r(Xo,{dataKey:c,data:e,xAccessor:p=>p==null?void 0:p.ts,yAccessor:p=>p==null?void 0:p.data[c]},c)):null;return l(Zo,_(h({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:d==="light"?Qo:er,margin:{left:0,right:50,top:10,bottom:40}},t),{children:[r(Et,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),r(Et,{orientation:"right",numTicks:t.height<250?3:5,tickFormat:n,label:"rows",labelOffset:20}),s,r(tr,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:a})]}))},Je=1e3,he=60*Je,Ee=60*he,We=24*Ee,B=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),$=e=>e?e<Je?`${B(e)}ms`:e<he?`${B(e/Je)}s`:e<Ee?`${Math.floor(e/he)}m${$(e%he)}`:e<We?`${Math.floor(e/Ee)}h${$(e%Ee)}`:`${Math.floor(e/We)}d${$(e%We)}`:"0s",Pi=100,Mi=1e3,H=class extends q{constructor(t){super();S(this,"latlng");S(this,"age",0);S(this,"marker");S(this,"pulse");this.latlng=t,this.marker=new _e,this.marker.beginFill(H.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new _e,this.pulse.beginFill(H.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(t,o){if(this.age+=o/60,this.age>H.lifetime&&this.parent){this.parent.removeChild(this);return}const i=this.age%H.lifetime/H.lifetime,d=dr(i);this.pulse.scale.set(1+d);const a=.4,n=i<a?or(i/a):1-rr((i-a)/(1-a));this.pulse.alpha=n,i<a?this.marker.alpha=n:this.marker.alpha=1-ir((i-a)/(1-a));const[s,c]=t(this.latlng);this.x=s,this.y=c}};let re=H;S(re,"lifetime",1.5),S(re,"markerColor",306687),S(re,"pulseColor",306687);const yo=()=>{const e=f(v),{initialized:t}=O();return g.exports.useMemo(()=>["notifications",e,t],[e,t])},uo=({scene:e,latLngToPixel:t,bounds:o})=>{const i=g.exports.useRef(new Date().toISOString()),d=f(v),{initialized:a}=O(),n=Qt(o,50),s=yo();return N(s,()=>Zr(d,i.current,Pi,n),{refreshInterval:Mi,isPaused:()=>!a,onSuccess:c=>{if(c.length>0){i.current=c[0][0];for(const[,p,y]of c)e.addChild(new re([y,p]))}}}),{update:g.exports.useCallback(c=>{for(let p=e.children.length-1;p>=0;p--)e.children[p].update(t,c)},[t,e])}},Ui=()=>{const e=f(v),t=so(e,"locations","requests","purchases","notifications","subscriber_segments"),o=N(["notificationsMapTableCounts",e],()=>ze(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),i=f($e("SimulatorMatcher")),d=f($e("SimulatorUpdateSegments")),a=ne(".4~s"),n=o.data?l(Pt,{templateColumns:"repeat(auto-fit, minmax(100px, 1fr))",columnGap:2,rowGap:2,children:[l(C,{children:[r(I,{children:"Offers"}),r(w,{children:a(o.data.offers)})]}),l(C,{children:[r(I,{children:"Cities"}),r(w,{children:a(o.data.cities)})]}),l(C,{children:[r(I,{children:"Subscribers"}),r(w,{children:a(o.data.subscribers)})]}),l(C,{children:[r(I,{children:"Segments"}),r(w,{children:a(o.data.segments)})]}),l(C,{children:[r(I,{children:"Segmentation"}),r(w,{children:$(d)})]}),l(C,{children:[r(I,{children:"Matching"}),r(w,{children:$(i)})]})]}):null;return l(A,{children:[r(T,{children:`
          ...
          about the demo.
        `}),n,l(L,{children:[r(ce,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),r(po,{data:t,height:150})]})]})},Bi=()=>{const e=f(Q);return gt(e),io(e),l(Se,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[r(F,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:r(Le,{useRenderer:uo,options:{}})}),l(F,{spacing:4,flex:"1 1 0",minWidth:"0",children:[r(T,{children:`
          ...
          `}),e?r(Ui,{}):r(oo,{})]})]})},go=o=>{var i=o,{children:e}=i,t=k(i,["children"]);return r(ar,_(h({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},t),{children:e}))},Fi=1e3,Gi=(e,t)=>{const o=f(v),{initialized:i}=O();N(["offers",o,i,e],()=>Qr(o,Fi,e),{isPaused:()=>!i,onSuccess:t})},Yi=e=>r(ro,_(h({},e),{useCells:Gi,getCellColor:()=>306687,getCellWKTPolygon:t=>t.notificationZone})),G=e=>{const{completed:t,title:o,left:i,right:d}=e,{colorMode:a}=Oe(),n=a==="light"?".300":".500",s=t?"gray"+n:void 0,c=(t?"green":"gray")+n;return l(A,{children:[l(Re,{children:[l(Ce,{as:"h2",size:"lg",mb:4,color:s,children:[r(xt,h({color:c},{boxSize:6,position:"relative",bottom:.5,mr:2})),o]}),i]}),r(Re,{children:d})]})},Hi=({connected:e,isVapor:t})=>t?r(G,{completed:e,title:"Connected",left:l(A,{children:[r(T,{children:`
            ...
            **Note**: The HTTP API may need to be enabled on your SingleStore
            ...
            [1]: https://docs.singlestore.com/docs/http-api/
          `}),right:r(no,{})}),Wi=({onClose:e,schemaObjectName:t})=>{const o=Hr(t),[i]=Dt("(max-width: 640px)");return l(lr,{isOpen:!0,onClose:e,size:i?"full":"4xl",scrollBehavior:"inside",children:[r(tt,{}),l(sr,{children:[l(ot,{children:["Create statement for ",o.name]}),r(kt,{}),r(rt,{children:r(go,{mb:4,children:o.createStmt})})]})]})},ji=({initialized:e})=>{const[t,o]=z(X),i=Zt(),{colorMode:d}=Oe(),[a,n]=g.exports.useState(),s=g.exports.useCallback(p=>n(p),[]),c=g.exports.useCallback(()=>n(null),[]);return l(A,{children:[!!a&&r(Wi,{onClose:c,schemaObjectName:a}),r(G,{completed:e,title:"Setup the schema",left:l(A,{children:[r(T,{children:`
              ...
              `}),r(nr,{mt:4,mb:6}),l(Ne,{alignItems:"flex-end",children:[l(Ze,{flex:1,children:[r(Qe,{fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Database name"}),r(wt,{placeholder:"martech",value:t,size:"sm",onChange:p=>o(p.target.value)})]}),r(L,{flex:1,textAlign:"center",children:r(lo,{colorScheme:"blue",size:"sm",disabled:e,skipSeedData:!0,children:e?"Schema is setup":"Setup schema"})})]})]}),right:r(Xe,{columns:[1,2,2],gap:1,children:Object.keys(i.data||{}).sort().map(p=>{var y;return r(Re,{bg:((y=i.data)!=null&&y[p]?"green":"gray")+(d==="light"?".200":".600"),color:d==="light"?"gray.800":"gray.100",textOverflow:"ellipsis",whiteSpace:"nowrap",overflow:"hidden",borderRadius:"md",px:2,py:1,textAlign:"center",_hover:{fontWeight:"bold"},cursor:"pointer",onClick:()=>s(p),children:p},p)})})})]})},fo=(e,t,o=!0)=>{var a;const i=N(["pipelineStatus",e,t],()=>jt(e,t),{isPaused:()=>!o}),d=(a=i.data)!=null&&a.length?i.data.every(n=>!n.needsUpdate):!1;return{pipelines:i,completed:d}},Vi=()=>{const e=f(v),t=f(Z),{pipelines:o,completed:i}=fo(e,t);gt(i);const[d,a]=Ae(),n=g.exports.useCallback(async()=>{a.on(),await Vt(e,t),o.mutate(),a.off()},[a,e,t,o]),s=so(e,"locations","requests","purchases"),c=s.length<2||s.every(({data:y})=>y.locations+y.purchases+y.requests===0);return r(G,{completed:i,title:"Ingest data",left:r(T,{children:`
          ...
          `}),right:c||!i?r(P,{h:220,children:l(R,{colorScheme:"blue",size:"sm",onClick:n,disabled:i,children:[(d||i)&&r(M,{mr:2}),d?"Creating Pipelines":i?"...waiting for data":"Create pipelines"]})}):r(po,{data:s,height:200})})},Pe=(e,t=!0)=>N(["overviewTableCounts",e],()=>ze(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!t}),$i=()=>{var s,c;const e=f(v),t=f(Z),[o,i]=Ae(),d=Pe(e),a=g.exports.useCallback(async()=>{i.on(),await lt(e,de,t),d.mutate(),i.off()},[e,t,d,i]),n=!!((s=d.data)!=null&&s.offers);return r(G,{completed:n,title:"Offers",left:r(A,{children:l(T,{children:[`
        ...
        `})}return r(G,{completed:s,title:"Segmentation",left:r(T,{children:`
          ...
          `}),right:r(P,{h:"100%",children:l(Mt,{gap:4,textAlign:"center",children:[l(R,{disabled:i,onClick:c,children:[i&&r(M,{mr:2}),i?"...running":"Match subscribers to segments"]}),p]})})})},Ji=()=>{var E;const e=f(v),t=Pe(e),o=yo(),{mutate:i}=cr(),{elapsed:d,isRunning:a,startTimer:n,stopTimer:s}=eo(),[c,p]=g.exports.useState(0),y=!!((E=t.data)!=null&&E.notifications),u=g.exports.useCallback(async()=>{let Y=0,ee=0;for(;Y===0&&ee++<10;)n(),Y=await st(e,"second");s(),p(Y),t.mutate(),i(o)},[e,n,s,t,i,o]);let m;if(d&&t.data){const{offers:Y,subscribers:ee,subscriber_segments:Me,notifications:Ue}=t.data,Be=B(Y*ee+Ue),Fe=B(Me),mo=$(d),vo=B(c);m=r(T,{children:`
          The last update evaluated up to ${Be} notification opportunities
          against ${Fe} segment memberships generating ${vo}
          notifications. This process took ${mo}.
        `})}return r(G,{completed:y,title:"Matching",left:r(T,{children:`
          ...
          `}),right:r(P,{h:"100%",children:l(Mt,{gap:4,w:"100%",children:[l(R,{disabled:a,onClick:u,children:[a&&r(M,{mr:2}),a?"...running":"Generate notifications"]}),r(L,{width:"100%",children:r(Le,{height:250,defaultZoom:12,useRenderer:uo,options:{}})}),m]})})})},Xi=()=>{const e=f(X);return r(G,{completed:!0,title:"Putting it all together",left:r(T,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: map
          `}),right:null})},Zi=()=>{const e=f(v),t=f(Z),{connected:o,initialized:i,isVapor:d}=O(),{completed:a}=fo(e,t,o&&i),{data:n}=Pe(e,o&&i),[s,c]=g.exports.useState(!1),p=[{completed:o,component:r(Hi,{connected:o,isVapor:d},"connection")},{completed:i,component:r(ji,{initialized:i},"schema")},{completed:a,component:r(Vi,{},"pipelines")},{completed:n?n.offers>0:!1,component:r($i,{},"offers")},{completed:s,component:r(Ki,{done:s,setDone:c},"warmup")},{completed:n?n.subscriber_segments>0:!1,component:r(qi,{},"segmentation")},{completed:n?n.notifications>0:!1,component:r(Ji,{},"matching")},{completed:!0,component:r(Xi,{},"summary")}];let y=!0;const u=[];for(const{completed:m,component:E}of p)if(y)u.push(E),y=m;else break;return l(K,{maxW:"container.lg",mt:10,mb:"30vh",children:[r(L,{maxW:"container.md",mb:10,px:0,children:r(T,{children:`
          ...
          `})}),r(Pt,{columnGap:6,rowGap:10,templateColumns:["minmax(0, 1fr)",null,"repeat(2, minmax(0, 1fr))"],children:u})]})};function Qi(){const e=r(P,{height:"100vh",children:r(M,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})});return r(g.exports.Suspense,{fallback:e,children:l(Se,{height:"100vh",direction:"column",children:[r(Di,{}),r(L,{m:4,flex:"1",children:l(pr,{children:[r(te,{path:"/",element:r(Zi,{})}),r(te,{path:"/map",element:r(Bi,{})}),r(te,{path:"/admin",element:r(vi,{})}),r(te,{path:"/analytics",element:r(Ni,{})}),r(te,{path:"*",element:r(yr,{to:"/",replace:!0})})]})})]})})}class ed extends ae.Component{constructor(){super(void 0);S(this,"state",{});this.handlePromiseRejection=this.handlePromiseRejection.bind(this)}componentDidMount(){window.addEventListener("unhandledrejection",this.handlePromiseRejection)}componentWillUnmount(){window.removeEventListener("unhandledrejection",this.handlePromiseRejection)}handlePromiseRejection(t){this.setState({error:t.reason})}static getDerivedStateFromError(t){return{error:t}}render(){const{error:t}=this.state;if(t){let o;return t instanceof D&&(o=l(A,{children:[r(ce,{textAlign:"center",children:"An error occurred while running the following query:"}),r(go,{children:j(t.sql)})]})),r(K,{maxW:"container.md",my:10,children:l(F,{gap:4,children:[r(P,{children:r(zt,{boxSize:20,color:"red"})}),r(Ce,{size:"xl",textAlign:"center",children:t.message}),o,l(Ne,{justify:"center",gap:4,children:[r(R,{onClick:()=>this.setState({error:void 0}),size:"sm",children:"Dismiss Error"}),r(R,{onClick:()=>window.location.reload(),size:"sm",colorScheme:"blue",leftIcon:r(ur,{}),children:"Reload"})]})]})})}return this.props.children}}const td=gr({fonts:{heading:"InterVariable, sans-serif",body:"InterVariable, sans-serif",mono:'"Source Code ProVariable", monospace'},components:{Link:{baseStyle:e=>({color:e.colorMode==="light"?"blue.600":"blue.300"})}}}),od=({children:e})=>{const t=Ct();return r(hr,{value:{onError:i=>{t({title:"An error occurred",description:i.message,status:"error",duration:5e3,isClosable:!0})}},children:e})};fr.render(r(ae.StrictMode,{children:r(mr,{theme:td,children:r(ed,{children:r(od,{children:r(vr,{children:r(br,{basename:"/",children:r(Qi,{})})})})})})}),document.getElementById("root"));
