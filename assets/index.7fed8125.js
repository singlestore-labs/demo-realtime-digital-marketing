var bt=Object.defineProperty,ht=Object.defineProperties;var Et=Object.getOwnPropertyDescriptors;var le=Object.getOwnPropertySymbols;var mo=Object.prototype.hasOwnProperty,vo=Object.prototype.propertyIsEnumerable;var Ye=(e,o,t)=>o in e?bt(e,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[o]=t,b=(e,o)=>{for(var t in o||(o={}))mo.call(o,t)&&Ye(e,t,o[t]);if(le)for(var t of le(o))vo.call(o,t)&&Ye(e,t,o[t]);return e},_=(e,o)=>ht(e,Et(o));var k=(e,o)=>{var t={};for(var r in e)mo.call(e,r)&&o.indexOf(r)<0&&(t[r]=e[r]);if(e!=null&&le)for(var r of le(e))o.indexOf(r)<0&&vo.call(e,r)&&(t[r]=e[r]);return t};var S=(e,o,t)=>(Ye(e,typeof o!="symbol"?o+"":o,t),t);import{d as W,l as _t,s as Tt,_ as Ve,r as g,j as i,B as L,M as St,a as s,F as O,L as j,R as ae,u as Oo,C as q,A as Nt,b as x,c as Ao,e as Rt,f,g as N,h as Co,i as z,k as Io,P as Ot,m as At,G as _e,q as Ct,E as It,N as wo,n as wt,o as K,p as ge,t as fe,v as me,w as R,x as ne,S as B,y as P,z as M,D as Oe,H as C,I,J as w,K as bo,O as Te,T as Lt,Q as kt,U as ho,V as se,W as te,X as Dt,Y as pe,Z as $e,$ as xt,a0 as Qe,a1 as eo,a2 as Lo,a3 as zt,a4 as Pt,a5 as oo,a6 as Ae,a7 as Mt,a8 as to,a9 as Ut,aa as ro,ab as io,ac as ko,ad as Bt,ae as Ft,af as Do,ag as Gt,ah as ce,ai as Yt,aj as Ce,ak as xo,al as Se,am as He,an as Ht,ao as jt,ap as Ne,aq as Ie,ar as zo,as as Po,at as Wt,au as Vt,av as $t,aw as Kt,ax as qt,ay as Jt,az as Xt,aA as Zt,aB as Qt,aC as er,aD as Eo,aE as or,aF as tr,aG as rr,aH as ir,aI as dr,aJ as ar,aK as nr,aL as cr,aM as Re,aN as Mo,aO as lr,aP as sr,aQ as pr,aR as ur,aS as oe,aT as yr,aU as gr,aV as fr,aW as mr,aX as vr,aY as br,aZ as hr,a_ as Er}from"./vendor.dc13b385.js";const _r=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const d of document.querySelectorAll('link[rel="modulepreload"]'))r(d);new MutationObserver(d=>{for(const a of d)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function t(d){const a={};return d.integrity&&(a.integrity=d.integrity),d.referrerpolicy&&(a.referrerPolicy=d.referrerpolicy),d.crossorigin==="use-credentials"?a.credentials="include":d.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(d){if(d.ep)return;d.ep=!0;const a=t(d);fetch(d.href,a)}};_r();const Tr=/^Error (?<code>\d+):/;class D extends Error{constructor(o,t,r){super(o);S(this,"code");S(this,"sql");var d;if(Object.setPrototypeOf(this,D.prototype),this.sql=t,r)this.code=r;else{const a=o.match(Tr);this.code=a?parseInt(((d=a.groups)==null?void 0:d.code)||"-1",10):-1}}isUnknownDatabase(){return this.code===1049}isDatabaseRecovering(){return this.code===2269}}const ao=async(e,o,...t)=>{const r=await G(e,o,...t);if(r.length!==1)throw new D("Expected exactly one row",o);return r[0]},G=async(e,o,...t)=>{const r=await we("query/rows",e,o,...t);if(r.results.length!==1)throw new D("Expected exactly one result set",o);return r.results[0].rows},Uo=(e,o,...t)=>G(_(b({},e),{database:void 0}),o,...t),no=async(e,o,...t)=>{const r=await we("query/tuples",e,o,...t);if(r.results.length!==1)throw new D("Expected exactly one result set",o);return r.results[0].rows},co=(e,o,...t)=>we("exec",_(b({},e),{database:void 0}),o,...t),h=(e,o,...t)=>we("exec",e,o,...t),we=async(e,o,t,...r)=>{var n;const d=await fetch(`${o.host}/api/v1/${e}`,{method:"POST",signal:(n=o.ctx)==null?void 0:n.signal,headers:{"Content-Type":"application/json",Authorization:`Basic ${btoa(`${o.user}:${o.password}`)}`},body:JSON.stringify({sql:t,args:r,database:o.database})});if(!d.ok)throw new D(await d.text(),t);const a=await d.json();if(a.error)throw new D(a.error.message,t,a.error.code);return a},Bo=e=>{const{table:o,columns:t,tuples:r,options:d}=e,a=`(${t.map(()=>"?").join(",")})`,n=r.map(()=>a).join(",");return{sql:W`
...
`),{sql:a,params:n}=_o(t);return{sql:W`
    ...
    `,o.id,o.name,`POINT(${o.lonlat[0]} ${o.lonlat[1]})`,o.diameter),Ar=(e,o)=>h(e,"DELETE FROM cities WHERE city_id = ?",o),Cr=["olc_8","purchase","request"],Ir=["minute","hour","day","week","month"],Yo=({interval:e,kind:o,value:t})=>Tt(`${e}-${o}-${t}`),wr=async(e,o)=>{const{sql:t,params:r}=Bo({table:"segments",options:{replace:!0},columns:["segment_id","valid_interval","filter_kind","filter_value"],tuples:o.map(d=>[Yo(d),d.interval,d.kind,d.value])});await h(e,t,...r)},Lr=async(e,o)=>{const t={table:"offers",options:{replace:!0},columns:["customer","notification_zone","segment_ids","notification_content","notification_target","maximum_bid_cents"],tuples:[]};let r=0,d=[];const a=async()=>{const{sql:n,params:l}=Bo(t);await Promise.all([h(e,n,...l),wr(e,d)]),t.tuples=[],d=[],r=0};for(const n of o)t.tuples.push([n.customer,n.notificationZone,JSON.stringify(n.segments.map(Yo)),n.notificationContent,n.notificationTarget,n.maximumBidCents]),r++,d=d.concat(n.segments),r>=Or&&await a();r>0&&await a()},kr=()=>Fo(Cr),Dr=()=>Fo(Ir),Ho=({vendor:e,tld:o})=>`${e.toLowerCase()}.${o}`,jo=e=>{const[o,t]=e.lonlat,r=e.diameter/2,[d,a]=[o-r,o+r],[n,l]=[t-r,t+r];return[Ke(d,a),Ke(n,l)]},xr=(e,o)=>{const t=kr(),r=Dr();switch(t){case"olc_8":{const[d,a]=jo(e),n=Ve.encode(a,d,8).substring(0,8);return{kind:t,interval:r,value:n}}case"purchase":return{kind:t,interval:r,value:o.vendor};case"request":return{kind:t,interval:r,value:Ho(o)}}},zr=e=>{const o=ve(1,3),t=Rr(),r=Array.from({length:o},()=>xr(e,t)),d=Ho(t),n=`${ve(10,50)}% off at ${t.vendor}`,l=d,[c,p]=jo(e),u=Ve.encode(p,c,8),y=Ve.decode(u),m={ne:[y.latitudeHi,y.longitudeHi],sw:[y.latitudeLo,y.longitudeLo]};return{customer:t.vendor,segments:r,notificationZone:Le(m),notificationContent:n,notificationTarget:l,maximumBidCents:ve(2,15)}},Pr=(e,o)=>Array.from({length:o},()=>zr(e)),Mr=e=>(o,t,r,d=1)=>`https://stamen-tiles.a.ssl.fastly.net/${e}/${r}/${o}/${t}${d>=2?"@2x":""}.png`,Ur=s(O,{children:["Map tiles by ",i(j,{href:"http://stamen.com",children:"Stamen Design"}),", under"," ",i(j,{href:"http://creativecommons.org/licenses/by/3.0",children:"CC BY 3.0"}),". Data by ",i(j,{href:"http://openstreetmap.org",children:"OpenStreetMap"}),", under"," ",i(j,{href:"http://www.openstreetmap.org/copyright",children:"ODbL"}),"."]}),Br=[de.lonlat[1],de.lonlat[0]],Fr=12,Gr=({width:e,height:o,bounds:t,latLngToPixel:r,pixelToLatLng:d,useRenderer:a,options:n})=>{const l=ae.useRef(null),c=Oo(()=>new q),{setup:p,update:u}=a({scene:c,width:e,height:o,bounds:t,latLngToPixel:r,pixelToLatLng:d,options:n});return g.exports.useLayoutEffect(()=>{if(!l.current)throw new Error("No canvas ref");console.log("PixiMapLayer: Setup");const y=new Nt({view:l.current,width:e,height:o,backgroundAlpha:0,antialias:!0});return y.stage.addChild(c),p==null||p(),u&&y.ticker.add(m=>{u(m)}),()=>{console.log("PixiMapLayer: Destroy"),y.stage.removeChild(c),y.destroy(!1,{children:!1,texture:!0,baseTexture:!0})}},[o,c,p,u,e]),i("canvas",{ref:l})},Yr=({mapState:e,latLngToPixel:o,pixelToLatLng:t,useRenderer:r,options:d})=>{const{width:a,height:n,bounds:l}=e||{width:0,height:0};return a<=0||n<=0||!o||!t||!l?null:i(Gr,{useRenderer:r,width:a,height:n,bounds:l,latLngToPixel:o,pixelToLatLng:t,options:d})},ke=n=>{var l=n,{height:e="100%",defaultCenter:o=Br,defaultZoom:t=Fr,useRenderer:r,options:d}=l,a=k(l,["height","defaultCenter","defaultZoom","useRenderer","options"]);const[c,p]=g.exports.useState(o),[u,y]=g.exports.useState(t);return i(L,_(b({borderRadius:"lg",overflow:"hidden",height:e},a),{children:i(St,{dprs:[1,2],provider:Mr("toner-lite"),attribution:Ur,maxZoom:20,center:c,zoom:u,onBoundsChanged:({center:m,zoom:E})=>{p(m),y(E)},children:i(Yr,{useRenderer:r,options:d})})}))};var De=[{name:"date_sub_dynamic",createStmt:`CREATE OR REPLACE FUNCTION date_sub_dynamic (
  _dt DATETIME(6),
...
END`}],ze=[{name:"worldcities",createStmt:`create rowstore table if not exists worldcities (
  ...
  `,"START PIPELINE worldcities FOREGROUND"],jr=e=>{const o=ze.find(d=>d.name===e);if(o)return o;const t=xe.find(d=>d.name===e);if(t)return t;const r=De.find(d=>d.name===e);if(r)return r;throw new Error("Could not find schema object: "+e)},Wr=async e=>{try{return await co(e,"SELECT 1"),!0}catch{return!1}},Vr=async e=>{let o={tables:[],procedures:[],functions:[]};const l=e,{database:t}=l,r=k(l,["database"]);try{o=(await no(r,`
        ...
        `,t,t)).reduce((c,[p,u])=>(c[p].push(u),c),o)}catch(c){if(!(c instanceof D&&(c.isUnknownDatabase()||c.isDatabaseRecovering())))throw c}const{tables:d,procedures:a,functions:n}=o;return Object.fromEntries([ze.map(({name:c})=>[c,d.includes(c)]),xe.map(({name:c})=>[c,a.includes(c)]),De.map(({name:c})=>[c,n.includes(c)])].flat())},Wo=e=>co(e,"DROP DATABASE IF EXISTS `"+e.database+"`"),$r=async(e,{progress:o,scaleFactor:t,includeSeedData:r,skipCreate:d=!1})=>{d||(o("Dropping existing schema","info"),await Wo(e),o("Creating database","info"),await co(e,"CREATE DATABASE `"+e.database+"`"));for(const a of De)o(`Creating function: ${a.name}`,"info"),await h(e,a.createStmt);for(const a of ze)o(`Creating table: ${a.name}`,"info"),await h(e,a.createStmt);for(const a of xe)o(`Creating procedure: ${a.name}`,"info"),await h(e,a.createStmt);await Kr(e),await Go(e,de),r&&(o("Creating sample data","info"),await so(e,de,t)),o("Schema initialized","success")},Kr=async e=>{for(const o of Hr)await h(e,o)},so=(e,o,t)=>{const r=100*t.partitions,d=Pr(o,r);return Lr(e,d)},Vo=async(e,o)=>{const t=o.prefix,r=["locations","requests","purchases"],d=await G(e,`
      SELECT
    ...
    `,e.database,...r);return r.map(a=>{var l;const n=d.find(c=>c.pipelineName===a);return{pipelineName:a,needsUpdate:(l=n==null?void 0:n.needsUpdate)!=null?l:!0}})},$o=async(e,o)=>{const t=o.prefix,r=await Vo(e,o);await Promise.all(r.filter(d=>d.needsUpdate).map(async d=>{switch(console.log(`recreating pipeline ${d.pipelineName}`),d.pipelineName){case"locations":await h(e,`
              ...
              `);break;case"purchases":await h(e,`
                CREATE OR REPLACE PIPELINE ${d.pipelineName}
              ...
              `);break}await h(e,`ALTER PIPELINE ${d.pipelineName} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await h(e,`START PIPELINE IF NOT RUNNING ${d.pipelineName}`),console.log(`finished creating pipeline ${d.pipelineName}`)}))},qr=async e=>{const o=await no(e,`
      SELECT
    ...
    `,e.database);await Promise.all(o.map(async([t])=>{console.log("restarting pipeline",t),await h(e,`ALTER PIPELINE ${t} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await h(e,`START PIPELINE IF NOT RUNNING ${t}`)}))},Ko=async e=>{const o=await G(e,`
      SELECT plan_id AS planId
      FROM information_schema.plancache
      WHERE
        plan_warnings LIKE "%empty tables%"
    `);return await Promise.all(o.map(({planId:t})=>h(e,`DROP ${t} FROM PLANCACHE`))),o.length>0},Jr=(e,...o)=>{const t=o.map(r=>`"${r}"`).join(",");return Uo(e,`
    ...
    `,e.database)},Pe=(e,...o)=>Jr(e,...o).then(t=>t.reduce((r,{tableName:d,count:a})=>(r[d]=a,r),{})),Xr=async(e,o)=>{const{maxRows:t}=o,d=["locations","requests","purchases","notifications"].map(n=>`"${n}"`).join(","),a=await Uo(e,`
      ...
      WHERE
        ...
        AND stats.count > ?
    `,e.database,t);await Promise.all(a.map(async({tableName:n,count:l,minTs:c,maxTs:p})=>{const y=(l-t)/l;if(y<.2)return;const m=new Date((c+y*(p-c))*1e3);console.log(`removing rows from ${n} older than ${m.toISOString()}`),await h(e,`DELETE FROM ${n} WHERE ts <= ?`,m.toISOString())}))},po=(e,o="minute")=>ao(e,"ECHO run_matching_process(?)",o).then(t=>t.RESULT),uo=async(e,o,t=!0)=>{const r=new Date().toISOString();return await h(e,"CALL update_segments(?, ?)",o,r),t&&await h(e,"CALL prune_segments(?)",r),r},Zr=(e,o,t,r)=>no(e,`
      SELECT
        ts,
...
`):W(e)}))},vi=()=>s(K,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(K,{maxW:"container.md",mb:10,children:i(T,{children:`
          ...
          `})}),i(bi,{})]}),bi=()=>s(O,{children:[i(K,{maxW:"container.md",mb:4,children:i(T,{children:`
            ...
            remove it.
          `})}),i(fi,{defaultZoom:4,defaultCenter:[39.716470511656766,-99.59395661915288],height:300})]}),rt=()=>{const e=Co(Q);return s(ge,{status:"warning",borderRadius:"md",children:[i(fe,{}),i(me,{children:"The simulator is disabled"}),i(R,{position:"absolute",right:4,top:3,size:"xs",colorScheme:"blue",onClick:()=>e(!0),children:"Enable simulator"})]})},Ro=e=>{const{r:o,g:t,b:r}=e.rgb();return o<<16|t<<8|r};class hi extends q{constructor(o){super();S(this,"points");S(this,"polygon");S(this,"hovering",!1);this.config=o,this.points=Nr(o.wktPolygon),this.polygon=new _e,this.addChild(this.polygon),this.polygon.interactive=!0,this.polygon.on("mouseover",()=>{this.hovering=!0}),this.polygon.on("mouseout",()=>{this.hovering=!1})}update(o){const t=this.hovering?this.config.hoverColor:this.config.color;this.polygon.clear(),this.polygon.lineStyle(1,Ro(t),.5),this.polygon.beginFill(Ro(t),.2),this.polygon.drawPolygon(this.points.flatMap(([r,d])=>o([d,r]))),this.polygon.endFill()}}const Ei=e=>({scene:o,latLngToPixel:t,bounds:r})=>{const d=et(r,100);return e.useCells(d,a=>{o.removeChildren();for(const n of a)o.addChild(new hi(e.getCellConfig(n)))}),{update:g.exports.useCallback(()=>{for(let a=0;a<o.children.length;a++)o.children[a].update(t)},[t,o])}},it=e=>{const a=e,{useCells:o,getCellConfig:t}=a,r=k(a,["useCells","getCellConfig"]),d=g.exports.useMemo(()=>Ei({useCells:o,getCellConfig:t}),[t,o]);return i(ke,_(b({},r),{useRenderer:d,options:{}}))},_i=10*1e3,fo=e=>{const o=f(v),t=f(Z),{initialized:r}=A(),d=g.exports.useCallback(a=>{const n=_(b({},o),{ctx:a});return Promise.all([$o(n,t),qr(n),Xr(n,t),Ko(n)])},[o,t]);Je(d,{name:"SimulatorMonitor",enabled:r&&e,intervalMS:_i})},Ti=1*1e3,Si=1*1e3,dt=e=>{const o=f(v),{initialized:t}=A(),r=g.exports.useRef(new Date(0).toISOString()),d=g.exports.useCallback(n=>po(_(b({},o),{ctx:n}),"minute"),[o]);Je(d,{name:"SimulatorMatcher",enabled:t&&e,intervalMS:Ti});const a=g.exports.useCallback(async n=>{r.current=await uo(_(b({},o),{ctx:n}),r.current)},[o]);Je(a,{name:"SimulatorUpdateSegments",enabled:t&&e,intervalMS:Si})},Xe=ne(",.2%"),ie=ne(".4~s"),Ni=()=>{const{initialized:e}=A(),o=f(Q);return fo(o),dt(o),i(K,{maxW:"container.lg",mt:10,mb:"30vh",children:e?o?s(B,{gap:10,children:[i(Ri,{}),i(Oi,{}),i(Ii,{})]}):i(rt,{}):i(at,{})})},at=()=>i(P,{children:i(M,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})}),Ri=()=>{var d,a;const e=f(v),o=N(["overallConversionRateRequests",e],()=>No(e,"requests"),{refreshInterval:1e3}),t=N(["overallConversionRatePurchases",e],()=>No(e,"purchases"),{refreshInterval:1e3}),r=N(["analyticsTableCounts",e],()=>Pe(e,"offers","subscribers","notifications"),{refreshInterval:1e3});return!r.data||!o.data||!t.data?i(at,{}):s(Oe,{spacing:2,minChildWidth:"150px",flex:2,children:[s(C,{children:[i(I,{children:"Offers"}),i(w,{children:ie(r.data.offers)})]}),s(C,{children:[i(I,{children:"Subscribers"}),i(w,{children:ie(r.data.subscribers)})]}),s(C,{children:[i(I,{children:"Notifications"}),i(w,{children:ie(r.data.notifications)})]}),s(C,{children:[i(I,{children:"Conversion Rate"}),i(w,{children:Xe(((d=o.data)==null?void 0:d.conversionRate)||0)}),i(bo,{children:"Requests"})]}),s(C,{children:[i(I,{children:"Conversion Rate"}),i(w,{children:Xe(((a=t.data)==null?void 0:a.conversionRate)||0)}),i(bo,{children:"Purchases"})]})]})},Oi=()=>{var a;const e=f(v),[o,t]=g.exports.useState("conversionRate"),r=N(["customerMetrics",e,o],()=>ti(e,"purchases",o,10),{refreshInterval:1e3}),d=Te("blue.500","blue.200");return i(L,{overflowX:"auto",children:s(Lt,{size:"sm",colorScheme:"gray",variant:"striped",children:[i(kt,{children:s(ho,{children:[s(se,{onClick:()=>t("customer"),_hover:{color:d},color:o==="customer"?d:void 0,cursor:"pointer",children:["Customer",o==="customer"&&i(te,{})]}),s(se,{onClick:()=>t("totalNotifications"),_hover:{color:d},color:o==="totalNotifications"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Notifications",o==="totalNotifications"&&i(te,{})]}),s(se,{onClick:()=>t("totalConversions"),_hover:{color:d},color:o==="totalConversions"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Total Conversions",o==="totalConversions"&&i(te,{})]}),s(se,{onClick:()=>t("conversionRate"),_hover:{color:d},color:o==="conversionRate"?d:void 0,isNumeric:!0,cursor:"pointer",children:["Conversion Rate",o==="conversionRate"&&i(te,{})]})]})}),i(Dt,{children:(a=r.data)==null?void 0:a.map(n=>s(ho,{children:[i(pe,{children:n.customer}),i(pe,{isNumeric:!0,children:ie(n.totalNotifications)}),i(pe,{isNumeric:!0,children:ie(n.totalConversions)}),i(pe,{isNumeric:!0,children:Xe(n.conversionRate)})]},n.customer))})]})})},Ai=(e,o)=>{const t=f(v);N(["zoneMetrics",t,e],()=>ri(t,e,"purchases"),{refreshInterval:1e3,onSuccess:o})},Ci=e=>$e(xt(e))||$e(0,0,0),Ii=()=>s(B,{direction:["column","row"],alignItems:"top",children:[i(L,{flex:1,children:i(T,{children:`
            ### Conversion Map
          ...
          `})}),i(L,{flex:2,children:i(it,{height:400,defaultZoom:14,useCells:Ai,getCellConfig:({conversionRate:e,wktPolygon:o})=>{const t=Ci(e);return{color:t,hoverColor:t.brighter(1),wktPolygon:o}}})})]}),ue=({label:e,placeholder:o,value:t,setValue:r,helpText:d,type:a="text"})=>s(Qe,{children:[i(eo,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),i(Lo,{size:"sm",placeholder:o,value:t,onChange:n=>r(n.target.value),type:a}),d?i(zt,{fontSize:"xs",children:d}):null]}),wi=()=>{const[e,o]=z(Z);return s(Qe,{children:[i(eo,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),i(Pt,{size:"sm",required:!0,value:e.name,onChange:t=>{const r=t.target.value;o(ii(r))},children:V.map(t=>i("option",{value:t.name,children:t.name},t.name))})]})},nt=({showDatabase:e,showScaleFactor:o})=>{const[t,r]=z(qo),[d,a]=z(Jo),[n,l]=z(Xo),[c,p]=z(X);return s(B,{spacing:4,children:[i(ue,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:t,setValue:r,helpText:i(T,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [HTTP API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),s(Oe,{columns:2,gap:2,children:[i(ue,{label:"Username",placeholder:"admin",value:d,setValue:a}),i(ue,{label:"Password",placeholder:"",value:n,setValue:l,type:"password"}),e&&i(ue,{label:"Database",placeholder:"martech",value:c,setValue:p}),o&&i(wi,{})]})]})},ct=e=>i(R,_(b({onClick:()=>{const{pathname:o,hash:t}=window.location;window.location.replace(o+t)},colorScheme:"red"},e),{children:"Disconnect"})),lt=e=>{const{connected:o,initialized:t}=A(),r=oo(),[d,a]=Ae(),n=f(X),l=ae.useRef(null),m=e,{skipSeedData:c,disabled:p}=m,u=k(m,["skipSeedData","disabled"]),y=pi({before:g.exports.useCallback(()=>a.on(),[a]),after:g.exports.useCallback(()=>{a.off(),r.onClose()},[r,a]),includeSeedData:!c});return s(O,{children:[i(R,b({disabled:!o||p,onClick:r.onOpen,colorScheme:t?"green":"red"},u)),i(Mt,{isOpen:r.isOpen,onClose:r.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:l,children:i(to,{children:s(Ut,{children:[s(ro,{fontSize:"lg",fontWeight:"bold",children:[t?"Reset":"Setup"," database ",n]}),s(io,{children:["This will ",t?"recreate":"create"," the database called ",n,". Are you sure?"]}),s(ko,{children:[i(R,{ref:l,onClick:r.onClose,disabled:d,children:"Cancel"}),i(R,{disabled:d,colorScheme:t?"red":"green",onClick:y,ml:3,children:d?i(M,{}):t?"Recreate database":"Create database"})]})]})})})]})},Li=({isOpen:e,onClose:o,finalFocusRef:t})=>{const[r,d]=z(Q),a=f(v),{connected:n,initialized:l,isVapor:c}=A(),p=oo(),[u,y]=Ae(!1),m=g.exports.useCallback(async()=>{y.on(),await Wo(a),y.off()},[a,y]);return s(Bt,{isOpen:e,placement:"right",onClose:o,finalFocusRef:t,children:[i(to,{}),s(Ft,{children:[i(Do,{}),i(ro,{children:"Config"}),i(io,{children:s(B,{spacing:4,children:[c?null:i(nt,{showScaleFactor:!0,showDatabase:!0}),s(ge,{status:n?"success":"error",borderRadius:"md",children:[i(fe,{}),i(me,{children:n?"connected":"disconnected"}),c?i(ct,{position:"absolute",right:4,top:3,size:"xs"}):null]}),s(ge,{status:l?"success":"warning",borderRadius:"md",children:[i(fe,{}),i(me,{children:"schema"}),i(lt,{position:"absolute",right:4,top:3,size:"xs",children:l?"Reset":"Setup"})]}),s(ge,{status:r?"success":"warning",borderRadius:"md",children:[i(fe,{}),i(me,{children:"simulator"}),i(Gt,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:r?"green":"red",isChecked:r,disabled:!n||!l,onChange:()=>d(!r)})]}),s(ce,{onClick:p.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",p.isOpen?i(Yt,{ml:2}):i(te,{ml:2})]}),p.isOpen?i(R,{size:"xs",_hover:{colorScheme:"red"},onClick:m,disabled:u,children:"Drop Database"}):void 0]})}),i(ko,{})]})]})},ye=({to:e,children:o,onClick:t})=>{const r=qt(e),d=Jt({path:r.pathname,end:!0});return i(j,{as:wo,to:e,px:2,py:1,onClick:t,rounded:"md",_hover:{textDecoration:"none",bg:Te("gray.300","gray.600")},fontWeight:d?"bold":"normal",href:"#",color:Te("gray.700","gray.200"),children:o})},ki=()=>{const{colorMode:e,toggleColorMode:o}=Ce(),t=oo(),[r,d]=z(ci),a=ae.useRef(null),{connected:n,initialized:l}=A(),c=f(Q),[p]=xo("(max-width: 640px)"),u=s(O,{children:[i(ye,{to:"/",onClick:t.onClose,children:"Overview"}),i(ye,{to:"/map",onClick:t.onClose,children:"Map"}),i(ye,{to:"/admin",onClick:t.onClose,children:"Admin"}),i(ye,{to:"/analytics",onClick:t.onClose,children:"Analytics"})]});let y;return p||(y=n?l?c?"connected":"simulator disabled":"needs schema":"disconnected"),i(O,{children:i(L,{bg:Te("gray.200","gray.700"),children:s(K,{maxW:"container.lg",children:[s(Se,{h:16,alignItems:"center",justifyContent:"space-between",children:[i(He,{size:"md",icon:t.isOpen?i(Ht,{}):i(jt,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:t.isOpen?t.onClose:t.onOpen}),s(Ne,{spacing:8,alignItems:"center",children:[i(Ie,{as:"h1",size:p?"sm":"md",children:p?"Martech":"Realtime Digital Marketing"}),i(Ne,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:u})]}),s(Se,{alignItems:"center",gap:2,children:[s(R,{size:"sm",ref:a,onClick:()=>d(!0),colorScheme:n?l&&c?"green":"yellow":"red",children:[l?i(zo,{}):i(Po,{}),p||i(ce,{pl:2,children:y})]}),i(He,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?i(Wt,{size:"1.4em"}):i(Vt,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),i(He,{"aria-label":"Toggle Color Mode",size:"sm",onClick:o,icon:e==="light"?i($t,{boxSize:"1.2em"}):i(Kt,{boxSize:"1.2em"})})]})]}),t.isOpen?i(L,{pb:4,display:{md:"none"},children:i(B,{as:"nav",spacing:4,children:u})}):null,i(Li,{isOpen:r,onClose:()=>d(!1),finalFocusRef:a})]})})})},Di=e=>{const o=g.exports.useRef([]),{data:t}=N(["timeseries",e.name,...e.deps||[]],async()=>{const r=await e.fetcher();return o.current.push({data:r,ts:new Date}),o.current=o.current.slice(-e.limit),o.current},{refreshInterval:e.intervalMS});return t||[]},xi=ne("~s"),st=(e,...o)=>Di({name:"estimatedRowCount",deps:o,fetcher:g.exports.useCallback(()=>Pe(e,...o),[e,o]),limit:30,intervalMS:1e3}),pt=t=>{var r=t,{data:e}=r,o=k(r,["data"]);const{colorMode:d}=Ce(),a=g.exports.useCallback(({tooltipData:c,colorScale:p})=>!p||!c?null:Object.keys(c.datumByKey).sort((u,y)=>c.datumByKey[y].datum.data[y]-c.datumByKey[u].datum.data[u]).map(u=>{const{datum:y}=c.datumByKey[u],m=y.data[u];return s(ce,{mb:1,color:p(u),fontSize:"sm",children:[u,": ",ne(".4~s")(m)]},u)}),[]),n=g.exports.useCallback(c=>xi(c).replace("G","B"),[]);if(e.length<2)return i(P,{height:o.height,children:i(M,{size:"md"})});const l=e.length>0?Object.keys(e[0].data).filter(c=>c!=="ts").map(c=>i(Xt,{dataKey:c,data:e,xAccessor:p=>p==null?void 0:p.ts,yAccessor:p=>p==null?void 0:p.data[c]},c)):null;return s(Zt,_(b({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:d==="light"?Qt:er,margin:{left:0,right:50,top:10,bottom:40}},o),{children:[i(Eo,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),i(Eo,{orientation:"right",numTicks:o.height<250?3:5,tickFormat:n,label:"rows",labelOffset:20}),l,i(or,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:a})]}))},Ze=1e3,he=60*Ze,Ee=60*he,We=24*Ee,U=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),$=e=>e?e<Ze?`${U(e)}ms`:e<he?`${U(e/Ze)}s`:e<Ee?`${Math.floor(e/he)}m${$(e%he)}`:e<We?`${Math.floor(e/Ee)}h${$(e%Ee)}`:`${Math.floor(e/We)}d${$(e%We)}`:"0s",zi=100,Pi=1e3,H=class extends q{constructor(o){super();S(this,"latlng");S(this,"age",0);S(this,"marker");S(this,"pulse");this.latlng=o,this.marker=new _e,this.marker.beginFill(H.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new _e,this.pulse.beginFill(H.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(o,t){if(this.age+=t/60,this.age>H.lifetime&&this.parent){this.parent.removeChild(this);return}const r=this.age%H.lifetime/H.lifetime,d=dr(r);this.pulse.scale.set(1+d);const a=.4,n=r<a?tr(r/a):1-rr((r-a)/(1-a));this.pulse.alpha=n,r<a?this.marker.alpha=n:this.marker.alpha=1-ir((r-a)/(1-a));const[l,c]=o(this.latlng);this.x=l,this.y=c}};let re=H;S(re,"lifetime",1.5),S(re,"markerColor",306687),S(re,"pulseColor",306687);const ut=()=>{const e=f(v),{initialized:o}=A();return g.exports.useMemo(()=>["notifications",e,o],[e,o])},yt=({scene:e,latLngToPixel:o,bounds:t})=>{const r=g.exports.useRef(new Date().toISOString()),d=f(v),{initialized:a}=A(),n=et(t,50),l=ut();return N(l,()=>Zr(d,r.current,zi,n),{refreshInterval:Pi,isPaused:()=>!a,onSuccess:c=>{if(c.length>0){r.current=c[0][0];for(const[,p,u]of c)e.addChild(new re([u,p]))}}}),{update:g.exports.useCallback(c=>{for(let p=e.children.length-1;p>=0;p--)e.children[p].update(o,c)},[o,e])}},Mi=()=>{const e=f(v),o=st(e,"locations","requests","purchases","notifications","subscriber_segments"),t=N(["notificationsMapTableCounts",e],()=>Pe(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),r=f(qe("SimulatorMatcher")),d=f(qe("SimulatorUpdateSegments")),a=ne(".4~s"),n=t.data?s(Oe,{spacing:2,minChildWidth:"120px",children:[s(C,{children:[i(I,{children:"Offers"}),i(w,{children:a(t.data.offers)})]}),s(C,{children:[i(I,{children:"Cities"}),i(w,{children:a(t.data.cities)})]}),s(C,{children:[i(I,{children:"Subscribers"}),i(w,{children:a(t.data.subscribers)})]}),s(C,{children:[i(I,{children:"Segments"}),i(w,{children:a(t.data.segments)})]}),s(C,{children:[i(I,{children:"Segmentation"}),i(w,{children:$(d)})]}),s(C,{children:[i(I,{children:"Matching"}),i(w,{children:$(r)})]})]}):null;return s(O,{children:[i(T,{children:`
          ...
          about the demo.
        `}),n,s(L,{children:[i(ce,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),i(pt,{data:o,height:150})]})]})},Ui=()=>{const e=f(Q);return fo(e),dt(e),s(Se,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[i(B,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:i(ke,{useRenderer:yt,options:{}})}),s(B,{spacing:4,flex:"1 1 0",minWidth:"0",children:[i(T,{children:`
          ...
          `}),e?i(Mi,{}):i(rt,{})]})]})},gt=t=>{var r=t,{children:e}=r,o=k(r,["children"]);return i(ar,_(b({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},o),{children:e}))},Bi=1e3,Fi=(e,o)=>{const t=f(v),{initialized:r}=A();N(["offers",t,r,e],()=>Qr(t,Bi,e),{isPaused:()=>!r,onSuccess:o})},Gi=e=>i(it,_(b({},e),{useCells:Fi,getCellConfig:o=>{const t=$e(4,173,255);return{color:t,hoverColor:t.brighter(1),wktPolygon:o.notificationZone}}})),F=e=>{const{completed:o,title:t,left:r,right:d}=e,{colorMode:a}=Ce(),n=a==="light"?".300":".500",l=o?"gray"+n:void 0,c=(o?"green":"gray")+n;return s(O,{children:[s(Re,{children:[s(Ie,{as:"h2",size:"lg",mb:4,color:l,children:[i(zo,b({color:c},{boxSize:6,position:"relative",bottom:.5,mr:2})),t]}),r]}),i(Re,{children:d})]})},Yi=({connected:e,isVapor:o})=>o?i(F,{completed:e,title:"Connected",left:s(O,{children:[i(T,{children:`
          ...
          `}),right:c||!r?i(P,{h:220,children:s(R,{colorScheme:"blue",size:"sm",onClick:n,disabled:r,children:[(d||r)&&i(M,{mr:2}),d?"Creating Pipelines":r?"...waiting for data":"Create pipelines"]})}):i(pt,{data:l,height:200})})},Me=(e,o=!0)=>N(["overviewTableCounts",e],()=>Pe(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!o}),Vi=()=>{var l,c;const e=f(v),o=f(Z),[t,r]=Ae(),d=Me(e),a=g.exports.useCallback(async()=>{r.on(),await so(e,de,o),d.mutate(),r.off()},[e,o,d,r]),n=!!((l=d.data)!=null&&l.offers);return i(F,{completed:n,title:"Offers",left:i(O,{children:s(T,{children:[`
            ...
            `,n&&`
                ...
                database.
            `]})}),right:n?i(Gi,{height:300,defaultZoom:13}):i(P,{h:"100%",children:s(R,{onClick:a,disabled:t,children:[t&&i(M,{mr:2}),t?"loading...":n?"loaded offers!":"load offers"]})})})},$i=({done:e,setDone:o})=>{const t=f(v),r=g.exports.useRef(new Date().toISOString());return g.exports.useEffect(()=>{if(e)return;const d=new AbortController,a=_(b({},t),{ctx:d});return(async()=>{try{for(let n=0;n<10;n++)if(r.current=await uo(a,r.current,!1),await po(a,"second"),n>1&&!await Ko(a))return}catch(n){if(d.signal.aborted||n instanceof DOMException&&n.name==="AbortError")return;throw n}})().then(()=>o(!0)),()=>{d.abort()}},[t,e,o]),e?null:i(Re,{colSpan:[1,1,2],children:s(P,{w:"100%",h:"200px",color:"gray.500",children:[i(M,{size:"md",mr:4}),i(Ie,{size:"md",children:"Warming up queries..."})]})})},Ki=()=>{var u;const e=f(v),o=Me(e),{elapsed:t,isRunning:r,startTimer:d,stopTimer:a}=ot(),n=g.exports.useRef(new Date().toISOString()),l=!!((u=o.data)!=null&&u.subscriber_segments),c=g.exports.useCallback(async()=>{d(),n.current=await uo(e,n.current),a(),o.mutate()},[e,o,d,a]);let p;if(t&&o.data){const{segments:y,subscriber_segments:m,locations:E,requests:Y,purchases:ee}=o.data,Ue=$(t),Be=U(E+Y+ee),Fe=U(y),Ge=U(m);p=i(T,{children:`
        ...
        `})}return i(F,{completed:l,title:"Segmentation",left:i(T,{children:`
          ...
          `}),right:i(P,{h:"100%",children:s(Mo,{gap:4,textAlign:"center",children:[s(R,{disabled:r,onClick:c,children:[r&&i(M,{mr:2}),r?"...running":"Match subscribers to segments"]}),p]})})})},qi=()=>{var E;const e=f(v),o=Me(e),t=ut(),{mutate:r}=lr(),{elapsed:d,isRunning:a,startTimer:n,stopTimer:l}=ot(),[c,p]=g.exports.useState(0),u=!!((E=o.data)!=null&&E.notifications),y=g.exports.useCallback(async()=>{let Y=0,ee=0;for(;Y===0&&ee++<10;)n(),Y=await po(e,"second");l(),p(Y),o.mutate(),r(t)},[e,n,l,o,r,t]);let m;if(d&&o.data){const{offers:Y,subscribers:ee,subscriber_segments:Ue,notifications:Be}=o.data,Fe=U(Y*ee+Be),Ge=U(Ue),mt=$(d),vt=U(c);m=i(T,{children:`
        ...
        `})}return i(F,{completed:u,title:"Matching",left:i(T,{children:`
          ...
          `}),right:i(P,{h:"100%",children:s(Mo,{gap:4,w:"100%",children:[s(R,{disabled:a,onClick:y,children:[a&&i(M,{mr:2}),a?"...running":"Generate notifications"]}),i(L,{width:"100%",children:i(ke,{height:250,defaultZoom:12,useRenderer:yt,options:{}})}),m]})})})},Ji=()=>{const e=f(X);return i(F,{completed:!0,title:"Putting it all together",left:i(T,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: map
          `}),right:null})},Xi=()=>{const e=f(v),o=f(Z),{connected:t,initialized:r,isVapor:d}=A(),{completed:a}=ft(e,o,t&&r),{data:n}=Me(e,t&&r),[l,c]=g.exports.useState(!1),p=[{completed:t,component:i(Yi,{connected:t,isVapor:d},"connection")},{completed:r,component:i(ji,{initialized:r},"schema")},{completed:a,component:i(Wi,{},"pipelines")},{completed:n?n.offers>0:!1,component:i(Vi,{},"offers")},{completed:l,component:i($i,{done:l,setDone:c},"warmup")},{completed:n?n.subscriber_segments>0:!1,component:i(Ki,{},"segmentation")},{completed:n?n.notifications>0:!1,component:i(qi,{},"matching")},{completed:!0,component:i(Ji,{},"summary")}];let u=!0;const y=[];for(const{completed:m,component:E}of p)if(u)y.push(E),u=m;else break;return s(K,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(L,{maxW:"container.md",mb:10,px:0,children:i(T,{children:`
          ...
          `})}),i(nr,{columnGap:6,rowGap:10,templateColumns:["minmax(0, 1fr)",null,"repeat(2, minmax(0, 1fr))"],children:y})]})};function Zi(){const e=i(P,{height:"100vh",children:i(M,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})});return i(g.exports.Suspense,{fallback:e,children:s(Se,{height:"100vh",direction:"column",children:[i(ki,{}),i(L,{m:4,flex:"1",children:s(ur,{children:[i(oe,{path:"/",element:i(Xi,{})}),i(oe,{path:"/map",element:i(Ui,{})}),i(oe,{path:"/admin",element:i(vi,{})}),i(oe,{path:"/analytics",element:i(Ni,{})}),i(oe,{path:"*",element:i(yr,{to:"/",replace:!0})})]})})]})})}class Qi extends ae.Component{constructor(){super(void 0);S(this,"state",{});this.handlePromiseRejection=this.handlePromiseRejection.bind(this)}componentDidMount(){window.addEventListener("unhandledrejection",this.handlePromiseRejection)}componentWillUnmount(){window.removeEventListener("unhandledrejection",this.handlePromiseRejection)}handlePromiseRejection(o){this.setState({error:o.reason})}static getDerivedStateFromError(o){return{error:o}}render(){const{error:o}=this.state;if(o){let t;return o instanceof D&&(t=s(O,{children:[i(ce,{textAlign:"center",children:"An error occurred while running the following query:"}),i(gt,{children:W(o.sql)})]})),i(K,{maxW:"container.md",my:10,children:s(B,{gap:4,children:[i(P,{children:i(Po,{boxSize:20,color:"red"})}),i(Ie,{size:"xl",textAlign:"center",children:o.message}),t,s(Ne,{justify:"center",gap:4,children:[i(R,{onClick:()=>this.setState({error:void 0}),size:"sm",children:"Dismiss Error"}),i(R,{onClick:()=>window.location.reload(),size:"sm",colorScheme:"blue",leftIcon:i(gr,{}),children:"Reload"})]})]})})}return this.props.children}}const ed=fr({fonts:{heading:"InterVariable, sans-serif",body:"InterVariable, sans-serif",mono:'"Source Code ProVariable", monospace'},components:{Link:{baseStyle:e=>({color:e.colorMode==="light"?"blue.600":"blue.300"})}}}),od=({children:e})=>{const o=Io();return i(Er,{value:{onError:r=>{o({title:"An error occurred",description:r.message,status:"error",duration:5e3,isClosable:!0})}},children:e})};mr.render(i(ae.StrictMode,{children:i(vr,{theme:ed,children:i(Qi,{children:i(od,{children:i(br,{children:i(hr,{basename:"/",children:i(Zi,{})})})})})})}),document.getElementById("root"));
