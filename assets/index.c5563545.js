...
`),{sql:d,params:n}=At(o);return{sql:q`
    ...
    `,t.id,t.name,`POINT(${t.lonlat[0]} ${t.lonlat[1]})`,t.diameter),Wr=(e,t)=>v(e,"DELETE FROM cities WHERE city_id = ?",t),jr=["olc_8","purchase","request"],Vr=["minute","hour","day","week","month"],$t=({interval:e,kind:t,value:o})=>Mo(`${e}-${t}-${o}`),Kr=async(e,t)=>{const{sql:o,params:r}=jt({table:"segments",options:{replace:!0},columns:["segment_id","valid_interval","filter_kind","filter_value"],tuples:t.map(a=>[$t(a),a.interval,a.kind,a.value])});await v(e,o,...r)},$r=async(e,t)=>{const o={table:"offers",options:{replace:!0},columns:["customer","notification_zone","segment_ids","notification_content","notification_target","maximum_bid_cents"],tuples:[]};let r=0,a=[];const d=async()=>{const{sql:n,params:c}=jt(o);await Promise.all([v(e,n,...c),Kr(e,a)]),o.tuples=[],a=[],r=0};for(const n of t)o.tuples.push([n.customer,n.notificationZone,JSON.stringify(n.segments.map($t)),n.notificationContent,n.notificationTarget,n.maximumBidCents]),r++,a=a.concat(n.segments),r>=Hr&&await d();r>0&&await d()},qr=()=>Vt(jr),Jr=()=>Vt(Vr),qt=({vendor:e,tld:t})=>`${e.toLowerCase()}.${t}`,Jt=e=>{const[t,o]=e.lonlat,r=e.diameter/2,[a,d]=[t-r,t+r],[n,c]=[o-r,o+r];return[tt(a,d),tt(n,c)]},Xr=(e,t)=>{const o=qr(),r=Jr();switch(o){case"olc_8":{const[a,d]=Jt(e),n=Qe.encode(d,a,8).substring(0,8);return{kind:o,interval:r,value:n}}case"purchase":return{kind:o,interval:r,value:t.vendor};case"request":return{kind:o,interval:r,value:qt(t)}}},Zr=e=>{const t=Se(1,3),o=Yr(),r=Array.from({length:t},()=>Xr(e,o)),a=qt(o),n=`${Se(10,50)}% off at ${o.vendor}`,c=a,[l,u]=Jt(e),p=Qe.encode(u,l,8),y=Qe.decode(p),f={ne:[y.latitudeHi,y.longitudeHi],sw:[y.latitudeLo,y.longitudeLo]};return{customer:o.vendor,segments:r,notificationZone:Fe(f),notificationContent:n,notificationTarget:c,maximumBidCents:Se(2,15)}},Qr=(e,t)=>Array.from({length:t},()=>Zr(e)),ei=e=>(t,o,r,a=1)=>`https://stamen-tiles.a.ssl.fastly.net/${e}/${r}/${t}/${o}${a>=2?"@2x":""}.png`,ti=s(C,{children:["Map tiles by ",i($,{href:"http://stamen.com",children:"Stamen Design"}),", under"," ",i($,{href:"http://creativecommons.org/licenses/by/3.0",children:"CC BY 3.0"}),". Data by ",i($,{href:"http://openstreetmap.org",children:"OpenStreetMap"}),", under"," ",i($,{href:"http://www.openstreetmap.org/copyright",children:"ODbL"}),"."]}),oi=[ot.lonlat[1],ot.lonlat[0]],ri=12,ii=({width:e,height:t,bounds:o,latLngToPixel:r,pixelToLatLng:a,useRenderer:d,options:n})=>{const c=ue.useRef(null),l=nt(()=>new te),{setup:u,update:p}=d({scene:l,width:e,height:t,bounds:o,latLngToPixel:r,pixelToLatLng:a,options:n});return g.exports.useLayoutEffect(()=>{if(!c.current)throw new Error("No canvas ref");console.log("PixiMapLayer: Setup");const y=new Bo({view:c.current,width:e,height:t,backgroundAlpha:0,antialias:!0});return y.stage.addChild(l),u==null||u(),p&&y.ticker.add(f=>{p(f)}),()=>{console.log("PixiMapLayer: Destroy"),y.stage.removeChild(l),y.destroy(!1,{children:!1,texture:!0,baseTexture:!0})}},[t,l,u,p,e]),i("canvas",{ref:c})},ai=({mapState:e,latLngToPixel:t,pixelToLatLng:o,useRenderer:r,options:a})=>{const{width:d,height:n,bounds:c}=e||{width:0,height:0};return d<=0||n<=0||!t||!o||!c?null:i(ii,{useRenderer:r,width:d,height:n,bounds:c,latLngToPixel:t,pixelToLatLng:o,options:a})},Ge=n=>{var c=n,{height:e="100%",defaultCenter:t=oi,defaultZoom:o=ri,useRenderer:r,options:a}=c,d=M(c,["height","defaultCenter","defaultZoom","useRenderer","options"]);const[l,u]=g.exports.useState(t),[p,y]=g.exports.useState(o);return i(z,N(E({borderRadius:"lg",overflow:"hidden",height:e},d),{children:i(Uo,{dprs:[1,2],provider:ei("toner-lite"),attribution:ti,maxZoom:20,center:l,zoom:p,onBoundsChanged:({center:f,zoom:h})=>{u(f),y(h)},children:i(ai,{useRenderer:r,options:a})})}))};var Ye=[{kind:"create",name:"date_sub_dynamic",statement:`CREATE OR REPLACE FUNCTION date_sub_dynamic (
  _dt DATETIME(6),
...
BEGIN
  ...
  END;
END`},{kind:"create",name:"date_add_dynamic",statement:`CREATE OR REPLACE FUNCTION date_add_dynamic (
  _dt DATETIME(6),
  _interval ENUM("second", "minute", "hour", "day", "week", "month")
) RETURNS DATETIME(6) AS
BEGIN
  RETURN CASE _interval
    ...
    WHEN "month" THEN _dt + INTERVAL 1 MONTH
  END;
END`},{kind:"create",name:"encode_open_location_code",statement:`CREATE OR REPLACE FUNCTION encode_open_location_code (
...
BEGIN
  ...
  END IF;
END`}],di=[{kind:"create",name:"locations",statement:`CREATE OR REPLACE PIPELINE locations
...
INTO PROCEDURE process_locations FORMAT PARQUET (
  ...
  offset_x <- offsetX,
  offset_y <- offsetY
);`},{kind:"create",name:"requests",statement:`CREATE OR REPLACE PIPELINE requests
...
INTO PROCEDURE process_requests FORMAT PARQUET (
  subscriber_id <- subscriberid,
  domain <- domain
);`},{kind:"create",name:"purchases",statement:`CREATE OR REPLACE PIPELINE purchases
...
INTO PROCEDURE process_purchases FORMAT PARQUET (
  subscriber_id <- subscriberid,
  vendor <- vendor
);`},{kind:"start",statement:"START ALL PIPELINES;"}],He=[{kind:"create",name:"process_locations",statement:`CREATE OR REPLACE PROCEDURE process_locations (
  _batch QUERY(
...
BEGIN
  ...
  FROM _expanded;
END`},{kind:"create",name:"process_requests",statement:`CREATE OR REPLACE PROCEDURE process_requests (
...
BEGIN
  ...
  FROM _batch, cities;
END`},{kind:"create",name:"process_purchases",statement:`CREATE OR REPLACE PROCEDURE process_purchases (
...
END`},{kind:"create",name:"prune_segments",statement:`CREATE OR REPLACE PROCEDURE prune_segments (
  _until DATETIME(6)
) AS BEGIN
  DELETE FROM subscriber_segments WHERE expires_at <= _until;
END`},{kind:"create",name:"update_sessions",statement:`CREATE OR REPLACE PROCEDURE update_sessions (
  ...
  EXCEPTION
    WHEN OTHERS THEN
      IF SCALAR(_num_transactions) > 0 THEN
        ROLLBACK;
      END IF;
END`}],We=[{kind:"create",name:"worldcities",statement:`create rowstore table if not exists worldcities (
  city_id BIGINT NOT NULL PRIMARY KEY,
  city_name TEXT NOT NULL,
  center GEOGRAPHYPOINT NOT NULL,

  INDEX (center)
);`},{kind:"create",name:"sessions",statement:`create rowstore table if not exists sessions (
  session_id TEXT NOT NULL,
  is_controller BOOLEAN NOT NULL DEFAULT FALSE,
  expires_at DATETIME(6) NOT NULL,

  PRIMARY KEY (session_id)
);`},{kind:"create",name:"cities",statement:`create rowstore reference table if not exists cities (
  city_id BIGINT NOT NULL PRIMARY KEY,
  city_name TEXT NOT NULL,
  center GEOGRAPHYPOINT NOT NULL,
  diameter DOUBLE
);`},{kind:"create",name:"subscribers",statement:`create rowstore table if not exists subscribers (
...
);`},{kind:"create",name:"subscribers_last_notification",statement:`create rowstore table if not exists subscribers_last_notification (
  city_id BIGINT NOT NULL,
  subscriber_id BIGINT NOT NULL,
...
);`},{kind:"create",name:"locations",statement:`create table if not exists locations (
  city_id BIGINT NOT NULL,
  subscriber_id BIGINT NOT NULL,
...
);`},{kind:"create",name:"requests",statement:`create table if not exists requests (
  city_id BIGINT NOT NULL,
  subscriber_id BIGINT NOT NULL,
  ts DATETIME(6) NOT NULL SERIES TIMESTAMP,
...
);`},{kind:"create",name:"purchases",statement:`create table if not exists purchases (
  city_id BIGINT NOT NULL,
  subscriber_id BIGINT NOT NULL,
  ts DATETIME(6) NOT NULL SERIES TIMESTAMP,
...
);`},{kind:"create",name:"offers",statement:`create rowstore reference table if not exists offers (
...
);`},{kind:"create",name:"notifications",statement:`create table if not exists notifications (
  ts DATETIME(6) NOT NULL SERIES TIMESTAMP,
  ...
  SHARD KEY (city_id, subscriber_id),
  SORT KEY (ts)
);`},{kind:"create",name:"segments",statement:`create rowstore reference table if not exists segments (
...
);`},{kind:"create",name:"subscriber_segments",statement:`create rowstore table if not exists subscriber_segments (
  city_id BIGINT NOT NULL,
  subscriber_id BIGINT NOT NULL,
  segment_id BIGINT NOT NULL,
  ...
  SHARD KEY (city_id, subscriber_id)
);`},{kind:"create",name:"match_offers_to_subscribers",statement:`CREATE OR REPLACE FUNCTION match_offers_to_subscribers(
  _interval ENUM("second", "minute", "hour", "day", "week", "month")
...
);`},{kind:"create",name:"dynamic_subscriber_segments_locations",statement:`CREATE OR REPLACE FUNCTION dynamic_subscriber_segments_locations(
  _since DATETIME(6),
  _until DATETIME(6)
) RETURNS TABLE AS RETURN (
  SELECT
...
);`},{kind:"create",name:"dynamic_subscriber_segments_requests",statement:`CREATE OR REPLACE FUNCTION dynamic_subscriber_segments_requests(
  _since DATETIME(6),
  _until DATETIME(6)
) RETURNS TABLE AS RETURN (
  SELECT
  ...
  WHERE
    ...
    AND ts < _until
  GROUP BY city_id, subscriber_id, segment_id
);`},{kind:"create",name:"dynamic_subscriber_segments_purchases",statement:`CREATE OR REPLACE FUNCTION dynamic_subscriber_segments_purchases(
  _since DATETIME(6),
  _until DATETIME(6)
) RETURNS TABLE AS RETURN (
  SELECT
  ...
  WHERE
    ...
    AND ts < _until
  GROUP BY city_id, subscriber_id, segment_id
);`},{kind:"create",name:"dynamic_subscriber_segments",statement:`CREATE OR REPLACE FUNCTION dynamic_subscriber_segments(
  _since DATETIME(6),
  _until DATETIME(6)
) RETURNS TABLE AS RETURN (
...
);`}],Xt=[{kind:"create",name:"offers",statement:`CREATE OR REPLACE PIPELINE offers AS
  ...
  );`},{kind:"start",statement:"START PIPELINE IF NOT RUNNING offers;"},{kind:"create",name:"segments",statement:`CREATE OR REPLACE PIPELINE segments AS
  ...
  );`},{kind:"start",statement:"START PIPELINE IF NOT RUNNING segments;"},{kind:"insert",statement:`INSERT INTO cities (city_id, city_name, center, diameter)
VALUES (120658, "New York", "POINT(-73.993562 40.727063)", 0.04)
ON DUPLICATE KEY UPDATE
  city_name = VALUES(city_name),
  center = VALUES(center),
  diameter = VALUES(diameter);`},{kind:"create",name:"worldcities",statement:`CREATE OR REPLACE PIPELINE worldcities AS
  ...
  SET center = GEOGRAPHY_POINT(@lng, @lat);`},{kind:"start",statement:"START PIPELINE IF NOT RUNNING worldcities;"}];const ni=e=>{const t=[Ye,He,We,Xt];for(const o of t){const r=o.find(a=>a.name===e);if(r)return r}throw new Error("Could not find schema object: "+e)},ci=e=>{const t=di.find(o=>o.name===e);if(t)return t;throw new Error("Could not find pipeline "+e)},li=async e=>{try{return await ft(e,"SELECT 1"),!0}catch{return!1}},si=async e=>{let t={tables:[],procedures:[],functions:[]};const c=e,{database:o}=c,r=M(c,["database"]);try{t=(await gt(r,`
        ...
        `,o,o)).reduce((l,[u,p])=>(l[u].push(p),l),t)}catch(l){if(!(l instanceof P&&(l.isUnknownDatabase()||l.isDatabaseRecovering())))throw l}const{tables:a,procedures:d,functions:n}=t;return Object.fromEntries([We.map(({name:l})=>[l,l&&a.includes(l)]),He.map(({name:l})=>[l,l&&d.includes(l)]),Ye.map(({name:l})=>[l,l&&n.includes(l)])].flat())},Zt=e=>ft(e,"DROP DATABASE IF EXISTS `"+e.database+"`"),pi=async(e,{progress:t,includeSeedData:o,resetDataOnly:r=!1})=>{r||(t("Dropping existing schema","info"),await Zt(e),t("Creating database","info"),await ft(e,"CREATE DATABASE `"+e.database+"`")),r&&(t("Resetting data","info"),await gi(e),await yi(e));for(const a of Ye)t(`Creating function: ${a.name}`,"info"),await v(e,a.statement);for(const a of We)t(`Creating table: ${a.name}`,"info"),await v(e,a.statement);for(const a of He)t(`Creating procedure: ${a.name}`,"info"),await v(e,a.statement);t("Creating New York","info"),await Kt(e,ot),o&&(t("Creating sample data","info"),await Qt(e)),t("Schema initialized","success")},Qt=async e=>{for(const t of Xt)await v(e,t.statement)},ui=(e,t,o)=>{const r=100*o.partitions,a=Qr(t,r);return $r(e,a)},Le=["locations","requests","purchases"],eo=async(e,t)=>{const o=t.prefix,r=await j(e,`
      SELECT
        pipeline_name AS pipelineName,
        (config_json::$connection_string NOT LIKE "%${o}%") AS needsUpdate
      FROM information_schema.pipelines
      WHERE
        pipelines.database_name = ?
        AND pipelines.pipeline_name IN (?, ?, ?)
    `,e.database,...Le);return Le.map(a=>{var n;const d=r.find(c=>c.pipelineName===a);return{pipelineName:a,needsUpdate:(n=d==null?void 0:d.needsUpdate)!=null?n:!0}})},yi=e=>Promise.all([v(e,"TRUNCATE TABLE cities"),v(e,"TRUNCATE TABLE locations"),v(e,"TRUNCATE TABLE notifications"),v(e,"TRUNCATE TABLE offers"),v(e,"TRUNCATE TABLE purchases"),v(e,"TRUNCATE TABLE requests"),v(e,"TRUNCATE TABLE segments"),v(e,"TRUNCATE TABLE sessions"),v(e,"TRUNCATE TABLE subscriber_segments"),v(e,"TRUNCATE TABLE subscribers"),v(e,"TRUNCATE TABLE subscribers_last_notification")]),to=(e,t)=>{const o=ci(e),r=/\$\{([^}]+)\}/g;return o.statement.replaceAll(r,(a,d)=>{switch(d){case"SCALE_FACTOR":return t.prefix;case"PARTITIONS":return t.partitions.toString();default:throw new Error(`Unknown variable: ${d}`)}})},gi=async e=>{await v(e,"STOP ALL PIPELINES"),await Promise.all(Le.map(t=>v(e,`DROP PIPELINE IF EXISTS ${t}`)))},oo=async(e,t)=>{const o=await eo(e,t);await Promise.all(o.filter(r=>r.needsUpdate).map(async r=>{console.log(`recreating pipeline ${r.pipelineName}`),await v(e,to(r.pipelineName,t)),await v(e,`ALTER PIPELINE ${r.pipelineName} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await v(e,`START PIPELINE IF NOT RUNNING ${r.pipelineName}`),console.log(`finished creating pipeline ${r.pipelineName}`)}))},fi=async e=>{const t=await gt(e,`
      SELECT
    ...
    `,e.database);await Promise.all(t.map(async([o])=>{console.log("restarting pipeline",o),await v(e,`ALTER PIPELINE ${o} SET OFFSETS EARLIEST DROP ORPHAN FILES`),await v(e,`START PIPELINE IF NOT RUNNING ${o}`)}))},vt=async e=>{const t=await j(e,`
      SELECT plan_id AS planId
      FROM information_schema.plancache
      WHERE
        plan_warnings LIKE "%empty tables%"
    `);try{await Promise.all(t.map(({planId:o})=>v(e,`DROP ${o} FROM PLANCACHE`)))}catch(o){if(!(o instanceof P&&o.isPlanMissing()))throw o}return t.length>0},mi=(e,...t)=>{const o=t.map(r=>`"${r}"`).join(",");return Wt(e,`
      ...
      GROUP BY tableName
    `,e.database)},je=(e,...t)=>mi(e,...t).then(o=>o.reduce((r,{tableName:a,count:d})=>(r[a]=d,r),{})),vi=async(e,t)=>{const{maxRows:o}=t,a=["locations","requests","purchases","notifications"].map(n=>`"${n}"`).join(","),d=await Wt(e,`
      SELECT
      ...
      WHERE
        ...
        AND stats.count > ?
    `,e.database,o);await Promise.all(d.map(async({tableName:n,count:c,minTs:l,maxTs:u})=>{const y=(c-o)/c;if(y<.2)return;const f=new Date((l+y*(u-l))*1e3);console.log(`removing rows from ${n} older than ${f.toISOString()}`),await v(e,`DELETE FROM ${n} WHERE ts <= ?`,f.toISOString())}))},ro=(e,t="minute")=>Ue(e,"ECHO run_matching_process(?)",t).then(o=>o.RESULT),io=async(e,t,o=!0)=>{const r=new Date().toISOString();return await v(e,"CALL update_segments(?, ?)",t,r),o&&await v(e,"CALL prune_segments(?)",r),r},hi=(e,t,o,r)=>gt(e,`
      SELECT
        ts,
...
`,Ti=(e,t,o,r)=>j(e,mt({with:[["metrics",ht(t)]],base:`
        SELECT
        ...
        ORDER BY ${o} DESC
        LIMIT ${r}
      `}).sql),Ct=(e,t)=>Ue(e,mt({with:[["metrics",ht(t)]],base:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `}).sql),Ni=(e,t,o)=>{const r=mt({with:[["metrics",ht(o)]],base:{sql:`
        SELECT
          *, (totalConversions / totalNotifications) :> DOUBLE AS conversionRate
        FROM (
          SELECT
      ...
      `,params:[Fe(t)]}});return j(e,r.sql,...r.params)},Si=(e,t,o)=>Ue(e,"CALL update_sessions(?, ?)",t,o).then(({session_id:r,is_controller:a,expires_at:d})=>({sessionID:r,isController:a,expiresAt:new Date(d)})),ao=(e,t,o)=>v(e,`
      UPDATE sessions
    ...
    `,o,t,t),J=[{name:"s00",maxRows:1e7,prefix:"v2/100k-2p",partitions:2},{name:"s0",maxRows:2e7,prefix:"v2/100k-4p",partitions:4},{name:"s1",maxRows:4e7,prefix:"v2/100k-8p",partitions:8},{name:"s2",maxRows:16e7,prefix:"v2/1m-16p",partitions:16},{name:"s4",maxRows:32e7,prefix:"v2/1m-32p",partitions:16},{name:"s8",maxRows:64e7,prefix:"v2/1m-64p",partitions:64},{name:"s10",maxRows:1e9,prefix:"v2/10m-80p",partitions:80}],Ri=e=>J.find(t=>t.name===e)||J[0],ae=({encode:e,decode:t}={encode:JSON.stringify,decode:JSON.parse})=>({setSelf:o,onSet:r,node:a})=>{const d=`recoil.localstorage.${a.key}`,n=localStorage.getItem(d);n!=null&&o(t(n)),r((c,l,u)=>{u?localStorage.removeItem(d):localStorage.setItem(d,e(c))})},no=()=>({setSelf:e,node:{key:t}})=>{const{location:o}=window;if(o){const r=new URLSearchParams(o.search);e(r.get(t)||new Fo)}},Ai=U({key:"sessionID",default:null,effects:[no()]}),Ii=U({key:"vaporBaseUrl",default:"https://vapor.labs.singlestore.com",effects:[no()]}),co=U({key:"connectionHost",default:"http://127.0.0.1",effects:[ae()]}),lo=U({key:"connectionUser",default:"root",effects:[ae()]}),so=U({key:"connectionPassword",default:"",effects:[ae()]}),de=U({key:"connectionDatabase",default:"martech",effects:[ae()]}),po=Dt({key:"vaporConnectionConfig",get:async({get:e})=>{const t=e(Ai),o=e(Ii);if(t&&o)try{const r=await fetch(o+"/api/v1/connect?sessionID="+t);if(r.status===200){const a=await r.json();return{host:"https://"+a.endpoint,user:a.user,password:a.password,database:e(de)}}}catch{console.log(`Failed to connect to vapor at ${o}, falling back to local config`)}}}),b=Dt({key:"connectionConfig",get:({get:e})=>{const t=e(po);if(t)return t;const o=e(co),r=e(lo),a=e(so),d=e(de);return{host:o,user:r,password:a,database:d}},cachePolicy_UNSTABLE:{eviction:"most-recent"}}),fe=U({key:"configScaleFactor",default:J[0],effects:[ae({encode:e=>e.name,decode:e=>J.find(t=>t.name===e)||J[0]})]}),ne=U({key:"simulatorEnabled",default:!0,effects:[ae()]}),uo=U({key:"databaseDrawerIsOpen",default:!1}),rt=Go({key:"tickDurationMs",default:void 0}),me=U({key:"resettingSchema",default:!1}),Oi=Object.fromEntries([We.map(({name:e})=>[e,!1]),He.map(({name:e})=>[e,!1]),Ye.map(({name:e})=>[e,!1])].flat()),yo=(e=!1)=>{const t=m(b);return R(["schemaObjects",t,e],()=>si(t),{isPaused:()=>e,refreshInterval:o=>Object.values(o||[]).some(a=>!a)?1e3:0,fallbackData:Oi})},O=()=>{const d=m(b),{database:e}=d,t=M(d,["database"]),o=m(po),r=R(["isConnected",t],()=>li(t)),a=yo(!r.data);return{isVapor:!!o,connected:!!r.data,initialized:!!r.data&&Object.values(a.data||[]).every(Boolean),reset:()=>{r.mutate(),a.mutate()}}},Ci=(()=>{let e={};return t=>(t in e||(e[t]=1),`${t}(${e[t]++})`)})(),it=(e,{name:t,enabled:o,intervalMS:r})=>{const a=De(rt(t));g.exports.useEffect(()=>{if(!o)return;const d=new AbortController,n=Ci(t);console.log(`Starting ${n}: tick interval: ${r}ms`);const c=async()=>{try{if(console.time(n),d.signal.aborted)return;const l=performance.now();await e(d);const u=performance.now()-l;a(u),setTimeout(c,Math.max(0,r-u))}catch(l){if(d.signal.aborted||l instanceof P&&l.isUnknownDatabase()||l instanceof DOMException&&l.name==="AbortError")return;throw l}finally{console.timeEnd(n)}};return c(),()=>{console.log(`Stopping ${n}`),d.abort()}},[o,e,r,t,a])},wi=()=>{const{cache:e,mutate:t}=zt();if(!(e instanceof Map))throw new Error("useInvalidateSWRCache requires the cache provider to be a Map instance");return g.exports.useCallback(async()=>{for(const[o]of e)await t(o)},[e,t])},Li=({before:e,after:t,includeSeedData:o,resetDataOnly:r=!1})=>{const a=m(b),d=m(fe),[n,c]=B(ne),l=xt(),u=De(me),p=wi();return g.exports.useCallback(async()=>{const y=n;c(!1),u(!0),e(),await pi(a,{progress(f,h){const A="reset-schema";l.isActive(A)?l.update(A,{title:f,status:h,duration:h==="success"?2e3:null,isClosable:!0}):l({id:A,title:f,status:h,duration:null})},includeSeedData:o,resetDataOnly:r}),t(),await p(),c(y),u(!1)},[n,c,u,e,a,d,o,r,t,p,l])},go=(e,t)=>{const[o,r]=g.exports.useState(e);return g.exports.useEffect(()=>{const a=setTimeout(()=>r(e),t);return()=>clearTimeout(a)},[e,t]),o},fo=()=>{const[{elapsed:e,isRunning:t},o]=g.exports.useReducer((r,a)=>{switch(a.type){case"start":return{start:Math.floor(performance.now()),isRunning:!0,elapsed:r.elapsed};case"stop":return{elapsed:Math.floor(performance.now())-(r.start||0),isRunning:!1}}},{isRunning:!1});return{elapsed:e,isRunning:t,startTimer:()=>o({type:"start"}),stopTimer:()=>o({type:"stop"})}},mo=(e,t)=>{const o=g.exports.useRef(!1);return g.exports.useEffect(()=>(o.current=!0,()=>{o.current=!1}),[]),g.exports.useCallback(()=>{o.current&&e()},t)},vo=(e,t)=>{let o=!1,r=new Yo(0,0),a=0;e.on("pointerdown",d=>{o=!0,r=d.data.global,a=performance.now()}),e.on("pointerup",d=>{if(!o||(o=!1,performance.now()-a>200))return;const c=d.data.global;Math.sqrt(Math.pow(c.x-r.x,2)+Math.pow(c.y-r.y,2))>10||t(d)}),e.on("pointercancel",()=>{o=!1})};class ki extends te{constructor(t,o){super();_(this,"gfx");_(this,"hover",!1);this.city=t,this.onRemove=o,this.gfx=new Ie,this.addChild(this.gfx),this.gfx.interactive=!0,this.gfx.on("pointerover",()=>{this.hover=!0}),this.gfx.on("pointerout",()=>{this.hover=!1}),vo(this.gfx,()=>o(this.city))}update(t){this.gfx.clear(),this.gfx.lineStyle(1,this.hover?16711680:306687,1),this.gfx.beginFill(this.hover?16711680:306687,.2);const[o,r]=t([this.city.centerLat,this.city.centerLon]);this.gfx.drawCircle(o,r,25),this.gfx.endFill()}}const Di=e=>{const t=m(b),{initialized:o}=O();return R(["cities",t,o],()=>Ei(t),{isPaused:()=>!o,onSuccess:e})},xi=({scene:e,latLngToPixel:t,pixelToLatLng:o,width:r,height:a})=>{const d=m(b),n=nt(()=>new te),{mutate:c}=Di(p=>{n.removeChildren();for(let y=0;y<p.length;y++)n.addChild(new ki(p[y],u))}),l=g.exports.useCallback(async(p,y)=>{const f=await _i(d,y,p),h={id:f.id,name:f.name,lonlat:[f.centerLon,f.centerLat],diameter:f.diameter};await Kt(d,h),await ui(d,h,J[0]),c()},[d,c]),u=g.exports.useCallback(async p=>{await Wr(d,p.id),c()},[d,c]);return{setup:g.exports.useCallback(()=>{const p=new te;e.addChild(p),e.addChild(n),p.interactive=!0,p.hitArea=new Ho(0,0,r,a),vo(p,y=>{const[f,h]=o([y.data.global.x,y.data.global.y]);l(f,h)})},[n,a,l,o,e,r]),update:g.exports.useCallback(()=>{for(let p=0;p<n.children.length;p++)n.children[p].update(t)},[n,t])}},zi=e=>i(Ge,N(E({},e),{useRenderer:xi,options:{},cursor:"pointer"})),Pi=Wo({a:o=>{var r=o,{children:e}=r,t=M(r,["children"]);const{href:a}=t,d=!!(a!=null&&a.startsWith("http"));return d?s($,N(E({isExternal:d},t),{children:[e,i(jo,{bottom:"2px",boxSize:"0.9em",position:"relative",ml:1})]})):i($,N(E({to:a||""},t),{as:Pt,children:e}))}}),S=o=>{var r=o,{children:e}=r,t=M(r,["children"]);return i(Vo,N(E({},t),{skipHtml:!0,components:Pi,children:Array.isArray(e)?e.filter(a=>a).map(a=>q(a||"")).join(`

`):q(e)}))},Mi=()=>s(oe,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(oe,{maxW:"container.md",mb:4,children:i(S,{children:`
            ## City Admin
            ...
            remove it.
          `})}),i(zi,{defaultZoom:4,defaultCenter:[39.716470511656766,-99.59395661915288],height:500})]}),wt=(()=>{const e=()=>crypto&&crypto.randomUUID?crypto.randomUUID():Ko();let t;return t=e(),console.log(`Session ID: ${t}`),t})(),Lt=60,ve=()=>{const e=m(b),t=m(me),{connected:o,initialized:r}=O(),{data:a,mutate:d}=R([e,"useSession"],()=>Si(e,wt,Lt),{refreshInterval:1e3,isPaused:()=>t||!o||!r});return{session:a||{sessionID:wt,isController:!1,expiresAt:new Date(Date.now()+Lt*1e3)},refresh:d}},ho=()=>{const e=De(ne),{session:t,refresh:o}=ve(),r=m(b),{connected:a,initialized:d}=O(),[n,c]=re(!1),l=mo(()=>c.off,[c]),u=g.exports.useCallback(async()=>{c.on(),a&&d&&await ao(r,t.sessionID,!0),e(!0),o(),l()},[r,a,c,d,o,t.sessionID,e,l]);return s(Q,{status:"warning",borderRadius:"md",children:[i(ee,{}),i(Ne,{children:"The simulator is disabled"}),i(I,{position:"absolute",right:4,top:3,size:"xs",colorScheme:"blue",disabled:n,onClick:u,children:"Enable simulator"})]})},kt=e=>{const{r:t,g:o,b:r}=e.rgb();return t<<16|o<<8|r};class Ui extends te{constructor(t,o){super();_(this,"points");_(this,"polygon");_(this,"hovering",!1);_(this,"color");_(this,"hoverColor");this.config=t,this.points=Gr(t.wktPolygon),this.polygon=new Ie,this.addChild(this.polygon);const r=o(t.value);this.color=kt(r),this.hoverColor=kt(r.darker(1)),this.polygon.interactive=!0,this.polygon.on("mouseover",()=>{this.hovering=!0}),this.polygon.on("mouseout",()=>{this.hovering=!1})}update(t){const o=this.hovering?this.hoverColor:this.color;this.polygon.clear(),this.polygon.lineStyle(1,o,.5),this.polygon.beginFill(o,.2),this.polygon.drawPolygon(this.points.flatMap(([r,a])=>t([a,r]))),this.polygon.endFill()}}const Bi=e=>({scene:t,latLngToPixel:o,bounds:r})=>{const a=go(r,100),d=nt(()=>$o(n=>qo(e.colorInterpolater(n))));return e.useCells(a,n=>{t.removeChildren();let c=1/0,l=-1/0;const u=[];for(const p of n){const y=e.getCellConfig(p);u.push(y),y.value<c&&(c=y.value),y.value>l&&(l=y.value)}d.domain([c,l]);for(const p of u)t.addChild(new Ui(p,d))}),{update:g.exports.useCallback(()=>{for(let n=0;n<t.children.length;n++)t.children[n].update(o)},[o,t])}},bo=e=>{const n=e,{useCells:t,getCellConfig:o,colorInterpolater:r}=n,a=M(n,["useCells","getCellConfig","colorInterpolater"]),d=g.exports.useMemo(()=>Bi({useCells:t,getCellConfig:o,colorInterpolater:r}),[r,o,t]);return i(Ge,N(E({},a),{useRenderer:d,options:{}}))},Fi=10*1e3,bt=e=>{const t=m(b),o=m(fe),{initialized:r}=O(),{session:a}=ve(),d=g.exports.useCallback(n=>{const c=N(E({},t),{ctx:n});return Promise.all([oo(c,o),fi(c),vi(c,o),vt(c)])},[t,o]);it(d,{name:"SimulatorMonitor",enabled:r&&e&&a.isController,intervalMS:Fi})},Gi=1*1e3,Yi=1*1e3,Eo=e=>{const t=m(b),{initialized:o}=O(),r=g.exports.useRef(new Date(0).toISOString()),{session:a}=ve(),d=g.exports.useCallback(c=>ro(N(E({},t),{ctx:c}),"minute"),[t]);it(d,{name:"SimulatorMatcher",enabled:o&&e&&a.isController,intervalMS:Gi});const n=g.exports.useCallback(async c=>{r.current=await io(N(E({},t),{ctx:c}),r.current)},[t]);it(n,{name:"SimulatorUpdateSegments",enabled:o&&e&&a.isController,intervalMS:Yi})},at=ye(",.2%"),pe=ye(".4~s"),Hi=()=>{const{initialized:e}=O(),t=m(ne);return bt(t),Eo(t),i(oe,{maxW:"container.lg",mt:10,mb:"30vh",children:e?t?s(G,{gap:10,children:[i(Wi,{}),i(ji,{}),i(Ki,{})]}):i(ho,{}):i(_o,{})})},_o=()=>i(H,{children:i(W,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})}),Wi=()=>{var a,d;const e=m(b),t=R(["overallConversionRateRequests",e],()=>Ct(e,"requests"),{refreshInterval:1e3}),o=R(["overallConversionRatePurchases",e],()=>Ct(e,"purchases"),{refreshInterval:1e3}),r=R(["analyticsTableCounts",e],()=>je(e,"offers","subscribers","notifications"),{refreshInterval:1e3});return!r.data||!t.data||!o.data?i(_o,{}):s(ge,{spacing:2,minChildWidth:"150px",flex:2,children:[s(k,{children:[i(D,{children:"Offers"}),i(x,{children:pe(r.data.offers)})]}),s(k,{children:[i(D,{children:"Subscribers"}),i(x,{children:pe(r.data.subscribers)})]}),s(k,{children:[i(D,{children:"Notifications"}),i(x,{children:pe(r.data.notifications)})]}),s(k,{children:[i(D,{children:"Conversion Rate"}),i(x,{children:at(((a=t.data)==null?void 0:a.conversionRate)||0)}),i(Nt,{children:"Requests"})]}),s(k,{children:[i(D,{children:"Conversion Rate"}),i(x,{children:at(((d=o.data)==null?void 0:d.conversionRate)||0)}),i(Nt,{children:"Purchases"})]})]})},ji=()=>{var d;const e=m(b),[t,o]=g.exports.useState("conversionRate"),r=R(["customerMetrics",e,t],()=>Ti(e,"purchases",t,10),{refreshInterval:1e3}),a=Oe("blue.500","blue.200");return i(z,{overflowX:"auto",children:s(Jo,{size:"sm",colorScheme:"gray",variant:"striped",children:[i(Xo,{children:s(St,{children:[s(be,{onClick:()=>o("customer"),_hover:{color:a},color:t==="customer"?a:void 0,cursor:"pointer",children:["Customer",t==="customer"&&i(le,{})]}),s(be,{onClick:()=>o("totalNotifications"),_hover:{color:a},color:t==="totalNotifications"?a:void 0,isNumeric:!0,cursor:"pointer",children:["Total Notifications",t==="totalNotifications"&&i(le,{})]}),s(be,{onClick:()=>o("totalConversions"),_hover:{color:a},color:t==="totalConversions"?a:void 0,isNumeric:!0,cursor:"pointer",children:["Total Conversions",t==="totalConversions"&&i(le,{})]}),s(be,{onClick:()=>o("conversionRate"),_hover:{color:a},color:t==="conversionRate"?a:void 0,isNumeric:!0,cursor:"pointer",children:["Conversion Rate",t==="conversionRate"&&i(le,{})]})]})}),i(Zo,{children:(d=r.data)==null?void 0:d.map(n=>s(St,{children:[i(Ee,{children:n.customer}),i(Ee,{isNumeric:!0,children:pe(n.totalNotifications)}),i(Ee,{isNumeric:!0,children:pe(n.totalConversions)}),i(Ee,{isNumeric:!0,children:at(n.conversionRate)})]},n.customer))})]})})},Vi=(e,t)=>{const o=m(b);R(["zoneMetrics",o,e],()=>Ni(o,e,"purchases"),{refreshInterval:1e3,onSuccess:t})},Ki=()=>s(G,{direction:["column","row"],alignItems:"top",children:[i(z,{flex:1,children:i(S,{children:`
            ### Conversion Map
          ...
          `})}),i(z,{flex:2,children:i(bo,{height:400,defaultZoom:14,useCells:Vi,colorInterpolater:Qo,getCellConfig:({conversionRate:e,wktPolygon:t})=>({value:e,wktPolygon:t})})})]}),_e=({label:e,placeholder:t,value:o,setValue:r,helpText:a,type:d="text"})=>s(ct,{children:[i(lt,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),i(Mt,{size:"sm",placeholder:t,value:o,onChange:n=>r(n.target.value),type:d}),a?i(er,{fontSize:"xs",children:a}):null]}),$i=()=>{const[e,t]=B(fe);return s(ct,{children:[i(lt,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),i(tr,{size:"sm",required:!0,value:e.name,onChange:o=>{const r=o.target.value;t(Ri(r))},children:J.map(o=>i("option",{value:o.name,children:o.name},o.name))})]})},To=({showDatabase:e,showScaleFactor:t})=>{const[o,r]=B(co),[a,d]=B(lo),[n,c]=B(so),[l,u]=B(de);return s(G,{spacing:4,children:[i(_e,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:o,setValue:r,helpText:i(S,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [Data API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),s(ge,{columns:2,gap:2,children:[i(_e,{label:"Username",placeholder:"admin",value:a,setValue:d}),i(_e,{label:"Password",placeholder:"",value:n,setValue:c,type:"password"}),e&&i(_e,{label:"Database",placeholder:"martech",value:l,setValue:u}),t&&i($i,{})]})]})},No=e=>i(I,N(E({onClick:()=>{const{pathname:t,hash:o}=window.location;window.location.replace(t+o)},colorScheme:"red"},e),{children:"Disconnect"})),ke=e=>{const{connected:t,initialized:o}=O(),r=st(),[a,d]=re(),n=m(de),c=ue.useRef(null),h=e,{skipSeedData:l,resetDataOnly:u,disabled:p}=h,y=M(h,["skipSeedData","resetDataOnly","disabled"]),f=Li({before:g.exports.useCallback(()=>d.on(),[d]),after:mo(()=>{d.off(),r.onClose()},[r,d]),includeSeedData:!l,resetDataOnly:!!u});return s(C,{children:[i(I,E({disabled:!t||p,onClick:r.onOpen,colorScheme:o?"green":"red"},y)),i(or,{isOpen:r.isOpen,onClose:r.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:c,children:i(xe,{children:s(rr,{children:[s(ze,{fontSize:"lg",fontWeight:"bold",children:[o?"Reset":"Setup"," database ",n]}),s(Pe,{children:["This will ",o?"recreate":"create"," the database called ",n,". Are you sure?"]}),s(Ut,{children:[i(I,{ref:c,onClick:r.onClose,disabled:a,children:"Cancel"}),i(I,{disabled:a,colorScheme:o?"red":"green",onClick:f,ml:3,children:a?i(W,{}):o?"Recreate database":"Create database"})]})]})})})]})},qi=({isOpen:e,onClose:t,finalFocusRef:o})=>{const[r,a]=B(ne),{session:d,refresh:n}=ve(),c=r&&d.isController,l=m(b),{connected:u,initialized:p,isVapor:y}=O(),f=st(),[h,A]=re(!1),T=g.exports.useCallback(async()=>{A.on();const Z=!(r&&d.isController);a(Z),await ao(l,d.sessionID,Z),n(),A.off()},[l,r,n,d.isController,d.sessionID,a,A]),[w,L]=re(!1),V=g.exports.useCallback(async()=>{L.on(),await Zt(l),L.off()},[l,L]);return s(ir,{isOpen:e,placement:"right",onClose:t,finalFocusRef:o,children:[i(xe,{}),s(ar,{children:[i(pt,{}),i(ze,{children:"Config"}),i(Pe,{children:s(G,{spacing:4,children:[y?null:i(To,{showScaleFactor:!0,showDatabase:!0}),s(Q,{status:u?"success":"error",borderRadius:"md",children:[i(ee,{}),i(Ne,{children:u?"connected":"disconnected"}),y?i(No,{position:"absolute",right:4,top:3,size:"xs"}):null]}),s(Q,{status:p?"success":"warning",borderRadius:"md",children:[i(ee,{}),i(Ne,{children:"schema"}),i(ke,{position:"absolute",right:4,top:3,size:"xs",children:p?"Reset":"Setup"})]}),s(Q,{status:c?"success":"warning",borderRadius:"md",children:[i(ee,{}),i(Ne,{children:"simulator"}),i(dr,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:c?"green":"red",isChecked:c,disabled:!u||!p||h,onChange:T})]}),s(ie,{onClick:f.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",f.isOpen?i(nr,{ml:2}):i(le,{ml:2})]}),f.isOpen?i(I,{size:"xs",_hover:{colorScheme:"red"},onClick:V,disabled:w,children:"Drop Database"}):void 0]})}),i(Ut,{})]})]})},Te=({to:e,children:t,onClick:o})=>{const r=gr(e),a=fr({path:r.pathname,end:!0});return i($,{as:Pt,to:e,px:2,py:1,onClick:o,rounded:"md",_hover:{textDecoration:"none",bg:Oe("gray.300","gray.600")},fontWeight:a?"bold":"normal",href:"#",color:Oe("gray.700","gray.200"),children:t})},Ji=()=>{const{colorMode:e,toggleColorMode:t}=Me(),o=st(),[r,a]=B(uo),d=ue.useRef(null),{connected:n,initialized:c}=O(),l=m(ne),[u]=ut("(max-width: 640px)"),{session:p}=ve(),y=s(C,{children:[i(Te,{to:"/",onClick:o.onClose,children:"Map"}),i(Te,{to:"/overview",onClick:o.onClose,children:"Overview"}),i(Te,{to:"/admin",onClick:o.onClose,children:"Admin"}),i(Te,{to:"/analytics",onClick:o.onClose,children:"Analytics"})]}),f=n?c&&l&&p.isController?"green":"yellow":"red";let h;return u||(h=n?c?l&&p.isController?"connected":"simulator disabled":"needs schema":"disconnected"),i(C,{children:i(z,{bg:Oe("gray.200","gray.700"),children:s(oe,{maxW:"container.lg",children:[s(Ce,{h:16,alignItems:"center",justifyContent:"space-between",children:[i(Je,{size:"md",icon:o.isOpen?i(cr,{}):i(lr,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:o.isOpen?o.onClose:o.onOpen}),s(we,{spacing:8,alignItems:"center",children:[i(yt,{as:"h1",size:u?"sm":"md",children:u?"Martech":"Realtime Digital Marketing"}),i(we,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:y})]}),s(Ce,{alignItems:"center",gap:2,children:[s(I,{size:"sm",ref:d,onClick:()=>a(!0),colorScheme:f,children:[f==="green"?i(Bt,{}):i(Ft,{}),u||i(ie,{pl:2,children:h})]}),i(Je,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?i(sr,{size:"1.4em"}):i(pr,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),i(Je,{"aria-label":"Toggle Color Mode",size:"sm",onClick:t,icon:e==="light"?i(ur,{boxSize:"1.2em"}):i(yr,{boxSize:"1.2em"})})]})]}),o.isOpen?i(z,{pb:4,display:{md:"none"},children:i(G,{as:"nav",spacing:4,children:y})}):null,i(qi,{isOpen:r,onClose:()=>a(!1),finalFocusRef:d})]})})})},Xi=ye("~s"),So=(e,...t)=>{const o=g.exports.useMemo(()=>t.reduce((d,n)=>N(E({},d),{[n]:[]}),{}),[t]),r=g.exports.useRef(o),{data:a}=R(["estimatedRowCount.timeseries",...t],async()=>{const d=await je(e,...t),n=new Date;return r.current=t.reduce((c,l)=>{const u=r.current[l];return u.push([n,d[l]]),c[l]=u.slice(-30),c},{}),r.current},{refreshInterval:1e3});return a!=null?a:o},Ro=r=>{var a=r,{data:e,yAxisLabel:t}=a,o=M(a,["data","yAxisLabel"]);const{colorMode:d}=Me(),n=Object.keys(e),c=g.exports.useCallback(({tooltipData:p,colorScale:y})=>!y||!p?null:n.sort((f,h)=>p.datumByKey[h].datum[1]-p.datumByKey[f].datum[1]).map(f=>{const{datum:h}=p.datumByKey[f];return s(ie,{mb:1,color:y(f),fontSize:"sm",children:[f,": ",ye(".4~s")(h[1])]},f)}),[n]),l=g.exports.useCallback(p=>Xi(p).replace("G","B"),[]);if(n.some(p=>e[p].length<2))return i(H,{height:o.height,children:i(W,{size:"md"})});const u=n.map(p=>i(mr,{dataKey:p,data:e[p],xAccessor:y=>y[0],yAccessor:y=>y[1]},p));return s(vr,N(E({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:d==="light"?hr:br,margin:{left:0,right:50,top:10,bottom:40}},o),{children:[i(Rt,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),i(Rt,{orientation:"right",numTicks:o.height<250?3:5,tickFormat:l,label:t,labelOffset:20}),u,i(Er,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:c})]}))},dt=1e3,Re=60*dt,Ae=60*Re,Ze=24*Ae,F=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),X=e=>e?e<dt?`${F(e)}ms`:e<Re?`${F(e/dt)}s`:e<Ae?`${Math.floor(e/Re)}m${X(e%Re)}`:e<Ze?`${Math.floor(e/Ae)}h${X(e%Ae)}`:`${Math.floor(e/Ze)}d${X(e%Ze)}`:"0s",Zi=100,Qi=1e3,K=class extends te{constructor(t){super();_(this,"latlng");_(this,"age",0);_(this,"marker");_(this,"pulse");this.latlng=t,this.marker=new Ie,this.marker.beginFill(K.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new Ie,this.pulse.beginFill(K.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(t,o){if(this.age+=o/60,this.age>K.lifetime&&this.parent){this.parent.removeChild(this);return}const r=this.age%K.lifetime/K.lifetime,a=Sr(r);this.pulse.scale.set(1+a);const d=.4,n=r<d?_r(r/d):1-Tr((r-d)/(1-d));this.pulse.alpha=n,r<d?this.marker.alpha=n:this.marker.alpha=1-Nr((r-d)/(1-d));const[c,l]=t(this.latlng);this.x=c,this.y=l}};let se=K;_(se,"lifetime",1.5),_(se,"markerColor",306687),_(se,"pulseColor",306687);const Ao=()=>{const e=m(b),{initialized:t}=O();return g.exports.useMemo(()=>["notifications",e,t],[e,t])},Io=({scene:e,latLngToPixel:t,bounds:o})=>{const r=g.exports.useRef(new Date().toISOString()),a=m(b),{initialized:d}=O(),n=go(o,50),c=Ao();return R(c,()=>hi(a,r.current,Zi,n),{refreshInterval:Qi,isPaused:()=>!d,onSuccess:l=>{if(l.length>0){r.current=l[0][0];for(const[,u,p]of l)e.addChild(new se([p,u]))}}}),{update:g.exports.useCallback(l=>{for(let u=e.children.length-1;u>=0;u--)e.children[u].update(t,l)},[t,e])}},ea=()=>{const e=m(b),t=So(e,"locations","requests","purchases","notifications","subscriber_segments"),o=R(["notificationsMapTableCounts",e],()=>je(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),r=m(rt("SimulatorMatcher")),a=m(rt("SimulatorUpdateSegments")),d=ye(".4~s"),n=o.data?s(ge,{spacing:2,minChildWidth:"120px",children:[s(k,{children:[i(D,{children:"Offers"}),i(x,{children:d(o.data.offers)})]}),s(k,{children:[i(D,{children:"Cities"}),i(x,{children:d(o.data.cities)})]}),s(k,{children:[i(D,{children:"Subscribers"}),i(x,{children:d(o.data.subscribers)})]}),s(k,{children:[i(D,{children:"Segments"}),i(x,{children:d(o.data.segments)})]}),s(k,{children:[i(D,{children:"Segmentation"}),i(x,{children:X(a)})]}),s(k,{children:[i(D,{children:"Matching"}),i(x,{children:X(r)})]})]}):null;return s(C,{children:[i(S,{children:`
          ...
          about the demo.
        `}),n,s(z,{children:[i(ie,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),i(Ro,{data:t,yAxisLabel:"total rows",height:150})]})]})},ta=()=>{const{connected:e,initialized:t}=O(),o=m(ne);bt(o&&e&&t),Eo(o&&e&&t);const r=De(uo);let a;return e?t?o?a=i(ea,{}):a=i(ho,{}):a=i(ke,{colorScheme:"blue",size:"sm",children:"Setup database"}):a=s(I,{size:"sm",onClick:()=>r(!0),colorScheme:"green",children:[i(Rr,{}),i(ie,{pl:2,children:"Connect to SingleStore"})]}),s(Ce,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[i(G,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:i(Ge,{useRenderer:Io,options:{}})}),s(G,{spacing:4,flex:"1 1 0",minWidth:"0",children:[i(S,{children:`
          ...
          `}),a]})]})},Et=o=>{var r=o,{children:e}=r,t=M(r,["children"]);return i(Ar,N(E({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},t),{children:e}))},oa=1e3,ra=(e,t)=>{const o=m(b),{initialized:r}=O();R(["offers",o,r,e],()=>bi(o,oa,e),{isPaused:()=>!r,onSuccess:t})},ia=e=>i(bo,N(E({},e),{useCells:ra,colorInterpolater:()=>"#04adff",getCellConfig:t=>({value:1,wktPolygon:t.notificationZone})})),aa=e=>e.every(([,t])=>t===0),Y=e=>{const{completed:t,title:o,left:r,right:a}=e,{colorMode:d}=Me(),n=d==="light"?".300":".500",c=t?"gray"+n:void 0,l=(t?"green":"gray")+n;return s(C,{children:[s(et,{children:[s(yt,{as:"h2",size:"lg",mb:4,color:c,children:[i(Bt,E({color:l},{boxSize:6,position:"relative",bottom:.5,mr:2})),o]}),r]}),i(et,{children:a})]})},da=({connected:e,isVapor:t})=>t?i(Y,{completed:e,title:"Connected",left:s(C,{children:[i(S,{children:`
                ...
                the button below.
              `}),i(No,{size:"xs",colorScheme:"gray"})]}),right:null}):i(Y,{completed:e,title:"Connect to SingleStore",left:i(S,{children:`
          ...
          `}),right:i(To,{})}),na=({onClose:e,schemaObjectName:t})=>{const o=ni(t),[r]=ut("(max-width: 640px)");return s(Yt,{isOpen:!0,onClose:e,size:r?"full":"4xl",scrollBehavior:"inside",children:[i(xe,{}),s(Ht,{children:[s(ze,{children:["Create statement for ",o.name]}),i(pt,{}),i(Pe,{children:i(Et,{mb:4,children:o.statement})})]})]})},Oo=({name:e,status:t,onClick:o})=>{const{colorMode:r}=Me();return i(et,{bg:(t?"green":"gray")+(r==="light"?".200":".600"),fontSize:"xs",color:r==="light"?"gray.800":"gray.100",textOverflow:"ellipsis",whiteSpace:"nowrap",overflow:"hidden",borderRadius:"md",px:2,py:1,textAlign:"center",_hover:{fontWeight:"bold"},cursor:"pointer",onClick:o,children:e},e)},ca=({initialized:e})=>{const[t,o]=B(de),r=yo(),[a,d]=g.exports.useState();return s(C,{children:[!!a&&i(na,{onClose:()=>d(null),schemaObjectName:a}),i(Y,{completed:e,title:"Setup the schema",left:s(C,{children:[i(S,{children:`
              ...
              `}),i(Or,{mt:4,mb:6}),e?i(ke,{colorScheme:"yellow",size:"sm",skipSeedData:!0,resetDataOnly:!0,children:"Restart tutorial"}):s(we,{alignItems:"flex-end",children:[s(ct,{flex:1,children:[i(lt,{fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Database name"}),i(Mt,{placeholder:"martech",value:t,size:"sm",onChange:n=>o(n.target.value)})]}),i(z,{flex:1,textAlign:"center",children:i(ke,{colorScheme:"blue",size:"sm",skipSeedData:!0,children:"Setup schema"})})]})]}),right:i(ge,{columns:[1,3,3],gap:1,children:Object.keys(r.data||{}).sort().map(n=>{var c;return i(Oo,{name:n,status:(c=r.data)==null?void 0:c[n],onClick:()=>d(n)},n)})})})]})},la=({onClose:e,name:t,scaleFactor:o})=>{const r=to(t,o),[a]=ut("(max-width: 640px)");return s(Yt,{isOpen:!0,onClose:e,size:a?"full":"4xl",scrollBehavior:"inside",children:[i(xe,{}),s(Ht,{children:[s(ze,{children:["Create statement for pipeline ",t]}),i(pt,{}),i(Pe,{children:i(Et,{mb:4,children:r})})]})]})},Co=(e,t,o=!0)=>{var d;const r=R(["pipelineStatus",e,t],()=>eo(e,t),{isPaused:()=>!o}),a=(d=r.data)!=null&&d.length?r.data.every(n=>!n.needsUpdate):!1;return{pipelines:r,completed:a}},sa=()=>{const e=m(b),t=m(fe),{pipelines:o,completed:r}=Co(e,t),a=m(me);bt(r&&!a);const d=T=>{var L;const w=(L=o.data)==null?void 0:L.find(V=>V.pipelineName===T);return w?!w.needsUpdate:!1},[n,c]=g.exports.useState(),[l,u]=re(),p=g.exports.useCallback(async()=>{u.on(),await oo(e,t),o.mutate(),u.off()},[u,e,t,o]),y=["locations","requests","purchases"],f=So(e,...y),h=y.some(T=>f[T].length<2)||y.every(T=>aa(f[T])),A=s(I,{colorScheme:"blue",size:"sm",onClick:p,disabled:r,children:[(l||r)&&i(W,{mr:2}),l?"Creating Pipelines":r?"...waiting for data":"Create pipelines"]});return s(C,{children:[!!n&&i(la,{onClose:()=>c(null),name:n,scaleFactor:t}),i(Y,{completed:r,title:"Ingest data",left:s(C,{children:[i(S,{children:`
              ...
              `}),i(ge,{columns:[1,3,3],gap:1,children:Le.map(T=>i(Oo,{name:T,status:d(T),onClick:()=>c(T)},T))})]}),right:h||!r?i(H,{h:220,children:A}):i(Ro,{data:f,yAxisLabel:"total rows",height:200})})]})},Ve=(e,t=!0)=>R(["overviewTableCounts",e],()=>je(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!t}),pa=()=>{var n,c;const e=m(b),[t,o]=re(),r=Ve(e),a=g.exports.useCallback(async()=>{o.on(),await Qt(e),r.mutate(),o.off()},[e,r,o]),d=!!((n=r.data)!=null&&n.offers);return i(Y,{completed:d,title:"Offers",left:i(C,{children:s(S,{children:[`
            ...
            `,d&&`
                ...
                boundary. There are ${(c=r.data)==null?void 0:c.offers} offers in the
                database.
            `]})}),right:d?i(ia,{height:300,defaultZoom:13}):i(H,{h:"100%",children:s(I,{onClick:a,disabled:t,children:[t&&i(W,{mr:2}),t?"loading...":d?"loaded offers!":"load offers"]})})})},ua=()=>{var f;const e=m(b),t=Ve(e),{elapsed:o,isRunning:r,startTimer:a,stopTimer:d}=fo(),[n,c]=g.exports.useState(!1),l=g.exports.useRef(new Date().toISOString()),u=!!((f=t.data)!=null&&f.subscriber_segments),p=g.exports.useCallback(async()=>{a(),l.current=await io(e,l.current),d(),t.mutate(),c((o||0)>1e3&&await vt(e))},[a,e,d,t,o]);let y;if(o&&t.data){const{segments:h,subscriber_segments:A,locations:T,requests:w,purchases:L}=t.data,V=X(o),Z=F(T+w+L),Ke=F(h),$e=F(A);y=i(S,{children:`
          The last update evaluated ${Z} rows against ${Ke} segments
          producing ${$e} segment memberships.
          
          **This process took ${V}**.
        `})}return i(Y,{completed:u,title:"Segmentation",left:i(S,{children:`
          ...
          `}),right:i(H,{h:"100%",children:s(Gt,{gap:4,textAlign:"center",children:[s(I,{disabled:r,onClick:p,children:[r&&i(W,{mr:2}),r?"...running":"Match subscribers to segments"]}),y,n&&s(Q,{status:"warning",children:[i(ee,{}),"Queries are still warming up. Please wait for a little bit and then try again."]})]})})})},ya=()=>{var T;const e=m(b),t=Ve(e),o=Ao(),{mutate:r}=zt(),{elapsed:a,isRunning:d,startTimer:n,stopTimer:c}=fo(),[l,u]=g.exports.useState(0),[p,y]=g.exports.useState(!1),f=!!((T=t.data)!=null&&T.notifications),h=g.exports.useCallback(async()=>{let w=0,L=0;for(;w===0&&L++<10;)n(),w=await ro(e,"second");c(),u(w),t.mutate(),r(o),y((a||0)>1e3&&await vt(e))},[c,t,r,o,a,n,e]);let A;if(a&&t.data){const{offers:w,subscribers:L,subscriber_segments:V,notifications:Z}=t.data,Ke=F(w*L+Z),$e=F(V),Lo=X(a),ko=F(l);A=i(S,{children:`
          The last update evaluated up to ${Ke} notification opportunities
          against ${$e} segment memberships generating ${ko}
          notifications. This process took ${Lo}.
        `})}return i(Y,{completed:f,title:"Matching",left:i(S,{children:`
          ...
          `}),right:i(H,{h:"100%",children:s(Gt,{gap:4,w:"100%",children:[s(I,{disabled:d,onClick:h,children:[d&&i(W,{mr:2}),d?"...running":"Generate notifications"]}),i(z,{width:"100%",children:i(Ge,{height:250,defaultZoom:12,useRenderer:Io,options:{}})}),A,p&&s(Q,{status:"warning",children:[i(ee,{}),"Queries are still warming up. Please wait for a little bit and then try again."]})]})})})},ga=()=>{const e=m(de);return i(Y,{completed:!0,title:"Putting it all together",left:i(S,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: /
            [2]: analytics
          `}),right:null})},fa=()=>{const e=m(b),t=m(fe),{connected:o,initialized:r,isVapor:a}=O(),{completed:d}=Co(e,t,o&&r),{data:n}=Ve(e,o&&r),c=[{completed:o,component:i(da,{connected:o,isVapor:a},"connection")},{completed:r,component:i(ca,{initialized:r},"schema")},{completed:d,component:i(sa,{},"pipelines")},{completed:n?n.offers>0:!1,component:i(pa,{},"offers")},{completed:n?n.subscriber_segments>0:!1,component:i(ua,{},"segmentation")},{completed:n?n.notifications>0:!1,component:i(ya,{},"matching")},{completed:!0,component:i(ga,{},"summary")}];let l=!0;const u=[];for(const{completed:p,component:y}of c)if(l)u.push(y),l=p;else break;return s(oe,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(z,{maxW:"container.md",mb:10,px:0,children:i(S,{children:`
          ...
          `})}),i(Ir,{columnGap:6,rowGap:10,templateColumns:["minmax(0, 1fr)",null,"repeat(2, minmax(0, 1fr))"],children:u})]})};function ma(){const e=i(H,{height:"100vh",children:i(W,{size:"xl",speed:"0.85s",thickness:"3px",emptyColor:"gray.200",color:"blue.500"})});return i(g.exports.Suspense,{fallback:e,children:s(Ce,{height:"100vh",direction:"column",children:[i(Ji,{}),i(z,{m:4,flex:"1",children:s(Cr,{children:[i(ce,{path:"/",element:i(ta,{})}),i(ce,{path:"/overview",element:i(fa,{})}),i(ce,{path:"/admin",element:i(Mi,{})}),i(ce,{path:"/analytics",element:i(Hi,{})}),i(ce,{path:"*",element:i(wr,{to:"/",replace:!0})})]})})]})})}const va=({children:e})=>{const t=m(me);return i(wo,{isResettingSchema:t,children:e})};class wo extends ue.Component{constructor(t){super(t);_(this,"state",{});this.handlePromiseRejection=this.handlePromiseRejection.bind(this)}componentDidMount(){window.addEventListener("unhandledrejection",this.handlePromiseRejection)}componentWillUnmount(){window.removeEventListener("unhandledrejection",this.handlePromiseRejection)}handlePromiseRejection(t){this.props.isResettingSchema?console.warn("Ignoring error while resetting schema",t.reason):this.setState({error:t.reason})}componentDidCatch(t){this.props.isResettingSchema?console.warn("Ignoring error while resetting schema",t):this.setState({error:t})}render(){const{error:t}=this.state;if(t){let o;return t instanceof P&&(o=s(C,{children:[i(ie,{textAlign:"center",children:"An error occurred while running the following query:"}),i(Et,{children:q(t.sql)})]})),i(oe,{maxW:"container.md",my:10,children:s(G,{gap:4,children:[i(H,{children:i(Ft,{boxSize:20,color:"red"})}),i(yt,{size:"xl",textAlign:"center",children:t.message}),o,s(we,{justify:"center",gap:4,children:[i(I,{onClick:()=>this.setState({error:void 0}),size:"sm",children:"Dismiss Error"}),i(I,{onClick:()=>window.location.reload(),size:"sm",colorScheme:"blue",leftIcon:i(Lr,{}),children:"Reload"})]})]})})}return this.props.children}}const ha=kr({fonts:{heading:"InterVariable, sans-serif",body:"InterVariable, sans-serif",mono:'"Source Code ProVariable", monospace'},components:{Link:{baseStyle:e=>({color:e.colorMode==="light"?"blue.600":"blue.300"})}}}),ba=({children:e})=>{const t=m(me),o=xt();return i(Mr,{value:{onError:a=>{if(t)console.warn("Ignoring error while resetting schema",a);else{console.error(a);const d="swr-error",n={id:"swr-error",title:"An error occurred",description:a.message,status:"error",duration:5e3,isClosable:!0};o.isActive(d)?o.update(d,n):o(E({id:d},n))}}},children:e})};Dr.render(i(ue.StrictMode,{children:i(xr,{theme:ha,children:i(wo,{children:i(zr,{children:i(Pr,{basename:"/",children:i(ba,{children:i(va,{children:i(ma,{})})})})})})})}),document.getElementById("root"));
