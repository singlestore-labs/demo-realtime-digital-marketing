...
`),{sql:a,params:n}=No(t);return{sql:$`
    ...
    `,o.id,o.name,`POINT(${o.lonlat[0]} ${o.lonlat[1]})`,o.diameter),xr=(e,o)=>E(e,"DELETE FROM cities WHERE city_id = ?",o),zr=["olc_8","purchase","request"],Pr=["minute","hour","day","week","month"],Vo=({interval:e,kind:o,value:t})=>Ct(`${e}-${o}-${t}`),Mr=async(e,o)=>{const{sql:t,params:r}=Ho({table:"segments",options:{replace:!0},columns:["segment_id","valid_interval","filter_kind","filter_value"],tuples:o.map(d=>[Vo(d),d.interval,d.kind,d.value])});await E(e,t,...r)},Ur=async(e,o)=>{const t={table:"offers",options:{replace:!0},columns:["customer","notification_zone","segment_ids","notification_content","notification_target","maximum_bid_cents"],tuples:[]};let r=0,d=[];const a=async()=>{const{sql:n,params:l}=Ho(t);await Promise.all([E(e,n,...l),Mr(e,d)]),t.tuples=[],d=[],r=0};for(const n of o)t.tuples.push([n.customer,n.notificationZone,JSON.stringify(n.segments.map(Vo)),n.notificationContent,n.notificationTarget,n.maximumBidCents]),r++,d=d.concat(n.segments),r>=Dr&&await a();r>0&&await a()},Br=()=>Wo(zr),Fr=()=>Wo(Pr),$o=({vendor:e,tld:o})=>`${e.toLowerCase()}.${o}`,Ko=e=>{const[o,t]=e.lonlat,r=e.diameter/2,[d,a]=[o-r,o+r],[n,l]=[t-r,t+r];return[Je(d,a),Je(n,l)]},Gr=(e,o)=>{const t=Br(),r=Fr();switch(t){case"olc_8":{const[d,a]=Ko(e),n=Xe.encode(a,d,8).substring(0,8);return{kind:t,interval:r,value:n}}case"purchase":return{kind:t,interval:r,value:o.vendor};case"request":return{kind:t,interval:r,value:$o(o)}}},Yr=e=>{const o=Se(1,3),t=kr(),r=Array.from({length:o},()=>Gr(e,t)),d=$o(t),n=`${Se(10,50)}% off at ${t.vendor}`,l=d,[c,u]=Ko(e),p=Xe.encode(u,c,8),y=Xe.decode(p),f={ne:[y.latitudeHi,y.longitudeHi],sw:[y.latitudeLo,y.longitudeLo]};return{customer:t.vendor,segments:r,notificationZone:Me(f),notificationContent:n,notificationTarget:l,maximumBidCents:Se(2,15)}},Hr=(e,o)=>Array.from({length:o},()=>Yr(e)),Wr=e=>(o,t,r,d=1)=>`https://stamen-tiles.a.ssl.fastly.net/${e}/${r}/${o}/${t}${d>=2?"@2x":""}.png`,jr=s(A,{children:["Map tiles by ",i(V,{href:"http://stamen.com",children:"Stamen Design"}),", under"," ",i(V,{href:"http://creativecommons.org/licenses/by/3.0",children:"CC BY 3.0"}),". Data by ",i(V,{href:"http://openstreetmap.org",children:"OpenStreetMap"}),", under"," ",i(V,{href:"http://www.openstreetmap.org/copyright",children:"ODbL"}),"."]}),Vr=[se.lonlat[1],se.lonlat[0]],$r=12,Kr=({width:e,height:o,bounds:t,latLngToPixel:r,pixelToLatLng:d,useRenderer:a,options:n})=>{const l=pe.useRef(null),c=Lo(()=>new Z),{setup:u,update:p}=a({scene:c,width:e,height:o,bounds:t,latLngToPixel:r,pixelToLatLng:d,options:n});return g.exports.useLayoutEffect(()=>{if(!l.current)throw new Error("No canvas ref");console.log("PixiMapLayer: Setup");const y=new wt({view:l.current,width:e,height:o,backgroundAlpha:0,antialias:!0});return y.stage.addChild(c),u==null||u(),p&&y.ticker.add(f=>{p(f)}),()=>{console.log("PixiMapLayer: Destroy"),y.stage.removeChild(c),y.destroy(!1,{children:!1,texture:!0,baseTexture:!0})}},[o,c,u,p,e]),i("canvas",{ref:l})},Xr=({mapState:e,latLngToPixel:o,pixelToLatLng:t,useRenderer:r,options:d})=>{const{width:a,height:n,bounds:l}=e||{width:0,height:0};return a<=0||n<=0||!o||!t||!l?null:i(Kr,{useRenderer:r,width:a,height:n,bounds:l,latLngToPixel:o,pixelToLatLng:t,options:d})},Ue=n=>{var l=n,{height:e="100%",defaultCenter:o=Vr,defaultZoom:t=$r,useRenderer:r,options:d}=l,a=z(l,["height","defaultCenter","defaultZoom","useRenderer","options"]);const[c,u]=g.exports.useState(o),[p,y]=g.exports.useState(t);return i(k,_(h({borderRadius:"lg",overflow:"hidden",height:e},a),{children:i(It,{dprs:[1,2],provider:Wr("toner-lite"),attribution:jr,maxZoom:20,center:c,zoom:p,onBoundsChanged:({center:f,zoom:v})=>{u(f),y(v)},children:i(Xr,{useRenderer:r,options:d})})}))};var Be=[{name:"date_sub_dynamic",createStmt:`CREATE OR REPLACE FUNCTION date_sub_dynamic (
  _dt DATETIME(6),
...
END`}],Ge=[{name:"worldcities",createStmt:`create rowstore table if not exists worldcities (
  ...
  `,"START PIPELINE worldcities FOREGROUND"],Jr=e=>{const o=Ge.find(d=>d.name===e);if(o)return o;const t=Fe.find(d=>d.name===e);if(t)return t;const r=Be.find(d=>d.name===e);if(r)return r;throw new Error("Could not find schema object: "+e)},Zr=async e=>{try{return await po(e,"SELECT 1"),!0}catch{return!1}},Qr=async e=>{let o={tables:[],procedures:[],functions:[]};const l=e,{database:t}=l,r=z(l,["database"]);try{o=(await so(r,`
    ...
    `,e.database,...r);return r.map(a=>{var l;const n=d.find(c=>c.pipelineName===a);return{pipelineName:a,needsUpdate:(l=n==null?void 0:n.needsUpdate)!=null?l:!0}})},Jo=async(e,o)=>{const t=o.prefix,r=await qo(e,o);await Promise.all(r.filter(d=>d.needsUpdate).map(async d=>{switch(console.log(`recreating pipeline ${d.pipelineName}`),d.pipelineName){case"locations":await E(e,`
...
`,li=(e,o,t,r)=>Y(e,uo({with:[["metrics",mo(o)]],base:`
    ...
    `,t,o,o),K=[{name:"s00",maxRows:1e7,prefix:"v2/100k-2p",partitions:2},{name:"s0",maxRows:2e7,prefix:"v2/100k-4p",partitions:4},{name:"s1",maxRows:4e7,prefix:"v2/100k-8p",partitions:8},{name:"s2",maxRows:16e7,prefix:"v2/1m-16p",partitions:16},{name:"s4",maxRows:32e7,prefix:"v2/1m-32p",partitions:16},{name:"s8",maxRows:64e7,prefix:"v2/1m-64p",partitions:64},{name:"s10",maxRows:1e9,prefix:"v2/10m-80p",partitions:80}],ui=e=>K.find(o=>o.name===e)||K[0],ee=({encode:e,decode:o}={encode:JSON.stringify,decode:JSON.parse})=>({setSelf:t,onSet:r,node:d})=>{const a=`recoil.localstorage.${d.key}`,n=localStorage.getItem(a);n!=null&&t(o(n)),r((l,c,u)=>{u?localStorage.removeItem(a):localStorage.setItem(a,e(l))})},vo=()=>({setSelf:e,node:{key:o}})=>{const{location:t}=window;if(t){const r=new URLSearchParams(t.search);e(r.get(o))}},yi=x({key:"skipCreateDatabase",default:null,effects:[vo()]}),gi=x({key:"sessionId",default:null,effects:[vo()]}),fi=x({key:"vaporBaseUrl",default:"https://vapor.labs.singlestore.com",effects:[vo()]}),et=x({key:"connectionHost",default:"http://127.0.0.1",effects:[ee()]}),ot=x({key:"connectionUser",default:"root",effects:[ee()]}),tt=x({key:"connectionPassword",default:"",effects:[ee()]}),oe=x({key:"connectionDatabase",default:"martech",effects:[ee()]}),rt=ko({key:"vaporConnectionConfig",get:async({get:e})=>{const o=e(gi),t=e(fi);if(o)try{const r=await fetch(t+"/api/v1/vapor/connect?sessionId="+o);if(r.status===200){const d=await r.json();return{host:d.endpoint,user:d.user,password:d.password,database:e(oe)}}}catch{console.log(`Failed to connect to vapor at ${t}, falling back to local config`)}}}),b=ko({key:"connectionConfig",get:({get:e})=>{const o=e(rt);if(o)return o;const t=e(et),r=e(ot),d=e(tt),a=e(oe);return{host:t,user:r,password:d,database:a}},cachePolicy_UNSTABLE:{eviction:"most-recent"}}),te=x({key:"configScaleFactor",default:K[0],effects:[ee({encode:e=>e.name,decode:e=>K.find(o=>o.name===e)||K[0]})]}),re=x({key:"simulatorEnabled",default:!0,effects:[ee()]}),mi=x({key:"databaseDrawerIsOpen",default:!1}),Ze=Lt({key:"tickDurationMs",default:void 0}),He=x({key:"resettingSchema",default:!1}),vi=Object.fromEntries([Ge.map(({name:e})=>[e,!1]),Fe.map(({name:e})=>[e,!1]),Be.map(({name:e})=>[e,!1])].flat()),it=(e=!1)=>{const o=m(b);return R(["schemaObjects",o,e],()=>Qr(o),{isPaused:()=>e,refreshInterval:t=>Object.values(t||[]).some(d=>!d)?1e3:0,fallbackData:vi})},C=()=>{const a=m(b),{database:e}=a,o=z(a,["database"]),t=m(rt),r=R(["isConnected",o],()=>Zr(o)),d=it(!r.data);return{isVapor:!!t,connected:!!r.data,initialized:!!r.data&&Object.values(d.data||[]).every(Boolean),reset:()=>{r.mutate(),d.mutate()}}},bi=(()=>{let e={};return o=>(o in e||(e[o]=1),`${o}(${e[o]++})`)})(),Qe=(e,{name:o,enabled:t,intervalMS:r})=>{const d=to(Ze(o));g.exports.useEffect(()=>{if(!t)return;const a=new AbortController,n=bi(o);console.log(`Starting ${n}: tick interval: ${r}ms`);const l=async()=>{try{if(console.time(n),a.signal.aborted)return;const c=performance.now();await e(a);const u=performance.now()-c;d(u),setTimeout(l,Math.max(0,r-u))}catch(c){if(a.signal.aborted||c instanceof D&&c.isUnknownDatabase()||c instanceof DOMException&&c.name==="AbortError")return;throw c}finally{console.timeEnd(n)}};return l(),()=>{console.log(`Stopping ${n}`),a.abort()}},[t,e,r,o,d])},hi=({before:e,after:o,includeSeedData:t})=>{const r=m(b),d=m(te),{reset:a}=C(),[n,l]=P(re),c=Do(),u=m(yi),p=to(He);return g.exports.useCallback(async()=>{const y=n;l(!1),p(!0),e(),await ei(r,{progress(f,v){const N="reset-schema";c.isActive(N)?c.update(N,{title:f,status:v,duration:v==="success"?2e3:null,isClosable:!0}):c({id:N,title:f,status:v,duration:null})},scaleFactor:d,includeSeedData:t,skipCreate:!!u}),o(),a(),l(y),p(!1)},[n,l,p,e,r,d,t,u,o,a,c])},dt=(e,o)=>{const[t,r]=g.exports.useState(e);return g.exports.useEffect(()=>{const d=setTimeout(()=>r(e),o);return()=>clearTimeout(d)},[e,o]),t},at=()=>{const[{elapsed:e,isRunning:o},t]=g.exports.useReducer((r,d)=>{switch(d.type){case"start":return{start:Math.floor(performance.now()),isRunning:!0,elapsed:r.elapsed};case"stop":return{elapsed:Math.floor(performance.now())-(r.start||0),isRunning:!1}}},{isRunning:!1});return{elapsed:e,isRunning:o,startTimer:()=>t({type:"start"}),stopTimer:()=>t({type:"stop"})}},nt=(e,o)=>{let t=!1,r=new kt(0,0),d=0;e.on("pointerdown",a=>{t=!0,r=a.data.global,d=performance.now()}),e.on("pointerup",a=>{if(!t||(t=!1,performance.now()-d>200))return;const l=a.data.global;Math.sqrt(Math.pow(l.x-r.x,2)+Math.pow(l.y-r.y,2))>10||o(a)}),e.on("pointercancel",()=>{t=!1})};class Ei extends Z{constructor(o,t){super();S(this,"gfx");S(this,"hover",!1);this.city=o,this.onRemove=t,this.gfx=new Ae,this.addChild(this.gfx),this.gfx.interactive=!0,this.gfx.on("pointerover",()=>{this.hover=!0}),this.gfx.on("pointerout",()=>{this.hover=!1}),nt(this.gfx,()=>t(this.city))}update(o){this.gfx.clear(),this.gfx.lineStyle(1,this.hover?16711680:306687,1),this.gfx.beginFill(this.hover?16711680:306687,.2);const[t,r]=o([this.city.centerLat,this.city.centerLon]);this.gfx.drawCircle(t,r,25),this.gfx.endFill()}}const _i=e=>{const o=m(b),{initialized:t}=C();return R(["cities",o,t],()=>ni(o),{isPaused:()=>!t,onSuccess:e})},Ti=({scene:e,latLngToPixel:o,pixelToLatLng:t,width:r,height:d})=>{const a=m(b),n=Lo(()=>new Z),{mutate:l}=_i(p=>{n.removeChildren();for(let y=0;y<p.length;y++)n.addChild(new Ei(p[y],u))}),c=g.exports.useCallback(async(p,y)=>{const f=await ci(a,y,p),v={id:f.id,name:f.name,lonlat:[f.centerLon,f.centerLat],diameter:f.diameter};await jo(a,v),await yo(a,v,K[0]),l()},[a,l]),u=g.exports.useCallback(async p=>{await xr(a,p.id),l()},[a,l]);return{setup:g.exports.useCallback(()=>{const p=new Z;e.addChild(p),e.addChild(n),p.interactive=!0,p.hitArea=new Dt(0,0,r,d),nt(p,y=>{const[f,v]=t([y.data.global.x,y.data.global.y]);c(f,v)})},[n,d,c,t,e,r]),update:g.exports.useCallback(()=>{for(let p=0;p<n.children.length;p++)n.children[p].update(o)},[n,o])}},Si=e=>i(Ue,_(h({},e),{useRenderer:Ti,options:{},cursor:"pointer"})),Ni=xt({a:t=>{var r=t,{children:e}=r,o=z(r,["children"]);const{href:d}=o,a=!!(d!=null&&d.startsWith("http"));return a?s(V,_(h({isExternal:a},o),{children:[e,i(zt,{bottom:"2px",boxSize:"0.9em",position:"relative",ml:1})]})):i(V,_(h({to:d||""},o),{as:xo,children:e}))}}),T=t=>{var r=t,{children:e}=r,o=z(r,["children"]);return i(Pt,_(h({},o),{skipHtml:!0,components:Ni,children:Array.isArray(e)?e.filter(d=>d).map(d=>$(d||"")).join(`
...
`):$(e)}))},Ri=()=>s(q,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(q,{maxW:"container.md",mb:10,children:i(T,{children:`
          ...
          `})}),i(Oi,{})]}),Oi=()=>s(A,{children:[i(q,{maxW:"container.md",mb:4,children:i(T,{children:`
            #### Cities
          ...
          `})}),i(k,{flex:2,children:i(lt,{height:400,defaultZoom:14,useCells:zi,getCellConfig:({conversionRate:e,wktPolygon:o})=>{const t=Pi(e);return{color:t,hoverColor:t.brighter(1),wktPolygon:o}}})})]}),be=({label:e,placeholder:o,value:t,setValue:r,helpText:d,type:a="text"})=>s(ro,{children:[i(io,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:e}),i(zo,{size:"sm",placeholder:o,value:t,onChange:n=>r(n.target.value),type:a}),d?i(Yt,{fontSize:"xs",children:d}):null]}),Ui=()=>{const[e,o]=P(te);return s(ro,{children:[i(io,{mb:1,fontSize:"xs",fontWeight:"bold",textTransform:"uppercase",children:"Scale Factor"}),i(Ht,{size:"sm",required:!0,value:e.name,onChange:t=>{const r=t.target.value;o(ui(r))},children:K.map(t=>i("option",{value:t.name,children:t.name},t.name))})]})},ut=({showDatabase:e,showScaleFactor:o})=>{const[t,r]=P(et),[d,a]=P(ot),[n,l]=P(tt),[c,u]=P(oe);return s(F,{spacing:4,children:[i(be,{label:"Host & Port",placeholder:"http://127.0.0.1:8808",value:t,setValue:r,helpText:i(T,{children:`
              The protocol (http, https), host, and port for the SingleStore
              [HTTP API][1].

              [1]: https://docs.singlestore.com/docs/http-api/
            `})}),s(ke,{columns:2,gap:2,children:[i(be,{label:"Username",placeholder:"admin",value:d,setValue:a}),i(be,{label:"Password",placeholder:"",value:n,setValue:l,type:"password"}),e&&i(be,{label:"Database",placeholder:"martech",value:c,setValue:u}),o&&i(Ui,{})]})]})},yt=e=>i(O,_(h({onClick:()=>{const{pathname:o,hash:t}=window.location;window.location.replace(o+t)},colorScheme:"red"},e),{children:"Disconnect"})),gt=e=>{const{connected:o,initialized:t}=C(),r=ao(),[d,a]=Q(),n=m(oe),l=pe.useRef(null),f=e,{skipSeedData:c,disabled:u}=f,p=z(f,["skipSeedData","disabled"]),y=hi({before:g.exports.useCallback(()=>a.on(),[a]),after:g.exports.useCallback(()=>{a.off(),r.onClose()},[r,a]),includeSeedData:!c});return s(A,{children:[i(O,h({disabled:!o||u,onClick:r.onOpen,colorScheme:t?"green":"red"},p)),i(Wt,{isOpen:r.isOpen,onClose:r.onClose,closeOnEsc:!1,closeOnOverlayClick:!1,leastDestructiveRef:l,children:i(no,{children:s(jt,{children:[s(co,{fontSize:"lg",fontWeight:"bold",children:[t?"Reset":"Setup"," database ",n]}),s(lo,{children:["This will ",t?"recreate":"create"," the database called ",n,". Are you sure?"]}),s(Po,{children:[i(O,{ref:l,onClick:r.onClose,disabled:d,children:"Cancel"}),i(O,{disabled:d,colorScheme:t?"red":"green",onClick:y,ml:3,children:d?i(U,{}):t?"Recreate database":"Create database"})]})]})})})]})},Bi=({isOpen:e,onClose:o,finalFocusRef:t})=>{const[r,d]=P(re),{session:a,refresh:n}=ge(),l=r&&a.isController,c=m(b),{connected:u,initialized:p,isVapor:y}=C(),f=ao(),[v,N]=Q(!1),H=g.exports.useCallback(async()=>{N.on();const J=!(r&&a.isController);d(J),await Qo(c,a.sessionId,J),n(),N.off()},[c,r,n,a.isController,a.sessionId,d,N]),[ie,W]=Q(!1),de=g.exports.useCallback(async()=>{W.on(),await Xo(c),W.off()},[c,W]);return s(Vt,{isOpen:e,placement:"right",onClose:o,finalFocusRef:t,children:[i(no,{}),s($t,{children:[i(Mo,{}),i(co,{children:"Config"}),i(lo,{children:s(F,{spacing:4,children:[y?null:i(ut,{showScaleFactor:!0,showDatabase:!0}),s(Ee,{status:u?"success":"error",borderRadius:"md",children:[i(_e,{}),i(Te,{children:u?"connected":"disconnected"}),y?i(yt,{position:"absolute",right:4,top:3,size:"xs"}):null]}),s(Ee,{status:p?"success":"warning",borderRadius:"md",children:[i(_e,{}),i(Te,{children:"schema"}),i(gt,{position:"absolute",right:4,top:3,size:"xs",children:p?"Reset":"Setup"})]}),s(Ee,{status:l?"success":"warning",borderRadius:"md",children:[i(_e,{}),i(Te,{children:"simulator"}),i(Kt,{position:"absolute",right:4,top:3.5,size:"md",colorScheme:l?"green":"red",isChecked:l,disabled:!u||!p||v,onChange:H})]}),s(ye,{onClick:f.onToggle,fontSize:"xs",textAlign:"center",cursor:"pointer",children:["Advanced",f.isOpen?i(Xt,{ml:2}):i(ne,{ml:2})]}),f.isOpen?i(O,{size:"xs",_hover:{colorScheme:"red"},onClick:de,disabled:ie,children:"Drop Database"}):void 0]})}),i(Po,{})]})]})},he=({to:e,children:o,onClick:t})=>{const r=tr(e),d=rr({path:r.pathname,end:!0});return i(V,{as:xo,to:e,px:2,py:1,onClick:t,rounded:"md",_hover:{textDecoration:"none",bg:Ce("gray.300","gray.600")},fontWeight:d?"bold":"normal",href:"#",color:Ce("gray.700","gray.200"),children:o})},Fi=()=>{const{colorMode:e,toggleColorMode:o}=De(),t=ao(),[r,d]=P(mi),a=pe.useRef(null),{connected:n,initialized:l}=C(),c=m(re),[u]=Uo("(max-width: 640px)"),{session:p}=ge(),y=s(A,{children:[i(he,{to:"/",onClick:t.onClose,children:"Overview"}),i(he,{to:"/map",onClick:t.onClose,children:"Map"}),i(he,{to:"/admin",onClick:t.onClose,children:"Admin"}),i(he,{to:"/analytics",onClick:t.onClose,children:"Analytics"})]}),f=n?l&&c&&p.isController?"green":"yellow":"red";let v;return u||(v=n?l?c&&p.isController?"connected":"simulator disabled":"needs schema":"disconnected"),i(A,{children:i(k,{bg:Ce("gray.200","gray.700"),children:s(q,{maxW:"container.lg",children:[s(Ie,{h:16,alignItems:"center",justifyContent:"space-between",children:[i(Ve,{size:"md",icon:t.isOpen?i(qt,{}):i(Jt,{}),"aria-label":"Open Menu",display:{md:"none"},onClick:t.isOpen?t.onClose:t.onOpen}),s(we,{spacing:8,alignItems:"center",children:[i(xe,{as:"h1",size:u?"sm":"md",children:u?"Martech":"Realtime Digital Marketing"}),i(we,{as:"nav",spacing:4,display:{base:"none",md:"flex"},children:y})]}),s(Ie,{alignItems:"center",gap:2,children:[s(O,{size:"sm",ref:a,onClick:()=>d(!0),colorScheme:f,children:[f==="green"?i(Bo,{}):i(Fo,{}),u||i(ye,{pl:2,children:v})]}),i(Ve,{"aria-label":"Github Repo",size:"sm",icon:e==="light"?i(Zt,{size:"1.4em"}):i(Qt,{size:"1.4em"}),onClick:()=>window.open("https://github.com/singlestore-labs/demo-realtime-digital-marketing","_blank")}),i(Ve,{"aria-label":"Toggle Color Mode",size:"sm",onClick:o,icon:e==="light"?i(er,{boxSize:"1.2em"}):i(or,{boxSize:"1.2em"})})]})]}),t.isOpen?i(k,{pb:4,display:{md:"none"},children:i(F,{as:"nav",spacing:4,children:y})}):null,i(Bi,{isOpen:r,onClose:()=>d(!1),finalFocusRef:a})]})})})},Gi=ue("~s"),ft=(e,...o)=>{const t=g.exports.useMemo(()=>o.reduce((a,n)=>_(h({},a),{[n]:[]}),{}),[o]),r=g.exports.useRef(t),{data:d}=R(["estimatedRowCount.timeseries",...o],async()=>{const a=await Ye(e,...o),n=new Date;return r.current=o.reduce((l,c)=>{const u=r.current[c];return u.push([n,a[c]]),l[c]=u.slice(-30),l},{}),r.current},{refreshInterval:1e3});return d!=null?d:t},mt=r=>{var d=r,{data:e,yAxisLabel:o}=d,t=z(d,["data","yAxisLabel"]);const{colorMode:a}=De(),n=Object.keys(e),l=g.exports.useCallback(({tooltipData:p,colorScale:y})=>!y||!p?null:n.sort((f,v)=>p.datumByKey[v].datum[1]-p.datumByKey[f].datum[1]).map(f=>{const{datum:v}=p.datumByKey[f];return s(ye,{mb:1,color:y(f),fontSize:"sm",children:[f,": ",ue(".4~s")(v[1])]},f)}),[n]),c=g.exports.useCallback(p=>Gi(p).replace("G","B"),[]);if(n.some(p=>e[p].length<2))return i(M,{height:t.height,children:i(U,{size:"md"})});const u=n.map(p=>i(ir,{dataKey:p,data:e[p],xAccessor:y=>y[0],yAccessor:y=>y[1]},p));return s(dr,_(h({xScale:{type:"time"},yScale:{type:"sqrt",nice:!0,zero:!1,clamp:!0},theme:a==="light"?ar:nr,margin:{left:0,right:50,top:10,bottom:40}},t),{children:[i(So,{orientation:"bottom",numTicks:5,label:"time",labelOffset:10}),i(So,{orientation:"right",numTicks:t.height<250?3:5,tickFormat:c,label:o,labelOffset:20}),u,i(cr,{showVerticalCrosshair:!0,detectBounds:!1,offsetLeft:-175,offsetTop:20,renderTooltip:l})]}))},oo=1e3,Re=60*oo,Oe=60*Re,Ke=24*Oe,B=e=>e.toLocaleString(void 0,{maximumFractionDigits:2}),X=e=>e?e<oo?`${B(e)}ms`:e<Re?`${B(e/oo)}s`:e<Oe?`${Math.floor(e/Re)}m${X(e%Re)}`:e<Ke?`${Math.floor(e/Oe)}h${X(e%Oe)}`:`${Math.floor(e/Ke)}d${X(e%Ke)}`:"0s",Yi=100,Hi=1e3,j=class extends Z{constructor(o){super();S(this,"latlng");S(this,"age",0);S(this,"marker");S(this,"pulse");this.latlng=o,this.marker=new Ae,this.marker.beginFill(j.markerColor).drawCircle(0,0,5).endFill(),this.addChild(this.marker),this.pulse=new Ae,this.pulse.beginFill(j.pulseColor),this.pulse.drawTorus&&this.pulse.drawTorus(0,0,4,6),this.pulse.endFill(),this.addChild(this.pulse)}update(o,t){if(this.age+=t/60,this.age>j.lifetime&&this.parent){this.parent.removeChild(this);return}const r=this.age%j.lifetime/j.lifetime,d=ur(r);this.pulse.scale.set(1+d);const a=.4,n=r<a?lr(r/a):1-sr((r-a)/(1-a));this.pulse.alpha=n,r<a?this.marker.alpha=n:this.marker.alpha=1-pr((r-a)/(1-a));const[l,c]=o(this.latlng);this.x=l,this.y=c}};let ce=j;S(ce,"lifetime",1.5),S(ce,"markerColor",306687),S(ce,"pulseColor",306687);const vt=()=>{const e=m(b),{initialized:o}=C();return g.exports.useMemo(()=>["notifications",e,o],[e,o])},bt=({scene:e,latLngToPixel:o,bounds:t})=>{const r=g.exports.useRef(new Date().toISOString()),d=m(b),{initialized:a}=C(),n=dt(t,50),l=vt();return R(l,()=>di(d,r.current,Yi,n),{refreshInterval:Hi,isPaused:()=>!a,onSuccess:c=>{if(c.length>0){r.current=c[0][0];for(const[,u,p]of c)e.addChild(new ce([p,u]))}}}),{update:g.exports.useCallback(c=>{for(let u=e.children.length-1;u>=0;u--)e.children[u].update(o,c)},[o,e])}},Wi=()=>{const e=m(b),o=ft(e,"locations","requests","purchases","notifications","subscriber_segments"),t=R(["notificationsMapTableCounts",e],()=>Ye(e,"offers","subscribers","cities","segments"),{refreshInterval:1e3}),r=m(Ze("SimulatorMatcher")),d=m(Ze("SimulatorUpdateSegments")),a=ue(".4~s"),n=t.data?s(ke,{spacing:2,minChildWidth:"120px",children:[s(I,{children:[i(w,{children:"Offers"}),i(L,{children:a(t.data.offers)})]}),s(I,{children:[i(w,{children:"Cities"}),i(L,{children:a(t.data.cities)})]}),s(I,{children:[i(w,{children:"Subscribers"}),i(L,{children:a(t.data.subscribers)})]}),s(I,{children:[i(w,{children:"Segments"}),i(L,{children:a(t.data.segments)})]}),s(I,{children:[i(w,{children:"Segmentation"}),i(L,{children:X(d)})]}),s(I,{children:[i(w,{children:"Matching"}),i(L,{children:X(r)})]})]}):null;return s(A,{children:[i(T,{children:`
          ...
          about the demo.
        `}),n,s(k,{children:[i(ye,{fontSize:"sm",fontWeight:"medium",children:"Row count / time"}),i(mt,{data:o,yAxisLabel:"total rows",height:150})]})]})},ji=()=>{const e=m(re);return bo(e),st(e),s(Ie,{gap:4,justifyContent:"space-between",direction:["column","column","row"],height:"100%",children:[i(F,{spacing:4,flex:"2 2 0",minHeight:"200px",maxHeight:"100%",children:i(Ue,{useRenderer:bt,options:{}})}),s(F,{spacing:4,flex:"1 1 0",minWidth:"0",children:[i(T,{children:`
          ...
          `}),e?i(Wi,{}):i(ct,{})]})]})},ht=t=>{var r=t,{children:e}=r,o=z(r,["children"]);return i(yr,_(h({as:"pre",borderRadius:"md",overflow:"auto",display:"block",px:6,py:4,minW:0},o),{children:e}))},Vi=1e3,$i=(e,o)=>{const t=m(b),{initialized:r}=C();R(["offers",t,r,e],()=>ai(t,Vi,e),{isPaused:()=>!r,onSuccess:o})},Ki=e=>i(lt,_(h({},e),{useCells:$i,getCellConfig:o=>{const t=qe(4,173,255);return{color:t,hoverColor:t.brighter(1),wktPolygon:o.notificationZone}}})),Xi=e=>e.every(([,o])=>o===0),G=e=>{const{completed:o,title:t,left:r,right:d}=e,{colorMode:a}=De(),n=a==="light"?".300":".500",l=o?"gray"+n:void 0,c=(o?"green":"gray")+n;return s(A,{children:[s(Le,{children:[s(xe,{as:"h2",size:"lg",mb:4,color:l,children:[i(Bo,h({color:c},{boxSize:6,position:"relative",bottom:.5,mr:2})),t]}),r]}),i(Le,{children:d})]})},qi=({connected:e,isVapor:o})=>o?i(G,{completed:e,title:"Connected",left:s(A,{children:[i(T,{children:`
          ...
          `}),right:u||!r?i(M,{h:220,children:s(O,{colorScheme:"blue",size:"sm",onClick:n,disabled:r,children:[(d||r)&&i(U,{mr:2}),d?"Creating Pipelines":r?"...waiting for data":"Create pipelines"]})}):i(mt,{data:c,yAxisLabel:"total rows",height:200})})},We=(e,o=!0)=>R(["overviewTableCounts",e],()=>Ye(e,"locations","notifications","offers","purchases","requests","segments","subscriber_segments","subscribers"),{isPaused:()=>!o}),ed=()=>{var l,c;const e=m(b),o=m(te),[t,r]=Q(),d=We(e),a=g.exports.useCallback(async()=>{r.on(),await yo(e,se,o),d.mutate(),r.off()},[e,o,d,r]),n=!!((l=d.data)!=null&&l.offers);return i(G,{completed:n,title:"Offers",left:i(A,{children:s(T,{children:[`
            ...
            `,n&&`
                ...
                database.
            `]})}),right:n?i(Ki,{height:300,defaultZoom:13}):i(M,{h:"100%",children:s(O,{onClick:a,disabled:t,children:[t&&i(U,{mr:2}),t?"loading...":n?"loaded offers!":"load offers"]})})})},od=({done:e,setDone:o})=>{const t=m(b),r=g.exports.useRef(new Date().toISOString());return g.exports.useEffect(()=>{if(e)return;const d=new AbortController,a=_(h({},t),{ctx:d});return(async()=>{try{for(let n=0;n<10;n++)if(r.current=await fo(a,r.current,!1),await go(a,"second"),n>1&&!await Zo(a))return}catch(n){if(d.signal.aborted||n instanceof DOMException&&n.name==="AbortError")return;throw n}})().then(()=>o(!0)),()=>{d.abort()}},[t,e,o]),e?null:i(Le,{colSpan:[1,1,2],children:s(M,{w:"100%",h:"200px",color:"gray.500",children:[i(U,{size:"md",mr:4}),i(xe,{size:"md",children:"Warming up queries..."})]})})},td=()=>{var p;const e=m(b),o=We(e),{elapsed:t,isRunning:r,startTimer:d,stopTimer:a}=at(),n=g.exports.useRef(new Date().toISOString()),l=!!((p=o.data)!=null&&p.subscriber_segments),c=g.exports.useCallback(async()=>{d(),n.current=await fo(e,n.current),a(),o.mutate()},[e,o,d,a]);let u;if(t&&o.data){const{segments:y,subscriber_segments:f,locations:v,requests:N,purchases:H}=o.data,ie=X(t),W=B(v+N+H),de=B(y),J=B(f);u=i(T,{children:`
        ...
        `})}return i(G,{completed:l,title:"Segmentation",left:i(T,{children:`
          ...
          `}),right:i(M,{h:"100%",children:s(Go,{gap:4,textAlign:"center",children:[s(O,{disabled:r,onClick:c,children:[r&&i(U,{mr:2}),r?"...running":"Match subscribers to segments"]}),u]})})})},rd=()=>{var v;const e=m(b),o=We(e),t=vt(),{mutate:r}=mr(),{elapsed:d,isRunning:a,startTimer:n,stopTimer:l}=at(),[c,u]=g.exports.useState(0),p=!!((v=o.data)!=null&&v.notifications),y=g.exports.useCallback(async()=>{let N=0,H=0;for(;N===0&&H++<10;)n(),N=await go(e,"second");l(),u(N),o.mutate(),r(t)},[e,n,l,o,r,t]);let f;if(d&&o.data){const{offers:N,subscribers:H,subscriber_segments:ie,notifications:W}=o.data,de=B(N*H+W),J=B(ie),Tt=X(d),St=B(c);f=i(T,{children:`
        ...
        `})}return i(G,{completed:p,title:"Matching",left:i(T,{children:`
          ...
          `}),right:i(M,{h:"100%",children:s(Go,{gap:4,w:"100%",children:[s(O,{disabled:a,onClick:y,children:[a&&i(U,{mr:2}),a?"...running":"Generate notifications"]}),i(k,{width:"100%",children:i(Ue,{height:250,defaultZoom:12,useRenderer:bt,options:{}})}),f]})})})},id=()=>{const e=m(oe);return i(G,{completed:!0,title:"Putting it all together",left:i(T,{children:`
            ...
            * Explore the ${e} database in SingleStore Studio
            ...
            [1]: map
          `}),right:null})},dd=()=>{const e=m(b),o=m(te),{connected:t,initialized:r,isVapor:d}=C(),{completed:a}=Et(e,o,t&&r),{data:n}=We(e,t&&r),[l,c]=g.exports.useState(!1),u=[{completed:t,component:i(qi,{connected:t,isVapor:d},"connection")},{completed:r,component:i(Zi,{initialized:r},"schema")},{completed:a,component:i(Qi,{},"pipelines")},{completed:n?n.offers>0:!1,component:i(ed,{},"offers")},{completed:l,component:i(od,{done:l,setDone:c},"warmup")},{completed:n?n.subscriber_segments>0:!1,component:i(td,{},"segmentation")},{completed:n?n.notifications>0:!1,component:i(rd,{},"matching")},{completed:!0,component:i(id,{},"summary")}];let p=!0;const y=[];for(const{completed:f,component:v}of u)if(p)y.push(v),p=f;else break;return s(q,{maxW:"container.lg",mt:10,mb:"30vh",children:[i(k,{maxW:"container.md",mb:10,px:0,children:i(T,{children:`
